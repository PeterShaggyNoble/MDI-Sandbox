{
	...
	/** PAGE SETUP **/
		page={
			light:false/*(u.pathname.substring(1,6)||u.hash.substr(1))==="light"*/,
			params:u.searchParams,
			header:$`header`,
			message:$`message`,
			textarea:d.createElement`textarea`,
			init(){
				b.dataset.light=this.light.toString();
				if(this.light)
					$`fab`.remove();
				...
				/*if(u.search.substring(1,5)==="test")
					icons.test();*/
			},
			copy(str,msg){
	...
	/** SIDEBAR **/
		info={
			...
			init(){
				if(page.light)
					this.actions.link.classList.add`dn`;
				/*if(!["ftp:","http:","https:"].includes(u.protocol))
					this.actions.url.classList.add`dn`;*/
				this.figure.classList.add(page.light?"ffmdl":"ffmd");
			...
			set(icon){
				...
				this.actions.html.dataset.copy=`<span class="${page.light?"mdil mdil":"mdi mdi"}-${icon}"></span>`;
				/*this.actions.name.dataset.copy=`${page.light?"mdil":"mdi"}-${icon}`;*/
				this.actions.link.dataset.url=`https://materialdesignicons.com/icon/${icon}${page.light?"/light":""}`;
				let hex=icons.list[icon].hex;
				this.img.src=!hex?`data:image/svg+xml;utf8,<?xml version="1.0" encoding="UTF-8"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"><path d="${icons.paths[icon]}"/></svg>`:"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=";
				this.aside.dataset.nocopy=(!(this.copy=!!hex)).toString();
				this.aside.dataset.nodownload=(!(this.path=icons.paths[icon])).toString();
			...
			download(){
				if(icons.list[this.name]){
					if(this.path){
						...
						/*icons.check(this.anchor.href=page.light?`https://raw.githubusercontent.com/Templarian/MaterialDesignLight/master/icons/svg/${name}.svg`:`https://materialdesignicons.com/api/download/icon/svg/${icons.list[name].id}`).then(()=>{*/
						if(this.type==="svg")
							icons.check(this.anchor.href=!icons.list[this.name].hex?`/svg/${page.light?"mdil":"mdi"}/${this.name}.svg`:`https://raw.githubusercontent.com/Templarian/MaterialDesign${page.light?"Light":""}/master/icons/svg/${this.name}.svg`).then(()=>{
	...
	/** CATEGORIES **/
		category=class{
			constructor(name,hex){
				Object.assign(this,{name,hex});
			}
			add(key){
				let 	section=categories.sections[key]=categories.section.cloneNode(0),
					heading=categories.heading.cloneNode(1),
					item=categories.item.cloneNode(1);
				section.dataset.name=key;
				heading.firstChild.nodeValue=item.firstChild.nodeValue=this.name;
				section.append(heading);
				m.append(section);
				item.dataset.icon=String.fromCharCode(`0x${this.hex}`);
			...
			init(){
				...
				for(let key in this.list)
					if(this.list.hasOwnProperty(key))
						if(!page.light||(key!=="new"&&key!=="updates"&&key!=="soon"))
							this.list[key].add(key);
						else if(page.light)
							delete this.list[key];
			},
			list:{
				"favourites":new category("My Favourites","f2d1"),
				"new":new category(`New in v${v}`,"f6bc"),
				"updates":new category(`Updated in v${v}`,"f453"),
				"soon":new category("Coming Soon","f6af"),
				"other":new category("Uncategorised","f2d6"),
				"arrows":new category("Arrows","f054"),
				"time":new category("Date & Time","f0f0"),
				"tech":new category("Devices & Hardware","f379"),
				"editor":new category("Editing & Formatting","f3eb"),
				"files":new category("Files & Folders","f224"),
				"food":new category("Food & Drink","f25a"),
				"google":new category("Google","f2ad"),
				"logos":new category("Logos & Brands","f032"),
				"player":new category("Media Player Controls","f40a"),
				"money":new category("Money & Payments","f1ad"),
				"characters":new category("Numbers, Letters & Symbols","f295"),
				"networking":new category("Networking","f318"),
				"nature":new category("Nature & Animals","f38e"),
				"places":new category("Places & Landmarks","f34e"),
				"power":new category("Power","f425"),
				"science":new category("Science & Medicine","f093"),
				"sport":new category("Sport","f4e3"),
				"travel":new category("Travel & Transport","f01d"),
				"users":new category("Users & Accounts","f004"),
				"weather":new category("Weather","f599")
			}
		},
	/** CONTRIBUTORS **/
		/*contributors={
			list:{
				"templarian":{name:"Austin Andrews"},
				"google":{name:"Google"},
				"alexefremo":{name:"Alex Efremo"},
				"splitbrain":{name:"Andreas Gohr"},
				"casesandberg":{name:"Case Sandberg"},
				"chrislitherland":{name:"Chris Litherland"},
				"diaryofabastard":{name:"Peter \"Shaggy\" Noble"},
				"infanf":{name:"Christopher Schreiner"},
				"xt3000":{name:"Cody"},
				"r3volution11":{name:"Doug C. Hardester"},
				"lastrosestudios":{name:"Gabriel"},
				"japanyoshilol":{name:"JapanYoshi"},
				"eccentric_jay":{name:"Jay Zawrotny"},
				"kaifaust":{name:"Kai Faust"},
				"krambertech":{name:"Kateryna Porshnieva"},
				"kumvert":{name:"Andy Martinez"},
				"mririgo":{name:"Michael Irigoyen"},
				"mrgrigri":{name:"Michael Richins"},
				"rejack89":{name:"REJack"},
				"robertogrrraham":{name:"Roberto Graham"},
				"_selectlol":{name:"Augustin Ursu"},
				"greenturtwig":{name:"Rowan"},
				"thunsaker":{name:"Thomas Hunsaker"},
				"belledeboheme":{name:"Yasmina Lembachar"}
			}
		},*/
	/** ICONS **/
		icon=class{
			constructor(id="",hex="",light=1,contributor="google",categories="other",aliases="",keywords="",added=0,updated=0){
				Object.assign(this,{id,hex,light,contributor,categories:categories.split`,`,aliases,keywords,added,updated});
			}
			add(key){
				let 	article=icons.article,
					img=icons.img,
					hex=this.hex,
				...
				/*article.dataset.contributor=this.contributor;*/
				article.dataset.hex=hex;
				article.dataset.name=key;
				article.dataset.icon=hex?String.fromCharCode(`0x${hex}`):"";
				if(!page.light&&!hex){
					img.src=`data:image/svg+xml;utf8,<?xml version="1.0" encoding="UTF-8"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"><path d="${icons.paths[key]}"/></svg>`;
					article.prepend(img);
				}else img.remove();
				...
				if(!page.light&&this.added===v&&(section=sections.new))
					section.append(article.cloneNode(1));
				if(!page.light&&this.updated===v&&(section=sections.updates))
					section.append(article.cloneNode(1));
				if(!page.light&&!hex&&(section=sections.soon))
					section.append(article.cloneNode(1));
				if(this.aliases.length)
					article.dataset.aliases=this.aliases;
				if(this.keywords.length)
					article.dataset.keywords=this.keywords;
		...
		icons={
			...
			init(){
				...
				for(let key in this.list)
					if(this.list.hasOwnProperty(key))
						if(!page.light||this.list[key].light)
							this.list[key].add(key);
						else if(page.light)
							delete this.list[key];
				/*let xml=new XMLHttpRequest();
				xml.open("GET","https://cdn.materialdesignicons.com/1.9.32/meta.json",1);
					...
					if(xml.readyState===4)
						if(xml.status===200){
							...
							for(let key in this.list){
								if(this.list.hasOwnProperty(key)){
									obj=this.list[key];
									data=json.find(item=>item.name===key);
									if(!data)data={id:"",author:"",aliases:[]};
									if(str.length)
										str+=",\n";
									str+=`\t\t\t\t"${key}":new icon("${data.id}","${obj.hex}",${obj.light},"${data.author}","${obj.categories}","${data.aliases.join(",")}","${obj.keywords}",${obj.added},${obj.updated})`;
								}
							}
							console.log(str);
						}
			...
			/*test(){
				page.alert`Test initiated.`;
				let xml=new XMLHttpRequest();
				xml.open("GET",`https://cdn.materialdesignicons.com/${page.light?"light/0.2.63":"1.9.32"}/meta.json`,1);
				xml.overrideMimeType`application/json`;
				xml.send();
				xml.addEventListener("readystatechange",()=>{
					if(xml.readyState===4)
						if(xml.status===200){
							let	json=JSON.parse(xml.responseText),
								missing=[],
								promises=json.map(obj=>this.check(`https://raw.githubusercontent.com/Templarian/MaterialDesign/master/icons/svg/${obj.name}.svg`).catch(()=>missing.push(obj.name)));
							Promise.all(promises).then(()=>{
								console.log(`%cSVGs Missing from MDI${page.light?"L":""} GitHub`,"background:#212121;color:#fff;font-weight:700;padding:5px;text-transform:uppercase;");
								console.log(missing.join`\n`);
								page.alert`Test results logged to console.`;
							});
						}
				},0);
			},*/
			...
			list:{
 				"access-point":new icon("4F013652-22DE-48CF-886B-A0FB995E8B41","f002",0,"xt3000","networking"),
				"access-point-network":new icon("06048943-9EE5-4FE2-91D7-7DA162E55203","f003",0,"xt3000","networking"),
				"account":new icon("E76EC23F-AB71-49B3-9173-841544527A20","f004",1,"google","users","person","user"),
				"account-alert":new icon("3D869F3A-8C3E-4ECB-829E-7785230FA680","f005",0,"templarian","users",_,"person,user"),
				"account-box":new icon("474D0A31-E56A-4780-9417-DCF8D9A38830","f006",0,"google","users","selfie","person,user"),
				"account-box-outline":new icon("537261C5-1AF6-478F-A8BA-4349865D9C1C","f007",0,"google","users","","person,selfie,user"),
				"account-card-details":new icon("4ACD18FB-87D4-46F1-9231-8BD0A91867A9","f5d2",0,"infanf","users","identification-card","id,person,user",1554),
				"account-check":new icon("F3C76352-A033-4969-BBC4-99E2BEE84FAE","f008",0,"templarian","users","","person,user"),
				"account-circle":new icon("1D7E8F31-998D-442A-80E6-EBB8DFA8CBA2","f009",0,"google","users","","person,user"),
				"account-convert":new icon("A6964E10-1CF0-41FA-BDCA-A77C9C6F30AF","f00a",0,"templarian","users","","person,user"),
				"account-edit":new icon("66271DF7-FF11-4998-9C03-F096CE407E4C","f6bb",0,"mrgrigri","users","","modify,person,user",1836),
				"account-key":new icon("645E04E6-A328-45DD-9B22-03E2296837B1","f00b",0,"rejack89","users","","person,user"),
				"account-location":new icon("CA087C29-F27F-4DBE-8617-1369C18DF51D","f00c",0,"google","users","account-address,user-address","person"),
				"account-minus":new icon("9CF96408-1A24-4040-AD04-011183CC9ABC","f00d",0,"rejack89","users","","person,user"),
				"account-multiple":new icon("A8C2EE6C-31B9-4D51-B941-8128FDD77A96","f00e",0,"google","users","people","accounts,users"),
				"account-multiple-minus":new icon("BD31FA9F-EC76-44E9-A9F3-A85F83045D78","f5d3",0,"templarian","users","","people,users",1554),
				"account-multiple-outline":new icon("30C6B7FE-4496-4961-B36F-E0FBC4F2696E","f00f",0,"google","users","","people,users"),
				"account-multiple-plus":new icon("047F8AC1-524D-4077-BCEB-434FE1C50C8B","f010",0,"google","users","","accounts,people,register,users"),
				"account-network":new icon("8F49C741-4ED8-4DD3-A22E-310C039EDDA6","f011",0,"templarian","networking,users","","accounts,people,users"),
				"account-off":new icon("2306EFC9-3375-4D03-A631-A32BD72075EC","f012",0,"xt3000","users","","person,user"),
				"account-outline":new icon("79ECAAC6-71DC-406C-A9B7-57C5F0BAA9E0","f013",0,"google","users","","person,user"),
				"account-plus":new icon("66556BA4-6B65-4ED9-B813-AD33CA8C2CCF","f014",0,"google","users","register","person,user"),
				"account-remove":new icon("0A1FDBBB-9E1C-480E-BC1D-725778D0851B","f015",0,"rejack89","users","","person,user"),
				"account-search":new icon("48E9C474-C544-4868-9966-C3A8D7808FCA","f016",0,"rejack89","users","","magnify,person,user,zoom",0,1554),
				"account-settings":new icon("A975CEEA-FDFD-49A2-A618-E74A3FF87A63","f630",0,"templarian","users","","person,user",1650),
				"account-settings-variant":new icon("3696B7DF-3E12-44EF-B27F-E171AEB5241F","f631",0,"xt3000","users","","person,user",1650),
				"account-star":new icon("1E04960E-FFFE-439D-A5FD-C51E7291DA6F","f017",0,"rejack89","users","","person,user"),
				"account-switch":new icon("FC4F4C4D-83C2-493F-9606-CA80E44BFEF8","f019",0,"templarian","users","","accounts,people,person,user,users"),
				"adjust":new icon("3334E19F-962D-45B4-BE11-F009E1192165","f01a",0),
				"air-conditioner":new icon("FACEA69B-49F0-4588-BDEC-693965AD4649","f01b",0,"xt3000"),
				"airballoon":new icon("3E1D81B2-7DF1-4AAF-9598-4995B8D8E5CC","f01c",0,"templarian","travel","","hot,baloon"),
				"airplane":new icon("5AE3D483-1E1C-49DE-92FF-21C6B93FD52F","f01d",0,"google","places,travel","","aeroplane,plane"),
				"airplane-landing":new icon("634EE7E8-8280-4CF1-B642-0921E740B6DB","f5d4",0,"google","travel","","aeroplane,plane",1554),
				"airplane-off":new icon("D2D1D38E-ABE7-47B6-9405-DC6BDBA1C335","f01e",0,"google","travel","","aeroplane,plane"),
				"airplane-takeoff":new icon("2B9BB7A1-A94B-4D24-8308-5599504317C2","f5d5",0,"google","travel","","aeroplane,plane",1554),
				"airplay":new icon("CD5DD59A-965F-455E-912B-9535BFD134E0","f01f",0,"google","logos","","apple"),
				"alarm":new icon("9A1AAF33-6F36-4987-9E8C-798E34D919A9","f020",1,"google","time","","clock"),
				"alarm-bell":new icon("02423F51-52A3-4F45-8373-05CA8E8D57B7","f78d",0,"mrgrigri","other","","",2046),
				"alarm-check":new icon("6DCCA48F-E413-4C45-BFE5-8E3C8BE61A4E","f021",0,"google","time","","clock"),
				"alarm-light":new icon("B6D88F9D-A85A-4943-A61C-7D33FB0EBF4F","f78e",0,"mrgrigri","other","","",2046),
				"alarm-multiple":new icon("67D410AB-495A-41BD-B9D8-20A7DFBBF623","f022",0,"templarian","time","","clocks"),
				"alarm-off":new icon("DD224DD6-9A65-47AB-8838-90FE346A7768","f023",0,"google","time","","clock"),
				"alarm-plus":new icon("6D93F44C-83F7-4446-A5CD-E4135C8644D7","f024",1,"google","time","","clock"),
				"alarm-snooze":new icon("28F85724-265B-4C24-9975-DDDF788A99E5","f68d",0,"google","time","","clock",1712),
				"album":new icon("8529D611-F581-4808-95BE-271FB1A6C2FD","f025",0),
				"alert":new icon("9FF7DF3F-D575-433B-9C9A-69C58363C186","f026"),
				"alert-box":new icon("7B5D47A1-5658-4169-94C7-0C41E7179DD2","f027",0,"templarian"),
				"alert-circle":new icon("C7EDD5B7-95D4-4D83-A4E3-95D8A16A4887","f028"),
				"alert-circle-outline":new icon("0F4002B4-3C3D-43C4-939F-A998B2C59177","f5d6",0,"google","other","","issue",1554),
				"alert-octagon":new icon("9BC1A338-CD03-4D39-BE46-E9DE5EE51A2F","f029"),
				"alert-decagram":new icon("B4866C08-2DAE-4B0A-8942-E057094B3C76","f6bc",0,"google","other","","new,release",1836,1932),
				"alert-octagram":new icon("124F37BE-27F6-4524-9655-A18D28E91CA6","f766",0,"templarian","other","","new,release",1932),
				"alert-outline":new icon("4E574535-954C-42F5-BE5B-DF3716DB7C5A","f02a",0,"xt3000"),
				"all-inclusive":new icon("5596E6E7-916E-4870-9346-5D46BC86C0D5","f6bd",0,"google","other","","",1836),
				"alpha":new icon("0B93DD30-B279-4997-BD6D-AC86E29D34CA","f02b",0,"templarian","characters"),
				"alphabetical":new icon("EAD8BAC5-EE7C-4553-9316-F45094CF9C7A","f02c",0,"templarian","characters","","abc"),
				"altimeter":new icon("1F7A2F31-3549-4F3C-A95E-E7356033A601","f5d7",0,"xt3000","science","","",1554),
				"amazon":new icon("9AE6BA3C-694B-47D5-99C3-7D063228F053","f02d",0,"templarian","logos"),
				"amazon-clouddrive":new icon("BC1934AD-28E6-4E7C-8C7E-1557CE482CCB","f02e",0,"templarian","logos"),
				"ambulance":new icon("B0DB559B-A9D4-473A-AF6D-C72559CCC9D9","f02f",0,"templarian","travel"),
				"amplifier":new icon("4A952C8C-7A6F-4028-A974-48E4DCE299CF","f030",0,"infanf","other","","",1554),
				"anchor":new icon("8A3C8CCE-D798-446B-A283-90129AD847C9","f031",0,"xt3000","places"),
				"android":new icon("4633B767-FF29-411D-8C04-69057C6B65B2","f032",0,"google","google"),
				"android-debug-bridge":new icon("F9923FF1-E31E-4C03-BBB7-438704CF3909","f033",0,"google","google"),
				"android-head":new icon("FF441E7F-8F7E-4B03-876E-FD65C2A847C9","f78f",0,"","google",_,_,2046),
				"android-studio":new icon("B156B15D-86F9-40E0-8B8E-421F78BE5509","f034",0,"templarian","google"),
				"angular":new icon("549F8173-7E91-411F-9ECF-D04D2B64B386","f6b1",0,"templarian","logos","","",1722),
				"angularjs":new icon("8A82CBEA-C1B3-40C2-96C2-DED8D83DA446","f6be",0,"templarian","logos","","",1836),
				"animation":new icon("4FE8F135-8FF9-427B-8857-122FBB0A300A","f5d8",0,"google","other","","",1554),
				"apple":new icon("2829275C-A01C-42CD-A195-447629791D04","f035",0,"eccentric_jay","logos"),
				"apple-finder":new icon("FAEC5B00-46A8-49AD-87DA-765891B9E387","f036",0,"templarian","logos"),
				"apple-ios":new icon("9B0B7248-3416-4D43-9CE1-13D70949EAA1","f037",0,"google","logos"),
				"apple-keyboard-caps":new icon("070FF4A9-7726-4682-8ABD-AC1800B8D83E","f632",0,"templarian","other","","",1650),
				"apple-keyboard-command":new icon("03043022-A59D-4E31-B385-E6D94D3D9B92","f633",0,"templarian","other","","",1650),
				"apple-keyboard-control":new icon("F24769F6-25C3-4244-8C64-13A514E7CAAD","f634",0,"templarian","other","","",1650),
				"apple-keyboard-option":new icon("C06A94E2-9606-484B-BC0D-D0B9A2FBA76F","f635",0,"templarian","other","","",1650),
				"apple-keyboard-shift":new icon("5AF5B660-DDD5-446A-8AC9-102776DBBBC9","f636",0,"templarian","other","","",1650),
				"apple-mobileme":new icon("BDB8AF3D-28BD-4FF2-AED0-36108C1B0543","f038",0,"eccentric_jay","logos"),
				"apple-safari":new icon("F79DE68B-BB98-41F7-9B5D-69C8926AB9B0","f039",0,"templarian","logos","","browser"),
				"application":new icon("55C0C50F-9F4D-44C4-A84B-C79F645A8604","f614",0,"templarian","other","","",1650),
				"approval":new icon("64E327CF-3FCB-4742-AB82-789B2C27D31B","f790",0,"mrgrigri","other","decagram-check","",2046),
				"apps":new icon("7F5B9650-26E7-4A88-A6D1-2C338778651D","f03b",0),
				"archive":new icon("9C2AD144-9997-4169-983C-879DCCD62760","f03c",0,"templarian"),
				"arrange-bring-forward":new icon("7F57A003-5F4E-46CF-9099-51B8D05381F8","f03d",1,"templarian","editor"),
				"arrange-bring-to-front":new icon("679C0678-9688-49FD-BA71-BED740A09267","f03e",1,"templarian","editor"),
				"arrange-send-backward":new icon("677B1C90-BB0B-4F73-8EEA-D6E8FA709A6D","f03f",1,"templarian","editor"),
				"arrange-send-to-back":new icon("86145497-4CAA-41D6-A14E-0DD3FEE7721E","f040",1,"templarian","editor"),
				"arrow-all":new icon("5540E986-54E7-4FBF-A62F-9937B9E4F78D","f041",0,"templarian","arrows"),
				"arrow-bottom-left":new icon("25DD11B1-DE14-49E3-A54F-B01DCC45798D","f042",0,"templarian","arrows","","down"),
				"arrow-bottom-right":new icon("F7CB7031-655F-43BE-9165-F6C2CEC047B4","f043",0,"templarian","arrows","","down"),
				"arrow-collapse":new icon("86BB43B4-910B-4174-8455-661875054171","f615",0,"templarian","arrows",_,"compress",1650,2046),
				"arrow-collapse-all":new icon("54364780-8F31-4B23-8085-ABE21EA55926","f044",0,"templarian","arrows",_,"compress",0,2046),
				"arrow-collapse-down":new icon("9989309E-22E1-46F6-B710-6717D1C5EA11","f791",0,"mrgrigri","arrows",_,"compress",2046),
				"arrow-collapse-left":new icon("9F794864-D790-48F3-A8B4-31AEC3BB17FD","f792",0,"mrgrigri","arrows",_,"compress",2046),
				"arrow-collapse-right":new icon("FFED25A5-FD40-4274-9EE3-6B26F5C03584","f793",0,"mrgrigri","arrows",_,"compress",2046),
				"arrow-collapse-up":new icon("1E02D94D-6931-4CB8-8836-5276B076D811","f794",0,"mrgrigri","arrows",_,"compress",2046),
				"arrow-down":new icon("3821BF79-5857-47BE-84E3-A100B7247535","f045",1,"templarian","arrows","","bottom"),
				"arrow-down-bold":new icon("CA8684F7-5654-4AE0-9840-9C3AD9611D19","f72d",0,"templarian","arrows","","bottom",1932),
				"arrow-down-bold-box":new icon("45DF72E-705C-46AC-BABE-94F6C304CFAB","f72e",0,"","arrows","","bottom",1932),
				"arrow-down-bold-box-outline":new icon("2D68AA5F-ACA1-45AA-873B-AD077377E698","f72f",0,"","arrows","","bottom",1932),
				"arrow-down-bold-circle":new icon("E4AFC38F-01B3-452D-BDD7-A08EA66D53FA","f047",0,"templarian","arrows","","bottom"),
				"arrow-down-bold-circle-outline":new icon("1DA60E82-C1F0-449C-8157-7014A7C9E749","f048",0,"templarian","arrows","","bottom"),
				"arrow-down-bold-hexagon-outline":new icon("1F47DB52-28B0-40B7-836F-F6F2C58F2412","f049",0,"templarian","arrows","","bottom"),
				"arrow-down-box":new icon("04449961-F211-4FB7-BD87-EDA5F828B41D","f6bf",0,"templarian","arrows","","",1836),
				"arrow-down-drop-circle":new icon("34BD0C0B-AF54-4BFC-A539-35D67612C4AC","f04a",0,"google","arrows","","bottom",0,1554),
				"arrow-down-drop-circle-outline":new icon("65BE2EE5-23A5-49F8-A7A2-AEDD25C9C661","f04b",0,"templarian","arrows","","bottom",1554),
				"arrow-down-thick":new icon("E345145F-AD51-4B6F-8F7B-EC22C34E4E89","f046",0,"templarian","arrows","","bottom",0,1932),
				"arrow-expand":new icon("F75C0670-7074-4756-BF30-7840D1C47E09","f616",0,"templarian","arrows","","",1650),
				"arrow-expand-all":new icon("14842517-5BC4-49B6-86F2-8D6DC8870786","f04c",0,"templarian","arrows","","",0,1650),
				"arrow-expand-down":new icon("2338FC6A-1234-4A1F-AF6D-CFD45C92A2DF","f795",0,"mrgrigri","arrows",_,_,2046),
				"arrow-expand-left":new icon("FDF3C8E5-7AD6-4428-90EC-9426E56B5478","f796",0,"mrgrigri","arrows",_,_,2046),
				"arrow-expand-right":new icon("FF7885EC-2A34-4149-A4F8-626135606D7F","f797",0,"mrgrigri","arrows",_,_,2046),
				"arrow-expand-up":new icon("C13A62FF-DCC7-40DA-9326-C7FA77E4610F","f798",0,"mrgrigri","arrows",_,_,2046),
				"arrow-left":new icon("C21995A9-094F-4EA8-9127-BA0506B240A6","f04d",1,"google","arrows"),
				"arrow-left-bold":new icon("E990CF7B-A7D8-444E-99FE-24930ABF2FA6","f730",0,"templarian","arrows","","",1932),
				"arrow-left-bold-box":new icon("B7333E10-D6D6-4F86-A163-3A486C0B839D","f731",0,"","arrows","","",1932),
				"arrow-left-bold-box-outline":new icon("E95F06DD-DD66-4CD1-AAAC-AAA870CE6AC7","f732",0,"","arrows","","",1932),
				"arrow-left-bold-circle":new icon("D40EF576-5116-4176-9F9D-C9E491517321","f04f",0,"templarian","arrows"),
				"arrow-left-bold-circle-outline":new icon("E5ED912C-8075-477C-B62B-60184A436F2C","f050",0,"templarian","arrows"),
				"arrow-left-bold-hexagon-outline":new icon("5B274371-4B53-4E82-9CE3-42EADBDCCF92","f051",0,"templarian","arrows"),
				"arrow-left-box":new icon("67481609-631A-45C8-AB97-679B3D95F9FB","f6c0",0,"templarian","arrows","","",1836),
				"arrow-left-drop-circle":new icon("199C908D-09C4-47C6-968A-74582AC4AF26","f052",0,"templarian","arrows","","",1554),
				"arrow-left-drop-circle-outline":new icon("37B06F58-3BD0-413F-B86D-2EFD008B3D69","f053",0,"templarian","arrows","","",1554),
				"arrow-left-thick":new icon("FA880DCB-AC6F-4C9C-9B6D-6E8236272C31","f04e",0,"templarian","arrows","","",0,1932),
				"arrow-right":new icon("05F25B05-A6D6-4863-8B21-6969E10329CF","f054",1,"google","arrows"),
				"arrow-right-bold":new icon("8C7A25B6-878E-4BDB-A5B7-2927257E1B7D","f733",0,"templarian","arrows","","",1932),
				"arrow-right-bold-box":new icon("7225998A-DEF1-40C6-A05C-FA4119A643D9","f734",0,"templarian","arrows","","",1932),
				"arrow-right-bold-box-outline":new icon("1830D607-FDD5-4CC1-8D74-2A92C16B9E51","f735",0,"templarian","arrows","","",1932),
				"arrow-right-bold-circle":new icon("AF178779-F8E7-4F77-A9D1-A4675713C440","f056",0,"templarian","arrows"),
				"arrow-right-bold-circle-outline":new icon("8B60DF03-2440-4D73-98DE-A8666666864E","f057",0,"templarian","arrows"),
				"arrow-right-bold-hexagon-outline":new icon("1EAE1304-ED67-4607-A5C3-833B9CF7D943","f058",0,"templarian","arrows"),
				"arrow-right-box":new icon("8BA08E5C-7ED5-49E2-BDDE-1F1425C9FE1A","f6c1",0,"templarian","arrows","","",1836),
				"arrow-right-drop-circle":new icon("39AEA4FF-B65C-4368-B582-98108E3F9F06","f059",0,"templarian","arrows","","",1554),
				"arrow-right-drop-circle-outline":new icon("1E7109A9-3178-4B5E-87A9-CD1054B38BE9","f05a",0,"templarian","arrows","","",1554),
				"arrow-right-thick":new icon("9F7385FB-733C-4C1F-AC88-684BE98F381B","f055",0,"templarian","arrows","","",0,1932),
				"arrow-top-left":new icon("DD1AC44D-81B8-42EF-8714-7E7D29F2BC3F","f05b",0,"templarian","arrows","","up"),
				"arrow-top-right":new icon("27AB7B33-64F3-49A5-8082-CA7B465152A9","f05c",0,"templarian","arrows","","up"),
				"arrow-up":new icon("3AF49B97-A909-4961-9FBB-82C60D7CC773","f05d",1,"templarian","arrows","","top"),
				"arrow-up-bold":new icon("36199A40-CCCB-44B9-A6B0-73F7315E5716","f736",0,"templarian","arrows","","top",1932),
				"arrow-up-bold-box":new icon("062452EE-7669-4C36-85E6-A85BBA735348","f737",0,"","arrows","","top",1932),
				"arrow-up-bold-box-outline":new icon("5386BD1B-8959-4312-8739-5B08021F319D","f738",0,"","arrows","","top",1932),
				"arrow-up-bold-circle":new icon("D6719240-C87E-4185-B694-1EA5FFC94F4E","f05f",0,"templarian","arrows","","top"),
				"arrow-up-bold-circle-outline":new icon("3337B267-94EC-426B-ABC9-5842F75B13B1","f060",0,"templarian","arrows","","top"),
				"arrow-up-bold-hexagon-outline":new icon("7C3BD067-49AB-41C8-9091-FBD2D533045E","f061",0,"templarian","arrows","","top"),
				"arrow-up-box":new icon("82958DF7-5F5F-4470-BFB4-4389937B4D29","f6c2",0,"templarian","arrows","","top",1836),
				"arrow-up-drop-circle":new icon("73B211DB-05CF-4025-B035-AD03454C47A6","f062",0,"templarian","arrows","","top",1554),
				"arrow-up-drop-circle-outline":new icon("42277E7D-D87A-4DE9-982B-37E6A8AE4E70","f063",0,"templarian","arrows","","top",1554),
				"arrow-up-thick":new icon("4EDBF232-461F-4F4C-82BB-64A89BA08405","f05e",0,"templarian","arrows","","top",0,1932),
				"assistant":new icon("0C612FE5-D7CC-44F3-945A-4BD15A7E39BA","f064",0),
				"asterisk":new icon("E8C373FE-4258-4341-B52A-E33D9A484968","f6c3",0,"mririgo","characters","","star",1836),
				"at":new icon("9FC24609-9C8B-4DBA-A473-F5EFAFCC90DF","f065",0,"templarian","other,characters"),
				"attachment":new icon("E3C20B38-A6D3-4EF0-817D-863B25E555BA","f066",0,"google","other","","horizontal,paperclip"),
				"atom":new icon("C366C8B8-44FB-481E-88F2-AE0C3B1E8C74","f767",0,"robertogrrraham","other","","",1932),
				"audiobook":new icon("10BCB9E5-2E1F-4CD0-871F-B36FA0595004","f067",0,"templarian"),
				"auto-fix":new icon("FAAFAACC-4E0D-4688-B583-FC88A782A9B6","f068",0,"google","other","magic,wand"),
				"auto-upload":new icon("3DEAD47C-90B3-485E-943C-CE2D70C85154","f069",0,"google","networking,other"),
				"autorenew":new icon("00598C19-1255-479D-914A-1AADFDBC4868","f06a",0),
				"av-timer":new icon("A118E3CD-FF18-48FD-B26C-B4A48641E4C5","f06b",0),
				"baby":new icon("2CD51EFC-51B6-4323-B1EA-429EB58BFF7F","f06c",0),
				"baby-buggy":new icon("FA711E97-6083-45AA-9C92-FCCDABC57D37","f68e",0,"google","other","","",1712),
				"backburger":new icon("5A5BC824-220B-4998-883A-0E57FB2AB75F","f06d",0,"templarian"),
				"backspace":new icon("2AAC06E6-8ABD-418B-B9A4-8554B62D7C04","f06e",0),
				"backup-restore":new icon("36F8C2B4-C82C-4546-AFFC-601ECA54A603","f06f",0),
				"bandcamp":new icon("38278159-AC2C-433A-9335-95B05C1F6F56","f674",0,"templarian","logos","","",1712),
				"bank":new icon("FE08919F-CFFC-4A25-994C-CEDEB299908B","f070",1,"google","money,places"),
				"barcode":new icon("5231CD58-9C30-40A8-993C-A24C6B70F6B8","f071",0,"templarian"),
				"barcode-scan":new icon("40365CB0-4664-4648-8C51-2E6E20A0D096","f072",0,"xt3000"),
				"barley":new icon("5126A5A7-ECBC-49FC-BBC6-1703DCACF5E4","f073",0,"templarian","food,nature","","grain,wheat"),
				"barrel":new icon("CD3098D2-892F-49F5-9FA7-1A5FDC53A15C","f074",0,"templarian"),
				"basecamp":new icon("26B94EEC-5090-4DF4-99FC-C4A90830720A","f075",0,"templarian","logos"),
				"basket":new icon("4E334FE9-DF93-469A-B7D7-AC88BBF25D84","f076",0),
				"basket-fill":new icon("9B7DC550-62F9-4FB0-9B21-0379AA925A19","f077",0,"templarian"),
				"basket-unfill":new icon("D46B98B3-4045-4EAD-A26E-659195B5CC65","f078",0,"templarian"),
				"battery":new icon("C12D919F-7D0D-4355-8109-912BA37154B5","f079",0,"google","power"),
				"battery-10":new icon("D753B56C-E806-4F17-B2A0-EBC4B4B78D19","f07a",0,"google","power"),
				"battery-20":new icon("95AEB324-9D57-4D27-B463-0C8077C04E24","f07b",0,"google","power"),
				"battery-30":new icon("970E1F42-4594-42CD-BB4E-6F5CBDBF5D21","f07c",0,"google","power"),
				"battery-40":new icon("EE290FAF-A1D6-4A0D-8BBA-8DD2455AFB82","f07d",0,"google","power"),
				"battery-50":new icon("A79598F9-7FDF-46A2-9F8D-1DBD6BAB1A1D","f07e",0,"google","power"),
				"battery-60":new icon("B6EB700B-9288-474C-9A5C-C269680BFC5F","f07f",0,"google","power"),
				"battery-70":new icon("5DC968CB-1DC2-42B1-96E2-80AC6B23BB9C","f080",0,"google","power"),
				"battery-80":new icon("54485D0C-49B3-424D-8283-4CE90E16F88D","f081",0,"google","power"),
				"battery-90":new icon("58205285-7EAA-400A-A8E5-A9373E7D986A","f082",0,"google","power"),
				"battery-alert":new icon("ABFAD078-0E10-4293-94AD-16871B75E51F","f083",0,"google","power"),
				"battery-charging":new icon("F365ACF3-9453-4516-B592-AECD72AB7433","f084",0,"google","power","","",0,1712),
				"battery-charging-100":new icon("C1379E5C-2335-4C37-9A73-EE54D6747512","f085",0,"google","power"),
				"battery-charging-20":new icon("3E25E8BE-5097-4414-A7E4-9CDF02CD4F84","f086",0,"google","power"),
				"battery-charging-30":new icon("04D00269-7E8F-40D1-BFC4-36A01720260B","f087",0,"google","power"),
				"battery-charging-40":new icon("D40803B3-43CB-4680-A7BD-56CC83ED54B8","f088",0,"google","power"),
				"battery-charging-60":new icon("23E8809B-FB62-4573-83CF-9C33E980FD41","f089",0,"google","power"),
				"battery-charging-80":new icon("20455031-CCDD-40F8-A7A4-5E1F9E55F20E","f08a",0,"google","power"),
				"battery-charging-90":new icon("0EC45F7B-7A0A-43AD-ABD3-10E4209659C0","f08b",0,"google","power"),
				"battery-charging-wireless":new icon("60EEA5B6-8070-482D-ABE3-54A9D2A80875",_,0,"mrgrigri","power",_,_,"2.x.x"),
				"battery-charging-wireless-10":new icon("5D2990D5-D3D4-4E8F-AED8-B90CE6164068",_,0,"mrgrigri","power",_,_,"2.x.x"),
				"battery-charging-wireless-20":new icon("5C194C6F-8CFE-4F1A-AFD3-11D7E8CB89B4",_,0,"mrgrigri","power",_,_,"2.x.x"),
				"battery-charging-wireless-30":new icon("567818F9-23C0-41C4-A3BD-2BA37F8BFF29",_,0,"mrgrigri","power",_,_,"2.x.x"),
				"battery-charging-wireless-40":new icon("1ABBC4EA-32D6-4FBA-AA00-E19707123AE5",_,0,"mrgrigri","power",_,_,"2.x.x"),
				"battery-charging-wireless-50":new icon("9BC0DBFF-A3F6-4061-B6E1-685880D6B653",_,0,"mrgrigri","power",_,_,"2.x.x"),
				"battery-charging-wireless-60":new icon("F09D15A6-1E87-488C-9F75-24EC677E72FF",_,0,"mrgrigri","power",_,_,"2.x.x"),
				"battery-charging-wireless-70":new icon("45966E8F-2801-4ED6-970F-12D9FD6C6290",_,0,"mrgrigri","power",_,_,"2.x.x"),
				"battery-charging-wireless-80":new icon("EB5E0801-60FA-4DD3-8709-2A6F0AC9C3ED",_,0,"mrgrigri","power",_,_,"2.x.x"),
				"battery-charging-wireless-90":new icon("E8C0AC60-D7AB-4FA3-9596-CE002E798180",_,0,"mrgrigri","power",_,_,"2.x.x"),
				"battery-charging-wireless-alert":new icon("F835E187-444F-43B8-A057-9915F1388A87",_,0,"mrgrigri","power",_,_,"2.x.x"),
				"battery-charging-wireless-outline":new icon("4AFDE54E-1A6D-4F7F-BD0D-AB67FB0F12CC",_,0,"mrgrigri","power",_,_,"2.x.x"),
				"battery-minus":new icon("15E0E37E-564A-40D5-9D4A-948C932C8E52","f08c",0,"templarian","power"),
				"battery-negative":new icon("447DBB2A-31ED-4856-A7A2-A61BF0780C7B","f08d",0,"templarian","power"),
				"battery-outline":new icon("925B02B4-CA05-4545-A4E3-421F8412DA37","f08e",0,"google","power"),
				"battery-plus":new icon("A4BD7F0D-E95C-413C-B853-435A53854844","f08f",0,"templarian","power"),
				"battery-positive":new icon("195F51E4-5B02-4BE3-B407-4B7FC1445F18","f090",0,"templarian","power"),
				"battery-unknown":new icon("80257130-A38B-4BC1-B194-2EB16048D763","f091",0,"google","power"),
				"beach":new icon("FB1FEB37-FA9B-40BF-A7EC-B4A1690E6B77","f092",0,"templarian","places,travel","","parasol"),
				"beaker":new icon("95E06F22-3EA5-448F-B260-E555C1DCD18E","f68f",0,"xt3000","science","","",1712),
				"beats":new icon("D3DFF539-E101-40B2-BA6D-B62327AFE6AC","f097",0,"templarian","logos","","by,dre",0,1932),
				"beer":new icon("9D9A73D2-0780-4141-95A3-CDFE21E6D4D6","f098",0,"templarian","food"),
				"behance":new icon("860292B0-C722-4829-9E30-AACF00D09C8C","f099",0,"templarian","logos"),
				"bell":new icon("45fea174-07db-11e4-bf19-842b2b6cfe1b","f09a"),
				"bell-off":new icon("69686D8F-75FE-4091-9061-88DB64D95C01","f09b"),
				"bell-outline":new icon("70A190E9-6F1D-40DB-81D4-C9516949DF0B","f09c",0),
				"bell-plus":new icon("FC07FF46-2FD1-4E4E-8D35-BADDEEB5F531","f09d",0),
				"bell-ring":new icon("CD75C484-B1AD-492B-8CAA-9F002398C3CA","f09e",0),
				"bell-ring-outline":new icon("EE7DADC1-CF66-4922-B0C9-9B8F753514F9","f09f",0),
				"bell-sleep":new icon("43BD9E91-2044-4B80-AF87-2FC810C42A1B","f0a0",0),
				"beta":new icon("4F83A19F-BAB5-4894-AC5A-B288AFD592DC","f0a1",0,"templarian","characters"),
				"bible":new icon("CC30F9D0-3076-4189-A00D-F570D5B0C5D1","f0a2",0,"infanf","other","","",1554),
				"bike":new icon("627C7FF1-BCAD-4741-966E-7CED73B35DC2","f0a3",0,"google","sport,travel","","bicycle,cycle,cycling,riding"),
				"bing":new icon("CB038F2A-85DE-4F59-B694-D4805D66322B","f0a4",0,"templarian","logos","","microsoft",0,1554),
				"binoculars":new icon("75806AA4-294B-4A0A-8BDB-FC4CABCA1768","f0a5",0,"templarian"),
				"bio":new icon("F5D76655-0F6E-4FF2-AC74-CC3A235B7FC6","f0a6",0,"templarian"),
				"biohazard":new icon("96BDE572-9D10-47D0-919F-68EB6CD3DFA9","f0a7",0,"belledeboheme","science"),
				"bitbucket":new icon("B48BB714-F66F-4D86-9864-051DB90AE197","f0a8",0,"krambertech","logos"),
				"black-mesa":new icon("1F233821-5ED4-4CB3-8933-9A16C05D7AC9","f0a9",0,"templarian","logos"),
				"blackberry":new icon("2E0E0624-1F5D-4998-B0F9-A957EC2ADD49","f0aa",0,"templarian","logos"),
				"blender":new icon("F365BC90-C8EC-4A5C-99FB-C2ED27B5593A","f0ab",0,"infanf","logos"),
				"blinds":new icon("926ACBEB-C5F6-4EF4-829E-E0B05501DDD6","f0ac",0,"templarian"),
				"block-helper":new icon("5832B598-DAAA-4497-B995-CF940A1C7F20","f0ad",0,"templarian"),
				"blogger":new icon("AAF23976-7C9D-4AFA-BE25-CCD225A95EEA","f0ae",0,"google","google"),
				"bluetooth":new icon("7CBB03E7-EAC6-44C2-8C28-A78728F8BB7B","f0af",1,"google","networking,logos"),
				"bluetooth-audio":new icon("6639774A-9027-4D20-AE57-24C78EF41141","f0b0",0,"google","networking"),
				"bluetooth-connect":new icon("1E123F41-EA93-4085-8446-88F50C501A6F","f0b1",0,"google","networking"),
				"bluetooth-off":new icon("CEB015C9-455E-4551-A898-7A992658CF72","f0b2",0,"google","networking"),
				"bluetooth-settings":new icon("E5DEA4AB-58E1-45CF-81EF-1A98594C5884","f0b3",0,"google","networking"),
				"bluetooth-transfer":new icon("A0D9FDB0-B6D8-43F9-A418-01B78336C84C","f0b4",0,"google","networking"),
				"blur":new icon("FAFCB184-2AAD-4E83-924F-1C37F1EDF956","f0b5",0),
				"blur-linear":new icon("B23B281D-C753-468E-A0D1-79C2963346C8","f0b6",0),
				"blur-off":new icon("4F541CC2-7659-4230-A307-6E5D515C529B","f0b7",0),
				"blur-radial":new icon("29F42A3B-BCD5-45BA-9B87-35F97FE9438D","f0b8",0),
				"bomb":new icon("7DC40C3F-3733-48AF-94C7-5454FB849A49","f690",0,"templarian","other","","",1712),
				"bomb-off":new icon("DEC98F6C-E85D-400C-87CD-6AE692583838","f6c4",0,"robertogrrraham","other","","",1836),
				"bone":new icon("7FCD9594-B235-45D5-8504-A41F251FD50E","f0b9",0,"templarian","science"),
				"book":new icon("FFF82791-D12F-4643-8128-71CF5FE38C9B","f0ba",1,"google","other","","repository"),
				"book-minus":new icon("7367B5F0-8155-4F3D-9C7E-BFDF677442D8","f5d9",0,"xt3000","other","","",1554),
				"book-multiple":new icon("637C4988-5432-4F5E-ADD5-EBDC397D0622","f0bb",1,"templarian"),
				"book-multiple-variant":new icon("6B7FCAFD-C14A-49FC-A959-A2B6C7C2C5BC","f0bc",0,"templarian"),
				"book-open":new icon("7EFAD89C-D84E-41F0-A8A4-F72AC8DB470C","f0bd",0),
				"book-open-page-variant":new icon("113421A1-241F-4479-B22B-5F56EFD63D4C","f5da",0,"google","other","","",1554),
				"book-open-variant":new icon("08C8BAF9-6B91-458D-BE03-F6A7AABEA2AB","f0be",0,"google","other","","",0,1554),
				"book-plus":new icon("3C49BDB2-C3A3-4E0C-9314-19FE66414A5B","f5db",1,"xt3000","other","","",1554),
				"book-secure":new icon("121AF367-3AE5-48D1-9868-8DC60342D4A0","f799",0,"mrgrigri",_,_,_,2046),
				"book-unsecure":new icon("90B49606-B4FF-4D4B-AE05-4769659094CE","f79a",0,"mrgrigri",_,_,_,2046),
				"book-variant":new icon("1B9F45CE-CA39-4ACF-8961-4B4B56D6F94A","f0bf",0),
				"bookmark":new icon("690787DD-F7B0-4D32-A668-32657D3A3AE8","f0c0"),
				"bookmark-check":new icon("65F155F1-7A9F-49AF-B570-FD6D24553CE5","f0c1",0),
				"bookmark-music":new icon("DF4ECEB8-EF5C-4ACC-BC7D-B4FEEE75D17D","f0c2",0,"templarian","other","","note,sound"),
				"bookmark-outline":new icon("0EB6BB85-4BE2-4608-BABF-2EF135D420A7","f0c3",0),
				"bookmark-plus":new icon("596822BD-8373-402C-9D27-C341405F55F9","f0c5",0,"templarian"),
				"bookmark-plus-outline":new icon("DB2B7624-66CB-4E7E-A65F-4CEE8870C6CC","f0c4",0),
				"bookmark-remove":new icon("89594C9C-18ED-45EA-A3AC-A91B570D1541","f0c6",0,"templarian"),
				"boombox":new icon("DAA06443-AE25-4881-BC62-8033C4420B8E","f5dc",0,"google","other","","",1554),
				"bootstrap":new icon("9DAC7258-AB2D-49E4-98A9-E84A5E3E474B","f6c5",0,"templarian","logos","","",1836),
				"border-all":new icon("A3D0E8B6-96B3-4281-B31C-0DDFD729903B","f0c7",1,"google","editor"),
				"border-bottom":new icon("9441B8BD-25C8-4F46-AFD4-6B2DA0C4A599","f0c8",1,"google","editor"),
				"border-color":new icon("CCD99C36-5D88-4696-8193-56F11C4B20A7","f0c9",0,"google","editor"),
				"border-horizontal":new icon("0F804E73-90EF-4175-984D-603698F0AF09","f0ca",1,"google","editor"),
				"border-inside":new icon("F7471447-8501-40A6-9FFB-AB353B55AA89","f0cb",1,"google","editor"),
				"border-left":new icon("6B8A1379-9497-4B1B-A8CF-51CB1AD67757","f0cc",1,"google","editor"),
				"border-none":new icon("F6333BD9-AC00-428D-B8A8-FA3B9187487F","f0cd",1,"google","editor"),
				"border-outside":new icon("F8EA9B00-82F1-4DE8-B8B5-0A71B934C44D","f0ce",1,"google","editor"),
				"border-right":new icon("BC67506B-CAE4-4EDA-B0C8-614436AFDCBF","f0cf",1,"google","editor"),
				"border-style":new icon("5A750E96-F9A0-4C38-B601-8BA770E89E01","f0d0",0,"google","editor"),
				"border-top":new icon("AE703F65-F8D5-43B9-9B6B-B5966260E799","f0d1",1,"google","editor"),
				"border-vertical":new icon("540E7940-BA85-4EED-BEAB-C50CEF348D50","f0d2",1,"google","editor"),
				"bowl":new icon("95E70948-C85D-41AC-887C-62752FBA7B6B","f617",0,"templarian","food","","",1650),
				"bowling":new icon("0CAB5DF9-E4A7-418D-B317-E792FF2DF8D1","f0d3",0,"templarian","sport","","ball"),
				"bow-tie":new icon("741B300C-06EF-459D-BB3E-95DB8E21194E","f677",0,"thunsaker","other","","",1712),
				"box":new icon("1E6B8A9E-921F-4695-B1CA-0A87AC157E88","f0d4",0,"templarian","logos"),
				"box-cutter":new icon("A4C51C21-DEB0-4247-AEA3-B5F454641BDC","f0d5",0,"xt3000"),
				"box-shadow":new icon("9DBE04CB-C425-4556-9046-15CBD88C866B","f637",0,"xt3000","editor","","",1650),
				"bridge":new icon("9FD9D8F0-D777-4B33-9CF7-E32FD8C25655","f618",0,"templarian","travel,other","","",1650),
				"briefcase":new icon("15A9F4A5-3EB6-443C-8283-547A077CB0C4","f0d6"),
				"briefcase-check":new icon("4182182E-F79B-4153-B652-2A4B4AC231E1","f0d7",0),
				"briefcase-download":new icon("D4705E48-0920-451E-BFF3-2DA1BBA5C21D","f0d8",0),
				"briefcase-upload":new icon("3D48B9FF-A060-47DA-809E-32D5ED68CA64","f0d9",0,"templarian"),
				"brightness-1":new icon("B3FF12D1-1C76-4E1D-BAD0-468E424BADA7","f0da",0),
				"brightness-2":new icon("FAEBEE4C-295C-475F-AE7D-11CFA4688017","f0db",0),
				"brightness-3":new icon("825E1BB2-1E01-4E6E-9CF0-04412FDECDA6","f0dc",0),
				"brightness-4":new icon("10EC7F50-BDC1-45C4-A6D2-2CB5FB4DE902","f0dd",0),
				"brightness-5":new icon("17314413-99ED-480C-B739-8572B6AE5477","f0de",0),
				"brightness-6":new icon("34818392-81EE-4210-8F86-9C448596C912","f0df",0),
				"brightness-7":new icon("014CCAA3-4B30-4C3D-921C-078A078A5198","f0e0",0),
				"brightness-auto":new icon("6E47CC3B-6D95-4311-A8DD-7B50AC24781C","f0e1",0),
				"broom":new icon("8159ED8F-4D1C-4845-8297-0FE41260D199","f0e2",0,"templarian"),
				"brush":new icon("B5C72984-BCCF-4729-A7D3-2A07D5794014","f0e3",0,"google","editor","","paintbrush"),
				"buffer":new icon("FBD11E2A-7F1F-4CE2-B17D-B3623D4FEA43","f619",0,"templarian","other","","",1650),
				"bug":new icon("09A131FB-EE06-49B8-80C3-49B294BCA612","f0e4",0,"google","nature,other"),
				"bulletin-board":new icon("094C9BF2-9EEE-434C-9CA9-8280FBDFBEF7","f0e5",0,"xt3000"),
				"bullhorn":new icon("A5D2E199-03A1-4C23-9C63-954D63DEBEB4","f0e6",0,"templarian",_,"announcement"),
				"bullseye":new icon("ED26BD4D-ACDB-45DC-A0DA-18ECA3B2008E","f5dd",0,"xt3000","sport,other","","archery,target",1554),
				"bus":new icon("F6516F38-B29E-4CC9-A7E2-706817121D45","f0e7",0,"google","travel","","autobus"),
				"bus-articulated-end":new icon("44D15383-D6D2-46CC-A977-7921DA98C7E8","f79b",0,"greenturtwig","travel","","autobus",2046),
				"bus-articulated-front":new icon("5C34E429-3B80-46CD-8DC8-44D5D9769682","f79c",0,"greenturtwig","travel","","autobus",2046),
				"bus-double-decker":new icon("1F4327A8-1E93-4490-B992-C9D04DFFB144","f79d",0,"greenturtwig","travel","","autobus",2046),
				"bus-school":new icon("774EC563-DF29-498C-8270-ABB051396687","f79e",0,"greenturtwig","travel","","autobus",2046),
				"bus-side":new icon("D944705B-8F7B-441F-8753-6E51E4378D7D","f79f",0,"greenturtwig","travel","","autobus",2046),
				"cached":new icon("7DFE345F-A336-43BC-89BE-18FE3C902BFC","f0e8",0),
				"cake":new icon("E5BFDCE4-1033-4062-9677-94B95E028B6E","f0e9",0,"google","food"),
				"cake-layered":new icon("934C9B6C-0DA5-4D71-9283-C960ED537D02","f0ea",0,"google","food"),
				"cake-variant":new icon("2F9E87A6-B7DB-48B1-9528-C8A941FBC3AF","f0eb",0,"google","food"),
				"calculator":new icon("3E9895C8-BCCB-464C-ACF1-CCA86113DA37","f0ec",0,"templarian","tech"),
				"calendar":new icon("23C8742A-612C-4C55-B184-2A0ABB387746","f0ed",1,"google","time"),
				"calendar-blank":new icon("57984F1A-6CA5-4928-B221-466C0CC11562","f0ee",0,"templarian","time"),
				"calendar-check":new icon("62008F88-6B17-4277-9155-B596476629A1","f0ef",0,"google","time"),
				"calendar-clock":new icon("921F6084-24E6-4D62-8BF9-9258D8FADE8E","f0f0",0,"templarian","time"),
				"calendar-multiple":new icon("F4851A5B-6F19-4C18-9A13-4BF2617FF0E0","f0f1",0,"templarian","time"),
				"calendar-multiple-check":new icon("7329D294-805D-4843-AB03-B87C661C296A","f0f2",0,"templarian","time"),
				"calendar-plus":new icon("34AFE807-D724-4A5A-A3FE-910928179BE8","f0f3",0,"templarian","time"),
				"calendar-question":new icon("1A7293FC-E6E7-4C86-8919-32D0C5F60B08","f691",0,"xt3000","time","calendar-rsvp","",1712),
				"calendar-range":new icon("740D7A91-7492-4922-96C7-A719E2BCD62A","f678",0,"google","time","","",1712,1932),
				"calendar-remove":new icon("2FAF3098-4BD1-4C70-94A8-F75E1EA54F49","f0f4",0,"google","time"),
				"calendar-text":new icon("1A873476-B82D-4E23-BF19-897F0A0C0B93","f0f5",0,"google","time"),
				"calendar-today":new icon("A566BA98-D35A-443F-AD31-0D31EF0B85EC","f0f6",0,"google","time"),
				"call-made":new icon("B5ACE913-DBF1-4E73-BFE5-BB86F0EBF76E","f0f7",0),
				"call-merge":new icon("8BEE5A5E-EC0A-4FC5-96BE-7F8C2A2EE52F","f0f8",0,"google","arrows,other"),
				"call-missed":new icon("CA2546B9-70B0-4E1A-B646-17163B0C76E4","f0f9",0,"google","arrows,other"),
				"call-received":new icon("008CD0E5-C47B-44FB-AF43-A1221C527056","f0fa",0,"google","arrows,other"),
				"call-split":new icon("790BCBB6-8B08-4AEC-A322-99F584BB394B","f0fb",0,"google","arrows,other"),
				"camcorder":new icon("89EE8EAB-CA5B-40C5-B114-1EC5248634BF","f0fc"),
				"camcorder-box":new icon("9E0AEA4A-7A90-43F7-8A7F-D49F374F11FF","f0fd",0),
				"camcorder-box-off":new icon("A8AD0C27-54CD-4362-A862-C6865B1EE750","f0fe",0),
				"camcorder-off":new icon("BE1C767B-C032-487C-AB85-E2E960C9A89D","f0ff",0),
				"camera":new icon("236D9E8E-E38C-4EA9-9539-0E8B1447003A","f100",1,"google","other","","photography"),
				"camera-burst":new icon("4FCD7DBE-6B4C-41DB-BDD8-40ED820EC7F1","f692",0,"google","other","","",1712),
				"camera-enhance":new icon("45456446-14D9-49F2-8842-93BAF8233F47","f101",0),
				"camera-front":new icon("574F4B2D-70FE-41E3-AFB4-EC1E2AB897AB","f102",0),
				"camera-front-variant":new icon("2C6477B5-AA9E-4EDD-A73A-79F2ED5E5F2A","f103",0),
				"camera-gopro":new icon("B4EDBFFC-CF00-45F3-93A7-6ADD45108FEE","f7a0",0,"mrgrigri","tech",_,_,2046),
				"camera-iris":new icon("E011977B-432E-470C-A4F6-9C7A4F8BB519","f104",0),
				"camera-metering-center":new icon("D178034B-0B93-40F5-BBF1-D28B25A86647","f7a1",0,"kumvert","other","","",2046),
				"camera-metering-matrix":new icon("700D143A-8347-4A79-9EF8-844E1B436524","f7a2",0,"kumvert","other","","",2046),
				"camera-metering-partial":new icon("EA33D5EE-5E13-4D82-A552-C3B16772926F","f7a3",0,"kumvert","other","","",2046),
				"camera-metering-spot":new icon("C1313085-6C7F-4D60-A278-A39361B57DA9","f7a4",0,"kumvert","other","","",2046),
				"camera-off":new icon("461A25B1-59F6-49F1-A917-BED92315AA63","f5df",0,"templarian","other","","",1554),
				"camera-party-mode":new icon("B58A0D5C-B137-42DD-A43B-8DD296D7684A","f105",0),
				"camera-rear":new icon("B4CA0FB9-D119-426C-9043-16D90F5086B8","f106",0),
				"camera-rear-variant":new icon("B7DB5F20-5D64-4096-959F-60BB040B320F","f107",0),
				"camera-switch":new icon("68BB6884-5CEA-4B2A-8F22-46B6A98CDA75","f108",0),
				"camera-timer":new icon("6A8FC2AF-724C-46A2-9F04-C34E7D658679","f109",0,"templarian"),
				"cancel":new icon("02F70DD2-E16E-43FD-9C2A-267C965E3919","f739",1,"google","other","","ban,block",1932),
				"candle":new icon("4FB0AA38-406A-4877-8B0C-15C7ED95F22C","f5e2",0,"google","other","","",1554),
				"candycane":new icon("8CAC723B-0FF5-493B-A3A2-5772FDE46A0F","f10a",0,"templarian","food"),
				"cannabis":new icon("4C2DC909-0C3F-431F-A37B-5B66C9F33E37","f7a5",0,"templarian","nature,science",_,_,2046),
				"car":new icon("FCF4FF57-4547-4C11-A20A-3D26252780EC","f10b",0,"google","travel"),
				"car-battery":new icon("4AF128D8-1E70-4396-BB5A-F96A7D0F9BCB","f10c",0,"xt3000","power,travel"),
				"car-connected":new icon("8C8468C7-8A41-42A1-8C33-4AAE55FF9E2A","f10d",0,"xt3000","networking"),
				/*"car-convertible"*/"car-convertable":new icon("D7E88B5B-B6F3-4C55-AE93-39A78593B351","f7a6",0,"greenturtwig","travel",_,_,2046),
				"car-estate":new icon("90BBBADD-0FCD-4147-9D6E-5DAFCACF2B0B","f7a7",0,"greenturtwig","travel",_,_,2046),
				"car-hatchback":new icon("21A2527E-9AC0-4FFA-84CB-246608BEB91D","f7a8",0,"greenturtwig","travel",_,_,2046),
				"car-pickup":new icon("76BB371D-335C-4F53-A439-2A681778C6BC","f7a9",0,"greenturtwig","travel",_,_,2046),
				"car-side":new icon("CB49A868-3317-4445-BFED-13CB6533000E","f7aa",0,"greenturtwig","travel",_,_,2046),
				"car-sports":new icon("97F5ED58-F2AB-40AC-A882-4A90DB5D2018","f7ab",0,"greenturtwig","travel",_,_,2046),
				"car-wash":new icon("95E617D7-9A48-458E-96C5-A8CBBEF3A852","f10e",0,"google","places"),
				"caravan":new icon("2E5B9249-0FFB-48D0-8A61-2019FD9ED32F","f7ac",0,"greenturtwig","places,travel",_,_,2046),
				"cards":new icon("7E04A92C-1DC5-4A5F-84B0-57A50545EBE4","f638",0,"xt3000","other","","",1650),
				"cards-outline":new icon("BB07EFB4-5078-47BA-B441-93D4957AF7F9","f639",0,"xt3000","other","","",1650),
				"cards-playing-outline":new icon("C388C342-49AA-4577-A968-12BD804E5A8E","f63a",0,"xt3000","other","","",1650),
				"cards-variant":new icon("A000BD20-147F-43FB-AD99-08AE6BA2E80B","f6c6",0,"casesandberg","other","","",1836),
				"carrot":new icon("6BD10A61-9A45-4A5A-ABEF-404135975917","f10f",0,"templarian","food,nature"),
				"cart":new icon("97563623-CF1C-43AE-87D8-DF54802D442B","f110"),
				"cart-off":new icon("05455801-C523-420A-A961-868ABA3DF636","f66b",0,"google","other","","",1650),
				"cart-outline":new icon("F290ABB0-4CD2-4C45-B543-E3AEBA1FE358","f111",0,"templarian"),
				"cart-plus":new icon("2BF13245-A7BF-49EC-8EB0-CA10F7AF11B2","f112",0),
				"case-sensitive-alt":new icon("250BE86F-4D41-4F22-AECD-DD8A2533DA62","f113",0,"r3volution11"),
				"cash":new icon("59956D81-BF6B-4DCA-ABAD-A890412F22F1","f114",0,"templarian","money","","money,note"),
				"cash-100":new icon("18E513D3-5D34-4A4B-B600-D7173CB30DDA","f115",0,"google","money","","money,note"),
				"cash-multiple":new icon("80D4170E-FDA3-40D0-9B05-1020D5FCA817","f116",0,"templarian","money","","money,notes"),
				"cash-usd":new icon("219B8956-E48B-4D11-9257-422E563955DB","f117",0,"google","money","","dollars,money,note"),
				"cast":new icon("996A1644-29FB-4221-9225-FD5CF8AAD5CE","f118",0,"google","player","","chromecast"),
				"cast-connected":new icon("80EC7FF6-03C0-4D61-8858-D2D94426D2DE","f119",0,"google","player","","chromecast"),
				"cast-off":new icon("F6AC6C9C-C82B-48C0-84AB-BEE76FC7BB5B","f789",0,"xt3000","player","","",1932),
				"castle":new icon("53FF9F06-A3F7-4B04-9D54-207FE8B56B8E","f11a",0,"templarian","places"),
				"cat":new icon("5D3A753E-1FA9-42F4-8A71-E686A36D1CB6","f11b",0,"templarian","nature"),
				"cctv":new icon("04FF8A0D-0B5F-426B-ABAF-001EAC16559F","f7ad",0,"robertogrrraham","tech",_,"camera,closed,circuit,television",2046),
				"ceiling-light":new icon("C45A21A3-671C-4B1A-B405-D625ECA93C11","f768",0,"templarian","other","","",1932),
				"cellphone":new icon("8898488F-1BE6-40A0-84B7-1C0832AA4754","f11c",0,"google","tech","","mobile,phone"),
				"cellphone-android":new icon("C633DDA7-FB93-4041-98C2-92117B970114","f11d",0,"google","tech","","mobile,phone"),
				"cellphone-basic":new icon("E22A55C0-983F-499E-8B43-4A66DB278B4E","f11e",0,"xt3000","tech","","mobile,phone"),
				"cellphone-dock":new icon("4FBBF196-CF97-436B-A3E6-A08D695E6986","f11f",0,"google","tech","","mobile,phone"),
				"cellphone-iphone":new icon("8B1B6ED1-8AA5-4888-8477-B122FB236E1D","f120",0,"google","tech","","mobile,phone"),
				"cellphone-link":new icon("E29A590D-51B8-471B-B23B-E0A41046EDA6","f121",0,"google","networking","","mobile,phone"),
				"cellphone-link-off":new icon("7E4265ED-151D-45CE-BDD2-08B6028B6006","f122",0,"google","networking","","mobile,phone"),
				"cellphone-settings":new icon("E7458A8C-66F2-41D7-81AE-4B2B961DFE1A","f123",0,"google","tech","","mobile,phone"),
				"cellphone-wireless":new icon("071CA76A-0ED5-42CD-9BE9-46AFA9D5459E",_,0,"","tech",_,"mobile,phone","2.x.x"),
				"certificate":new icon("2DBEB397-D80B-445D-A11E-7B8362CFBEF4","f124",0,"xt3000"),
				"chair-school":new icon("47FCC651-522C-4786-B518-91A03A721A90","f125",0,"templarian"),
				"chart-arc":new icon("98939E5B-1528-4A2F-B35A-C37C60C75D93","f126",0,"templarian","science"),
				"chart-areaspline":new icon("00654F5E-1B8B-4BD7-933B-0BD65B2C9BAC","f127",1,"templarian","science"),
				"chart-bar":new icon("85D4DC49-5359-4867-A5D1-52C44699387F","f128",1,"templarian","science"),
				"chart-bar-stacked":new icon("FAA40519-5517-44DF-AF2E-30D07874BEB7","f769",0,"templarian","science","","",1932),
				"chart-bubble":new icon("9D79A433-CF5A-45A2-971F-4FBF72DB9821","f5e3",0,"google","science","","",1554),
				"chart-donut":new icon("C7BED6AB-8D91-42EC-A22F-D4B922B0EB14","f7ae",0,"google","other,science","chart-doughnut,data-usage","",2046),
				"chart-donut-variant":new icon("FE9CBE2A-4D6F-4A1F-B817-26607BB9561B","f7af",0,"templarian","science","chart-doughnut-variant","",2046),
				"chart-gantt":new icon("A2839B3A-760A-4061-80CA-41B3FA5817E0","f66c",0,"templarian","science","","",1650),
				"chart-histogram":new icon("8DCC14D7-057F-4DA4-89B2-B26D6B6F0C00","f129",1,"templarian","science"),
				"chart-line":new icon("D996574D-5B42-47C5-91D6-F86555C2FBC5","f12a",1,"templarian","science"),
				"chart-line-stacked":new icon("B53C0CF7-F923-409F-91C3-420513E44231","f76a",0,"japanyoshilol","science","","",1932),
				"chart-line-variant":new icon("2FAF8E0B-5AB4-4914-A0A1-CECFFAF85427","f7b0",0,_,"science",_,_,2046),
				"chart-pie":new icon("9C6B53C5-698B-4428-9738-A6700BF8698C","f12b",1,"templarian","science"),
				"chart-scatterplot-hexbin":new icon("852E3EF2-942E-42C5-87BB-E1193EBD3E0C","f66d",0,"templarian","science","","",1650),
				"chart-timeline":new icon("922A0C03-C46D-45E7-8B44-9D53F1292360","f66e",0,"templarian","science","","",1650),
				"check":new icon("F789CE44-7EA3-4E97-88FB-BEC22EB2030C","f12c",1,"google","characters,other","","tick"),
				"check-all":new icon("48BA3B7B-1EF7-4160-A0BB-54EBCF999A13","f12d",0,"google","other","","multiple,tick"),
				"check-circle":new icon("93D7B6DC-17D2-4A2B-B787-79E2E8BEF304","f5e0",0,"templarian","characters,other","","tick",1554),
				"check-circle-outline":new icon("F609EE7E-AAB4-4CE7-A002-D0F7ECF89609","f5e1",0,"templarian","characters,other","","tick",1554),
				"checkbox-blank":new icon("2B75FE22-5209-4DF8-B16A-B6F74272337B","f12e",0),
				"checkbox-blank-circle":new icon("F031DE59-CC30-47BF-B689-BC993893B03A","f12f",0),
				"checkbox-blank-circle-outline":new icon("7C094780-770D-44B6-981C-C701784192D6","f130",0),
				"checkbox-blank-outline":new icon("C7D0E43D-6393-429B-BDCE-B522419B7B3D","f131",0),
				"checkbox-marked":new icon("C3E50D88-07AB-491F-B21E-9AA11A1E5886","f132",0),
				"checkbox-marked-circle":new icon("4336ADDD-7A8E-46E7-A886-3873CCCFD3DA","f133",0),
				"checkbox-marked-circle-outline":new icon("7DC53566-5640-4124-A2C2-5070D7FBA591","f134",0),
				"checkbox-marked-outline":new icon("AB384DA7-C0DA-4A68-96EA-FC54BF0EDED1","f135",0),
				"checkbox-multiple-blank":new icon("2B01AE9D-AFA4-4CDA-82BD-21076D27C006","f136",0,"templarian"),
				"checkbox-multiple-blank-circle":new icon("0AE5C836-2A43-4706-81C5-5053A73B9CAA","f63b",0,"xt3000","other","","",1650),
				"checkbox-multiple-blank-circle-outline":new icon("CCBAD6F8-5D3D-420A-94AF-CC85AA12397E","f63c",0,"xt3000","other","","",1650),
				"checkbox-multiple-blank-outline":new icon("CA74F33C-3AEE-4EA9-93B4-643099DFD92D","f137",0,"templarian"),
				"checkbox-multiple-marked":new icon("4F160BFE-433B-49D1-B2DC-E7F71AF7070B","f138",0,"templarian"),
				"checkbox-multiple-marked-circle":new icon("85C35F15-1AC0-407B-BCBF-AD79B6E6DDEA","f63d",0,"xt3000","other","","",1650),
				"checkbox-multiple-marked-circle-outline":new icon("5158D0E3-0E77-4CC3-A9A4-727825812D00","f63e",0,"xt3000","other","","",1650),
				"checkbox-multiple-marked-outline":new icon("16BECBE7-BD8E-4301-B5CB-5EE534FBDAD3","f139",0,"templarian"),
				"checkerboard":new icon("A5F7D4AF-C7A3-4F38-B21B-B9F3E68770DE","f13a",0,"templarian"),
				"chemical-weapon":new icon("7916D1CB-2F73-4C27-8A6B-B14D593F8F59","f13b",0,"xt3000","science"),
				"chevron-double-down":new icon("74ACC301-AA62-492B-92C1-8021BDD89A02","f13c",1,"templarian","arrows","","bottom"),
				"chevron-double-left":new icon("76350FC3-7629-4247-9D09-8AB9AF9BC6CF","f13d",1,"templarian","arrows,characters","","angle,quotation"),
				"chevron-double-right":new icon("E4B5D36C-A663-4D53-BE18-09393497556F","f13e",1,"templarian","arrows,characters","","angle,quotation"),
				"chevron-double-up":new icon("53D302C9-3A0D-4104-967E-21D174E3C0B2","f13f",1,"templarian","arrows","","top"),
				"chevron-down":new icon("84FE90C1-076D-4EA1-B56F-4C2582A39AC3","f140",1,"google","arrows","","bottom"),
				"chevron-left":new icon("CF5607F2-4106-4D47-8FE6-B8F5A16E6D98","f141",1,"google","arrows,characters","","angle,quotation"),
				"chevron-right":new icon("A6D25AD4-462B-4185-B739-FBFCD3ACF3C3","f142",1,"google","arrows,characters","","angle,quotation"),
				"chevron-up":new icon("AECCC94F-C38A-4A97-879E-ACD09F89169A","f143",1,"google","arrows","","top"),
				"chili-hot":new icon("E868226C-7BE8-4A22-8A9A-8E040004016A","f7b1",0,"kumvert","other","","chilli",2046),
				"chili-medium":new icon("C9DA0BF5-09DD-46A9-AE62-1612B26F0BB1","f7b2",0,"kumvert","other","","chilli",2046),
				"chili-mild":new icon("3CE5B420-F103-47EA-800C-A4D145B89508","f7b3",0,"kumvert","other","","chilli",2046),
				"chip":new icon("A535271B-1114-44AD-9D9D-1984905026FF","f61a",0,"templarian","tech","","",1650),
				"church":new icon("82E4FDFE-C9C8-4087-ABCC-DF51F760379A","f144",0,"templarian","places"),
				"circle":new icon("59803983-F6CE-4D40-B83C-36D42C9464A9","f764",1,"templarian","other","","",1932),
				"circle-outline":new icon("00E1BEF8-DD84-4DCE-BE3C-8AA411DCE5FD","f765",0,"templarian","other","","",1932),
				"cisco-webex":new icon("A6387660-7DB0-41DC-9ECF-EBBA5A78FC82","f145",0,"templarian","logos"),
				"city":new icon("5A5AC571-1818-45D0-8259-A9177DBED615","f146",0,"google","places"),
				"clipboard":new icon("423D4239-D8DC-4D8B-9365-9D51E2A0FDF7","f147",1,"templarian"),
				"clipboard-account":new icon("C45D118E-4FFA-42E5-A18B-B8A7B58BF42F","f148",0,"google","users,other","","person,user"),
				"clipboard-alert":new icon("57AC4C5E-B2AB-42B5-9826-BCFEACCB2E7C","f149",0),
				"clipboard-arrow-down":new icon("863E0318-495E-437A-B22B-3C1274D108E6","f14a",0),
				"clipboard-arrow-left":new icon("1D6DD9E5-61EA-40E6-A19A-EF4BA71B0FC0","f14b",0),
				"clipboard-check":new icon("2FA574EF-C285-465F-A254-868506FA4273","f14c"),
				"clipboard-flow":new icon("5A450EF8-D2F0-4F32-8D10-A606DD847E19","f6c7",0,"mrgrigri","other","","",1836),
				"clipboard-outline":new icon("54F34575-7348-4032-B072-EC8F9A6C843D","f14d",0,"templarian"),
				"clipboard-plus":new icon("A5AA9DEA-AAAE-4C79-965F-6828F823E2CD","f750",1,"templarian","other","","",1932),
				"clipboard-text":new icon("81453216-6EC0-4751-82A4-BFFF63B922FC","f14e"),
				"clippy":new icon("6B346FB6-F563-4AC4-B769-06A143B42152","f14f",0,"templarian","logos","","microsoft,word"),
				"clock":new icon("E3A4F70D-92EF-4115-BBB3-3BE68A788F5D","f150",1,"google","time"),
				"clock-alert":new icon("CB400FB2-95E5-4420-B579-80DCA5C0F8B0","f5ce",0,"xt3000","time","","",1554),
				"clock-end":new icon("F7F5CA75-E8B5-45E1-B0BA-040F225D877D","f151",0,"xt3000","time"),
				"clock-fast":new icon("111210EB-0EF4-4DCB-ABBD-6A75F15EEB44","f152",0,"templarian","time"),
				"clock-in":new icon("6483D8DB-4170-4104-8A69-40D28401EF4C","f153",0,"xt3000","time"),
				"clock-out":new icon("7C3F10AF-CB56-4A35-B22A-C833D5C823A3","f154",0,"xt3000","time"),
				"clock-start":new icon("85A4435A-CDCF-42BC-8F2C-B46EDF8820BD","f155",0,"xt3000","time"),
				"close":new icon("FEA26660-7D6A-4C2A-9F13-7AE125FBA543","f156",0,"google","characters,other"),
				"close-box":new icon("0823D18B-529A-4B7E-8090-A913399A3D5E","f157",0,"lastrosestudios","characters,other"),
				"close-box-outline":new icon("05B8E566-B224-4ECC-AE70-2BF8BE90C82A","f158",0,"lastrosestudios","characters,other"),
				"close-circle":new icon("DC0E1491-A8A0-4563-ACEC-C795D96602A7","f159",0,"templarian","characters,other","remove-circle"),
				"close-circle-outline":new icon("EA41E6BB-A176-4E0E-896A-36F9FA5AA62F","f15a",0,"google","characters,other","","remove"),
				"closed-caption":new icon("5367B460-F7E5-46C5-A4F5-40B339BF9DAD","f15e",1,"google","player","","cc"),
				"close-network":new icon("4043C369-E619-47E9-9363-E5E9C43457FB","f15b",0,"templarian","networking","","remove"),
				"close-octagon":new icon("BA7E9F56-A5F5-4BEE-8934-90CA070A6029","f15c",0,"xt3000","characters,other","","remove"),
				"close-octagon-outline":new icon("9676C4C3-D8C3-44A6-A447-59A56A15DA34","f15d",0,"xt3000","characters,other","","remove"),
				"close-outline":new icon("2FEE0020-4271-487C-897D-75529B20C4C6","f6c8",0,"mririgo","characters,other","","",1836),
				"cloud":new icon("CF07C502-388E-4A65-BD89-FACCFD00C245","f15f",1,"google","networking,weather"),
				"cloud-braces":new icon("6ED02FDD-323E-4004-9D7B-336F2402DF8E","f7b4",0,"kumvert","networking","cloud-json","",2046),
				"cloud-check":new icon("5B607B90-B492-43AD-A5B0-4AC800A9F7DA","f160",0,"google","networking"),
				"cloud-circle":new icon("06BCD41B-8BFF-43C0-88A1-69F262C51C5F","f161",0,"google","networking"),
				"cloud-download":new icon("D8C49CD8-61B2-4F34-A4B8-543396B4A610","f162",1,"google","networking"),
				"cloud-off-outline":new icon("E19C3062-FFE5-441C-91C8-B1792E3AA3CA","f164",0,"google","networking"),
				"cloud-outline":new icon("6EBE020D-405B-4E36-8B47-CAC6FAF1166C","f163",0,"google","networking"),
				"cloud-print":new icon("DB32F759-BA18-488B-9260-9A38529BE7A8","f165",0,"xt3000","networking"),
				"cloud-print-outline":new icon("7B3F8F72-1F4B-429A-B969-8E42ADBBD3E1","f166",0,"xt3000","networking"),
				"cloud-sync":new icon("BEA2DB85-AD43-4208-8F5E-5029997B23B7","f63f",0,"xt3000","networking","","",1650),
				"cloud-tags":new icon("AE3A5033-BA77-4E82-BFD0-4C23275B602F","f7b5",0,"kumvert","networking","cloud-xml","",2046),
				"cloud-upload":new icon("BB4F16F6-B596-4725-8831-A794321542EB","f167",1,"google","networking"),
				"code-array":new icon("04020C45-A5ED-4D33-A7BD-AE986516C0DE","f168",0,"templarian"),
				"code-braces":new icon("1F6661BC-6538-4EF0-92B5-46EFAE5E0C77","f169",0,"xt3000","characters,other"),
				"code-brackets":new icon("C08498C1-E43B-4E79-817C-121AD2827689","f16a",0,"xt3000","characters,other","","square"),
				"code-equal":new icon("16C07036-EE56-4447-8495-EB2FAD143072","f16b",0,"xt3000"),
				"code-greater-than":new icon("2C70B20E-4B20-4CF6-8775-339C1184E032","f16c",0,"xt3000"),
				"code-greater-than-or-equal":new icon("3C9D2060-53C2-4D66-BE38-C46EE87D8D46","f16d",0,"xt3000"),
				"code-less-than":new icon("92266B3A-6EC4-4CE7-9904-2A793B2A4084","f16e",0,"xt3000"),
				"code-less-than-or-equal":new icon("3D003F4A-7BCB-4946-AE70-CCAA2B7D5B10","f16f",0,"xt3000"),
				"code-not-equal":new icon("1A01458F-59E8-4AF9-B398-8058900EE85F","f170",0,"xt3000"),
				"code-not-equal-variant":new icon("05E12366-E7AA-46B9-8D6E-3664EBD34BB3","f171",0,"xt3000"),
				"code-parentheses":new icon("A4E1DE1B-754D-4884-9902-8D5DDE2182B0","f172",0,"xt3000","characters,other","","brackets"),
				"code-string":new icon("76686B91-00D8-4ADD-A502-8D1788C9C17B","f173",0,"templarian"),
				"code-tags":new icon("609A0AB0-05EE-4824-BD40-A4E78F4A74D3","f174",0),
				"code-tags-check":new icon("7F098441-8B1D-4FB1-88EC-95726397BA7C","f693",0,"xt3000","other","","",1712),
				"codepen":new icon("FB9F6D89-8A07-407E-AD97-AAEF0E022585","f175",0,"templarian","logos"),
				"coffee":new icon("C95D04C5-F5EE-411A-88F7-A9872B2B4021","f176",0,"google","food","","cup,tea"),
				"coffee-outline":new icon("8994C73B-937C-4541-AAFF-6FA2CE0573DF","f6c9",0,"casesandberg","food","","cup,tea",1836),
				"coffee-to-go":new icon("8093CDE7-C795-4415-94C6-2EF40ED6D057","f177",0,"templarian","food","","cup,tea"),
				"coin":new icon("42F0733E-F36F-491B-ADC9-AC8ABAF2C0B7","f178",0,"templarian","money","","dollar,money"),
				"coins":new icon("BAD0A147-6CA0-4BCF-88DF-8E8A4C247B0E","f694",0,"google","money","","change,money",1712),
				"collage":new icon("8FD44CCD-5073-4C73-98BE-139F777F6E94","f640",0,"google","other","","",1650),
				"color-helper":new icon("F27490D2-F7BE-4B35-83E6-40D1F7247755","f179",0),
				"comment":new icon("B42FD735-27ED-47EC-887B-F5108774E6BC","f17a",1,"templarian"),
				"comment-account":new icon("E0D4328B-7A71-46E7-804B-DFC3753BEDF6","f17b",0,"templarian","users,other","","person,user"),
				"comment-account-outline":new icon("18A9FFE4-B768-4A8F-BD55-778C8E8C41FC","f17c",0,"templarian","users,other","","person,user"),
				"comment-alert":new icon("04CF8C3D-0D65-41CA-8D0D-53DD7EAB25B8","f17d",1,"templarian"),
				"comment-alert-outline":new icon("CBAD69A4-A6FF-4A8A-AA85-B5962910106E","f17e",0,"templarian"),
				"comment-check":new icon("5D2CEEF1-3F19-4AD2-8965-13DB365B0013","f17f",0,"templarian"),
				"comment-check-outline":new icon("D9BBEE92-5775-4364-8ECD-89C0872BE79F","f180",0,"templarian"),
				"comment-multiple-outline":new icon("A5FAC5DC-088F-485C-A885-FBBEEC70B352","f181",0,"templarian"),
				"comment-outline":new icon("B1A0A26E-3E9C-4718-8A26-2837A981D9B5","f182",0,"templarian"),
				"comment-plus-outline":new icon("813C3AFA-56D8-472B-8C1C-C365AC752663","f183",0,"templarian"),
				"comment-processing":new icon("D07698E0-AB53-4E7A-9C25-9A25D1D5CDA9","f184",0,"templarian"),
				"comment-processing-outline":new icon("0CDF5E61-25C4-4E30-8E16-32E4E7EDE705","f185",0,"templarian"),
				"comment-question-outline":new icon("7BD335A6-C4A7-48F1-B04F-F1457B7B1F20","f186",0,"xt3000"),
				"comment-remove-outline":new icon("520544E5-1693-4084-BB9C-B6FA70204B2C","f187",0,"templarian"),
				"comment-text":new icon("483321DB-C7E5-4E48-B739-8500F6153446","f188",1,"templarian"),
				"comment-text-outline":new icon("3D9E4543-670E-4434-8C82-3A80122ED4EE","f189",0,"templarian"),
				"compare":new icon("A9786B48-6664-4170-B56C-6F2868D5000D","f18a",0),
				"compass":new icon("8FE64B61-0FD6-4056-9A4F-E62408CE70FE","f18b",0,"google","travel"),
				"compass-outline":new icon("EDA6D9AB-4AAE-4080-A1D3-78762666D7B1","f18c",0,"lastrosestudios","travel"),
				"console":new icon("DCD0A183-A5DC-43BD-BC48-8FFF0CA0FA9C","f18d",1,"templarian","networking","terminal"),
				"console-line":new icon("D6FF21C5-201A-43E0-B8AF-276A6BED653A","f7b6",0,"templarian","editor,networking","terminal-line",_,2046),
				"contact-mail":new icon("81840940-8672-42C0-B657-15E94B3638D6","f18e",0,"google","users,other"),
				"contacts":new icon("5A68EA78-9792-4223-808D-17E5205765E6","f6ca",0,"google","other","","",1836),
				"content-copy":new icon("2B3B8FC2-C8AB-40AF-9B3F-AFFC93482676","f18f",0,"google","editor"),
				"content-cut":new icon("D4028362-37C3-4EED-BE0B-C78927C3F55D","f190",1,"google","editor","scissors,clip"),
				"content-duplicate":new icon("B1A86989-2CB4-47DC-BC93-67A077792F72","f191",1,"templarian","editor"),
				"content-paste":new icon("75856C98-A0D6-4C78-A323-BD170B6E6094","f192",1,"google","editor"),
				"content-save":new icon("29F946C0-CA58-4287-AF0B-964961E5CC2C","f193",1,"google","editor,tech","","disc,disk"),
				"content-save-all":new icon("B9BE7889-D858-41A1-AB4E-9C58325261E9","f194",1,"templarian","editor,tech","","disc,disks"),
				"content-save-settings":new icon("67E755F6-209A-41EF-98C5-423739A3AC10","f61b",0,"xt3000","editor","","disc,disk",1650),
				"contrast":new icon("B50D388A-4647-4780-83E7-2C5AD8375FB9","f195",0,"templarian"),
				"contrast-box":new icon("B7FCC914-C6E9-4919-8574-F0161C2CF28D","f196",0),
				"contrast-circle":new icon("A7CBFD5D-FDFD-4202-A290-840219A79F2F","f197",0),
				"cookie":new icon("8E3FB537-B293-41A6-B6C5-B2BE927091F5","f198",0,"google","food"),
				"copyright":new icon("34B43A77-9873-4723-AA65-45D42992748E","f5e6",0,"google","characters","","",1554),
				"corn":new icon("B49614ED-B7AB-4123-BD9C-B50CE119C76C","f7b7",0,"thunsaker","food,nature",_,_,2046),
				"counter":new icon("F789F2E4-022E-4A5A-B548-30D21BC3A7F6","f199",0,"infanf","time","","",1554),
				"cow":new icon("1D459B7E-A98C-4E02-929B-FA0BA329B97F","f19a",0,"templarian","nature"),
				"creation":new icon("598B7931-3DF8-4CFA-A6E6-80550CA31372","f1c9",0,"google","nature","","",1712),
				"credit-card":new icon("A121DBBB-C9E6-4534-AA7B-F59496787BD2","f19b",1,"google","money"),
				"credit-card-multiple":new icon("D7C8ADB6-B7C9-4653-9EA7-EB98552304BA","f19c",0,"templarian","money"),
				"credit-card-off":new icon("CD527CB6-15F0-41BF-BF50-2BCB8B6C769F","f5e4",0,"templarian","money","","",1554),
				"credit-card-plus":new icon("FA914D65-0F2C-463D-A54F-9B0DE9FBEED3","f675",0,"templarian","money","","",1712),
				"credit-card-scan":new icon("CF494E4E-F1FC-411D-87FD-933CC17EE08C","f19d",1,"templarian","money"),
				"crop":new icon("FA68ACCA-389F-453E-B886-FF3DAFE10530","f19e",1,"google","editor"),
				"crop-free":new icon("17AB799B-F531-4800-A7DE-23C5D95238F4","f19f",1,"google","editor"),
				"crop-landscape":new icon("DE641C3F-FEF6-4764-A276-F6FECFE031DA","f1a0",0,"google","editor"),
				"crop-portrait":new icon("02E45E84-72D2-4FE1-BF98-6A9521E31A8A","f1a1",0,"google","editor"),
				"crop-rotate":new icon("03774672-2612-4A56-9E32-69060B32B94C","f695",0,"google","editor","","",1712),
				"crop-square":new icon("72BA6354-04A5-4BE9-A84C-843B9441164E","f1a2",0,"google","editor"),
				"crosshairs":new icon("33845FDE-0003-4780-8DC9-07FC29D46599","f1a3",0),
				"crosshairs-gps":new icon("D3A1EC2E-98D5-46B6-BF33-DECBBAACEFBE","f1a4",0,"google","travel"),
				"crown":new icon("266349FD-1B26-4BCD-A682-D25C4469B682","f1a5",0,"templarian"),
				"cube":new icon("64E19922-572B-41F8-9139-BE6CBC8A0F80","f1a6",0,"templarian"),
				"cube-outline":new icon("11B7F7B5-8813-48DE-9469-B1159355DDC3","f1a7",0,"templarian"),
				"cube-send":new icon("F0726D57-782C-44E8-A404-336480FC9E7B","f1a8",0,"xt3000"),
				"cube-unfolded":new icon("A22472A9-D83E-4234-AAF0-F60AFB7C57DB","f1a9",0,"templarian"),
				"cup":new icon("D5DA2C54-C8D0-469F-99A9-C8DB9D3A6F15","f1aa",0,"templarian","food"),
				"cup-off":new icon("FD336A31-52C0-41AF-A0F3-BA475DEA1A54","f5e5",0,"templarian","food","","",1554),
				"cup-water":new icon("AC4AD054-775A-4D59-BF92-A57A6A952607","f1ab",0,"google","food"),
				"currency-btc":new icon("CCAF9A48-2989-47C7-B4A5-1CF424A339CC","f1ac",0,"templarian","logos,money","bitcoin"),
				"currency-chf":new icon("55AE86E1-C6DB-4F41-BC21-1750DB608D23","f7b8",0,"japanyoshilol","money","","franc,swiss",2046),
				"currency-cny":new icon("0F5809A3-18DD-4B42-9A7E-B35B65EF3751","f7b9",0,"japanyoshilol","money","","chinese,yuan,renminbi",2046),
				"currency-eth":new icon("222B8F14-2217-4FC1-8940-AC1CF8AB150B","f7ba",0,"greenturtwig","logos,money",_,"ethereum",2046),
				"currency-eur":new icon("94C667B3-E2EB-428D-B422-751C234CCF44","f1ad",1,"templarian","money","","euro"),
				"currency-gbp":new icon("F9BD830F-EBB6-45A4-A576-0DEC27084A95","f1ae",1,"templarian","money","","pounds,sterling"),
				"currency-inr":new icon("AB8EAA72-9A34-4F87-937A-9A8FDEFA1FEF","f1af",0,"templarian","money","rupee","indian"),
				"currency-jpy":new icon("639A8D4C-086C-4038-A569-F9387E851262","f7bb",0,"japanyoshilol","money",_,"japanese,yen",2046),
				"currency-krw":new icon("72750D9E-229F-4D77-B1CB-9C2C0FD12335","f7bc",0,"japanyoshilol","money",_,"korean,won",2046),
				"currency-ngn":new icon("2F091499-4472-423E-A0C5-8C96CDDE1ABF","f1b0",0,"templarian","money","","naira,nigerian"),
				"currency-rub":new icon("57057EA1-1BA7-49F3-A8C7-51AF633DED68","f1b1",1,"templarian","money","","ruble,russian"),
				"currency-sign":new icon("17CFE8D4-18D7-4414-B8EE-244D5A8FF791","f7bd",0,"mrgrigri","money","currency-scarab",_,2046),
				"currency-try":new icon("94DAFCB6-FA70-4DAE-B3DF-A107031F81E8","f1b2",0,"templarian","money",_,"lira,turkish"),
				"currency-twd":new icon("E0103EBC-20BF-48EA-BC8F-BEF04BF2A581","f7be",0,"japanyoshilol","money",_,"dollar,taiwanese",2046),
				"currency-usd":new icon("3FA4946C-029B-42D3-AA31-3D607FB4A2F1","f1b3",1,"google","money","","dollars"),
				"currency-usd-off":new icon("5E9D35E4-9487-4A9B-9D4B-E1BBCA52AE0C","f679",0,"google","money","","dollars",1712),
				"cursor-default":new icon("2B463003-089D-47DE-97F7-434F16A4735B","f1b4",0,"templarian"),
				"cursor-default-outline":new icon("E6A56AAF-22C5-4DAE-9E97-184501755DF5","f1b5",0,"templarian"),
				"cursor-move":new icon("EDAD5377-8923-4D6C-AC12-CBDC6C78DC7F","f1b6",0,"templarian"),
				"cursor-pointer":new icon("B5465B23-729A-405E-9155-486A36D8135F","f1b7",0,"templarian"),
				"cursor-text":new icon("76C56C15-C2A3-4042-95C7-F143A3B58765","f5e7",0,"templarian","other","","",1554),
				"database":new icon("C8FC48A7-AE19-4BD8-B57E-14B76D93937B","f1b8",0,"xt3000","networking"),
				"database-minus":new icon("31CE0431-ABF2-4650-8439-515C0E9012CD","f1b9",0,"xt3000","networking","","",0,1650),
				"database-plus":new icon("940D2514-B309-4CE0-A2E4-D02121415CA3","f1ba",0,"xt3000","networking","","",0,1650),
				"debug-step-into":new icon("316468B3-C3F6-4A7B-B7B2-061E5C35FFE9","f1bb",0,"templarian"),
				"debug-step-out":new icon("08B9B3C7-BB6B-4110-ACEC-3BB947FFCFBA","f1bc",0,"templarian"),
				"debug-step-over":new icon("8242E7C8-1400-476D-AC27-DCA7B6292C70","f1bd",0,"templarian"),
				"decagram":new icon("DA734DBD-1239-4E30-B688-ADF6A9D222D0","f76b",0,"templarian","other","","",1932),
				"decagram-outline":new icon("5F4B9A38-F090-4FA3-A138-1F758A9D446E","f76c",0,"templarian","other","","",1932),
				"decimal-decrease":new icon("3A6FCF00-DE3C-4CD7-BF06-1D26E37E0C47","f1be",0,"xt3000","editor"),
				"decimal-increase":new icon("E99CB4D3-330D-493C-9C6B-FD43B27522FD","f1bf",0,"xt3000","editor"),
				"delete":new icon("71CD492D-A1E8-4A7A-961A-51DA30952BAD","f1c0",1,"google","other","trash","bin"),
				"delete-circle":new icon("1158F80B-E934-4E74-A4C6-7750BDCC409E","f682",0,"templarian","other","","bin,trash",1712),
				"delete-empty":new icon("E39FB607-9058-4C00-840C-AF666F372071","f6cb",0,"templarian","other","","bin,trash",1836),
				"delete-forever":new icon("52AFD546-8C5D-4E77-8D83-D4D058A742FE","f5e8",0,"google","other","","bin,trash",1554),
				"delete-sweep":new icon("3B3D514C-AFC3-4D04-91EA-E18F03BB494A","f5e9",0,"google","other","","bin,trash",1554),
				"delete-variant":new icon("DC3862AC-6945-4104-9F15-50BD46D13705","f1c1",0,"templarian","other","trash-variant","bin"),
				"delta":new icon("D4B29470-8EE3-4ED8-BB01-6C942CE7E748","f1c2",0,"google","characters"),
				"deskphone":new icon("C05777DC-F874-4231-B9EB-5675C808F7BB","f1c3",0,"chrislitherland","tech"),
				"desktop-classic":new icon("40B89929-0709-461F-8C7A-ED94CDDCC4AC","f7bf",0,"greenturtwig","tech","computer-classic",_,2046),
				"desktop-mac":new icon("4B4C339D-D581-44A3-95DE-4254CC42AC8D","f1c4",0,"google","tech","","computer"),
				"desktop-tower":new icon("362BCE24-8F91-491A-8EE8-BD08C296511A","f1c5",0,"chrislitherland","tech","","computer"),
				"details":new icon("21A2819F-3B97-49D0-A588-30CF7B8915F5","f1c6",0),
				"developer-board":new icon("7D1C43A0-CDE0-416B-A1A9-1CD07F930284","f696",0,"google","other","","",1712),
				"deviantart":new icon("ECD72042-9BA7-4C24-A740-7F538B443302","f1c7",0,"templarian","logos"),
				"dialpad":new icon("B732FAD7-93A7-478E-810F-835069DE6EDB","f61c",0,"google","tech,other","","keypad",1650),
				"diamond":new icon("7AEA1B64-9B6D-4D55-91F8-05BA1BF3BF89","f1c8",1,"xt3000"),
				"dice-1":new icon("F8E5E9B6-9953-46F8-84DC-CFBB11DEFFB7","f1ca",0,"belledeboheme","other","","die,one"),
				"dice-2":new icon("07927207-23B1-4A93-BB8A-E6B5F41B919A","f1cb",0,"belledeboheme","other","","die,two"),
				"dice-3":new icon("2948109E-F9DA-4306-8247-665CC05BDB21","f1cc",0,"belledeboheme","other","","die,three"),
				"dice-4":new icon("F7FA1307-CC98-4B93-B42A-533F1F6E851C","f1cd",0,"belledeboheme","other","","die,four"),
				"dice-5":new icon("9B9F7FE0-5AA9-4B5F-B865-D7F21C1382AF","f1ce",0,"belledeboheme","other","","die,five"),
				"dice-6":new icon("015F173B-CA59-4125-8F19-925ED108BE07","f1cf",0,"belledeboheme","other","","die,six"),
				"dice-d10":new icon("47BB1E5C-0CCD-4A50-B1EF-2437411217C0","f76e",0,"templarian","other","","10,die,sided,ten",1932),
				"dice-d20":new icon("926FAA94-AB58-44AA-916C-66AF56A5BCCF","f5ea",0,"templarian","other","","20,die,sided,twenty",1554),
				"dice-d4":new icon("DCC141FA-CA87-48E1-969D-BB010C973DD5","f5eb",0,"templarian","other","","4,die,four,sided",1554),
				"dice-d6":new icon("A0F00FDF-6648-475B-819B-29E4C0769FFA","f5ec",0,"templarian","other","","6,die,sided,six",1554),
				"dice-d8":new icon("64967BE6-CAAF-4F28-BF55-C5451D4E8B94","f5ed",0,"templarian","other","","8,die,eight,sided",1554,1932),
				"dice-multiple":new icon("8C9D5084-1B34-4AB9-BE23-E44B03AE85E5","f76d",0,"mrgrigri","other","","",1932),
				"dictionary":new icon("250BF541-072A-4773-8BC2-B1943DF1EDBB","f61d",0,"infanf","other","","",1650),
				"dip-switch":new icon("2356EE38-11BE-44B1-BAD9-D74ECE86F8E7","f7c0",0,"templarian","other",_,_,2046),
				"directions":new icon("4C84603B-BEB6-4282-B6CE-D9AD3C098627","f1d0",0,"google","arrows,travel"),
				"directions-fork":new icon("8F53DAC3-E72D-473E-ABD1-AC1849EB660A","f641",0,"google","arrows,travel","","",1650),
				"discord":new icon("2C23A3F9-54C7-4C7F-8C2F-182A4F75F894","f66f",0,"templarian","logos","","",1650),
				"disk":new icon("95CEA0DD-5123-4FFA-B906-E6C55766030D","f5ee",0,"xt3000","tech","","disc",1554),
				"disk-alert":new icon("63A41E0F-CCDB-42F8-848B-F64AA94F9BDF","f1d1",0,"google","other","","disc"),
				"disqus":new icon("28670432-3B76-43FC-B879-558B338F1E1F","f1d2",0,"templarian","logos"),
				"disqus-outline":new icon("66BF0ABD-9688-49F1-B260-382B15D53432","f1d3",0,"lastrosestudios","logos"),
				"division":new icon("FB313489-5EA3-4F07-ABA4-F84995D7DD13","f1d4",0,"templarian","characters"),
				"division-box":new icon("1A0BABA0-5F5E-45ED-A4BB-DCBD569F6E43","f1d5",0,"templarian","characters"),
				"dna":new icon("2C726E7E-53C8-410C-82F4-FE5DE9EF4BC1","f683",0,"japanyoshilol","science","","helix",1712),
				"dns":new icon("D4A20191-F5B8-4323-A0A8-F4C15A86A83B","f1d6",0,"google","networking"),
				"do-not-disturb":new icon("F33DB278-2B2B-4731-9FDD-6D053EC2CBAB","f697",0,"google","other","","entry",1712),
				"do-not-disturb-off":new icon("092B5CD3-BB99-492C-9784-4BE71B0C7F5B","f698",0,"google","other","","",1712),
				"dolby":new icon("FE71CD75-B2E7-49A5-B00B-732BACB52F6F","f6b2",0,"mrgrigri","logos","","",1722),
				"domain":new icon("CA264BA4-62A9-4823-A172-22DD413A6CF5","f1d7",0,"google","networking","building,company"),
				"donkey":new icon("7027E5FC-228D-4E32-B2BB-02287E94D132","f7c1",0,"","nature",_,_,2046),
				"dots-horizontal":new icon("9156AFAA-25BB-4E97-9EC8-BB9BE9AF60B0","f1d8",1,"google","characters,other","more","ellipsis"),
				"dots-horizontal-circle":new icon("2ED6A664-DAE9-427C-8810-496C331C9BE0","f7c2",0,"","characters,other",_,"ellipsis,more",2046),
				"dots-vertical":new icon("5D70B3D1-8407-42C9-A3C1-42EE68FF18F3","f1d9",1,"google","other","","ellipsis,more,options"),
				"dots-vertical-circle":new icon("5D23E65D-271A-463B-972F-E8524E76E6D7","f7c3",0,"","other",_,"ellipsis,more,options",2046),
				"douban":new icon("FF8D4F38-8A77-4FDD-8C6D-D17F6A44516D","f699",0,"mrgrigri","logos","","",1712),
				"download":new icon("704F7397-0E85-4213-8D76-FE156DF1795F","f1da",1,"google","networking,other"),
				"download-network":new icon("8DD93DC3-060D-4CB3-AB41-8A1A5243BFFD","f6f3",0,"templarian","networking","","",1836,1932),
				"drag":new icon("2366C232-208F-4A03-9FC9-D9C8C52622CA","f1db",0,"templarian"),
				"drag-horizontal":new icon("544A0702-E7DC-4E1F-9A6E-8785AA3048D8","f1dc",0,"templarian"),
				"drag-vertical":new icon("4B8D8E9B-547D-4DE3-B8E1-5023867EF965","f1dd",0,"templarian"),
				"drawing":new icon("E8557F02-8241-47FB-B546-402947A5818C","f1de",0,"templarian","editor"),
				"drawing-box":new icon("BF9750EC-EB85-4670-A4DE-4808729249B5","f1df",0,"google","editor"),
				"dribbble":new icon("D3FD64E5-2836-4527-8861-29D53D101672","f1e0",0,"templarian","logos"),
				"dribbble-box":new icon("4147C0BC-E3AE-4324-AA38-D2EC7A7AAD5E","f1e1",0,"lastrosestudios","logos"),
				"drone":new icon("B6A0EC44-BDF3-4001-ABBF-51E0F2522BD3","f1e2",0,"templarian","travel"),
				"dropbox":new icon("C8E22510-9369-4C7C-B598-8799DB9FE2A2","f1e3",0,"templarian","logos"),
				"drupal":new icon("5FCCAA35-0339-4B8F-984A-D4112C3277C1","f1e4",0,"krambertech","logos"),
				"duck":new icon("74F300CC-D7A5-45AF-A946-B219E82F8997","f1e5",0,"templarian","nature"),
				"dumbbell":new icon("E792948B-8E66-49B5-83E7-8CDF1ECE6C5D","f1e6",0,"templarian","places,sport","","gym,weight,workout"),
				"ear-hearing":new icon("9F02DA93-0C4D-4A77-8F6B-E4220480AB55","f7c4",0,_,_,_,_,2046),
				"earth":new icon("0D1618BF-A3AD-4B4A-92EA-5DBF93BF7625","f1e7",0,"google","places,science,other","globe","planet"),
				"earth-box":new icon("3F4C3330-49D5-4F2B-8FCC-A3448BEF521E","f6cc",0,"greenturtwig","other","","",1836),
				"earth-box-off":new icon("CAE8B8BC-E89F-49C3-8178-6F09ACED1FC3","f6cd",0,"greenturtwig"),
				"earth-off":new icon("519E0041-FD5F-4DAD-96A4-BED1EDE9A20B","f1e8",0,"templarian","science"),
				"edge":new icon("C2D33448-5C6E-41D9-89B4-65184FF5EE15","f1e9",0,"templarian","logos","","browser,microsoft"),
				"eject":new icon("4B57E9DF-354F-460D-9551-65C0DB55D788","f1ea",1,"google","player"),
				"elephant":new icon("0332819B-1686-4375-86E9-0866AE19C2BF","f7c5",0,"","nature",_,_,2046),
				"elevation-decline":new icon("6057DE08-41EC-4DE6-9ACC-7FB5AF3D4536","f1eb",0,"templarian","science"),
				"elevation-rise":new icon("CEFE04E6-CBE8-4DDD-BCF2-F445579B68FE","f1ec",0,"templarian","science"),
				"elevator":new icon("8A9045D4-D6AC-4660-8C55-D622156A1B8C","f1ed",0,"templarian","places"),
				"email":new icon("14AAE073-8399-4D67-9F7E-8E9424328681","f1ee",1,"google","other","","e-mail,envelope,letter,mail,notification,support"),
				"email-alert":new icon("8031577D-2528-4278-9F7B-93BD5DED18E3","f6ce",0,"templarian","other","","e-mail,envelope,letter,mail,notification,support",1836),
				"email-open":new icon("1E550A45-9D97-4918-9DEC-F536EC5C7A1C","f1ef",1,"templarian","other","","e-mail,envelope,letter,mail,notification,support",0,1554),
				"email-open-outline":new icon("4F7B4311-FC6B-463D-A2A3-760554AF144E","f5ef",0,"templarian","other","","e-mail,envelope,letter,mail,notification,support",1554),
				"email-outline":new icon("53CE3621-DBCC-45E8-B105-2BEA7493CCA0","f1f0",0,"lastrosestudios",_,_,"e-mail,envelope,letter,mail,notification,support",0,2046),
				"email-secure":new icon("04288F6D-7E3C-4BB6-8FDE-B8951C0D0BDF","f1f1",0,"xt3000","other","","e-mail,envelope,letter,lock,mail,notification,support"),
				"email-variant":new icon("80BB05EB-8F75-4205-9952-60B09204A9F6","f5f0",0,"templarian","other","","e-mail,envelope,letter,mail,notification,support",1554),
				"emby":new icon("7CACE4E9-A4B1-461E-A8E5-8032C22E86A1","f6b3",0,"infanf","logos","","",1722),
				"emoticon":new icon("69AAECAA-0B17-4C53-8345-4F172B7FEF50","f1f2",0),
				"emoticon-cool":new icon("62BB1B4E-67AC-4DFE-B37C-65D0F04F71D0","f1f3",0,"templarian"),
				"emoticon-dead":new icon("47AD308C-C9D8-43DB-8E92-B0FB02B906CF","f69a",0,"google","other","","",1712),
				"emoticon-devil":new icon("916B1319-9E91-48C0-AD65-B21B599D8FCA","f1f4",0,"templarian"),
				"emoticon-excited":new icon("828FF1EE-1B9B-4407-A45B-A071FA938158","f69b",0,"google","other","","",1712),
				"emoticon-happy":new icon("F51C2659-3EE9-471C-A919-190D3C1A9681","f1f5",0,"lastrosestudios"),
				"emoticon-neutral":new icon("17F30B32-37E2-41BB-876C-70E568D04623","f1f6",0,"templarian"),
				"emoticon-poop":new icon("968319FB-0E94-4F04-A6D8-9E71DF200E1F","f1f7",0,"templarian",_,_,_,0,2046),
				"emoticon-sad":new icon("6D8A3A11-7A90-424C-82A6-93C455379743","f1f8",0,"lastrosestudios"),
				"emoticon-tongue":new icon("57288378-59EE-4705-ACD5-3B424ACA70C1","f1f9",0,"templarian"),
				"engine":new icon("290CA835-F009-4630-87D3-D4515E1F5527","f1fa",0,"xt3000","travel"),
				"engine-outline":new icon("75A5F242-D136-49B9-9DFF-25F0631743A7","f1fb",0,"xt3000","travel"),
				"equal":new icon("119DD58E-769B-47C2-9AB8-1671DEC4FE4A","f1fc",0,"templarian","characters"),
				"equal-box":new icon("F98CD2ED-FD62-414E-9116-94BA99713526","f1fd",0,"templarian","characters"),
				"eraser":new icon("758CA292-BBF5-4C08-BCBD-88B7A84C8BC6","f1fe",0,"templarian","editor"),
				"eraser-variant":new icon("8E45C70B-EE1A-48AE-B97F-204F1958E788","f642",0,"google","editor","","",1650),
				"escalator":new icon("2DB352CF-8F2F-43FD-BCA0-675F7C9D298C","f1ff",0,"templarian","places"),
				"ethernet":new icon("3AB3C243-0FD3-4903-A6EA-B0B29ABFAD6C","f200",0,"xt3000","networking"),
				"ethernet-cable":new icon("FC900F32-A228-4E42-9E09-EA7CCDEC08F2","f201",0,"xt3000","networking"),
				"ethernet-cable-off":new icon("79E1B678-8458-4750-9EE0-C5CE7E57E9F1","f202",0,"xt3000","networking"),
				"etsy":new icon("BC0BD74D-06D4-458A-B0CE-90B96A2ADCBF","f203",0,"templarian","logos"),
				"ev-station":new icon("7C859DE1-16F6-4EF2-9097-A1D0C14CC3A2","f5f1",0,"google","places,power,travel","","charging,electric,vehicle",1554),
				"eventbrite":new icon("8ABE8FB2-F704-4095-9E65-F614F86FCE99","f7c6",0,"mrgrigri","logos",_,_,2046),
				"evernote":new icon("193F4AB4-12B2-4E3C-965F-284967A7F736","f204",0,"templarian","logos"),
				"exclamation":new icon("06E68A9B-2ED4-4697-82A2-02F1FA342D55","f205",0,"templarian","characters"),
				"exit-to-app":new icon("DD2BE6C6-A15C-44D4-807A-C29DE965CF22","f206",0),
				"export":new icon("670C2CEA-D9B1-4126-89F4-C881D032F3AD","f207",0,"templarian"),
				"eye":new icon("3C2B7DF3-97FE-4EC4-B6A9-69A75FB26B67","f208"),
				"eye-off":new icon("4D1385CF-1389-43D3-BD88-A83018434FB6","f209"),
				"eye-outline":new icon("F2AA59FA-23F6-4FE8-A52A-AEC674A9E864","f6cf",0,"templarian","other","","",1836),
				"eye-off-outline":new icon("D88D00BE-0B70-40F5-AFD0-51C65DE8D674","f6d0",0,"templarian","other","","",1836,1932),
				"eyedropper":new icon("89350468-16D8-4F39-AA78-C3E00EE8FB2C","f20a",0,"templarian","editor"),
				"eyedropper-variant":new icon("24A1E7A8-D8A4-4216-B467-72C144972358","f20b",0,"google","editor"),
				"face":new icon("D41E7F40-FF48-422F-A64B-4908C6C10F00","f643",0,"google","other","","",1650),
				"face-profile":new icon("97E9CDDB-45B3-4592-8E1F-0DB66E16E1A3","f644",0,"google","other","","",1650),
				"facebook":new icon("95CC9E46-A553-42B3-B44E-2E88DB13C1E1","f20c",0,"templarian","logos"),
				"facebook-box":new icon("B6FBB02F-98A0-4521-BA9B-D00EA8A2FC57","f20d",0,"google","logos","","",0,1932),
				"facebook-messenger":new icon("1989DA16-DAA9-4C95-A61F-BA512FE5592D","f20e",0,"belledeboheme","logos"),
				"factory":new icon("B74F1DE6-5DEC-4866-AEED-DE85FE09C52F","f20f",1,"templarian","places","industrial"),
				"fan":new icon("2606F8A3-AFD7-41EB-BD2D-C3546FEADB2F","f210",0,"templarian","tech,other"),
				"fan-off":new icon("BB761A30-6F3C-484D-A0C9-501972F544AB",_,0,"greenturtwig",_,_,_,"2.x.x"),
				"fast-forward":new icon("98B9D071-70A9-422B-BCC1-55DC4C2E0744","f211",1,"google","player"),
				"fast-forward-outline":new icon("05435BA8-4BB4-4581-A2BA-D2D7679B831F","f6d1",0,"mririgo","player","","",1836),
				"fax":new icon("2C398569-5DBF-4405-AF73-6F5CA629AEE1","f212",0,"xt3000","tech","","facsimile",0,1932),
				"feather":new icon("A0C975EA-A25D-4882-96DE-39CB72DAC2CA","f6d2",0,"xt3000","nature","","",1836),
				"ferry":new icon("F138AC6A-406B-4EB0-BB85-0FDB5415B6F8","f213",0,"google","travel","cargo-ship"),
				"file":new icon("BFF59001-B52D-47E6-A217-C9095F81C3B8","f214",1,"google","files"),
				"file-account":new icon("94A8A0E0-B69E-4099-A32E-34B83449AFBC","f73a",0,"templarian","files","","person,user",1932),
				"file-chart":new icon("303BB890-634F-405C-B77C-4AC831BCAEC4","f215",0,"xt3000","files","file-report"),
				"file-check":new icon("9E66E6CF-74AD-4DB5-953B-DC135B4AD44C","f216",0,"xt3000","files"),
				"file-cloud":new icon("452A53B0-3718-4483-ABB0-2897EBE97312","f217",0,"templarian","files"),
				"file-delimited":new icon("46650D6B-318F-4202-AB77-79A113EC77AA","f218",0,"templarian","files"),
				"file-document":new icon("B8F65B26-E57F-4879-852E-D894E4ACAB65","f219",0,"templarian","files"),
				"file-document-box":new icon("32E03B3D-EAFA-4483-AE94-E43944F0F0AE","f21a",0,"google","files"),
				"file-excel":new icon("C3AADE94-4136-4D8E-8DFE-9AA7C88EE5D5","f21b",0,"templarian","files"),
				"file-excel-box":new icon("A2FE83DC-3544-4D13-85BD-2C54CDC1A460","f21c",0,"google","files"),
				"file-export":new icon("5693BB52-A00A-45E6-8DDD-C84FE3D9D440","f21d",0,"xt3000","files"),
				"file-find":new icon("A9D2E13D-A9F6-48AC-9998-22756DA6C709","f21e",0,"google","files","print-preview"),
				"file-hidden":new icon("22033CAF-C8AF-4C33-9FCD-9D6FC4EE7EAF","f613",0,"templarian","files","","",1554),
				"file-image":new icon("2318EAB3-F03A-40C3-A245-668B244A9AC1","f21f",0,"templarian","files"),
				"file-import":new icon("1294020B-960A-4390-916F-BF8118A6E7C6","f220",0,"xt3000","files"),
				"file-lock":new icon("1D017133-E895-4103-98C1-E90D26126003","f221",0,"templarian","files"),
				"file-multiple":new icon("7696AF65-B943-4BA3-94DB-5E85077F7BA9","f222",1,"xt3000","files"),
				"file-music":new icon("C6CD26A5-C5F6-4C5D-AF2C-919E8ED4166C","f223",0,"templarian","files","","note,sound"),
				"file-outline":new icon("36FCB7D4-D7DE-4B44-BD28-53615689D2C6","f224",0,"templarian","files"),
				"file-pdf":new icon("D5A23F56-0398-40EF-8B0D-640CD1F39669","f225",0,"templarian","files"),
				"file-pdf-box":new icon("C09B20B5-3650-4F36-AC40-540ACE36EB6E","f226",0,"google","files"),
				"file-percent":new icon("267C5350-A0FC-4683-9FA1-30CD64AAA7E5",_,0,"mrgrigri","files",_,_,"2.x.x"),
				"file-plus":new icon("9C42F83F-4C75-4E0A-A1C2-F10FA032E495","f751",1,"templarian","files","","",1932),
				"file-powerpoint":new icon("62D44147-9B6F-4B4A-A06B-1AF92C2E7F3E","f227",0,"templarian","files"),
				"file-powerpoint-box":new icon("2C917F0E-C35E-45B2-9E60-0C3D7C2630CF","f228",0,"google","files"),
				"file-presentation-box":new icon("A7F6B3BE-8D61-4AF3-BBFC-15A795254F6A","f229",0,"google","files"),
				"file-restore":new icon("EE0E5547-D368-43CB-8BDD-7F3774985BEF","f670",0,"google","files","","",1650),
				"file-send":new icon("CEB97477-6633-4486-BDD4-9E7D7C747805","f22a",0,"templarian","files"),
				"file-tree":new icon("FE2B1AE3-7158-473B-B1EE-45FB9CAE1137","f645",0,"kaifaust","files","","",1650),
				"file-video":new icon("7BEB068A-898D-43FF-AAA6-BC239FBA74F2","f22b",0,"templarian","files"),
				"file-word":new icon("05004893-1DB7-4A34-AC50-D4B46133A603","f22c",0,"templarian","files"),
				"file-word-box":new icon("AE6B9B24-DD1E-4896-B385-8DBB9D21C9E7","f22d",0,"google","files"),
				"file-xml":new icon("F11E3989-CBFD-4431-BDC1-44AEBBCDD8F6","f22e",0,"templarian","files"),
				"film":new icon("2EFEE436-9663-4C09-AD65-6727A0ED2AFD","f22f",0),
				"filmstrip":new icon("10A06B6D-A551-425C-B084-DA3F2239DFA1","f230",0),
				"filmstrip-off":new icon("CB040E6C-85FD-4C09-9ACD-C41EE5FB770E","f231",0,"templarian"),
				"filter":new icon("39CAC4E6-CC95-42C8-94E9-E29089F1E91E","f232",0,"templarian"),
				"filter-outline":new icon("524BE3DE-F5C8-4E2E-A329-8480136DCBDB","f233",0,"templarian"),
				"filter-remove":new icon("F0D392A7-69A4-4301-8E3B-46A8FC7C3DF9","f234",0,"templarian"),
				"filter-remove-outline":new icon("C6DD0143-A7E3-464D-B0AC-F97E5C51F74C","f235",0,"templarian"),
				"filter-variant":new icon("AECECEA4-9E56-4B4B-ACD6-2C85AB09788A","f236",0),
				"find-replace":new icon("D093813C-B59B-42BD-B6C7-B451FA51E87E","f6d3",0,"google","other","","search",1836),
				"fingerprint":new icon("F71C897D-9858-40AE-8DB4-253CE675D823","f237",0),
				"fire":new icon("5259DBA5-B2FB-4112-B1F2-5DC17002205C","f238",0,"google","science"),
				"firefox":new icon("2A7EE574-62BE-4000-B8D8-B601C29D2960","f239",0,"chrislitherland","logos","","browser"),
				"fish":new icon("91D8C321-95BC-4AC6-9B3E-D38D457BFF75","f23a",0,"templarian","nature"),
				"flag":new icon("55271063-77EF-43FA-917C-657E57135A24","f23b"),
				"flag-checkered":new icon("B7386AC8-4DBF-4948-AD45-49234A8A019B","f23c",0,"templarian"),
				"flag-outline":new icon("3C0BD546-A778-4BDC-A30A-A627D61CBA47","f23d",0,"templarian"),
				"flag-outline-variant":new icon("756B772A-F638-48EB-918C-2FA4237C7767","f23e",0,"templarian"),
				"flag-triangle":new icon("3E14D0C4-25AA-405E-89A7-37E9A224BA93","f23f",0,"templarian"),
				"flag-variant":new icon("9A9DB93D-CE2E-4887-B648-9C70E1922092","f240",0,"templarian"),
				"flash":new icon("EF3D6923-793B-410C-B349-90A6A338F06C","f241",1,"google","power,weather,other","lightning-bolt"),
				"flash-auto":new icon("D3251831-8AEF-420A-9AA8-2BA0A0621538","f242",0),
				"flash-off":new icon("A6D1B09D-EDB0-4241-B42D-E56052A070DE","f243",0),
				"flash-outline":new icon("088BF56F-9281-43DB-879E-EB5158428EB7","f6d4",0,"mririgo","power,weather,other","","bolt,lightning",1836),
				"flashlight":new icon("0EC7CDC8-86F4-4C72-AC2E-1DEDB196043F","f244",0,"templarian","other","","torch"),
				"flashlight-off":new icon("043DEA8B-1F5B-49CE-BC9F-AA3FC802A58A","f245",0,"templarian","other","","torch"),
				"flash-red-eye":new icon("C25CEF12-DF9C-45A4-8399-3102B79BDF14","f67a",0,"templarian","other","","",1712),
				"flask":new icon("5E171637-949C-4091-9A6E-1A56C1DC8347","f093",1,"templarian","science"),
				"flask-empty":new icon("D036C297-DB1B-42F5-A856-13EEBDB48613","f094",1,"templarian","science"),
				"flask-empty-outline":new icon("E9FFE6A9-C641-47BE-988B-A94B34A90CED","f095",0,"templarian","science"),
				"flask-outline":new icon("14C068EE-90AC-42DA-AA1E-D24F74EE7263","f096",0,"templarian","science"),
				"flattr":new icon("E86BFC0D-B4A4-41F2-A8E3-D1AE79072A45","f246",0,"templarian","logos"),
				"flip-to-back":new icon("F9DD0BF3-1CF8-456E-A542-2D22131A5761","f247",0,"google","editor"),
				"flip-to-front":new icon("6CEAE4F9-F6CB-4DA8-A25C-1F41494C6DD5","f248",0,"google","editor"),
				"floor-plan":new icon("131D3C5D-880D-486B-A041-039B1F1E5284",_,0,"",_,_,_,"2.x.x"),
				"floppy":new icon("B4AC5BF4-AF66-4DC5-9743-F62A80489149","f249",0,"templarian","tech"),
				"flower":new icon("D73BB486-A112-48C1-A4EE-993825164C43","f24a",0,"google","nature"),
				"folder":new icon("9D8C1CEE-19BE-4B0B-85CC-DEB829F9F045","f24b",1,"google","files"),
				"folder-account":new icon("0C56278E-06DE-4D32-BA08-C78F3EB572CC","f24c",0,"google","files,users","","person,user"),
				"folder-download":new icon("E10E0982-353D-484A-886B-30D343261422","f24d",0,"templarian","files"),
				"folder-google-drive":new icon("B8ACEEFF-E80A-42A9-BCAE-A804D47D8929","f24e",0,"google","files,google"),
				"folder-image":new icon("726DE98D-9BA1-4E73-8632-FF3F3768A3B3","f24f",0,"templarian","files"),
				"folder-lock":new icon("FABB67CE-5F69-4D45-95B9-02D7BFC9EABD","f250",0,"templarian","files"),
				"folder-lock-open":new icon("F89AD3B3-DD09-44F7-81A7-0433ECD44A8F","f251",0,"templarian","files"),
				"folder-move":new icon("B7AD0302-5738-4474-9679-AC118E566A7E","f252",0,"google","files","","",0,2046),
				"folder-multiple":new icon("7116841C-C243-4A44-8C68-267048AAF939","f253",1,"templarian","files"),
				"folder-multiple-image":new icon("29BE785E-BAAB-4824-A0BF-6892D8027B1E","f254",0,"google","files"),
				"folder-multiple-outline":new icon("F91AD38D-33E3-46A4-83BC-17B671750D6C","f255",0,"templarian","files"),
				"folder-open":new icon("7BBC57AE-0EBA-4198-8B85-5082A38522DE","f76f",0,"templarian","files","","",1932),
				"folder-outline":new icon("0524FF60-B273-4675-9B69-043730244645","f256",0,"google","files"),
				"folder-plus":new icon("BAE32170-6509-4D1F-A6A5-A2FD1A0C679B","f257",1,"templarian","files"),
				"folder-remove":new icon("3FF41316-69DC-4913-A299-84206E12FE42","f258",0,"templarian","files"),
				"folder-star":new icon("58C8B00C-897C-4381-9AD2-33B754B96865","f69c",0,"google","files","","",1712),
				"folder-upload":new icon("9F84EC25-D8C7-4BB0-B39F-E71919F4EE6D","f259",0,"templarian","files"),
				"font-awesome":new icon("0D7EBC60-1884-41C7-B37E-E0EED68E896E","f03a",0,"eccentric_jay","logos","","flag",1836,1836),
				"food":new icon("140954DE-20F5-4A8B-BFC3-DB8E49922AF3","f25a",0,"templarian","food,places"),
				"food-apple":new icon("D5B1A45F-8C43-4E3B-8E75-09EAF1984021","f25b",0,"templarian","food"),
				"food-croissant":new icon("28363B2E-72C8-481E-B702-7DE52F72717C","f7c7",0,"alexefremo","food","","",2046),
				"food-fork-drink":new icon("4CE93EC4-0938-4CB2-AB0E-0DCA0AF27B91","f5f2",0,"google","food,places","","",1554),
				"food-off":new icon("3731F58E-CAEA-4B54-87A6-7F4E039F2B31","f5f3",0,"templarian","food","","",1554),
				"food-variant":new icon("1D25DDEC-2656-4729-BEBD-BB17F972DD09","f25c",0,"templarian","food"),
				"football":new icon("3C0488C6-E807-401D-9689-7770550EC2E7","f25d",0,"templarian","sport","","american,ball"),
				"football-australian":new icon("97B1FB51-7C30-4B83-AEED-95700B38F65F","f25e",0,"templarian","sport","","aussie,ball,rules"),
				"football-helmet":new icon("8F719D4B-9A91-46E1-81B0-00C23AA0D313","f25f",0,"templarian","sport","","american"),
				"forklift":new icon("9CB941AF-8C23-4201-B891-A23521B011CD","f7c8",0,"greenturtwig",_,_,_,2046),
				"format-align-bottom":new icon("CF22AACF-228D-4C3A-9BE7-D5DE853A0139","f752",1,"templarian","editor","","",1932),
				"format-align-center":new icon("9B295DCA-8352-407E-84F1-34890975D010","f260",1,"google","editor"),
				"format-align-justify":new icon("521B67DD-EC96-4B1D-B884-BE155D850F85","f261",1,"google","editor"),
				"format-align-left":new icon("56F0424F-3D53-486E-BC4C-0738457ACBA8","f262",1,"google","editor"),
				"format-align-middle":new icon("59384E78-B7EF-4BDA-B537-35E537C00130","f753",1,"templarian","editor","","",1932),
				"format-align-right":new icon("7289388F-3768-4833-B282-0662FD9B9A73","f263",1,"google","editor"),
				"format-align-top":new icon("71140AD8-A0A6-45DD-9414-5DB2FBC875F1","f754",1,"templarian","editor","","",1932),
				"format-annotation-plus":new icon("591A45AB-511C-4791-957C-303186C666AA","f646",0,"kaifaust","editor","","",1650),
				"format-bold":new icon("2107C153-0FEC-4171-8602-6549ACABA768","f264",1,"google","editor"),
				"format-clear":new icon("D5213C5D-AC53-40A5-BBCC-C8B3F849D6B4","f265",1,"google","editor"),
				"format-color-fill":new icon("C4E2DE69-EC92-490F-814A-5D8A20E7E595","f266",0,"google","editor"),
				"format-color-text":new icon("D28EF658-3CE7-4F5B-99B3-50F60F5B0BA0","f69d",0,"google","editor","","",1712),
				"format-float-center":new icon("3BC78F10-A7C3-4F15-9328-138E35CFC259","f267",1,"splitbrain","editor"),
				"format-float-left":new icon("E595D32A-5108-4E9A-BF98-52DEFC1A50EE","f268",1,"splitbrain","editor"),
				"format-float-none":new icon("22DE1517-7E6C-43B9-B0E1-F3EDAEFE6398","f269",1,"splitbrain","editor"),
				"format-float-right":new icon("8F5AF64B-3A3D-449C-9FCC-374EAF6D523C","f26a",1,"splitbrain","editor"),
				"format-font":new icon("C7D57EF8-207C-48F9-953A-EAFB03308A1E","f6d5",0,"japanyoshilol","editor","","",1836),
				"format-header-1":new icon("F64E046B-8690-4ACF-90F7-98896159BB34","f26b",0,"templarian","editor"),
				"format-header-2":new icon("00E2A358-A6A9-493C-BFC2-A259AA0092CF","f26c",0,"templarian","editor"),
				"format-header-3":new icon("EE76BE9D-B10D-43C8-9B5A-746BE228C344","f26d",0,"templarian","editor"),
				"format-header-4":new icon("CC669D6C-53AD-43C2-A660-EFF783847D6F","f26e",0,"templarian","editor"),
				"format-header-5":new icon("FFC1FF08-CEFF-4623-B715-4731CDEF27D4","f26f",0,"templarian","editor"),
				"format-header-6":new icon("854D0158-05E0-47A7-8E6E-2F66DCD415EE","f270",0,"templarian","editor"),
				"format-header-decrease":new icon("CF17BB12-9537-4F2E-9E88-3E1DE3D0DCE6","f271",0,"splitbrain","editor"),
				"format-header-equal":new icon("99554AA1-419F-420F-9AEB-0826D411B420","f272",0,"splitbrain","editor"),
				"format-header-increase":new icon("20BCC8DA-F055-46B0-9C27-68791E3BA80E","f273",0,"splitbrain","editor"),
				"format-header-pound":new icon("C632F7EE-B560-4FAA-802E-968DAB3EA979","f274",0,"templarian","editor"),
				"format-horizontal-align-center":new icon("83EE24A9-9D1A-45AA-B4CD-F75F1174F0EB","f61e",0,"templarian","editor","","",1650),
				"format-horizontal-align-left":new icon("AEA5545F-4C74-4A14-8F9E-92CC258216AD","f61f",0,"templarian","editor","","",1650),
				"format-horizontal-align-right":new icon("7EFCB642-F9B5-41C8-B2CF-2566C6AC45C2","f620",0,"templarian","editor","","",1650),
				"format-indent-decrease":new icon("148FD97C-E3C6-4E41-87B8-488036159CC6","f275",1,"google","editor"),
				"format-indent-increase":new icon("18B9F49B-7A69-4E93-AEA6-8CB30F22E100","f276",1,"google","editor"),
				"format-italic":new icon("F766C5E3-1BBB-4ADE-9D33-170A223DB6F9","f277",1,"google","editor"),
				"format-line-spacing":new icon("24F69EED-721D-48A1-BA3C-3C1657B65C04","f278",1,"google","editor"),
				"format-line-style":new icon("2E9CEB4F-7C1F-4572-9A8E-830A3258407A","f5c8",0,"google","editor","","",1554),
				"format-line-weight":new icon("1BA8A6A0-348E-4268-B02B-6708E1E30373","f5c9",0,"google","editor","","",1554),
				"format-list-bulleted":new icon("2FBAE8A7-BAC7-44C8-85DC-EB458871BF29","f279",1,"google","editor","","",0,1554),
				"format-list-bulleted-type":new icon("535ABAF7-65D8-4CAB-A3B0-D5B732B6C36F","f27a",0,"templarian","editor"),
				"format-list-checks":new icon("2B19EECF-71BF-41F3-B62A-468607BA0B47","f755",1,"templarian","editor","","checklist",1932),
				"format-list-numbers":new icon("EFEB4AB3-780B-4C2D-B673-36BB0A4FE0B2","f27b",1,"google","editor"),
				"format-page-break":new icon("4C2390EF-6AE7-4868-945B-AACD2E581F46","f6d6",0,"google","editor","","",1836),
				"format-paint":new icon("70232BC6-D883-48CD-B992-9EE1DABEBFD7","f27c",0,"google","editor"),
				"format-paragraph":new icon("252574CE-020B-461A-995B-D4BA81741BBC","f27d",0,"templarian","editor"),
				"format-pilcrow":new icon("9AF465C3-5FEF-48E4-8D38-5A5A3D2A9799","f6d7",0,"mrgrigri","editor","","",1836),
				"format-quote-close":new icon("0450C081-EE6B-4CB1-A7F7-B6F0F524CA99","f27e",0,"google","characters,editor","","",0,1932),
				"format-quote-open":new icon("CF5D126B-7DC1-4BE7-B5A1-E31B715EDBAA","f756",1,"templarian","characters,editor","","",1932),
				"format-rotate-90":new icon("99448D5B-50D3-4F49-8E88-DD75F7DFB231","f6a9",0,"google","editor","","ninety",1712,1836),
				"format-section":new icon("6F0198AB-0903-4B36-AC27-B72EBC7A8A83","f69e",0,"mrgrigri","editor","","",1712),
				"format-size":new icon("3F6E54F6-CF3E-46C8-BD72-A9BCF6DCF80C","f27f",0,"google","editor"),
				"format-strikethrough":new icon("0BE83BB5-3D22-478D-AAC2-F586A4E5FA69","f280",0,"google","editor"),
				"format-strikethrough-variant":new icon("CB728339-FA66-440F-9E88-8A6FFE827EA1","f281",0,"google","editor"),
				"format-subscript":new icon("4765CE92-9095-4C00-9137-1C35761C7B59","f282",0,"templarian","editor"),
				"format-superscript":new icon("41BF2594-97C2-481A-AA66-029CE1BF4C2D","f283",0,"templarian","editor,other","exponent"),
				"format-text":new icon("FE7F03F1-79D3-4113-A35E-088C3F2AB8AD","f284",0,"templarian","editor"),
				"format-textdirection-l-to-r":new icon("D6B79C3B-22FB-4B52-90B8-6979AB48C3E8","f285",0,"google","editor"),
				"format-textdirection-r-to-l":new icon("C317FCCF-DCDB-4429-B1A7-850FED29F5B3","f286",0,"google","editor"),
				"format-title":new icon("4B4B86CC-C989-4629-9B9D-C31243A29DB9","f5f4",0,"google","editor","","",1554),
				"format-underline":new icon("DD218F3D-C302-477A-9B9F-482813328DE6","f287",1,"google","editor"),
				"format-vertical-align-bottom":new icon("723F4461-61B3-4D53-A03D-302F5D9401E1","f621",0,"google","editor","","",1650),
				"format-vertical-align-center":new icon("4C8985BA-B48F-4015-9389-35672ECDE544","f622",0,"google","editor","","",1650),
				"format-vertical-align-top":new icon("06A3A04F-F7F7-4707-86FC-5DEBA497B79E","f623",0,"google","editor","","",1650),
				"format-wrap-inline":new icon("556AFB1F-1857-4CB9-94B8-2E7E8A8DD292","f288",1,"splitbrain","editor"),
				"format-wrap-square":new icon("D5787449-1950-4A7C-8CD9-CABC628AFBCE","f289",1,"splitbrain","editor"),
				"format-wrap-tight":new icon("4AA96763-2A6C-4BF0-BA64-32AD08B530F6","f28a",1,"splitbrain","editor"),
				"format-wrap-top-bottom":new icon("0378C7CD-8331-42A0-9C0F-114960FD5966","f28b",1,"splitbrain","editor"),
				"forum":new icon("3AC84477-2308-4445-868C-9666AE25B054","f28c",0,_,_,"message-group"),
				"forward":new icon("EAE07425-A6D5-4B33-A9C5-6D7E9E9E1908","f28d",0,"google","arrows,other"),
				"foursquare":new icon("84EB4644-EC38-431B-B55B-12363EB63765","f28e",0,"templarian","logos"),
				"fridge":new icon("214668FF-C50D-4D69-B916-AE66E73CB3B0","f28f",0,"templarian","food"),
				"fridge-filled":new icon("148520BB-2172-4261-9336-3E85E5131869","f290",0,"xt3000","food"),
				"fridge-filled-bottom":new icon("3D6FCDAF-F7F8-42C2-87C6-6DF36EB8C935","f291",0,"xt3000","food"),
				"fridge-filled-top":new icon("F88B80D0-1521-48F8-BC15-94BA5F14BFC1","f292",0,"xt3000","food"),
				"fuel":new icon("8E016660-0C3A-46EA-B3A5-8DC490238EC7","f7c9",0,"japanyoshilol","places,travel",_,"petrol,can",2046),
				"fullscreen":new icon("A4F7E2E4-704C-4A71-99D5-4BD19AD8E755","f293",1,"google","player,other"),
				"fullscreen-exit":new icon("CE6DC9C1-A636-4B3E-B838-34069330D3B2","f294",1,"google","player,other"),
				"function":new icon("76B75225-53BF-4523-BD48-CB555FFF0C67","f295",0,"templarian","characters"),
				"gamepad":new icon("5C29EFA9-0FF3-4101-BC87-C9C15ACBA7AB","f296",0),
				"gamepad-variant":new icon("A4DB98F5-FFD6-4F36-BB90-1B06AB202096","f297",0,"templarian"),
				"garage":new icon("FC744BA5-2E98-459F-BBD6-60788B23D93E","f6d8",0,"alexefremo","places,other","","",1836),
				"garage-open":new icon("6B34986A-5D17-4C64-9840-994B66EC00AB","f6d9",0,"alexefremo","places,other","","",1836),
				"gas-cylinder":new icon("7CEC48C5-3A70-4BA2-9FB8-A383387DC4A1","f647",0,"xt3000","other","","",1650),
				"gas-station":new icon("50E30598-BCD8-4167-BDAC-FF6971E745D7","f298",0,"google","travel","","petrol,pump"),
				"gate":new icon("340B7941-DB9B-40A2-9968-100AB599F204","f299",0,"xt3000","other","","",0,1650),
				"gauge":new icon("EC7B7499-25F1-43D4-9A09-9742F5B6D3F2","f29a",0,"google","science"),
				"gavel":new icon("AB600896-534E-4A82-8E7F-99E0F22B54AE","f29b",0,"templarian","places,other"),
				"gender-female":new icon("0441EBEF-476C-420E-A04E-58367F99BD93","f29c",0,"templarian","science","","woman,women"),
				"gender-male":new icon("78C91AE2-F79B-48EF-9CCD-5E6874BA20CA","f29d",0,"templarian","science","","man,men"),
				"gender-male-female":new icon("9B06F269-893F-4F1C-910D-D26578C6D976","f29e",0,"templarian","science"),
				"gender-transgender":new icon("47F759DA-8ECB-4BAA-8102-A843844EEBB3","f29f",0,"templarian","science"),
				"gesture":new icon("FFC2833D-65AB-47BB-AC7C-8CFA41DF9250","f7ca",0,"google","other","","",2046),
				"gesture-double-tap":new icon("D02C7FA0-E8E6-48B7-BEB7-4678B8D9DCA1","f73b",0,"mrgrigri","other","","",1932),
				"gesture-swipe-down":new icon("92FD3A8C-813E-4AC1-8D0B-85B89747C598","f73c",0,"mrgrigri","other","","",1932),
				"gesture-swipe-left":new icon("D0887CD1-2BF1-4A5A-B573-2BA6FF8A6129","f73d",0,"mrgrigri","other","","",1932),
				"gesture-swipe-right":new icon("9B3D3150-CF71-473E-AF65-403C389C308A","f73e",0,"mrgrigri","other","","",1932),
				"gesture-swipe-up":new icon("CE26D04A-C6AC-4379-AA25-A702F49F1DC2","f73f",0,"mrgrigri","other","","",1932),
				"gesture-tap":new icon("D881AFBC-7477-46C2-9269-324676F19E51","f740",0,"mrgrigri","other","","",1932),
				"gesture-two-double-tap":new icon("96C02705-84D1-4677-9DDE-CCDE1D43FE11","f741",0,"mrgrigri","other","","",1932),
				"gesture-two-tap":new icon("AA47E759-39DE-4A5C-B3CF-FAEB215EAB91","f742",0,"mrgrigri","other","","",1932),
				"ghost":new icon("6B39D7DA-255C-4615-84D4-FFCF34D76A4A","f2a0",0,"xt3000"),
				"golf":new icon("80A4F47A-3512-4C76-AA10-C0232C57E624",_,0,_,"sport",_,_,"2.x.x"),
				"gift":new icon("22D0C782-CD05-4FEB-845F-BBA7126C7326","f2a1",1,"templarian","other","donate","present"),
				"git":new icon("4CB8AF2D-5373-4247-AB9D-3B28B72EB7BC","f2a2",0,"xt3000","logos"),
				"github-box":new icon("951C68F1-876F-440E-A4D9-B724BB6D6181","f2a3",0,"templarian","logos","","",0,1932),
				"github-circle":new icon("5C6175DD-8549-4004-AB77-A545D721A0DE","f2a4",0,"templarian","logos"),
				"github-face":new icon("97C9CAC2-9F94-40EA-9A08-1A9BDD208743","f6da",0,"templarian","logos","","",1836),
				"glass-flute":new icon("CD1215BB-D889-4A86-8944-AF724C71DF21","f2a5",0,"templarian","food"),
				"glass-mug":new icon("9081982B-5EB6-47C1-A1F3-A83A0ED1B609","f2a6",0,"templarian","food"),
				"glass-stange":new icon("E26942A0-61AE-4D1A-941C-895D92E94C5D","f2a7",0,"templarian","food"),
				"glass-tulip":new icon("43E8B624-633D-472F-991E-4AEDB20A5454","f2a8",0,"templarian","food"),
				"glassdoor":new icon("D0021FC3-865F-45B4-8542-4937DC2952E2","f2a9",0,"infanf","logos",_,_,1554,"2.x.x"),
				"glasses":new icon("BE4C1227-C47E-4839-85AA-4EA6928BAAAE","f2aa",0,"xt3000"),
				"gmail":new icon("259F5EC9-395F-40C8-9389-6B6A82D9997C","f2ab",0,"google","google"),
				"gnome":new icon("2C4AF25A-8EC5-4B3B-BBCD-60F801F553B8","f2ac",0,"infanf","logos","","",1554),
				"gondola":new icon("9FE486F5-20A0-4CB5-A820-93AD82F52EB6","f685",0,"templarian","places,travel","","cable,car",1712),
				"google":new icon("F787FBCA-3C54-43CC-AE16-E23436AD0720","f2ad",0,"google","google"),
				"google-analytics":new icon("B328003D-F2FD-4C31-8171-BD6EB5A81A8A","f7cb",0,"diaryofabastard","google",_,_,2046),
				"google-assistant":new icon("3DD7794E-8603-49D0-B34E-DD0939225AAF","f7cc",0,_,"google",_,_,2046),
				"google-cardboard":new icon("8CC1E909-6274-4738-AF1D-0E2C3239E853","f2ae",0,"google","google"),
				"google-chrome":new icon("0B7D7D86-21E1-4759-8E4D-5D2BB291BB3F","f2af",0,"google","google","","browser"),
				"google-circles":new icon("FAF03601-DED3-4AD2-B252-DF739AC96986","f2b0",0,"google","google"),
				"google-circles-communities":new icon("073A8D2A-C834-4655-AA4F-792D7ADD7E6E","f2b1",0,"google","google"),
				"google-circles-extended":new icon("9ABBC701-54DE-48B3-A579-6FB3503F8929","f2b2",0,"google","google"),
				"google-circles-group":new icon("00CC15EA-653E-4F50-B681-3176664F9B3C","f2b3",0,"templarian","google"),
				"google-controller":new icon("605CAD46-2EA0-47AE-8A41-953C1F27F9CD","f2b4",0,"templarian","google","","games"),
				"google-controller-off":new icon("8C28F332-2037-476E-8FAA-D5E6BC81D8B2","f2b5",0,"templarian","google","","games"),
				"google-drive":new icon("EE98C0AD-0A55-4A6B-BB7A-01CBD3D819A2","f2b6",0,"google","google"),
				"google-earth":new icon("8A61F8F2-511B-45E9-9459-27BBD58936F8","f2b7",0,"google","google"),
				"google-glass":new icon("6A73A89B-2C02-4DB5-89DF-0449750171BC","f2b8",0,"google","google"),
				"google-keep":new icon("73BACA3B-710C-4F23-9730-D88ADA3EA914","f6db",0,"google","google","","",1836),
				"google-maps":new icon("21FBF51C-0081-4987-8129-CFB0BB81729F","f5f5",0,"google","google","","",0,1554),
				"google-nearby":new icon("576EFEB3-D7E0-463F-A783-19A0F97D45EE","f2b9",0,_,"google",_,_,0,2046),
				"google-pages":new icon("DEC0A182-36E6-47D2-ABC4-AF717946C412","f2ba",0,"google","google"),
				"google-photos":new icon("A4C7D4DF-2B1F-424B-9502-6618F88C9A65","f6dc",0,"google","google","","",1836),
				"google-physical-web":new icon("390FC04F-F2A9-44F5-9808-6370A647BAF0","f2bb",0,"google","google"),
				"google-play":new icon("5FE693A7-2A33-46A5-B502-D42588072E56","f2bc",0,"templarian","google"),
				"google-plus":new icon("0D3A668A-E3B7-4512-B22D-10B13362DC2B","f2bd",0,"google","google","","google+"),
				"google-plus-box":new icon("2D12922D-3C06-4916-9575-CA9A1014C4BF","f2be",0,_,"google",_,"google+",0,2046),
				"google-translate":new icon("DFF485C3-0A13-4546-A267-7687AF1AB82F","f2bf",0,"google","google"),
				"google-wallet":new icon("432C2FB2-AA01-40F8-AAB1-CB964967D3BD","f2c0",0,"google","google","","",0,2046),
				"gradient":new icon("F10A05F8-FD09-4BDA-B906-747E9A89AB6E","f69f",0,"google","other","","",1712),
				"grease-pencil":new icon("137F01F1-86AC-4923-A9D7-C72057367BB7","f648",0,"google","other","","",1650),
				"grid":new icon("8D4C203D-A1F0-42DA-997A-AB7BAC63D97B","f2c1",1,"google","editor"),
				"grid-large":new icon("4A3863FA-620C-4564-8A7B-57681117B81D","f757",1,"templarian","editor","","",1932),
				"grid-off":new icon("4A8DDCEF-7E60-4864-9CC3-64C9A5B0D6D4","f2c2",1,"google","editor"),
				"group":new icon("D1B31666-9F9A-4CAB-843B-4BFEDBCC5347","f2c3",1,"xt3000","editor"),
				"guitar-acoustic":new icon("C4015804-7FF3-4483-94CA-CEB79F7B34BC","f770",0,"japanyoshilol","other","","",1932),
				"guitar-electric":new icon("C2F16EBD-E72B-45E0-9A34-0BAF7ADB87B3","f2c4",0,"templarian","other","","",0,1932),
				"guitar-pick":new icon("68377A86-6428-4553-B768-7E9FC306E962","f2c5",0,"lastrosestudios"),
				"guitar-pick-outline":new icon("0FA22632-A0B2-49E0-A779-56022111C9D8","f2c6",0,"lastrosestudios"),
				"guy-fawkes-mask":new icon("FDDC802D-37F5-4E15-96DA-8A6D553B1D67",_,0,"_selectlol",_,_,_,"2.x.x"),
				"hackernews":new icon("A19711E4-E339-4016-970B-F81D14B303AC","f624",0,"templarian","logos","","",1650),
				"hamburger":new icon("F5BC2290-D719-4974-9920-DF8E08E5F955","f684",1,"japanyoshilol","food","","burger",1712),
				"hand-pointing-right":new icon("C18F21E1-2363-42DD-8FFF-3381AC368C23","f2c7",0,"templarian"),
				"hanger":new icon("2FB0994B-BBA8-4F59-93AF-87F2065F34EA","f2c8",0,"templarian"),
				"hangouts":new icon("3EA0D516-133D-4A5E-865B-82B7CC2763D5","f2c9",0,"google","google"),
				"harddisk":new icon("6CBB2398-E7ED-4A08-8489-1FFF87D0605C","f2ca",0,"templarian","tech","","disc,disk,drive"),
				"headphones":new icon("51F72F83-1559-4037-8BF9-2D8AE3BCB1A8","f2cb",0,"google","tech"),
				"headphones-box":new icon("5B608320-1BEB-499C-9CAB-0897D3A2D2B6","f2cc",0,"google","tech"),
				"headphones-off":new icon("678F779A-DE83-4DC0-A49D-657CBAF631F0","f7cd",0,"greenturtwig","tech",_,_,2046),
				"headphones-settings":new icon("54A22337-9D03-4F52-8D3E-B2A0A32147B7","f2cd",0,"templarian","tech"),
				"headset":new icon("AFF98802-E02B-4EC8-8AFF-F0F5373D86C5","f2ce",0,"google","tech"),
				"headset-dock":new icon("36F33522-9167-42DD-BA0A-8920F480F38C","f2cf",0,"chrislitherland","tech"),
				"headset-off":new icon("E2A86F6D-6E4D-4C61-B54A-85BEDACA052F","f2d0",0,"templarian","networking"),
				"heart":new icon("32B56DB2-B6BF-4B54-AD0C-9444106B1C1D","f2d1",1,"google","science,other","","favourite,like,love"),
				"heart-box":new icon("558E28AE-47E7-4C95-9846-7653C79CBA33","f2d2",0,"templarian","other","","favourite,like,love"),
				"heart-box-outline":new icon("24811FE6-6C95-4CAB-B708-71862BA40C05","f2d3",0,"templarian","other","","favourite,like,love"),
				"heart-broken":new icon("64D15AD4-07A4-4D43-8730-6C9860C89B44","f2d4",0,"templarian"),
				"heart-half":new icon("1B01BAE0-095E-424E-9552-6ECEF5E4FC62","f6de",1,"templarian","other","","favourite,like,love",1836,1932),
				"heart-half-full":new icon("0FC24699-3C95-4319-A60B-286B0D328D7A","f6dd",0,"templarian","science,other","","favourite,like,love",1836,1932),
				"heart-half-outline":new icon("F4384972-741C-4BB6-91BF-9509E75C8AF8","f6df",0,"casesandberg","other","","favourite,like,love",1836,1932),
				"heart-off":new icon("012A92C0-E5DE-4FB4-9AB1-9BD5F53861E0","f758",1,"templarian","science,other","","favourite,like,love",1932),
				"heart-outline":new icon("9BCD22D2-7304-4BB3-9C41-3431ED13542A","f2d5",0,"google","science,other","","favourite,like,love"),
				"heart-pulse":new icon("389486F3-5A73-4C65-8EA6-43D432F6490E","f5f6",0,"google","science,other","","health,heartbeat",1554),
				"help":new icon("62675A10-D453-40EB-8AED-A789A39EEF11","f2d6",1,"templarian","characters,other","question-mark","faq",0,1554),
				"help-box":new icon("6EFBBE96-37EA-4372-98CC-9B0D84B92C34","f78a",0,"templarian","characters,other","","",1932),
				"help-circle":new icon("49B41103-DD15-4FF4-A18A-44D8586704B6","f2d7",1,"google","characters,other","question-mark-circle","faq"),
				"help-circle-outline":new icon("60E15D8D-3956-4461-91D8-E8059D02ECE6","f625",0,"google","characters,other","","faq,question",1650),
				"help-network":new icon("FE0A3DAC-0D3D-4D49-A869-F78B44B26E35","f6f4",0,"templarian","networking","","",1836,1932),
				"hexagon":new icon("229D267D-F77F-4F33-ADD4-325647EC2662","f2d8",1,"templarian"),
				"hexagon-multiple":new icon("60636193-AC27-470B-BCA5-94CEA29719A8","f6e0",0,"templarian","other","","",1836),
				"hexagon-outline":new icon("0A85BE3F-ACF1-4D93-A66B-34C7F29D10A3","f2d9",0,"templarian"),
				"high-definition":new icon("8FC812E7-2B7B-412B-9114-1899203DECC4","f7ce",0,"templarian",_,_,"hd",2046),
				"highway":new icon("81E5D79D-2ECD-4040-9B07-3A0C19792348","f5f7",0,"infanf","travel","autobahn","motorway,road",1554),
				"history":new icon("55AF2D53-7FAD-4A1D-8440-10301C95D3B8","f2da",0,_,_,"recent,latest"),
				"hololens":new icon("826E9B16-2A0D-4E8C-9C3A-BBBE3319AE4D","f2db",0,"templarian","tech"),
				"home":new icon("5D085274-15B9-42EC-8CCE-2F94C5EC039C","f2dc",1,"google","places,other","house"),
				"home-assistant":new icon("80923357-29F3-429E-A186-F3561451398C","f7cf",0,"","logos,other,tech",_,_,2046),
				"home-automation":new icon("FD2567BF-09EC-4871-B3E8-DAE9CDCF3A38","f7d0",0,"greenturtwig","other",_,_,2046),
				"home-circle":new icon("59CB69E0-6F23-4572-90C7-9B360121C266","f7d1",0,"","places,other",_,"house",2046),
				"home-heart":new icon("513D2CF1-31F5-4F3B-8543-2499ABB20924",_,0,"mrgrigri","google,other","family",_,"2.x.x"),
				"home-map-marker":new icon("D543BDC6-BC40-4A36-B2F0-60313D8F4EEB","f5f8",0,"xt3000","places,travel","","house",1554),
				"home-modern":new icon("6949FE9A-5B8C-4EDF-B74E-E0268A4F69F1","f2dd",0,"templarian","places","house-modern"),
				"home-outline":new icon("B4E2287E-8872-48AD-B765-83D82AF66CA3","f6a0",0,"templarian","places,other","","house",1712),
				"home-variant":new icon("7AFA8EEF-6A41-4A7D-97D2-F9F03DB24DB0","f2de",0,"templarian","places","house-variant"),
				"hook":new icon("8A2A8364-B33C-4931-BF78-EB171C569D5F","f6e1",0,"mrgrigri","other","","fishing",1836),
				"hook-off":new icon("984487C2-EBB2-474C-8914-046E6BDC6EC6","f6e2",0,"mrgrigri","other","","fishing",1836),
				"hops":new icon("E82A026A-DD54-4C5F-8961-A7C97754CF04","f2df",0,"templarian","food,nature"),
				"hospital":new icon("83D0E9E7-B196-4515-A9C8-6E6FEB03ADD1","f2e0",0,"google","places,science"),
				"hospital-building":new icon("D4FAA416-4429-451F-B4EE-647CCABDF3EB","f2e1",0,"templarian","places,science"),
				"hospital-marker":new icon("FA30BC13-BE77-44F6-BEB1-942749E019A7","f2e2",0,"templarian","places,science"),
				"hot-tub":new icon("832FBA55-F65E-4706-93B1-9018D651CAA3",_,0,_,_,_,_,"2.x.x"),
				"hotel":new icon("EA62EF73-ACC7-4E54-87EF-D5E1683BE58F","f2e3",0,"google","places,travel,other","bed"),
				"houzz":new icon("3C547C40-FF5E-4BB6-B45E-2B26AD990B20","f2e4",0,"lastrosestudios","logos"),
				"houzz-box":new icon("267AF23F-D48A-493E-91BD-E78CD3EFCCBA","f2e5",0,"lastrosestudios","logos"),
				"hulu":new icon("788D7C34-3E50-468B-A205-D953D844F1B7",_,0,"","logos",_,_,"2.x.x"),
				"human":new icon("B05E458D-886A-491D-9969-156562C52105","f2e6",0),
				"human-child":new icon("ABBC3761-B437-4800-9C57-BCBE5AC8FA31","f2e7",0,"templarian"),
				"human-female":new icon("059421A9-4F27-493A-8835-4B49B5286366","f649",0,"google","other","","bathroom,ladies,toilets,wc,woman",1650),
				"human-greeting":new icon("1C9856E1-6945-464E-85E7-A46C4A974C9D","f64a",0,"google","other","","",1650),
				"human-handsdown":new icon("10E7CAB4-7B15-4F73-82B1-E42562B9103C","f64b",0,"google","other","","",1650),
				"human-handsup":new icon("FA427178-750A-425C-81F2-B46DDC061771","f64c",0,"google","other","","",1650),
				"human-male":new icon("1369FF9C-0E57-4644-BE89-7B5EED0131B0","f64d",0,"google","other","","bathroom,gents,man,toilets,wc",1650),
				"human-male-female":new icon("0FC16450-7A7E-43C5-AED4-E27C4A6BFF99","f2e8",0,"google","other","wc","bathroom,man,toilets,woman"),
				"human-pregnant":new icon("05DB88BC-FA28-4DF1-8308-541E338E0234","f5cf",0,"google","science,other","","woman",1554),
				"humble-bundle":new icon("9A2A1178-7E30-49E7-A639-2D16464EA7EA","f743",0,"templarian","logos","","",1932),
				"ice-cream":new icon("C8D5186F-BF39-40DA-9F7A-747DB166EABD",_,0,"xt3000","food,places",_,_,"2.x.x"),
				"image":new icon("3238BA72-FEE8-4C90-A440-AD701359A7BC","f2e9",1,"google","editor,other"),
				"image-album":new icon("DD2262AA-A145-4788-899D-46D807B4FC0D","f2ea",0),
				"image-area":new icon("D23B9039-C6D4-45F8-B625-EEDE883FF5BD","f2eb",0,"templarian"),
				"image-area-close":new icon("3BE3AA75-C604-45F3-9DD3-5E8731201F08","f2ec",0,"templarian"),
				"image-broken":new icon("40DCC37F-8A3F-4C15-97E8-2AB88B4DC756","f2ed",0,"templarian"),
				"image-broken-variant":new icon("D243B11E-D824-4185-B14F-B1C53DB11C24","f2ee",0),
				"image-filter":new icon("BCCF75AE-F73D-4B7A-BDFD-9E767DED0B28","f2ef",0,"google","other,places","","mountains"),
				"image-filter-black-white":new icon("7D3932BA-9061-40D7-B624-044EE7A7B445","f2f0",0),
				"image-filter-center-focus":new icon("E3745997-1AD2-4D79-83FE-72ADE96E3C69","f2f1",0),
				"image-filter-center-focus-weak":new icon("50F3F396-4286-4D09-B726-4F626649BC04","f2f2",0),
				"image-filter-drama":new icon("882F82B8-EDF8-4F1A-A6BA-9C6DAEDBB259","f2f3",0,"google","weather,other","","cloud"),
				"image-filter-frames":new icon("8EC8847F-E96F-4D14-BF88-F4BE47856865","f2f4",0),
				"image-filter-hdr":new icon("999CF81E-71B7-48E1-8B8F-70FDE391F647","f2f5",0,"google","other","mountain"),
				"image-filter-none":new icon("56164312-7555-4017-8A1A-48954BE7F7C5","f2f6",0),
				"image-filter-tilt-shift":new icon("368537EA-9261-4097-A1FA-D33EE48A7D59","f2f7",0),
				"image-filter-vintage":new icon("0E6F8B1C-14D2-4A98-9414-FFC4B2146748","f2f8",0),
				"image-multiple":new icon("E7CA4672-9863-4015-B3C5-D2C8DEBD2F2F","f2f9",0),
				"import":new icon("FB8BEE36-EF77-4820-92B3-5B4C4291D751","f2fa",0,"templarian"),
				"inbox":new icon("4DDB79C2-C3AE-41DC-B560-AFBF3F689E86","f686",1,"google","other","","e-mail,mail,notification",1712),
				"inbox-arrow-down":new icon("A20D1ABC-DD99-404B-8BEE-967BB1C636B0","f2fb",0,"google","other","","e-mail,mail,notification"),
				"inbox-arrow-up":new icon("5317ED5A-9D37-4C50-AA7D-83491547D214","f3d1",0,"templarian","other","","e-mail,mail,notification"),
				"incognito":new icon("1350E7BA-9354-4F62-9B21-0238E3DF4D81","f5f9",0,"infanf","other","","",1554),
				"infinity":new icon("8C4EBD04-376D-41AC-86D3-2BBDD56768C7","f6e3",0,"templarian","characters","","",1836),
				"information":new icon("2BC4A4B6-119B-4637-BF3D-1FB9394E1F38","f2fc"),
				"information-outline":new icon("F7C01A96-16E0-44C0-A261-2CF22D056A7F","f2fd",0),
				"information-variant":new icon("D991D5FA-BD60-48E1-979D-A103D005725A","f64e",0,"xt3000","other","","",1650),
				"instagram":new icon("2AA07220-461B-4070-AA95-17DEFE501444","f2fe",0,"google","logos","","",0,1650),
				"instapaper":new icon("EB68865A-2308-4667-9B2F-C550923180A9","f2ff",0,"templarian","logos"),
				"internet-explorer":new icon("255BB365-7B2F-46C7-B85E-EFDAD527BB54","f300",0,"templarian","logos","","browser"),
				"invert-colors":new icon("2B0100AC-D0EB-4B85-A9AB-EB921C9A65AC","f301",0),
				"itunes":new icon("857C302E-0AC9-438D-A8E5-DE3DC9680FAB","f676",0,"templarian","logos","","",1712),
				"jeepney":new icon("2C0278A5-D43D-4B8B-8870-878BEAF6BE17","f302",0,"templarian","travel"),
				"jira":new icon("2F0CB359-6C54-4723-9E8D-94481F0A8E30","f303",0,"templarian","logos"),
				"jsfiddle":new icon("B6B10BEF-B1E3-43D7-AAAA-85566157B30B","f304",0,"templarian","logos"),
				"json":new icon("24C1AA84-85C2-41F4-A5E3-8FE7421CD359","f626",0,"templarian","other","","",1650),
				"karate":new icon("85144563-B019-4B8A-AB76-3DE0797D517E",_,0,"mrgrigri","sport",_,_,"2.x.x"),
				"keg":new icon("EEF9C07A-019A-49B4-805D-0DF8601F09DF","f305",0,"templarian","food"),
				"kettle":new icon("C4476901-9B29-410C-BCA7-67814F5421B4","f5fa",0,"xt3000","food","","",1554),
				"key":new icon("D6208581-CF7F-438A-8578-B6ADEE462212","f306",0),
				"key-change":new icon("FEEA71CA-4810-46DD-B459-6D9327720D17","f307",0,"templarian"),
				"key-minus":new icon("F58302B9-82F4-46AC-9A60-4640CFCE33B2","f308",0,"templarian"),
				"key-plus":new icon("000AAEC6-5E6C-40F4-B589-AE85920E7EC2","f309",0,"templarian"),
				"key-remove":new icon("5A1609F7-424E-417F-B1C4-7EDA3051A4BA","f30a",0,"templarian"),
				"key-variant":new icon("967692C3-B061-425E-A0E4-FF1F580275E5","f30b",0,"templarian"),
				"keyboard":new icon("520C8488-DD34-43E1-AEA0-A188B2DE6B01","f30c",0,"google","tech"),
				"keyboard-backspace":new icon("21C8B558-8398-43E8-A79A-8BA99BE693D6","f30d",0,"google","arrows,other"),
				"keyboard-caps":new icon("0F441009-7A1F-45BF-A239-B9591B0A5404","f30e",0,"google","arrows,other"),
				"keyboard-close":new icon("8545C0A1-5625-422F-AF38-624FB54237D3","f30f",0),
				"keyboard-off":new icon("A7DFF78C-C6DD-4BB6-BBFA-A88242516A74","f310",0,"templarian"),
				"keyboard-return":new icon("7816CE91-EBD1-4136-8523-CF47F677F4C6","f311",0,"google","arrows,other"),
				"keyboard-tab":new icon("D7C0D37A-BF75-4542-8AFF-614FA0EC498C","f312",0,"google","arrows,other"),
				"keyboard-variant":new icon("BCAA42FF-BF36-42D8-B8FD-5DE2968162D8","f313",0,"templarian","tech"),
				"kickstarter":new icon("D881D589-79F0-4255-B050-13E396293D1F","f744",0,"templarian","logos","","",1932),
				"kodi":new icon("AD953D07-5F33-439B-895F-7AD5615EA14A","f314",0,"infanf","logos","","",1554),
				"label":new icon("C749E06B-E75E-4D9B-97A6-47E9399D01FC","f315"),
				"label-outline":new icon("91C2FA0C-2273-42F9-ACBF-BD418B8F970D","f316",0),
				"lambda":new icon("1815038E-B466-4F5F-91D9-9D03DDA6A9DA","f627",0,"templarian","characters","","",1650),
				"lamp":new icon("A39CC0FD-32DA-4AB2-8483-9E4C4F03D220","f6b4",0,"greenturtwig","other","","light",1722),
				"lan":new icon("A20B1B0B-DC60-4ED1-A7E6-F390BA31D613","f317",0,"xt3000","networking"),
				"lan-connect":new icon("B52D6944-3AC2-4113-A91C-199C0CD577A6","f318",0,"xt3000","networking"),
				"lan-disconnect":new icon("10DCD7DC-998B-4631-B8A6-A0D8C93412A3","f319",0,"xt3000","networking"),
				"lan-pending":new icon("B5E302E3-DF81-430E-AAE0-4CAF44AFAD00","f31a",0,"xt3000","networking"),
				"language-c":new icon("082F25B3-8413-4CC7-B908-8BBD40BB32D8","f671",0,"templarian","other","","",1650),
				"language-cpp":new icon("74446CD2-562D-44E7-AAC1-62D4CCDB9F43","f672",0,"templarian","other","","",1650),
				"language-csharp":new icon("EFF1E516-3470-456C-AC79-0F9C82C79391","f31b",0,"templarian"),
				"language-css3":new icon("DA72E30D-C562-4E93-B8C8-CAFA686A1D23","f31c",0,"templarian","logos,other"),
				"language-go":new icon("ACAFCF05-E04D-4212-AB53-C72BD8DB5768","f7d2",0,"templarian","logos,other",_,_,2046),
				"language-html5":new icon("98D9A5A1-626A-4273-B895-4C838936613C","f31d",0,"templarian","logos,other"),
				"language-javascript":new icon("9D3ED5EB-8951-4E75-A623-EEF618ED4172","f31e",0,"templarian"),
				"language-php":new icon("2A153653-6727-4DE1-95DC-AC6801A7DC01","f31f",0,"templarian","logos,other"),
				"language-python":new icon("4E453C2B-40D4-4D60-8EAF-750091283FAC","f320",0,"templarian","logos,other"),
				"language-python-text":new icon("445CF970-F03C-4DDC-A326-F77DA919CB39","f321",0,"templarian","logos,other"),
				"language-r":new icon("2F197131-0666-4F07-8BDE-B6FB3C4BB39B","f7d3",0,"greenturtwig","logos,other",_,_,2046),
				"language-swift":new icon("9F060254-CB0B-4DD9-87C5-BADAE8F2F8C4","f6e4",0,"greenturtwig","logos,other","","",1836),
				"language-typescript":new icon("BFE7B3A3-4B61-4583-B22D-395E1FCE1A07","f6e5",0,"templarian","logos,other","","",1836),
				"laptop":new icon("A8B6481F-EE91-4F90-81AC-DEB8A096F45A","f322",0,"google","tech"),
				"laptop-chromebook":new icon("70793340-E8F2-43A0-8AB1-0DAB70CC8B9A","f323",0,"google","tech","","",0,1554),
				"laptop-mac":new icon("DC51467E-30C0-4144-9AE6-80762ACA972C","f324",0,"google","tech","","",0,1554),
				"laptop-off":new icon("C9A08F85-B996-498D-ADDC-20A9B77B5489","f6e6",0,"mrgrigri","tech","","",1836),
				"laptop-windows":new icon("CFF782E5-F36B-4F80-B105-68E6B4B91C64","f325",0,"google","tech","","",0,1554),
				"lastfm":new icon("A6C14603-8189-4CC5-82CF-1231422B6F70","f326",0,"templarian","logos"),
				"launch":new icon("ED8AF9CE-E555-49C9-8E7E-F9B85CD94CDF","f327",0),
				"lava-lamp":new icon("B1E2F856-253B-465C-861A-40C5C7D6C8DB","f7d4",0,"greenturtwig",_,_,_,2046),
				"layers":new icon("36A9B462-C487-458E-BFB6-2415739BC968","f328"),
				"layers-off":new icon("1ADB303D-B8D9-49EF-8EB0-C02AFD269F02","f329",0),
				"lead-pencil":new icon("5EB00CD5-91CA-438E-B569-2D680E6102D6","f64f",0,"google","editor","","",1650),
				"leaf":new icon("30AC82B4-6073-462B-B63E-0F64706AAC2F","f32a",0,"templarian","nature"),
				"led-off":new icon("8A29D85F-1BAD-4610-AF2F-B4AF0F0D2755","f32b",0,"xt3000","power"),
				"led-on":new icon("5DACA128-6BEE-424D-83BA-8C94E01F5C0A","f32c",0,"xt3000","power"),
				"led-outline":new icon("423F2C55-8E79-441A-A987-45A97FAA3F53","f32d",0,"xt3000","power"),
				"led-strip":new icon("F301BDB9-027C-40D0-A21F-3111A7AB218F","f7d5",0,"greenturtwig","power",_,_,2046),
				"led-variant-off":new icon("BBDD4244-D5C9-4150-9936-31C775AA463F","f32e",0,"xt3000","power"),
				"led-variant-on":new icon("9929F712-7241-468C-B10B-5739356EC85C","f32f",0,"xt3000","power"),
				"led-variant-outline":new icon("AEACBB35-5466-4C5B-8AA5-B366D0322A27","f330",0,"xt3000","power"),
				"library":new icon("45FA5A9C-DFF1-4D7E-B683-DB7DE2BAEFC7","f331",0,"google","places"),
				"library-books":new icon("FB635DB5-18DA-448E-81C7-0602181EE21A","f332",0,"google","files"),
				"library-music":new icon("56F24AF4-9E5B-4E53-89ED-3472E08C9466","f333",0,"google","files,other","","note,sound"),
				"library-plus":new icon("BF1B666E-57AC-41B0-950B-4F4060BDF601","f334",0,"google","files"),
				"lightbulb":new icon("ECC94305-DFA6-4D9B-85C8-CC79F3F05FB5","f335",1,"google","power","","idea"),
				"lightbulb-on":new icon("4B3F67C4-02C3-4083-B47A-645AD24992FA","f6e7",1,"templarian","power","","idea",1836),
				"lightbulb-on-outline":new icon("1FDA626F-5858-43AE-92A0-9CCE7168F08F","f6e8",0,"templarian","power","","idea",1836),
				"lightbulb-outline":new icon("BF6C3B65-0795-43E0-B373-058414FDD485","f336",0,"templarian","power","","idea"),
				"link":new icon("462769C2-0A30-4B31-B66C-55168B10D705","f337",1,"google","editor,other"),
				"link-off":new icon("0DACA19D-EFEB-4D22-BE20-9E8FB8C1BBEB","f338",0,"templarian","editor"),
				"link-variant":new icon("4D09DDBE-9716-4162-9DA9-B50892241E15","f339",1,"templarian","editor,other"),
				"link-variant-off":new icon("BC8F07E8-9157-49BB-B8DF-CCCDB19C5467","f33a",0,"templarian","editor"),
				"linkedin":new icon("248F9A0F-7732-4FC9-8E64-2E4B47BBFDCD","f33b",0,"templarian","logos"),
				"linkedin-box":new icon("A00FD3F3-01E7-489E-AB22-66F3B94AF6C0","f33c",0,"google","logos","","",0,1932),
				"linux":new icon("A58FE3A3-BC2C-48A4-8146-0D15F1B80128","f33d",0,"templarian","logos"),
				"loading":new icon("205A2FF1-8827-4D3D-8580-FF7FFCD5232C","f771",0,"krambertech","other","","",1932),
				"lock":new icon("D711AFDE-2B8D-4932-82AC-A04E7B2810AE","f33e"),
				"lock-open":new icon("E357D5CD-7E42-463B-899A-7D7B038A3E31","f33f"),
				"lock-open-outline":new icon("DCE8B967-BCDE-4130-8BF3-DDA78A78326F","f340",0),
				"lock-outline":new icon("86AD97CA-6028-45C2-8C9A-8C4A562A8E49","f341",0),
				"lock-pattern":new icon("6921C166-7D1E-44E4-90B9-ADF6668DDFB9","f6e9",0,"japanyoshilol","other","","",1836),
				"lock-plus":new icon("BA4D2E1E-2BCB-4B17-AC02-52C8F34FAEAE","f5fb",0,"google","other","","",1554),
				"lock-reset":new icon("82312B48-E128-494E-9D84-DAACB41986F4","f772",0,"google","other","password-reset","",1932),
				"locker":new icon("B8B0EAF4-369F-412A-A092-4AA85BBE77FD","f7d6",0,"","other","","",2046),
				"locker-multiple":new icon("4A5533A8-402C-45F2-9D7A-A8949C22C33B","f7d7",0,"","other","","",2046),
				"login":new icon("63D8BFA5-7AE4-4002-A4C2-C464638C38FC","f342",1,"templarian"),
				"login-variant":new icon("B590AA80-D315-4344-8036-8FBC25C87D2C","f5fc",0,"templarian","other","","",1554),
				"logout":new icon("47DF41F2-49C7-4081-8419-F49C7894E7F1","f343",1,"templarian"),
				"logout-variant":new icon("FD2A4CE0-AD1F-45D4-B487-BB6E57F2143F","f5fd",0,"templarian","other","","",1554),
				"looks":new icon("3633613A-B8A7-49D0-8C1B-5415EC76F426","f344",0,"google","nature,weather,other","","rainbow"),
				"loop":new icon("1573C575-7FBA-4BCD-A960-02D42043FE6F","f6ea",0,"mririgo","other","","",1836),
				"loupe":new icon("DB75FD27-01F6-4232-AA23-86C115751A0C","f345",0),
				"lumx":new icon("235EF258-40BB-47C3-9D5F-1497A7FD34D9","f346",0,"templarian","logos"),
				"magnet":new icon("65B3A914-578A-468F-95C1-9C2B6D0C3A52","f347",0,"xt3000"),
				"magnet-on":new icon("3A386A5A-35AC-4760-9384-33A9A43CF584","f348",0,"xt3000"),
				"magnify":new icon("C2889545-7F08-4AE1-9142-ECF9B79957E1","f349",1,"google","other","search","zoom"),
				"magnify-minus":new icon("36D3966F-BFA2-407B-BF36-D21FBA930930","f34a",1,"templarian","other","","minify,out,smaller,zoom"),
				"magnify-minus-outline":new icon("9E259697-7035-4E17-82D6-431C74215E67","f6eb",0,"google","other","","minify,out,smaller,zoom",1836),
				"magnify-plus":new icon("798F7C9D-2EC7-47EF-8729-845B4E2DDD16","f34b",1,"templarian","other","","bigger,enlarge,in,zoom"),
				"magnify-plus-outline":new icon("521EC414-ECAD-435D-BAE3-4CF772659845","f6ec",0,"google","other","","bigger,enlarge,in,zoom",1836),
				"mailbox":new icon("CCEA599C-8CED-4D49-83FB-7AC452AADFA0","f6ed",0,"google","other","","letterbox,postbox",1836),
				"mail-ru":new icon("93BBA1EA-76F8-4D2E-B4D0-98F684B15AC3","f34c",0,"templarian","logos"),
				"map":new icon("99738FF8-01AE-420D-8481-8B9E1402255B","f34d",0,"google","places,travel"),
				"map-marker":new icon("379B9D93-434B-46E7-9ABC-CAFAB694B209","f34e",1,"google","places","address-marker,location"),
				"map-marker-circle":new icon("03F79839-314C-4F29-B3E3-43B97D7F7FA6","f34f",0,"google","places","","location"),
				"map-marker-minus":new icon("34DD1168-3875-4F77-9C0B-5BCFFB80FBBD","f650",0,"xt3000","places","","location",1650),
				"map-marker-multiple":new icon("6283577D-6B31-4297-8747-4F466580E79A","f350",0,"templarian","places","","location"),
				"map-marker-off":new icon("92410469-09D9-4C29-AC79-CD0DF882D05F","f351",0,"templarian","places","","location"),
				"map-marker-outline":new icon("DE8F4623-A6D4-4DD4-B61A-5936A0538FD2","f7d8",0,"","places",_,"location",2046),
				"map-marker-plus":new icon("40CBD1A1-11E1-44A6-8627-6F7C658F5E0F","f651",0,"xt3000","places","","location",1650),
				"map-marker-radius":new icon("8F346B27-607A-4C98-B83E-C32E921D0468","f352",0,"templarian","places","","location"),
				"margin":new icon("4A7710D4-41B8-4D98-A5B9-591943C3B3EF","f353",0,"templarian"),
				"markdown":new icon("42875A08-46EC-4077-95A9-86D16888F2D4","f354",0,"templarian","editor"),
				"marker":new icon("71E6D8F0-A3D2-43CB-8940-16AA4E1D9825","f652",0,"google","editor","","highlighter",1650),
				"marker-check":new icon("74C5E15E-D227-4272-94E6-EDFDD0F66C9A","f355",0,"google","places"),
				"martini":new icon("9291BDB1-CE57-4802-8CD2-7AD2ED9D9959","f356",0,"google","food","","alcohol,bar,cocktail,drink,glass,liquor"),
				"material-ui":new icon("878C7F4D-DAD0-4334-A3AA-695FD3AD5391","f357",0,"templarian","logos"),
				"math-compass":new icon("10E7FA7C-8451-44B9-979F-1916AAC7FE28","f358",0,"lastrosestudios","science"),
				"matrix":new icon("5D5ED3F2-71BD-44B6-B4BB-61D73211335F","f628",0,"templarian","science","","",1650),
				"maxcdn":new icon("7FB125A0-875A-4766-BFAF-02CC45226530","f359",0,"templarian","logos","","cdn"),
				"medical-bag":new icon("7F6DF58A-C9A3-4CE7-9664-28C04218C628","f6ee",0,"thunsaker","science","first-aid-kit","doctor",1836),
				"medium":new icon("C7561067-F057-4E26-B8F1-791BD24E0A2C","f35a",0,"krambertech","logos",_,_,0,"2.x.x"),
				"memory":new icon("E404434E-17DB-4E90-9D97-5355258E1FCF","f35b",1,"google","tech"),
				"menu":new icon("0BD2CD08-CCFB-4EC3-B96D-08B0B8230A91","f35c",1,"google","other","","bars,burger,hamburger,navigation"),
				"menu-down":new icon("624A47B1-947E-45AD-A34F-D5DCC1143C5A","f35d",0,"google","arrows","","bottom,caret"),
				"menu-down-outline":new icon("EE6F8AAE-7856-4E4C-AC01-3589A2C66D98","f6b5",0,"templarian","arrows","","bottom,caret",1722),
				"menu-left":new icon("91F83E23-FD44-4277-BD91-037B3D7EB72E","f35e",0,"templarian","arrows","","caret"),
				"menu-right":new icon("51157881-5A20-4D7D-8E5F-FB0E815C9B3D","f35f",0,"templarian","arrows","","caret"),
				"menu-up":new icon("A526C6AC-3E29-49D1-91FA-07F95B470626","f360",0,"google","arrows","","caret,top"),
				"menu-up-outline":new icon("33B1FB6B-D4F4-4B76-820C-4A2B075DB1B3","f6b6",0,"templarian","arrows","","caret,top",1722),
				"message":new icon("99DA4752-8C79-44D8-8286-6EBD696F0B45","f361"),
				"message-alert":new icon("213A797A-41C0-4804-A5B1-A841898CCC11","f362","google","other","","feedback"),
				"message-bulleted":new icon("1EC9427A-2A02-4F74-9C1B-C4EC5E62B793","f6a1",0,"google","other","speaker-notes","",1712),
				"message-bulleted-off":new icon("5AAB267C-9A9C-4966-862D-A2AC910494E5","f6a2",0,"google","other","speaker-notes-off","",1712),
				"message-draw":new icon("6434A4B3-F803-4C8B-A03C-BE39E947166B","f363",0),
				"message-image":new icon("C4C9B194-78C3-47FB-ABF6-5129230527AC","f364"),
				"message-outline":new icon("2AE3707D-5DE3-41E6-968B-A56D3D9ADD40","f365",0),
				"message-plus":new icon("C0B4CC94-B6B5-462F-93C2-98F07093614C","f653",0,"xt3000","other","","",1650),
				"message-processing":new icon("602EE454-C61C-4608-919E-FCCF3B58DE65","f366"),
				"message-reply":new icon("6657779A-7238-4686-B3D5-1244862D7B2C","f367"),
				"message-reply-text":new icon("FF34C5A8-4433-4B47-A9E5-EB836CFFCEC9","f368",0),
				"message-settings":new icon("4B15BF16-CD96-4427-9EA4-5A8B09F3A2B6","f6ef",0,"mrgrigri","other","","",1836),
				"message-settings-variant":new icon("F0F27B00-3C37-4AC0-B8D7-DB2554894079","f6f0",0,"mrgrigri","other","","",1836),
				"message-text":new icon("D2AFF074-2CE4-442D-AF1A-64B168BC622A","f369"),
				"message-text-outline":new icon("E8C7D2D2-5B78-40E9-A3E6-51B9C31A43F8","f36a",0,"templarian"),
				"message-video":new icon("7AEB07C3-0EFC-4D74-BB5B-2EB1288DC27D","f36b"),
				"meteor":new icon("78644A46-55EA-4208-B3DC-89C79B5F96A5","f629",0,"templarian","science,weather","","",1650),
				"metronome":new icon("13256CBF-E284-4229-AAB9-5612FBADD060","f7d9",0,"japanyoshilol",_,_,_,2046),
				"metronome-tick":new icon("43A2B10E-F7DF-4181-B607-EC2039AFFA0D","f7da",0,"japanyoshilol",_,_,_,2046),
				"micro-sd":new icon("6A3136A3-62AD-4DE6-A783-D9D69AAD8919","f7db",0,"greenturtwig","tech",_,"memory,card",2046),
				"microphone":new icon("18C99959-2A0E-4095-BAEA-F5B266377648","f36c",1,"google","tech"),
				"microphone-off":new icon("90AD0141-2243-49F0-8B84-FF909244D237","f36d",1,"google","networking"),
				"microphone-outline":new icon("E152DB47-F7EE-42A5-A01B-DC5E54A525D8","f36e",0,"google","tech"),
				"microphone-settings":new icon("E8F70177-01CF-4C20-9956-DCA7B331FED6","f36f",0,"google","tech"),
				"microphone-variant":new icon("5824EE2F-01BA-42E7-A943-B0D1C569B2C5","f370",0,"templarian","tech"),
				"microphone-variant-off":new icon("B0811263-2D40-44D9-945D-13393A170311","f371",0,"templarian","networking"),
				"microscope":new icon("CFCFD9FE-AFF3-4D4F-A7C6-A40E0886B064","f654",0,"xt3000","science","","",1650),
				"microsoft":new icon("4636AAFF-A0E5-494C-8630-31142B4A2F48","f372",0,"templarian","logos"),
				"minecraft":new icon("84402452-AA4A-43D6-A26C-A0946B48310C","f373",0,"templarian","logos","","",1554),
				"minus":new icon("2CEA6B7B-E7C9-4D52-9D9D-286E50001B70","f374",1,"google","characters"),
				"minus-box":new icon("6BFAE994-AF2D-4B04-965D-9734631D5F0D","f375",1,"google","characters"),
				"minus-box-outline":new icon("D37AECEA-5BC3-4C57-8886-BC6C1A86987D","f6f1",0,"templarian","characters","","",1836),
				"minus-circle":new icon("DDEB98E7-E016-44CA-8DE7-A31969C2CC04","f376",1,"google","characters"),
				"minus-circle-outline":new icon("E1568BA6-EA0E-478F-933F-102F76996D6C","f377",0,"google","characters"),
				"minus-network":new icon("F48994C7-4A76-43B8-B851-F7389F8B2B59","f378",0,"templarian"),
				"mixcloud":new icon("77B97AED-2613-434C-BD9C-82755C8B468C","f62a",0,"templarian","logos","","",1650),
				"mixer":new icon("62F96579-80AE-4827-9C18-1C1FD239DE49","f7dc",0,"","logos",_,_,2046),
				"monitor":new icon("35091AEB-2AF7-4F92-A249-2955F01404A3","f379",1,"google","tech"),
				"monitor-multiple":new icon("7768BF7B-0A52-4492-88BD-5A482E4D61C3","f37a",1,"chrislitherland","tech"),
				"more":new icon("6284690E-A12C-4209-A779-18284E241DE3","f37b",0),
				"motorbike":new icon("D6AADAF8-D44E-44C0-8647-E578B277441D","f37c",0,"chrislitherland","sport,travel","","bicycle,motorcycle,riding"),
				"mouse":new icon("965CDBD7-9E52-4169-B363-E0428C75C19D","f37d",0,"google","tech"),
				"mouse-off":new icon("2FB92E91-9B25-46BF-85D2-BC0A2DB877B1","f37e",0,"templarian","networking"),
				"mouse-variant":new icon("2E7ADC17-384C-4763-9D52-31AFF16BC864","f37f",0,"templarian","tech"),
				"mouse-variant-off":new icon("7542DE09-B799-4ED5-8ADB-AE809808FAE1","f380",0,"templarian","networking"),
				"move-resize":new icon("4E3B74C0-3E85-4A50-B5FF-3D6AED1CF016","f655",0,"xt3000","other","","",1650),
				"move-resize-variant":new icon("7A5B3547-16C4-4000-9082-E13A9139C737","f656",0,"xt3000","other","","",1650),
				"movie":new icon("122C53AA-C8BC-41B3-89B2-B9A9F8BB56DC","f381",0,"google","other","slate,clapperboard","film"),
				"movie-roll":new icon("21D0F9FB-6814-4CE7-B37D-FC97EBF1D0D2","f7dd",0,"","other","film-reel",_,2046),
				"multiplication":new icon("489C9004-CF90-483E-83E3-CD40DD5B9ACF","f382",0,"templarian","characters"),
				"multiplication-box":new icon("38DF4F2F-85CF-4F71-B170-AAAAF25799E0","f383",0,"templarian","characters"),
				"mushroom":new icon("FCA4F099-5FCB-43DE-8166-2CE30508C1EC","f7de",0,"","food,nature",_,_,2046),
				"mushroom-outline":new icon("D6C17EB7-0A54-4ECA-81AA-86311E311934","f7df",0,"","food,nature",_,_,2046),
				"music":new icon("E7DA3CF2-C345-441D-BFC2-ABC4DB195A6A","f759",1,"templarian","other","","note,sound",1932),
				"music-box":new icon("2EDBEBA6-8590-4049-BB28-8959378DC44C","f384",0,"templarian","other","","note,sound"),
				"music-box-outline":new icon("9E8ADF62-9136-40F3-BED9-54A2934B4B3B","f385",0,"templarian","other","","note,sound"),
				"music-circle":new icon("33A79A85-7985-4E08-8AA8-D6242A9C2700","f386",0,"templarian","other","","note,sound"),
				"music-note":new icon("05F3F5DD-59CC-4FBD-9428-0D0CB125A8AE","f387",0,"templarian","other","","sound",0,1554),
				"music-note-bluetooth":new icon("40A9BA37-B1BD-4869-A3F9-8F534258DB3F","f5fe",0,"xt3000","networking,other","","sound",1554),
				"music-note-bluetooth-off":new icon("98CC5D8B-5D4B-4379-8FFF-1C7FEA82672C","f5ff",0,"xt3000","networking,other","","sound",1554),
				"music-note-eighth":new icon("44EDC206-CF12-4DA5-8DA6-E72FDC35BBD2","f388",0,"templarian","other","","",0,1554),
				"music-note-half":new icon("2F2FC9A9-FAC3-4736-B8EC-B7DF9548586C","f389",0,"templarian","other","","",0,1554),
				"music-note-off":new icon("08305F79-B7E4-4FC9-9B5B-8E76920C3DCC","f38a",0,"templarian","other","","sound",0,1554),
				"music-note-quarter":new icon("D71DFC98-3401-4268-9956-3EFEEE336235","f38b",0,"templarian","other","","",0,1554),
				"music-note-sixteenth":new icon("882DF0E2-C223-4B3F-A538-81EC05421BA9","f38c",0,"templarian","other","","",0,1554),
				"music-note-whole":new icon("13454604-C50C-4381-AC96-552848F0DF9E","f38d",0,"templarian","other","","",0,1554),
				"music-off":new icon("E9D8BB99-B31B-4940-9EEE-B69569060B0D","f75a",1,"templarian","other","","mute,note,sound",1932),
				"nature":new icon("C5FCAD4F-C7E6-4BDB-9F2F-A665CB68B7FD","f38e",0,"google","nature","","tree"),
				"nature-people":new icon("B0635A70-D2A9-41CE-82C6-3FB1D1D353B4","f38f",0,"google","nature,places,other","","man,park,person,tree"),
				"navigation":new icon("DAAF6988-6EE9-4595-A758-294C83C7304B","f390",0,"google","travel"),
				"near-me":new icon("6766F53D-88E4-452A-A222-7F50DDFB757C","f5cd",0,"google","travel,other","","",1554),
				"needle":new icon("2B76647F-92FE-4F8E-B193-7EC20DADD5D2","f391",0,"templarian","science","","hypodermic,syringe"),
				"nest-protect":new icon("1DDC71A0-A86A-4E8F-BF1D-CD33C0B0BEA4","f392",0),
				"nest-thermostat":new icon("628D16E2-7E57-43CA-8451-012B8AB852DA","f393",0),
				"netflix":new icon("7AEF7097-EC88-4D09-A65E-5244DDA99599","f745",0,"templarian","logos","","",1932),
				"network":new icon("089C6F75-2FF5-4B48-B4B4-651AEAD3D24F","f6f2",0,"templarian","networking","","",1836),
				"new-box":new icon("1ABEE375-A0DC-4262-9CCD-3B9C78B5FE7D","f394",0,"google","editor","","",1554),
				"newspaper":new icon("EE440B14-2E25-4C8E-99A7-A3C98CBC9151","f395",0,"google","other","","",0,1554),
				"nfc":new icon("961106B7-BD56-462C-936C-E2CDC83051B5","f396",0,"templarian","networking"),
				"nfc-tap":new icon("656C274C-CDC8-4FB6-AFFA-F704784BC997","f397",0,"templarian","networking"),
				"nfc-variant":new icon("4DFF5414-0EA3-4255-BC50-B40B0E3ADB15","f398",1,"google","networking"),
				"ninja":new icon("8E7C1B4B-C4E8-4072-9FB7-90E207038FFB","f773",0,"mrgrigri","other","","",1932),
				"nintendo-switch":new icon("D57C5D23-1122-4DEB-BEC4-77D5A4D685FE","f7e0",0,"greenturtwig","logos",_,_,2046),
				"nodejs":new icon("46A696BA-7A78-40C1-A685-C9B9851286A6","f399",0,"xt3000","logos,other"),
				"note":new icon("5E1DF73F-AEF5-48F8-B766-419FBB05C5D0","f39a",1,"templarian","files"),
				"note-multiple":new icon("0A0E42BA-FE9D-44C6-BF6A-D29D6013F2E0","f6b7",1,"templarian","files","","",1722),
				"note-multiple-outline":new icon("6294246C-A524-4121-B141-5262D89FFD4D","f6b8",0,"templarian","files","","",1722),
				"note-outline":new icon("DD6D5075-A7F5-4183-9F99-93C295F18B0B","f39b",0,"templarian","files"),
				"note-plus":new icon("753F2E09-A32F-4790-9C07-7CD9AB69104D","f39c",1,"templarian","files"),
				"note-plus-outline":new icon("706F4C63-412B-44CD-81DE-612D4483D09C","f39d",0,"templarian","files"),
				"note-text":new icon("2ADC4253-F51B-4BC2-B04C-0DDD139425CF","f39e",1,"templarian","files"),
				"notebook":new icon("2D28230E-DAF3-4A49-ACB6-7D9C3E9E6495",_,0,"",_,_,_,"2.x.x"),
				"npm":new icon("5E072845-A46E-4D62-A65D-28CD7DAD976B","f6f6",0,"casesandberg","logos,other","","",1836),
				"notification-clear-all":new icon("E758A025-3B14-4A2F-A1D7-2D12C38B47E4","f39f",0),
				"nuke":new icon("DB44684C-B1E7-4039-8BAA-C7C0BC4EB075","f6a3",0,"templarian","science","","",1712),
				"null":new icon("5004722B-DE0B-4F37-BCAD-36B46477E80F","f7e1",0,"templarian","characters",_,_,2046),
				"numeric":new icon("1293DBCD-E538-4AD1-97C9-3F17BBD28457","f3a0",0,"templarian","characters","","123"),
				"numeric-0-box":new icon("C676CDFC-A808-4BCA-A670-49EE8478ED32","f3a1",0,"google","characters","","zero"),
				"numeric-0-box-multiple-outline":new icon("B3652E81-9CA5-4B7C-B603-FE94CB2D1323","f3a2",0,"google","characters","","zero"),
				"numeric-0-box-outline":new icon("1EB53615-9A62-4377-A2D0-246C8F42CAF8","f3a3",0,"google","characters","","zero"),
				"numeric-1-box":new icon("0EF5316E-7978-4F6C-B38E-297837B3CFF5","f3a4",0,"google","characters","","one"),
				"numeric-1-box-multiple-outline":new icon("55513DD6-D73E-438E-8834-D6761C47BA4B","f3a5",0,"google","characters","","one"),
				"numeric-1-box-outline":new icon("50AEDC65-99B1-45CA-8078-CD6D8633995A","f3a6",0,"google","characters","","one"),
				"numeric-2-box":new icon("0F35B058-84BF-42A1-8EC2-4DF8A5F2CB6D","f3a7",0,"google","characters","","two"),
				"numeric-2-box-multiple-outline":new icon("989BAC0E-21F6-4AF2-849A-3DA35BA5958F","f3a8",0,"google","characters","","two"),
				"numeric-2-box-outline":new icon("0C255402-1176-46B5-B38C-60118732FCC7","f3a9",0,"google","characters","","two"),
				"numeric-3-box":new icon("F34D170B-4DF1-470D-ABC4-AE0A93035227","f3aa",0,"google","characters","","three"),
				"numeric-3-box-multiple-outline":new icon("394B1DFD-7009-4057-AD14-7F7D99B3A658","f3ab",0,"google","characters","","three"),
				"numeric-3-box-outline":new icon("0A0F7443-4234-4990-9C0B-A8AC88F924E5","f3ac",0,"google","characters","","three"),
				"numeric-4-box":new icon("9C9EEFA4-B764-41CE-A679-3927454AE59A","f3ad",0,"google","characters","","four"),
				"numeric-4-box-multiple-outline":new icon("EB320CFB-296A-4C6F-9585-76CA21DDCD04","f3ae",0,"google","characters","","four"),
				"numeric-4-box-outline":new icon("18423C69-0B97-4590-A690-1AAF99615875","f3af",0,"google","characters","","four"),
				"numeric-5-box":new icon("1F91841C-B56D-486E-8113-187E28F1E53A","f3b0",0,"google","characters","","five"),
				"numeric-5-box-multiple-outline":new icon("A39788D6-B09D-42CF-ADC3-7575B14DBE79","f3b1",0,"google","characters","","five"),
				"numeric-5-box-outline":new icon("38CB37B2-2BF9-4890-8060-5576DDAE6FC6","f3b2",0,"google","characters","","five"),
				"numeric-6-box":new icon("DC1FE999-3DD7-423B-95A5-89005C66875E","f3b3",0,"google","characters","","six"),
				"numeric-6-box-multiple-outline":new icon("F3AA6A15-D060-40D7-A301-9EB1BAAF2F12","f3b4",0,"google","characters","","six"),
				"numeric-6-box-outline":new icon("8ED3719B-D733-46ED-BFCF-0BDE0819F7EF","f3b5",0,"google","characters","","six"),
				"numeric-7-box":new icon("C01DF00A-5B63-4B15-B6A5-FEA9E3E084B1","f3b6",0,"google","characters","","seven"),
				"numeric-7-box-multiple-outline":new icon("CF43DB99-4419-491B-A5E3-2486A36F24DB","f3b7",0,"google","characters","","seven"),
				"numeric-7-box-outline":new icon("373DD873-E15F-4B7C-8328-76389DC81DB0","f3b8",0,"google","characters","","seven"),
				"numeric-8-box":new icon("863E0667-F376-4303-9261-CAA4B7F073C6","f3b9",0,"google","characters","","eight"),
				"numeric-8-box-multiple-outline":new icon("869A508B-5F8E-41A7-BCE5-E205FC66C80F","f3ba",0,"google","characters","","eight"),
				"numeric-8-box-outline":new icon("DC2B6D38-A6B3-4171-AAC6-E08EF2C23710","f3bb",0,"google","characters","","eight"),
				"numeric-9-box":new icon("12DCC44D-8BA2-4D25-A88B-665920C8B730","f3bc",0,"google","characters","","nine"),
				"numeric-9-box-multiple-outline":new icon("A41F44A0-816E-497E-A08C-C9646FE161BE","f3bd",0,"google","characters","","nine"),
				"numeric-9-box-outline":new icon("EE2E9486-0C32-4EC9-9D4F-9B8A7287F696","f3be",0,"google","characters","","nine"),
				"numeric-9-plus-box":new icon("7CF309F0-D751-44A3-A313-BA7F2F8865FD","f3bf",0,"google","characters","","nine"),
				"numeric-9-plus-box-multiple-outline":new icon("46A850FC-F6E6-4000-A93F-6B954DA62886","f3c0",0,"google","characters","","nine"),
				"numeric-9-plus-box-outline":new icon("C1F38C40-BD01-45FE-A94C-B3C1432707E0","f3c1",0,"google","characters","","nine"),
				"nut":new icon("8B702257-4232-459E-BDA8-C4E698DF8E8E","f6f7",0,"xt3000","other","","",1836),
				"nutrition":new icon("723E0BBB-78CC-4192-98B1-426B17D694B9","f3c2",0,"templarian","food"),
				"oar":new icon("A065A53E-118C-424A-8A81-0D300975AB04","f67b",0,"thunsaker","sport,travel","","boat,rower,rowing",1712),
				"octagon":new icon("5E3C88DE-A208-471A-9096-7C7868CC957C","f3c3",1,"xt3000"),
				"octagon-outline":new icon("3CF63E10-42E7-4E13-8BFF-10E9257953AB","f3c4",0,"xt3000"),
				"octagram":new icon("455C8475-5555-49B7-825B-206581104AB2","f6f8",0,"templarian","other","","",1836,1932),
				"octagram-outline":new icon("8316E0F1-5F66-4C4E-ACA8-EE61AD93A42A","f774",0,"templarian","other","","",1932),
				"odnoklassniki":new icon("8BB24B94-491F-4465-8E87-45FF8FED7C4A","f3c5",0,"templarian","logos","ok-ru","ok.ru"),
				"office":new icon("7E2456A3-891B-43F4-B233-AA0D890815CF","f3c6",0,"templarian","logos","","microsoft"),
				"oil":new icon("DE398350-B7B7-4E6B-AE4C-F99AAE56C7CF","f3c7",0,"templarian","travel"),
				"oil-temperature":new icon("A260896B-178E-4E3A-9F2C-793AD68154F4","f3c8",0,"xt3000","science"),
				"omega":new icon("A98F63CB-AB27-4A2D-B76C-6994507BCDBB","f3c9",0,"templarian","characters"),
				"onedrive":new icon("455893F6-D0C4-4257-ABE4-85B1D68F60FF","f3ca",0,"templarian","logos","","microsoft"),
				"onenote":new icon("E95EC3DF-2A48-4167-9F22-F4E735D4F298","f746",0,"templarian","logos","","microsoft",1932),
				"opacity":new icon("27C36043-E269-4223-ADCE-568B1EFB4623","f5cc",0,"google","other","","",1554),
				"open-in-app":new icon("AF69E2E1-8119-49A2-8E24-915E2254522A","f3cb",0),
				"open-in-new":new icon("12B95238-1D74-4C6C-9BBD-C055B4DD0E4D","f3cc",0,_,"external-link"),
				"openid":new icon("C9525FF9-FE74-467C-99CE-F8DD8FE3576C","f3cd",0,"infanf","logos","","",1554),
				"opera":new icon("A0BCE6D1-D558-487E-9629-F7CCC495C27B","f3ce",0,"templarian","logos","","browser"),
				"orbit":new icon("D672819E-C3D1-49FC-A1E7-9F4732D034DC","f018",0,"robertogrrraham","","","",1932,1932),
				"ornament":new icon("ADC4F1DD-B840-4C28-8D5C-08F3BE15A424","f3cf",0,"templarian"),
				"ornament-variant":new icon("9C3E1D75-FB73-44AA-8BCC-9B30692D8D79","f3d0",0,"templarian"),
				"owl":new icon("1F963457-7A4F-4BEE-AE9C-0E54CF804DD3","f3d2",0,"xt3000","nature"),
				"package":new icon("57771FFC-0E2C-40DE-AF7C-F3F51EFFE2C0","f3d3",0,"templarian","other","","box"),
				"package-down":new icon("0C18B335-700A-4D68-BF88-C95A69479F2E","f3d4",0,"google","other","","box"),
				"package-up":new icon("383EF914-6014-473D-8C54-0314432007E3","f3d5",0,"templarian","other","","box"),
				"package-variant":new icon("558C8C17-E4E1-4921-874D-F9ACB26C35C8","f3d6",0,"templarian","other","","box"),
				"package-variant-closed":new icon("290F16B3-147C-446D-B14B-56AECCA76276","f3d7",0,"templarian","other","","box"),
				"page-first":new icon("DF23FF47-4DD3-4CB3-9BEC-6EE986B0FA65","f600",0,"google","other","","",1554),
				"page-last":new icon("CF9B4635-FE27-4DA5-BE51-F5F4116AFC54","f601",0,"google","other","","",1554),
				"page-layout-body":new icon("39AF8334-4244-49DD-A8A4-D4F638B9D939","f6f9",0,"templarian","editor","","",1836),
				"page-layout-footer":new icon("74636C38-381A-46B8-97FD-B312735DE60D","f6fa",0,"templarian","editor","","",1836),
				"page-layout-header":new icon("3606AC64-ABC8-4DA6-ACE8-64D58E0B0A46","f6fb",0,"templarian","editor","","",1836),
				"page-layout-sidebar-left":new icon("6E39564D-2B4B-4940-9E74-5274ED12E800","f6fc",0,"templarian","editor","","",1836),
				"page-layout-sidebar-right":new icon("29C8714B-1CAD-41B8-829B-2A14F6F87684","f6fd",0,"templarian","editor","","",1836),
				"palette":new icon("954CCE2B-7FEE-4F9C-9923-4E1D567607C3","f3d8",0,"google","editor"),
				"palette-advanced":new icon("3617B5EE-9A4A-4C3C-9C9A-8C69C7569EB4","f3d9",0,"templarian","editor"),
				"panda":new icon("A797FE46-DF68-4179-85BE-172BD79F0667","f3da",0,"templarian","nature"),
				"pandora":new icon("24BCD03F-8D84-4154-95F5-086230CE3BBA","f3db",0,"templarian","logos"),
				"panorama":new icon("4054A322-F348-49BA-B85F-B978EFC1BDAD","f3dc",0),
				"panorama-fisheye":new icon("6D0BD840-6985-440A-9C55-782B5C3F4F9C","f3dd",0),
				"panorama-horizontal":new icon("42B1DAD8-8731-49DB-B415-9BFD78A8DDEA","f3de",0),
				"panorama-vertical":new icon("7EC1E0AF-1AC5-4CC8-BDCC-5E2D3BF2AC70","f3df",0),
				"panorama-wide-angle":new icon("12D83006-87DE-49CE-B8C3-7D6492934CDA","f3e0",0),
				"paper-cut-vertical":new icon("4E8B4DBC-83EE-4CBD-BEDD-5866DE057324","f3e1",0,"templarian"),
				"paperclip":new icon("27BCEC7F-ABF8-4506-B339-EE2425E1BAF9","f3e2",1,"google","other","","attachment,vertical"),
				"parking":new icon("07C8266A-A135-443C-B2DD-4148CD718C51","f3e3",0,"google","places,travel","","carpark"),
				"passport":new icon("31BE5768-FCE0-46D5-A20B-E8CBFED471E0","f7e2",0,"greenturtwig","travel",_,_,2046),
				"pause":new icon("2A1F0831-13CA-4419-BBD7-1F1FAF62A32B","f3e4",1,"google","player","","",0,1650),
				"pause-circle":new icon("7AA13CBC-D472-4462-8263-88DA2BDCD6BB","f3e5",0,"google","player","","",0,1650),
				"pause-circle-outline":new icon("6F271406-B475-45D0-9B37-EF3DBE7D0DAA","f3e6",0,"google","player","","",0,1650),
				"pause-octagon":new icon("D0A95719-9B9F-4E86-A6E5-8013C1A6D4A7","f3e7",0,"templarian","player"),
				"pause-octagon-outline":new icon("95AA0ED2-4221-4123-B3BF-9FACF3702CA4","f3e8",0,"templarian","player"),
				"paw":new icon("802EBFA2-6D86-4E93-BEBF-7F69F6C98C01","f3e9",0,"xt3000","nature","","print"),
				"paw-off":new icon("039D7C7E-AB09-4364-B08D-1FC120442AFE","f657",0,"xt3000","other","","print",1650),
				"pen":new icon("054B1710-EE28-4AA8-9D7E-705B5703E33E","f3ea",0,"templarian","editor"),
				"pencil":new icon("BB27CE6C-769A-4C0C-A53C-F1B10B9C4423","f3eb",1,"google","editor"),
				"pencil-box":new icon("56CC04F4-4E58-434D-962A-C824F5959D20","f3ec",0,"templarian","editor"),
				"pencil-box-outline":new icon("48A9B269-08B8-4DCB-85F1-68F2334DC004","f3ed",0,"templarian","editor"),
				"pencil-circle":new icon("F5C5B903-7160-4B46-AC15-28C965289469","f6fe",0,"greenturtwig","editor","","",1836),
				"pencil-circle-outline":new icon("5D68DE43-969F-40BE-8A2D-F5C25F2B0853","f775",0,"templarian","editor","","",1932),
				"pencil-lock":new icon("33BBFD25-1E97-49AA-BA9A-0B42369DF4A6","f3ee",0,"xt3000","editor"),
				"pencil-off":new icon("AEB0F9CD-B3FF-4F64-9D6E-4916D5C720C3","f3ef",0,"xt3000","editor"),
				"pentagon":new icon("A1E0EA60-79AF-42FD-966D-485276671F9C","f6ff",0,"mririgo","other","","",1836),
				"pentagon-outline":new icon("7251D20A-5A23-456D-9A68-0107EF2BF01B","f700",0,"mririgo","other","","",1836),
				"percent":new icon("3AB307BF-41D9-4CA4-9D44-58C82304C7BB","f3f0",0,"xt3000","characters"),
				"periodic-table-co2":new icon("6F7A0011-054A-4805-A970-A48BEAA9454B","f7e3",0,"greenturtwig","science","","carbon,dioxide",2046),
				"periscope":new icon("05EDCFBB-803B-4DA9-BDC5-17A4E43DE584","f747",0,"greenturtwig","logos","","",1932),
				"pharmacy":new icon("71BD315A-B0C1-4B8B-93CB-2A952C3A7C16","f3f1",0,"google","places,science","","chemist,medicine"),
				"phone":new icon("B5BA809F-FCE8-476C-8388-6A9CFFF73015","f3f2",1,"google","tech,other"),
				"phone-bluetooth":new icon("34F52268-8571-4501-93C1-D4BF606BB10E","f3f3",0,"google","networking,other"),
				"phone-classic":new icon("A9ED94F7-0ADB-4CB3-AAF1-35B87D9B7724","f602",0,"xt3000","tech","","",1554),
				"phone-forward":new icon("5EF77B27-31D7-47F8-8D72-8BC040CD154E","f3f4",0),
				"phone-hangup":new icon("2018B4C8-A296-4D62-A30A-85F988B206EA","f3f5",0),
				"phone-in-talk":new icon("F9BA7066-C1F8-4B19-9860-37BDCEB6F11C","f3f6",0),
				"phone-incoming":new icon("AA8EEDF8-EB34-46C5-8117-9258E1349197","f3f7",0,"xt3000"),
				"phone-locked":new icon("31349A83-A803-48DF-98C8-55D5E27B81E4","f3f8",0),
				"phone-log":new icon("B87821E3-2131-4C50-BB88-880BE6D0066F","f3f9",0,"xt3000","other","","",0,1650),
				"phone-minus":new icon("7F431DF5-245C-4572-962C-CC57177BD8D0","f658",0,"google","other","","",1650),
				"phone-missed":new icon("BF6662C4-D1D0-42E6-8C0A-B071F12975F2","f3fa",0),
				"phone-outgoing":new icon("52280181-270B-4624-97FE-F46126C65BE7","f3fb",0,"xt3000"),
				"phone-paused":new icon("1ABFB2C1-72CB-46C7-8E8B-B8A24C0285EA","f3fc",0),
				"phone-plus":new icon("E58A5CD8-2D42-4A3A-BCC2-70870B43752C","f659",0,"google","other","","",1650),
				"phone-return":new icon("B0FC2BB4-6C44-42CA-8F90-52CBCD0F1AD4",_,0,"mrgrigri",_,_,_,"2.x.x"),
				"phone-settings":new icon("C9E81E97-C4DA-4612-AC4D-0F81C7986CD8","f3fd",0),
				"phone-voip":new icon("43DAD9DC-C484-452A-9450-1F9C83C6B50E","f3fe",0,"xt3000","networking,other"),
				"pi":new icon("0E3F11DA-8458-4A89-BB7B-D3A6972D3E30","f3ff",0,"xt3000","characters"),
				"piano":new icon("E7651219-1BF9-4D06-9B4A-7599A2E0A407","f67c",0,"templarian","other","","",1712),
				"pi-box":new icon("7C14B1F3-D836-42D6-AC5F-9FD31ADEBFFD","f400",0,"xt3000","characters"),
				"pig":new icon("5E4A3F96-7779-44C8-86EF-948EDBD53C20","f401",0,"templarian","nature"),
				"pill":new icon("6487E4ED-C501-416C-9DCE-1B7C1F676050","f402",0,"templarian","science"),
				"pillar":new icon("AD451D24-BA4B-466E-8146-D3FBBDA6E275","f701",0,"greenturtwig","other","historic","column",1836),
				"pin":new icon("B1337135-0E57-465F-8C0C-E658C9981A19","f403",1,"google","places,other"),
				"pin-off":new icon("8C59FE68-D89C-4A86-8E01-5C8109D1B028","f404",1,"templarian","places,other"),
				"pine-tree":new icon("F053196C-66BC-4D0D-B75F-24773CA618E5","f405",0,"templarian","nature,places","","forest"),
				"pine-tree-box":new icon("A8F37CBB-10AA-42DE-9CD6-BDCE10C2AF8C","f406",0,"templarian","nature"),
				"pinterest":new icon("6BAC7A7E-340B-474D-8448-2DEC0FE66146","f407",0,"templarian","logos"),
				"pinterest-box":new icon("E7D24172-A5A7-4BAE-A679-D2191E8E7F51","f408",0,"google","logos"),
				"pipe":new icon("840AF950-F514-452B-AD1F-18EC878CB1F8","f7e4",0,"mrgrigri",_,_,_,2046),
				"pipe-disconnected":new icon("01D59BE4-7863-471D-840D-8C810F934344","f7e5",0,"mrgrigri",_,_,_,2046),
				"pistol":new icon("34C9947D-5943-4C3E-9E7A-2CD95061222B","f702",0,"mrgrigri","other","","gun",1836),
				"pizza":new icon("E617E8BD-2C63-4E59-B1F4-EB3F9F3916D3","f409",0,"google","food,places","","pizzeria"),
				"plane-shield":new icon("B8FB8784-2E21-4D35-9DE8-95E8E2A42591","f6ba",0,"greenturtwig","other","","aeroplane,airplane",1722),
				"play":new icon("90AD6D2A-7986-49D0-8DA5-DC92F9F92A15","f40a",1,"google","player"),
				"play-box-outline":new icon("D0431F42-A1C2-409B-9D44-2EDDEF3F9AB3","f40b",0,"google","player"),
				"play-circle":new icon("79F68E60-010F-4A8E-8E30-06CB64A5DBF6","f40c",0,"google","player","","",0,1650),
				"play-circle-outline":new icon("E0C875C2-16F3-4C92-BABF-DAB2D08258DC","f40d",0,"google","player","","",0,1650),
				"play-pause":new icon("93DAA69E-9A21-4D5A-B6B1-0AF0A24B7FEB","f40e",0,"xt3000","player"),
				"play-protected-content":new icon("FEB9507A-DA7D-4CB3-918A-E64BBB9D4CC9","f40f",0,"google","player"),
				"playlist-check":new icon("F3E26F6E-9F9A-490B-A28A-1BD32A60D143","f5c7",0,"google","player","subscriptions","",1554),
				"playlist-minus":new icon("1D472295-8F79-4F51-B68A-63A2CD2DF634","f410",0,"templarian","player"),
				"playlist-play":new icon("313918D8-1CB9-40FC-B24F-3A974F1A6EAF","f411",0,"google","player","","",0,1554),
				"playlist-plus":new icon("350D7B60-3F36-4FB0-9959-B90625F5267C","f412",0,"google","player"),
				"playlist-remove":new icon("526856F3-6DF1-454A-B905-3DA120370563","f413",0,"xt3000","player"),
				"playstation":new icon("FF92F5A9-DE89-4E7D-BCAB-98920EA96FFE","f414",0,"templarian","logos","","sony"),
				"plex":new icon("D390D1E2-571E-49DB-BBB9-9D3821EAF819","f6b9",0,"infanf","logos","","",1722),
				"plus":new icon("2DE4F8E6-F25C-4FCA-8405-109FA8918B78","f415",1,"google","characters","add"),
				"plus-box":new icon("87EE041D-81D2-4F1A-A757-F76E9D8686EF","f416",1,"google","characters","","add"),
				"plus-box-outline":new icon("75A7BDE6-40BC-4938-AFCD-D4DDF1B65B2A","f703",0,"mririgo","characters","","add",1836),
				"plus-circle":new icon("0F76DADF-2A8D-4C1F-B43E-DC3C6D282BBF","f417",1,"google","characters","","add"),
				"plus-circle-multiple-outline":new icon("0C5565E9-9E74-4E50-BF9E-6F904BB83E52","f418",0,"google","characters","","add"),
				"plus-circle-outline":new icon("EFB8C700-D60B-4995-B8DE-F3A3E2DA75F3","f419",0,"google","characters","","add"),
				"plus-network":new icon("14F6A9EC-BD40-4181-B084-05A9FCFA3973","f41a",0,"templarian","networking","","add"),
				"plus-one":new icon("E67044BA-8025-4D61-916C-56DF4D6FFE6D","f41b",0,"google","characters,google","","google+,1"),
				"plus-outline":new icon("680B6AD6-C9AD-44D1-9228-EDDB8C242343","f704",0,"mririgo","characters","","add",1836),
				"pocket":new icon("DEAC0604-6FD1-496C-99E1-74068FC27713","f41c",0,"templarian","logos"),
				"pokeball":new icon("48329A9B-7B16-469C-9D64-B2E9381620BF","f41d",0,"templarian","logos"),
				"poker-chip":new icon("D73F724D-EEE6-43EC-BA3A-E185ABD7A258",_,0,"mrgrigri",_,_,_,"2.x.x"),
				"polaroid":new icon("8408CE08-26C2-49B9-95CE-C5A9AAF4455E","f41e",0,"templarian"),
				"poll":new icon("C4A1DAE5-04E0-47EF-84D8-CB81FA58EF87","f41f",0,"templarian"),
				"poll-box":new icon("5FFF2FB6-08B2-4860-ACCF-72D614641882","f420",0),
				"polymer":new icon("528FF16A-C55C-43F9-8E0B-3879A209AEDE","f421",0,"google","logos"),
				"pool":new icon("F42C2F0C-BEFC-46EB-A46C-665032BD6641","f606",0,"templarian","places,sport","","swimming",1554),
				"popcorn":new icon("3401BCC7-DECF-4A92-9B6C-34AF063B2FED","f422",0,"templarian","food"),
				"pot":new icon("444286FD-F41C-4945-BF9D-7C2913EC663E","f65a",0,"xt3000","food","","",1650),
				"pot-mix":new icon("C264A721-9CFD-4AE5-BD97-404E7DCDC6C2","f65b",0,"xt3000","food","","",1650),
				"pound":new icon("9344AA1D-FF8B-432F-A314-C416DFA37F12","f423",0,"templarian","characters","hashtag"),
				"pound-box":new icon("597DF175-F0F5-4892-9F13-EA712DBC947E","f424",0,"templarian","characters","hashtag-box"),
				"power":new icon("C945D203-9737-4C25-87CA-29D97B862DD2","f425",1,"google","power"),
				"power-plug":new icon("60E77DB8-2D58-462F-8512-41D9E0E42795","f6a4",0,"google","power","","",1712),
				"power-plug-off":new icon("ACF38F54-4726-4F8F-9916-8C582137FA69","f6a5",0,"xt3000","power","","",1712),
				"power-settings":new icon("B5587844-E70A-4F55-A2DA-CE85D8F79689","f426",0,"google","power"),
				"power-socket":new icon("175A9E67-3723-4D49-85EC-8D34B4BA0C14","f427",0,"xt3000","power","","plug"),
				"power-socket-eu":new icon("07F4FD1C-A171-4088-BE30-53758CFF45E5","f7e6",0,"greenturtwig","power",_,"plug",2046),
				"power-socket-uk":new icon("E9F0AC95-A660-4FB1-BE5D-20153B709E15","f7e7",0,"greenturtwig","power",_,"plug",2046),
				"power-socket-us":new icon("C4F7F8FF-3465-4F85-B615-B852A6919100","f7e8",0,"greenturtwig","power",_,"plug",2046),
				"presentation":new icon("DAEB5F87-858A-4677-B023-C9EC71F99F6C","f428",1,"templarian"),
				"presentation-play":new icon("E182F4B3-B2B0-41CD-90DC-5ADFBE25DA90","f429",1,"templarian"),
				"prescription":new icon("DEF7F9EA-ACA8-452E-B587-6524BE7D67EE","f705",0,"robertogrrraham","places,science","","chemist,medicine,pharmacy",1836),
				"printer":new icon("7365D689-4C10-4EBA-AD9A-09189B8091EE","f42a",1,"google","tech,other"),
				"printer-3d":new icon("86A3D6B7-6C8B-4883-B51B-753DEF0F4A62","f42b",0,"templarian","tech"),
				"printer-alert":new icon("DD64AF52-2610-43D3-A992-9F3FCCB4A576","f42c",0,"templarian"),
				"printer-settings":new icon("33E4D9A3-F8C1-4C58-9E88-977AE4F4E4CA","f706",0,"xt3000","other","","",1836),
				"priority-high":new icon("FA96A5AC-D499-4C13-93C7-7A422A5DE4B7","f603",0,"google","other","","",1554),
				"priority-low":new icon("DFC698A7-3040-48F4-A341-C1E667A4FE22","f604",0,"google","other","","",1554),
				"professional-hexagon":new icon("53EA516B-544D-4DC3-90BD-3A5C4838923C","f42d",0,"templarian"),
				"projector":new icon("D23095BD-C1C0-4FED-B114-CE9CF9DD5DB6","f42e",0,"xt3000","tech"),
				"projector-screen":new icon("A152DD64-B013-4AE7-B89F-49FC90B2E471","f42f",0,"xt3000","tech"),
				"publish":new icon("7E1AC29D-46E3-4C7C-9A00-D8803E502795","f6a6",0,"google","other","","",1712),
				"pulse":new icon("2A0F7B5D-5D23-4E76-B97D-9D2281D3C4EA","f430",0,"templarian","science","","health,heartbeat"),
				"puzzle":new icon("0773D18C-C6A2-41B5-9685-F3E0507E1770","f431",0),
				"qqchat":new icon("6EAADAE4-30AE-4F69-888F-364BBAFFF5E7","f605",0,"templarian","logos","","",1554),
				"qrcode":new icon("779E7DDE-0ACE-4752-9966-22761E2A128A","f432",0,"templarian"),
				"qrcode-scan":new icon("C8A7580B-5288-4A60-8033-797EB07A05AC","f433",0,"xt3000"),
				"quadcopter":new icon("E81082B7-E851-4407-B0D2-08CC105C6A5D","f434",0,"templarian","travel"),
				"quality-high":new icon("C07BA504-080D-4B47-AD4D-7F772E5C92F3","f435",0),
				"quicktime":new icon("B58005AE-8DFA-4C34-AC4D-C14DEF3D35C2","f436",0,"templarian","logos","","apple"),
				"radar":new icon("73BD6C2A-0D5B-4DF6-9FA3-EC489AFBF947","f437",0,"google","science"),
				"radiator":new icon("BFFA61BF-959B-4E15-BE31-4D9AFB5E3FDF","f438",0,"templarian"),
				"radio":new icon("2FA21C1E-99C3-4C9B-AF46-8DF6B9F2A8FC","f439",0,"google","tech"),
				"radio-handheld":new icon("6EE69D5F-CF42-4257-B974-470E397E0DC1","f43a",0,"xt3000","tech"),
				"radio-tower":new icon("8E5FC366-E9F8-40ED-A16D-CD6C87B0C5B1","f43b",0,"templarian","places"),
				"radioactive":new icon("D70016AF-1FEE-4E66-8D51-3DE1BAAC0031","f43c",0,"belledeboheme","science"),
				"radiobox-blank":new icon("10BF2326-3190-4C27-9040-E2F8F4961238","f43d",0),
				"radiobox-marked":new icon("BA101E5E-CDA9-45AA-B249-BD176AF11D95","f43e",0),
				"raspberrypi":new icon("AFC49CE3-9442-4F15-B3EE-6C841A226040","f43f",0,"templarian","logos"),
				"ray-end":new icon("935371AF-0FF0-4D1E-86F8-DB6E5C5510F9","f440",0,"templarian"),
				"ray-end-arrow":new icon("16DEE563-B4C3-4B6D-A47F-B23151965007","f441",0,"templarian"),
				"ray-start":new icon("932F0926-4F5D-4ACA-B4E3-461837361212","f442",0,"templarian"),
				"ray-start-arrow":new icon("5D6F58F7-61B8-4461-B284-4B0D6B031CA2","f443",0,"templarian"),
				"ray-start-end":new icon("0C572F61-2EF1-4F4D-9B53-8FE285BC0BFB","f444",0,"templarian"),
				"ray-vertex":new icon("B391C303-5456-4746-83DD-7862952E281E","f445",0,"templarian"),
				"rdio":new icon("65AC32C4-911E-4005-8BD1-663AE0000988","f446",0,"templarian","logos"),
				"react":new icon("F13DC81C-DF03-4A33-99D6-489FBDB5B29C","f707",0,"templarian","logos","","",1836),
				"read":new icon("36EB4754-ADCF-47B6-9863-4EFFB819FC93","f447",0,"templarian"),
				"readability":new icon("011BAC94-8FD5-4335-AFF3-120C04299E78","f448",0,"templarian","logos"),
				"receipt":new icon("80E9E435-2478-4B48-99B8-D8BEF353AE5F","f449",0),
				"record":new icon("F84F1E59-868C-42CE-80EA-159588E83462","f44a",0,"xt3000","player"),
				"record-rec":new icon("8C452244-41D8-46F9-AF74-665F62EF5E50","f44b",0,"xt3000","player"),
				"recycle":new icon("93C67522-76EA-4A1D-8C9D-29B0901BE55A","f44c",0,"templarian"),
				"reddit":new icon("8CDBB9B4-921B-47CC-9A06-D0F391666654","f44d",0,"templarian","logos"),
				"redo":new icon("7061BAB7-4413-4666-A919-9DD8C4F405F9","f44e",0,"google","editor"),
				"redo-variant":new icon("72717CF3-6D1D-4032-9799-1F553CAD067E","f44f",1,"templarian","editor"),
				"refresh":new icon("AD3C7A2B-0B64-4183-9452-C96EAAF3E08E","f450"),
				"regex":new icon("3313CE4A-E2EF-4E46-8110-C0BF297D0C16","f451",0,"r3volution11"),
				"relative-scale":new icon("912AD329-9B77-4959-9407-0F64BABFAC7D","f452",0),
				"reload":new icon("8E25B2CE-4DAF-4BD1-9D3F-27F86DA55D21","f453",0,"templarian"),
				"remote":new icon("49C7BBC2-6C7F-442E-A6EE-B58AB758A8D4","f454",0,"google","tech"),
				"rename-box":new icon("1DFADA84-47E4-40EF-B1F8-D0A34D1482BA","f455",0),
				"reorder-horizontal":new icon("08CB23B7-EC19-4FE5-9CBB-C308CC89C10B","f687",0,"google","other","","order",1712),
				"reorder-vertical":new icon("F189DB12-9323-47A1-89C9-451EF2A886CB","f688",0,"templarian","other","","order",1712),
				"repeat":new icon("9AEE0CB7-46B9-414F-A8A8-AFB127CB7057","f456",1,"google","player"),
				"repeat-off":new icon("06540FC6-0AF2-40C7-895A-B8C98BD143D1","f457",1,"templarian","player"),
				"repeat-once":new icon("D27E266C-5F69-4E4F-9DE3-65A47B5208F5","f458",1,"google","player"),
				"replay":new icon("A15D2CB0-E938-4894-8BF3-BC6C628E6433","f459",0,"google","player"),
				"reply":new icon("CC3BEE2C-0FEA-46D2-BC53-F7D248AAF47C","f45a",0),
				"reply-all":new icon("0BDA0697-946D-4B4C-AD02-2FC6ECA4A528","f45b",0),
				"reproduction":new icon("A522A51F-EE61-473F-97D6-9D5106FD11CA","f45c",0,"templarian","science"),
				"resize-bottom-right":new icon("84916A68-B413-4D71-B4E7-5FD64914B354","f45d",0,"templarian"),
				"responsive":new icon("0C72C131-779D-460F-A059-B9DF2B79E40C","f45e",0,"lastrosestudios"),
				"restart":new icon("15954B5D-3ADA-4B6B-BE15-F95B6A5D4659","f708",0,"google","other","","",1836),
				"restore":new icon("21D860AE-A880-4ED2-9E11-617D888BD744","f6a7",0,"google","other","","",1712),
				"rewind":new icon("28BCDF41-AA93-4C25-B87A-95A3F5DD8805","f45f",1,"google","player"),
				"rewind-outline":new icon("61E83433-F6D1-442D-9EDE-EDEF27AB789D","f709",0,"mririgo","player","","",1836),
				"rhombus":new icon("68CFD178-A6FE-4DB5-9C39-FCA6A3EA83A5","f70a",1,"mririgo","other","","diamond",1836),
				"rhombus-outline":new icon("101A7558-A38E-48E8-93EA-A21F37238E78","f70b",0,"mririgo","other","","diamond",1836),
				"ribbon":new icon("1C09CB9B-162B-486B-966C-1FCB18C0F633","f460",0),
				"rice":new icon("B90B4B7C-9FDD-427A-834C-F3DFB5EC1823","f7e9",0,"","food",_,_,2046),
				"ring":new icon("7D845AED-5EA2-44C0-8F38-6A2C4E08C8A3","f7ea",0,"",_,_,_,2046),
				"road":new icon("2AA1C93A-17BE-4BB6-A85C-C477A4FF1069","f461",0,"xt3000","travel"),
				"road-variant":new icon("0BBDD64A-3C67-43DD-9B3A-580E12DDA2D7","f462",0,"templarian","travel"),
				"robot":new icon("EC6C8D3D-0315-4C3A-B37A-97411758DF34","f6a8",0,"templarian","other","","",1712),
				"rocket":new icon("96BE0E43-42AB-4F93-8045-0C7B61BF69CC","f463",0,"templarian","science,travel"),
				"roomba":new icon("E091C285-7AA8-4907-9398-EBFDAC7A179D","f70c",0,"robertogrrraham","tech","","",1836),
				"rotate-3d":new icon("D09D0551-14A0-470B-A24C-0AC38F739FFA","f464",0,"templarian","editor"),
				"rotate-left":new icon("1E960D83-0632-47D2-8CC9-D8A137887BAB","f465",0,"google","editor"),
				"rotate-left-variant":new icon("CC6E0E23-9F7B-40F5-B00F-0690A5F7B400","f466",0,"templarian","editor"),
				"rotate-right":new icon("5324E881-FACF-4CAC-9118-FD963EDCDD27","f467",0,"google","editor"),
				"rotate-right-variant":new icon("02105B39-715B-4989-93DC-1DDC338A4552","f468",0,"templarian","editor"),
				"rounded-corner":new icon("FEBD153A-F07E-4329-A727-D75F13F3133D","f607",0,"google","editor","","",1554),
				"router-wireless":new icon("3244EAC8-8349-4CFB-BE35-A0812368CEDA","f469",0,"templarian","tech"),
				"routes":new icon("4E7234E7-AB5F-491D-BA6F-674B3BAD9027","f46a",0,"templarian","travel","sign-routes","direction,signpost"),
				"rowing":new icon("72F11BA0-1557-4500-8235-2E3F2346FE69","f608",0,"google","sport,travel","","boat,oar,rower",1554),
				"rss":new icon("9E877D76-9BC5-496D-99E4-1E6029DE1B4D","f46b",1,"google","other","","",0,1554),
				"rss-box":new icon("649343BD-3C91-43EA-9000-AE10520CAA2D","f46c",0,"lastrosestudios"),
				"ruler":new icon("66A2EA92-0743-4740-B3F2-254C38E9027F","f46d",0,"templarian","editor"),
				"run":new icon("2A869029-60EB-4965-9BE4-9B3DB964C707","f70d",0,"google","sport,travel,other","","emergency,exit,runner,running",1836),
				"run-fast":new icon("D541EB73-227A-419B-A5F7-7242EB02D916","f46e",0,"templarian","sport,travel,other","","emergency,exit,runner,running",0,1836),
				"sale":new icon("688543EC-EC01-474C-883C-C2EA2EDE75BF","f46f",0,"xt3000","other","discount","offer"),
				"sass":new icon("2AFE6E3E-61AB-48D2-A333-E5324AD534CD","f7eb",0,"templarian","logos,other",_,_,2046),
				"satellite":new icon("D77BED79-19CC-45A9-9940-5EB621E95C11","f470",0,"google","science"),
				"satellite-variant":new icon("3945E491-7E92-4A9F-BD2A-C436200B3716","f471",0,"templarian","science"),
				"saxophone":new icon("64F494E1-5B39-488D-B46E-0FC1B9567478","f609",0,"google","other","","",1554),
				"scale":new icon("3FE1D769-A292-44DB-BB8A-E60F3A020D2A","f472",0,"templarian","food"),
				"scale-balance":new icon("82048BA4-F949-4572-B59B-23197F9B36D6","f5d1",0,"xt3000","science","","",1554),
				"scale-bathroom":new icon("F4501EC3-6AB0-4A69-B840-F07DDFC45A19","f473",0,"templarian","science"),
				"scanner":new icon("BE9A1BD3-1DF7-407F-98B7-24070994D472","f6aa",0,"google","tech","","",1712),
				"school":new icon("A671C11E-0A75-4F41-AA32-EAA99955DEDE","f474",0,"google","places","graduation-cap"),
				"screen-rotation":new icon("913EA106-BCB3-410B-A5F4-6FAAA1B79880","f475",0,"google","tech"),
				"screen-rotation-lock":new icon("0C15E49D-5D29-4A3D-803B-0B9695295E04","f476",0,"google","tech"),
				"screwdriver":new icon("2F75C2DC-FAAD-4D59-BAAB-3922EF9AF376","f477",0,"xt3000"),
				"script":new icon("6E18A0EA-1F19-47E3-83DD-25732C1D318D","f478",1,"templarian","other","","scroll"),
				"sd":new icon("68B68EDB-6CDA-4488-A213-5E6DF4146EA6","f479",0,"google","tech"),
				"seal":new icon("82C413A0-A055-4527-87B7-F977B6CD3F74","f47a",0,"templarian","other","ribbon","rosette"),
				"search-web":new icon("F6E7F332-1625-4A46-8E10-B6DEC4059E7E","f70e",0,"mrgrigri","other","","find",1836),
				"seat-flat":new icon("FDDF112E-DFF5-4D31-9821-69902F92E6CF","f47b",0,"google","travel"),
				"seat-flat-angled":new icon("22BC78FF-895C-497C-B6F0-143F60901C20","f47c",0,"google","travel"),
				"seat-individual-suite":new icon("A8F9F185-D2AE-4DEE-845C-3C74801E2CD0","f47d",0,"google","travel"),
				"seat-legroom-extra":new icon("F73EE06A-6898-40A7-9B0E-784A4280C075","f47e",0,"google","travel"),
				"seat-legroom-normal":new icon("1FC39B1E-567E-452C-B923-581F9A90F06D","f47f",0,"google","travel"),
				"seat-legroom-reduced":new icon("4306743D-7833-44E7-88AB-659DD694C8B0","f480",0,"google","travel"),
				"seat-recline-extra":new icon("EB83D5D9-0439-476C-9BFD-04B5D6789940","f481",0,"google","travel"),
				"seat-recline-normal":new icon("B6642D7A-EE36-4C22-945E-88A218708CB6","f482",0,"google","travel"),
				"security":new icon("0C2F3617-9710-4265-AFB5-29C52AD2FBE0","f483",0,"google","networking"),
				"security-home":new icon("2A5A98F5-ED95-40DE-8EC5-1293795CF661","f689",0,"templarian","networking","","",1712),
				"security-network":new icon("C9FA8517-7CD1-4AB7-86AD-0A2BF1016466","f484",0,"templarian","networking"),
				"select":new icon("B350D031-599B-4BB7-9D21-EC955B7FEF43","f485",0,"templarian","editor"),
				"select-all":new icon("7C2879B0-6BFE-42A3-9EDF-4A42AC3C9D70","f486",0,"google","editor"),
				"select-inverse":new icon("DAA46B9D-9215-4BF8-BDA7-52E575817ABC","f487",0,"templarian","editor"),
				"select-off":new icon("B2C462E1-44F0-456A-8A73-919DB480D978","f488",0,"templarian","editor"),
				"selection":new icon("33A5D3FF-E2A7-4E3A-95B5-86D4C6604911","f489",0,"r3volution11","editor","","",0,1932),
				"selection-off":new icon("DE8BF55F-05A8-4CB8-86FC-63D6EAC57A6C","f776",0,"templarian","editor","","",1932),
				"send":new icon("6791A1E4-DBF8-471C-AA27-0D4540A23678","f48a",0),
				"send-secure":new icon("343A4B08-D77B-453B-A8A7-AF40D1A98DD2","f7ec",0,"mrgrigri",_,_,_,2046),
				"serial-port":new icon("5D18BB49-3214-49C0-BD5C-B4581172C650","f65c",0,"xt3000","tech","","",1650),
				"server":new icon("692F85E2-79A8-4207-ACF7-DEC8D675BE38","f48b",0,"templarian","tech"),
				"server-minus":new icon("09F53FF1-31D7-44CA-A00E-8CDDF55DB716","f48c",0,"templarian","networking"),
				"server-network":new icon("21F268BE-CC44-49CE-B59A-121D073ADBA5","f48d",0,"templarian","networking"),
				"server-network-off":new icon("E01B3638-DE80-4D1E-93D1-1A0C5E9AFCF4","f48e",0,"templarian","networking"),
				"server-off":new icon("578A1213-5F0D-4C6B-A929-9157D126A9F8","f48f",0,"templarian","networking"),
				"server-plus":new icon("99AC1D59-A2F0-4B53-872D-0374D0804E0A","f490",0,"templarian","networking"),
				"server-remove":new icon("C7C1A659-403B-44E0-9EF5-94B5C722CAFD","f491",0,"templarian","networking"),
				"server-security":new icon("E42A523C-D28D-4AAB-8A86-4816DD872B78","f492",0,"templarian","networking"),
				"set-all":new icon("501D1421-A50E-470A-A05B-87864461C4ED","f777",0,"xt3000","other","","",1932),
				"set-center":new icon("0267D77C-9968-45EF-87FC-CD3368D56383","f778",0,"xt3000","other","","",1932),
				"set-center-right":new icon("614D2F8D-5170-4FE8-87C7-419903F205CB","f779",0,"xt3000","other","","",1932),
				"set-left":new icon("FB4645C1-DF04-49E0-BA0B-7C02C87AF3A9","f77a",0,"","other","xt3000","",1932),
				"set-left-center":new icon("9C04991C-6A68-4634-885F-A4D6E2816AFF","f77b",0,"xt3000","other","","",1932),
				"set-left-right":new icon("E1BE2EC4-D5D5-475C-A562-9855DA1612FB","f77c",0,"xt3000","other","","",1932),
				"set-none":new icon("9674B809-B544-45E8-BBD8-4E8D9E1A966E","f77d",0,"xt3000","other","","",1932),
				"set-right":new icon("27D4B799-E231-49DF-AB06-0201493C83E9","f77e",0,"xt3000","other","","",1932),
				"settings":new icon("E4A14909-3821-4DB1-A739-4DA464ABEEB7","f493",1,"google","other","cog,gear"),
				"settings-box":new icon("6F15658D-723C-4BE9-85D1-F170E4B90281","f494",0,"google","other","cog-box,gear-box"),
				"shape-circle-plus":new icon("C989421F-7F77-45D9-9BB4-97D3DE8C8FB4","f65d",0,"kaifaust","other","","",1650),
				"shape-plus":new icon("C91D9DCD-5ADA-4D48-857C-39D38CD37A6B","f495",0,"templarian"),
				"shape-polygon-plus":new icon("CFE631FF-AAD1-49D9-BA22-84BAC90B8787","f65e",0,"kaifaust","other","","",1650),
				"shape-square-plus":new icon("56A31026-C5C6-45D5-A9D4-1C660357F430","f660",0,"kaifaust","other","","",1650),
				"shape-rectangle-plus":new icon("C92D4248-E908-4B39-A6D0-296E6FB5FFE1","f65f",0,"kaifaust","other","","",1650),
				"share":new icon("F0053E35-64B2-45D5-92D6-EE9F8A8839A1","f496",0),
				"share-variant":new icon("C25D5913-39C7-4215-B372-88F90EE2B6E5","f497",0),
				"shield":new icon("A3709A80-3219-4E83-9D4F-EF74F31EEAAE","f498",1,"templarian"),
				"shield-half-full":new icon("9E908727-9325-4FC6-B8B8-C5CA52A7A827","f77f",0,"greenturtwig","other","","",1932),
				"shield-outline":new icon("A8FF94DD-6BA5-4DBA-AE23-59BB22DD733B","f499",0,"templarian"),
				"shopping":new icon("7A5ED547-B142-4921-8050-647B2B9F4DC0","f49a",0,"google","places"),
				"shopping-music":new icon("E3FDDEB1-6D36-4E18-914E-06E2887E7D96","f49b",0,"templarian","places"),
				"shovel":new icon("16D35D19-90C2-42DD-9E83-8F47E21A53DF","f70f",0,"mrgrigri","other","","spade",1836),
				"shovel-off":new icon("01E7F800-E769-4A3F-9A30-D1B8E96F617B","f710",0,"mrgrigri","other","","spade",1836),
				"shredder":new icon("BCE4CF23-0A2B-430F-89C9-7597F1132919","f49c",0,"xt3000","tech"),
				"shuffle":new icon("99537665-2115-40D6-9725-0F4B4730C99A","f49d",1,"google","player"),
				"shuffle-disabled":new icon("DAA3B240-E394-46A8-83FE-6EE6712BF806","f49e",0,"xt3000","player"),
				"shuffle-variant":new icon("84D958BE-5145-4490-BA8F-D00E6870CC9D","f49f",0,"xt3000","player"),
				"sigma":new icon("59A98F47-9067-492A-8454-42BEFA2391C1","f4a0",0,"templarian","characters","summation"),
				"sigma-lower":new icon("DD1EAF89-C6AC-4E61-BF78-93425B16DD24","f62b",0,"templarian","characters","","",1650),
				"sign-caution":new icon("159F7B23-A336-4F8C-A3BB-D8AB143D6661","f4a1",0,"templarian","travel,other"),
				"sign-direction":new icon("93E3355E-36F9-4B26-A337-C5F794D98941","f780",0,"templarian","travel","","signpost",1932),
				"sign-text":new icon("6AC6C6C2-8925-4ECC-BD95-6B961B2CD0A5","f781",0,"templarian","places,travel","","signpost",1932),
				"signal":new icon("7099FDF8-B653-4C49-BE2B-5B96147A709D","f4a2",1,"xt3000","networking"),
				"signal-4g":new icon("7D633D1D-C265-4D2F-860E-43263B34A06F","f713",0,"greenturtwig","networking","","",1836),
				"signal-hspa":new icon("A960C38F-7EFE-4FE6-94AB-C7B0CD07DD50","f714",0,"greenturtwig","networking","","",1836),
				"signal-hspa-plus":new icon("CDCB7012-AD69-4B80-A64E-FDA1375271AD","f715",0,"greenturtwig","networking","","",1836),
				"signal-off":new icon("9DAFE242-BF4B-43F8-8A6E-89EBB0EEDCAA","f782",0,"greenturtwig","networking","","",1932),
				"signal-3g":new icon("F0ACC092-8F79-43C9-9F8F-72E41AE557F2","f712",0,"greenturtwig","networking","","",1836),
				"signal-2g":new icon("C281EBBF-23FD-4F0A-8908-BFBA18F75FDD","f711",0,"greenturtwig","networking","","",1836),
				"signal-variant":new icon("F4D628E8-ADAA-48B7-9ED2-83560FF4583F","f60a",0,"templarian","networking","","",1554),
				"silverware":new icon("F7C26535-863F-4295-9E48-9847B740FEE7","f4a3",0,"google","food"),
				"silverware-fork":new icon("7B00A99C-3766-4939-993F-657333EE430B","f4a4",0,"templarian","food"),
				"silverware-spoon":new icon("5FCBB812-F381-4E83-B60E-E126992910FB","f4a5",0,"templarian","food"),
				"silverware-variant":new icon("A91FC6E1-2613-41E7-A8CA-58740B3322DA","f4a6",0,"templarian","food"),
				"sim":new icon("93020F21-A0FE-427D-8685-B74EE39B9921","f4a7",0,"google","tech","","",0,1554),
				"sim-alert":new icon("43CD286A-D183-474F-9B8A-93D43A355117","f4a8",0,"google","networking,other"),
				"sim-off":new icon("65B6C060-C1A9-4049-A6B6-FEAC02A899D3","f4a9",0,"google","networking"),
				"sitemap":new icon("673CE0A7-8AA2-4BFD-9308-B51589FBF520","f4aa",1,"xt3000"),
				"skip-backward":new icon("45260E4C-E8EB-4E35-85A8-F19A91FE1A2C","f4ab",0,"xt3000","player"),
				"skip-forward":new icon("760EA0AB-7906-4FA4-86E0-CD18A4073302","f4ac",0,"xt3000","player"),
				"skip-next":new icon("D2F19A25-4EF4-41A7-A91A-C03C77E32186","f4ad",1,"google","player","","",0,1650),
				"skip-next-circle":new icon("0D688B5D-27F8-47CF-9234-87DB3F25D28E","f661",0,"xt3000","player","","",1650),
				"skip-next-circle-outline":new icon("5AE3DE91-B2E8-48DD-A170-1F26E391F830","f662",0,"xt3000","player","","",1650),
				"skip-previous":new icon("8D8B924F-0AD5-4458-9BCE-0A5887D935B6","f4ae",1,"google","player","","",0,1650),
				"skip-previous-circle":new icon("3584845F-971C-45BB-8184-CFEBE0044474","f663",0,"xt3000","player","","",1650),
				"skip-previous-circle-outline":new icon("FF83529F-FAA5-4FAD-9EE8-9F9A74409F93","f664",0,"xt3000","player","","",1650),
				"skull":new icon("AD1B00BA-C98D-4961-A444-9484EF434BEC","f68b",0,"japanyoshilol","science,other","","",1712),
				"skype":new icon("07E9D89D-2D58-40C6-9D41-49722CFC0DAE","f4af",0,"templarian","logos"),
				"skype-business":new icon("813333B0-4A34-4AC6-819C-0FBEABC06246","f4b0",0,"templarian","logos"),
				"slack":new icon("EA0E061F-B48E-4443-BBE8-6080C2258730","f4b1",0,"templarian","logos"),
				"sleep":new icon("C9CF20D8-55F4-4997-8019-F8056ED86702","f4b2"),
				"sleep-off":new icon("0801B02C-2187-40D1-8A03-D521D0214662","f4b3",1,"xt3000"),
				"smoking":new icon("20A9F2BB-C53E-410E-A433-4CEE2305AD49","f4b4",0,"xt3000","other","","area,cigarette,smoke,rooms",0,1932),
				"smoking-off":new icon("5F974B83-AEEC-4C52-B281-1A8663B70027","f4b5",0,"xt3000","other","","cigarette,no,smoke",0,1932),
				"snapchat":new icon("6DA57C23-2ADA-4CA1-8D1D-AFBBFA59C4FA","f4b6",0,"templarian","logos"),
				"snowflake":new icon("5675A747-D467-473E-9A1D-1C61E1B5C619","f716",0,"google","weather","","",1836),
				"snowman":new icon("06497E01-D87F-479B-90DC-B4E33497C8D8","f4b7",0,"templarian","weather"),
				"soccer":new icon("B4AFB6A4-C315-4B06-AE4D-AC633F3ED0A7","f4b8",0,"infanf","sport","football","ball",1554),
				"soccer-field":new icon("C24D4262-700B-46E1-82C1-01449C16205E",_,0,"greenturtwig","sport","football-pitch",_,"2.x.x"),
				"sofa":new icon("5560ABF9-E635-4D73-A39B-5404443F099F","f4b9",0,"xt3000"),
				"solid":new icon("F0E0017F-DD8C-4811-9428-613238CA66A4","f68c",0,"templarian","other","","",1712),
				"sort":new icon("3052FDE9-791A-43E8-ACF4-A5EB7DF8296F","f4ba",0,"templarian"),
				"sort-alphabetical":new icon("C2687EF2-6AEB-48BC-98E5-9A010C6E2BE7","f4bb",0),
				"sort-ascending":new icon("F36D1111-54BF-4BB8-AE34-DE4809105551","f4bc",0,"templarian"),
				"sort-descending":new icon("F0028BDF-0589-400F-8596-100CCB029D6E","f4bd",0,"templarian"),
				"sort-numeric":new icon("2CD8E0F3-0AF4-4BBD-B1C8-EEF6391F62C3","f4be",0),
				"sort-variant":new icon("9E32B54D-9759-4233-B358-C00A11300713","f4bf",0),
				"soundcloud":new icon("5952089F-872D-454C-AD1F-18B205938245","f4c0",0,"templarian","logos"),
				"source-branch":new icon("AADA1B60-0161-4417-9726-75AFB5C7AC31","f62c",0,"templarian","other","","",1650),
				"source-commit":new icon("B0400135-C84A-47D8-AD30-B6BD8292E6A4","f717",0,"casesandberg","other","","",1836),
				"source-commit-end":new icon("5558E497-77AD-48F4-9456-E6D6B4CA991B","f718",0,"casesandberg","other","","",1836),
				"source-commit-end-local":new icon("5681B6C8-CC7F-42B0-9B6F-B53D9A72D12F","f719",0,"casesandberg","other","","",1836),
				"source-commit-local":new icon("DF889541-FEF0-42C0-BF6E-E29D4503C3FB","f71a",0,"casesandberg","other","","",1836),
				"source-commit-next-local":new icon("42A5B80B-C7A6-42F4-8437-458F504B7AF5","f71b",0,"casesandberg","other","","",1836),
				"source-commit-start":new icon("6647D5DC-4BF4-47FB-9B11-F1ABB94B3769","f71c",0,"casesandberg","other","","",1836),
				"source-commit-start-next-local":new icon("64F8200C-7866-46A6-9E8B-1CAF621517CC","f71d",0,"casesandberg","other","","",1836),
				"source-fork":new icon("F2A480EB-B06A-4472-88B9-C881754675FE","f4c1",0,"templarian","other","","",0,1650),
				"source-merge":new icon("C4A094D6-A68C-41F8-A2EC-C87997DACE70","f62d",0,"templarian","other","","",1650),
				"source-pull":new icon("6555FD23-E5EE-4F40-91CF-B72476ADED54","f4c2",0,"templarian","other","","",0,1650),
				"soy-sauce":new icon("62A5E551-73E0-4C84-89E4-C0F34BDACEFA","f7ed",0,"","food",_,"soya",2046),
				"speaker":new icon("43C37FC5-E271-40FA-BB50-C139DDD5B15B","f4c3",0),
				"speaker-off":new icon("9B55ECCE-270B-4A52-9A96-80BEECAD1E0B","f4c4",0,"templarian"),
				"speaker-wireless":new icon("F9EA980F-2C75-48DE-9D56-9A15CFE52865","f71e",0,"xt3000","other","","",1836),
				"speedometer":new icon("F0EE6F6A-2B43-4880-8DC9-6E7515B3BEDE","f4c5",0,"templarian","travel"),
				"spellcheck":new icon("72253002-9545-40A4-95A4-49401269B553","f4c6",1,"google","editor"),
				"spotify":new icon("51C1DE39-1C25-49B7-A295-DD13B874C48B","f4c7",0,"templarian","logos"),
				"spotlight":new icon("A4956491-730F-4BC9-A6C1-03AF3C54C134","f4c8",0,"templarian"),
				"spotlight-beam":new icon("13AE04D2-BB67-4CA4-89F6-11C88C2A217E","f4c9",0,"templarian"),
				"spray":new icon("0CDAFE95-E28B-4A8D-9634-C6BBB99EE598","f665",0,"templarian","other","","paint",1650),
				"square":new icon("5659F8EC-377D-41D2-AB3A-52DC40815DC7","f763",1,"templarian","other","","",1932),
				"square-inc":new icon("32DEB304-15CC-4B30-832E-A1377A57EC47","f4ca",0,"templarian","logos"),
				"square-inc-cash":new icon("82D545A0-9A8E-4363-A462-883526E48330","f4cb",0,"templarian","logos"),
				"square-outline":new icon("5ED659B5-F175-445F-950D-0B4DDAB3F8B3","f762",0,"templarian","other","","",1932),
				"square-root":new icon("D0835CDD-0255-4A0D-B86F-DAB300C5ADCC","f783",0,"templarian","editor","","",1932),
				"stackexchange":new icon("D76A8752-ED97-4E90-95EC-B1D6E81ABA9E","f60b",0,"templarian","logos","","",1554),
				"stackoverflow":new icon("72E7037B-1C3B-44BB-A9EC-FC2D6B3EA745","f4cc",0,"templarian","logos","","",0,1554),
				"stadium":new icon("0407BE27-099D-4170-BA1C-A87A4239F9DA","f71f",0,"alexefremo","places,sport","","arena",1836),
				"stairs":new icon("D5BBEF8B-FC7A-4FA5-9DA6-4D970AC6A530","f4cd",0,"xt3000","places"),
				"standard-definition":new icon("DAA79A7B-03FB-431A-85DD-AB9749783DC0","f7ee",0,"templarian",_,_,"sd",2046),
				"star":new icon("53D81A11-D8FF-46F4-A0CB-B7F668BA720D","f4ce",1,"google","weather,other","","award,achievement,favourite,night,rate,rating,score"),
				"star-circle":new icon("76D19C8B-0302-436A-A19F-5AC5EE8AC88C","f4cf",0,"google","other","","award,achievement,favourite,rate,rating,score"),
				"star-half":new icon("52E97617-C7F4-45D0-98E0-E9B4407EC179","f4d0",1,"google","other","","award,achievement,favourite,rate,rating,score",0,1836),
				"star-off":new icon("3CE96C58-D12F-474D-916F-D0509E3BA408","f4d1",0,"templarian","other","","award,achievement,favourite,rate,rating,score,slash"),
				"star-outline":new icon("D443AD2F-291D-496E-ACD2-109891446FF2","f4d2",0,"google","weather,other","","award,achievement,favourite,night,rate,rating,score"),
				"steam":new icon("FBD721A3-7CD8-4769-902C-2B434CA107EE","f4d3",0,"templarian","logos"),
				"steering":new icon("A2FE9DC5-BC17-4265-9D2C-4CA20135C4BB","f4d4",0,"templarian","travel"),
				"step-backward":new icon("3056B0E6-E30C-4F6D-8647-AC5559FD7DCF","f4d5",0,"xt3000","player","","",0,1650),
				"step-backward-2":new icon("9815CAC2-7390-4AE1-AE72-2B49546987EC","f4d6",0,"xt3000","player"),
				"step-forward":new icon("6773EDAB-CBAA-4C56-80D6-E029EB45115E","f4d7",0,"xt3000","player","","",0,1650),
				"step-forward-2":new icon("890D584F-45C1-4D2C-96C0-373465DB6477","f4d8",0,"xt3000","player"),
				"stethoscope":new icon("641202BA-294A-4A0F-851D-FB83FEC9D7EE","f4d9",0,"xt3000","science"),
				"sticker":new icon("F4C92E8A-A238-4F7C-B2FC-CBA914C5CE04","f5d0",0,"infanf","other","","",1554),
				"sticker-emoji":new icon("9E28CC83-5155-4620-80C1-62875D117A79","f784",0,"google","other","","",1932),
				"stocking":new icon("3C90040A-0B3F-4849-B21D-E16240D7A699","f4da",0,"templarian"),
				"stop":new icon("F1057179-EA45-4D87-A14D-D05442C06503","f4db",1,"google","player"),
				"stop-circle":new icon("EC57EC60-1C8E-45CE-BF4A-D019AFD1F148","f666",0,"xt3000","player","","",1650),
				"stop-circle-outline":new icon("B343DEEB-A0ED-41BF-8C86-37D04A1040A6","f667",0,"xt3000","player","","",1650),
				"store":new icon("3C3AEDE0-B6DA-4CB9-A686-869634678D5D","f4dc",0,"google","places"),
				"store-24-hour":new icon("417393DA-3C7F-4BF2-9283-AB1429FFA068","f4dd",0,"google","places"),
				"stove":new icon("18EF6E1E-8EF9-4A62-AAB9-6E8BE591408A","f4de",0,"templarian","food"),
				"subdirectory-arrow-left":new icon("FC46F7BD-E8E2-452C-868C-E168E13B278D","f60c",0,"google","arrows,other","","",1554),
				"subdirectory-arrow-right":new icon("AFD661FE-31E3-4BB5-8977-10113C7AC3F4","f60d",0,"google","arrows,other","","",1554),
				"subway":new icon("769FB684-BA81-4E2A-B623-4C8B6F3DCD2C","f6ab",0,"google","travel","","underground",1712),
				"subway-variant":new icon("EBD55581-BE34-4D0D-A151-974FD5FD7D92","f4df",0,"google","travel","","underground",0,1712),
				"summit":new icon("052D93D8-A1F1-450C-99F3-AEEE07D77CF4","f785",0,"templarian","other,placse","","peak",1932),
				"sunglasses":new icon("E52FC33A-09BD-4B34-AF94-92C891020CDC","f4e0",0,"xt3000"),
				"surround-sound":new icon("AB38BBD9-58A6-4D21-8A76-8940B7717550","f5c5",0,"google","other","","",1554),
				"surround-sound-2-0":new icon("13009B66-7459-4C86-8EB0-3CAED977BB98","f7ef",0,"templarian",_,_,_,2046),
				"surround-sound-3-1":new icon("4B744BE0-A739-44FF-ADA6-CFC9BC520B1D","f7f0",0,"templarian",_,_,_,2046),
				"surround-sound-5-1":new icon("CFD48DE8-0DA8-455C-9C4C-337EDC54D7C0","f7f1",0,"templarian",_,_,_,2046),
				"surround-sound-7-1":new icon("BC85CD47-E52C-4A7D-8E05-DD45596C5822","f7f2",0,"templarian",_,_,_,2046),
				"svg":new icon("5E34C73B-E200-4BD3-A10E-A00D1D47BFF4","f720",0,"templarian","logos","","",1836),
				"swap-horizontal":new icon("D1E543C5-6ECA-43AA-B04D-438319BC5562","f4e1",0,"google","arrows,other","","switch"),
				"swap-vertical":new icon("DA7FB76D-58FA-4AED-9DF9-033E994AE000","f4e2",0,"google","arrows,other","","switch"),
				"swim":new icon("668BF75C-2B3B-46CB-8731-AE6BF10244BD","f4e3",0,"templarian","places,sport,travel","","pool,swimmer,swimming"),
				"switch":new icon("A2ED8CF0-EAE1-4B83-9469-448260288DDE","f4e4",0,"templarian","tech"),
				"sword":new icon("D73618B2-062C-40B2-BF8D-43DC48809F9B","f4e5",0,"templarian"),
				"sword-cross":new icon("37B336A5-5827-4929-93B5-C12373966731","f786",0,"mrgrigri","other","","",1932),
				"sync":new icon("E8CE455E-8C08-48F4-B989-8D91E185E8AE","f4e6",0,"google","networking"),
				"sync-alert":new icon("66A07118-4C78-44D0-8B73-930144C74BD1","f4e7",0,"google","networking"),
				"sync-off":new icon("538457F5-44DB-404B-92FE-5FB8597B258E","f4e8",0,"google","networking"),
				"tab":new icon("76D6AAA9-7D7F-4C7A-818E-D9947744A23C","f4e9"),
				"tab-plus":new icon("9E23B225-E972-4369-A94A-C2AAF4C93870","f75b",1,"templarian","other","","",1932),
				"tab-unselected":new icon("9A9059F0-CADA-47EF-82DC-4B1FB2B9E4C5","f4ea",0),
				"table":new icon("984D8348-AB61-4DD8-838C-3F2542577F73","f4eb",1,"templarian","editor"),
				"table-column":new icon("D45D7513-AA4C-43CA-8435-CA6AD2B7F868",_,0,"templarian","editor",_,_,"2.x.x"),
				"table-column-plus-after":new icon("0EB91CE4-3223-4799-9BB7-3BA0C923BC40","f4ec",0,"templarian","editor"),
				"table-column-plus-before":new icon("67B4875F-B08F-4006-AFE1-9C243F8B873A","f4ed",0,"templarian","editor"),
				"table-column-remove":new icon("455B9D6F-1842-434F-8C31-16F68A2C1BA9","f4ee",0,"templarian","editor"),
				"table-column-width":new icon("2343FF2B-E5D3-4BEC-90EA-FB3F5291D4B0","f4ef",0,"templarian","editor"),
				"table-edit":new icon("DDC0FFBC-73D2-49E8-8B8C-22D65A5719A6","f4f0",0,"templarian","editor"),
				"table-large":new icon("99BE0AB4-A123-4745-839F-DC355DA8C3D4","f4f1",0,"templarian","editor"),
				"table-row":new icon("8EA23E11-D670-4D09-8AA6-7DAFBEAA54FD",_,0,"templarian","editor",_,_,"2.x.x"),
				"table-row-height":new icon("5B9A6186-2C24-4D16-9FE4-F0E23C8E5B5F","f4f2",0,"templarian","editor"),
				"table-row-plus-after":new icon("0B2B45F7-3597-4049-9643-9E972826F67C","f4f3",0,"templarian","editor"),
				"table-row-plus-before":new icon("784BF375-370F-4DAE-985D-7BEF2FDA6951","f4f4",0,"templarian","editor"),
				"table-row-remove":new icon("017D1949-234A-4C27-A653-FF0EAF33AD92","f4f5",0,"templarian","editor"),
				"table-settings":new icon("B506843C-4832-4F30-8266-9B02632AB582",_,0,"",_,_,_,"2.x.x"),
				"tablet":new icon("703B639C-E17D-40F1-8025-2B2950B1961D","f4f6",0,"google","tech"),
				"tablet-android":new icon("179831B0-F175-4694-9313-3B745C133F96","f4f7",0,"google","tech"),
				"tablet-ipad":new icon("A7147BE3-0B04-4B61-94F3-48B0D9C5551E","f4f8",0,"google","tech"),
				"taco":new icon("9E259FF6-513C-44B0-BB10-7F930DFA47DD","f761",1,"templarian","food","","",1932),
				"tag":new icon("0BE85AB2-0D51-411C-B119-789E9E317216","f4f9"),
				"tag-faces":new icon("5DCE0F4D-F740-4D9A-AC93-281D3477E9AF","f4fa",0),
				"tag-heart":new icon("2D9E735C-EA23-4EB2-9AC4-C92D69218577","f68a",0,"google","other","","",1712),
				"tag-multiple":new icon("408AB5A3-F100-4175-96CD-8602BE101150","f4fb",0,"templarian"),
				"tag-outline":new icon("2022546E-45D4-4AC5-B24F-6D6AAEA0F452","f4fc",0,"templarian"),
				"tag-plus":new icon("83C0C7C5-26FF-4EF7-A05B-B05472FC40FC","f721",0,"mrgrigri","other","","",1836),
				"tag-remove":new icon("E90C088F-8DFD-4B7D-962C-BE2DD9DB61BD","f722",0,"mrgrigri","other","","",1836),
				"tag-text-outline":new icon("8ED927D3-84B9-43D1-82B4-3859653006D6","f4fd",0,"templarian"),
				"target":new icon("363D29C5-9F0F-43EA-BE7E-D1C2C1418517","f4fe",0,"r3volution11"),
				"taxi":new icon("32F3835A-EBD0-4927-9497-6F67F7075EAF","f4ff",0,"google","travel"),
				"teamviewer":new icon("3335C183-CD35-4D66-87AB-C5E3A7FCAFBF","f500",0,"templarian","logos"),
				"telegram":new icon("47F1C290-ED78-4459-B33C-6E2ACC867CC6","f501",0,"templarian","logos"),
				"television":new icon("1B699A99-578E-450C-9523-934F4D281F72","f502",1,"google","tech","tv"),
				"television-classic":new icon("EB7FD483-EAF9-4FEE-8B82-25186D26827A","f7f3",0,"greenturtwig","tech","tv-classic",_,2046),
				"television-guide":new icon("6E5CAF6F-F00B-4613-B520-BDC1E5DD2832","f503",0,"templarian","tech"),
				"temperature-celsius":new icon("A94E333D-F8C5-4726-B81A-6DDF4CC37FD0","f504",0,"templarian","characters,science","","centigrade"),
				"temperature-fahrenheit":new icon("9A1DF8BB-627A-47C9-B609-BAC145D320DF","f505",0,"templarian","characters,science"),
				"temperature-kelvin":new icon("DF9D47EE-157B-4E1E-85CE-A043E5F2AE51","f506",0,"templarian","characters,science"),
				"tennis":new icon("DE92B1F1-31FB-4551-84A2-32F5B5D842EC","f507",0,"google","sport","","ball"),
				"tent":new icon("688277DE-082A-4BE2-8E59-129245E02DD7","f508",0,"templarian","places,travel","","camping"),
				"terrain":new icon("1F98A781-6023-4368-AC06-5A421D166FCC","f509",0,"google","nature,places,travel","","mountains"),
				"test-tube":new icon("0B88F54B-7522-4D7D-85EC-3C0C3E7D36FE","f668",0,"kaifaust","science","","",1650),
				"text-shadow":new icon("4595BB97-16B7-4B19-8AC5-9C33167A6D20","f669",0,"xt3000","editor","","",1650),
				"text-to-speech":new icon("5B1FA77D-0384-4931-AFD8-C4FF5D73D372","f50a",0,"templarian"),
				"text-to-speech-off":new icon("1AE8F7A9-5454-44D2-B16D-1D383E33978D","f50b",0,"templarian"),
				"textbox":new icon("BB7E18FD-F473-4A80-B6A9-A17D3648E0A4","f60e",0,"templarian","other","","",1554),
				"textbox-password":new icon("F35B5B3C-762F-473C-B229-B6818D50E045","f7f4",0,"mrgrigri","other","","",2046),
				"texture":new icon("E3A06403-51B5-4D00-9349-53517553A324","f50c",0),
				"theater":new icon("37350655-CB4D-4D9F-8C90-B8049CA0E48E","f50d",0,"templarian","places","","cinema,theatre"),
				"theme-light-dark":new icon("AE66BEF4-7040-4A15-8BF3-639B116853CC","f50e",0,"templarian"),
				"thermometer":new icon("F41863ED-B66A-4FF4-B436-0876C8D3665B","f50f",0,"templarian","science,weather"),
				"thermometer-lines":new icon("A9FC898C-8CC5-44F2-822D-05C5625E95C8","f510",0,"templarian","science,weather"),
				"thought-bubble":new icon("46ACA864-4B1C-4DBD-94FB-7A0D6B9A500E","f7f5",0,"templarian","other","","",2046),
				"thought-bubble-outline":new icon("2C82E0CA-9872-431C-8739-0EA33825EBF7","f7f6",0,"templarian","other","","",2046),
				"thumb-down":new icon("83D606E3-69A1-4583-854D-5C44477D038D","f511"),
				"thumb-down-outline":new icon("00EE8027-00FE-43B8-ACEC-7779E39D6E29","f512",0,"templarian"),
				"thumb-up":new icon("C32E4FC9-F3DC-4C67-81FB-62648E3F1AB5","f513","other","","like"),
				"thumb-up-outline":new icon("BFA3B3A3-0D00-459A-8BDB-DAC2D4233023","f514",0,"templarian"),
				"thumbs-up-down":new icon("C38D6CEC-4D8E-44DB-B704-9A76552733D4","f515"),
				"ticket":new icon("18F55984-07FD-4630-BB11-8285F83AA838","f516",0),
				"ticket-account":new icon("DE2E8A6C-33F1-4148-A228-C512C26B3159","f517",0,"templarian","users,other","","person,user"),
				"ticket-confirmation":new icon("F19DA1EC-CBDA-456E-BC19-F03C635C886F","f518",0),
				"ticket-percent":new icon("297864D0-935F-4EF0-9A2C-28F018544581","f723",0,"greenturtwig","other","coupon","voucher",1836),
				"tie":new icon("475062F1-407D-43B6-8FBF-1E0D4C7D690C","f519",0,"templarian"),
				"tilde":new icon("708986EE-2BC9-401D-8ACD-0BC5A3E20EA3","f724",0,"mririgo","characters","","accent",1836),
				"timelapse":new icon("348DB89A-B4E2-4CB9-A7A4-B86973243ADE","f51a",0,"google","time","","clock"),
				"timer":new icon("017E0965-CD2E-4B39-B0C5-410335848B12","f51b",0,"google","time","","stopwatch"),
				"timer-10":new icon("BDC89918-A38F-41C6-997E-DE9F779D4435","f51c",0,"google","time","","ten,seconds"),
				"timer-3":new icon("3DEFEFB6-57CE-4C82-9D0C-16DBDBEF5950","f51d",0,"google","time","","three,seconds"),
				"timer-off":new icon("BE74C70B-7E47-4E25-957C-C83CFEB73D6D","f51e",0,"google","time","","stopwatch"),
				"timer-sand":new icon("64EFBA89-F8CB-4193-8656-A83CCBC66A76","f51f",0,"templarian","time","hourglass","",0,1932),
				"timer-sand-empty":new icon("DD31FFF2-A93B-41F5-BA6C-1732E8A8DEFF","f6ac",0,"google","time","hourglass-empty","",1712,1932),
				"timer-sand-full":new icon("E603301B-7DF4-43C2-9035-0DDB2A50B88E","f78b",0,"google","time","hourglass-full","",1932),
				"timetable":new icon("F06ED6E0-0EB1-4B39-8E85-1A82A273F473","f520",0,"templarian","time"),
				"toggle-switch":new icon("D1AD4F4E-3CFE-4F51-932D-D3942A26C418","f521",0,"r3volution11"),
				"toggle-switch-off":new icon("A54ADA14-0917-432E-9288-3364FBAEBCE2","f522",0,"r3volution11"),
				"tooltip":new icon("D6AD70EE-33F4-4C3A-8ED1-3CD3236222F8","f523",1,"templarian"),
				"tooltip-edit":new icon("C1684CDD-9C71-4A10-B3BA-5B26706B3B28","f524",0,"templarian"),
				"tooltip-image":new icon("1DF33E50-EBEA-4A62-8455-84C28271C8D2","f525",0,"templarian"),
				"tooltip-outline":new icon("C14A3C70-357F-4AE8-963C-B45ED543A4DB","f526",0,"templarian"),
				"tooltip-outline-plus":new icon("CAA5F3A3-2044-48AC-94CA-04899F9459ED","f527",0,"templarian"),
				"tooltip-text":new icon("B608ACE2-279D-4C66-9169-32BD86BDF5F3","f528",1,"templarian"),
				"tooth":new icon("BFD05B50-CF42-49C4-B76D-447DB0AEFEEE","f529",0,"infanf","places,science","","",1554),
				"tor":new icon("1771EA83-96FC-4A06-8A03-E4048C9F9C27","f52a",0,"templarian","logos"),
				"tower-beach":new icon("70D21CFE-DC3C-4615-9524-4CD2F2FDC44E","f680",0,"thunsaker","places","","",1712),
				"tower-fire":new icon("11E0C03B-7522-4247-B0D3-F04AE1ECB166","f681",0,"thunsaker","places","","",1712),
				"trackpad":new icon("C06AFD8C-C769-41B1-8E5C-355CE5DBEE8E","f7f7",0,"templarian","tech",_,_,2046),
				"traffic-light":new icon("073B4489-5787-432C-9D10-50B270182D34","f52b",0,"google","travel"),
				"train":new icon("B6E1232A-3A43-4200-BE34-1BC436B34BF1","f52c",0,"google","travel"),
				"tram":new icon("13AE3C37-5323-4FE6-86F7-3B30B635969F","f52d",0,"r3volution11","travel","","",0,1932),
				"transcribe":new icon("6DD88A18-582D-400D-A5AB-12996F26A05D","f52e",0,"templarian"),
				"transcribe-close":new icon("2D2FB32D-B253-4D3E-BA04-7AD5D5FE2C2E","f52f",0,"templarian"),
				"transfer":new icon("D2895587-8DBA-4EDC-8624-3A32C20AB638","f530",0,"templarian","arrows,other"),
				"transit-transfer":new icon("CE6451FA-EF46-40B4-B87B-BCF93DDE6E54","f6ad",0,"google","travel","","",1712),
				"translate":new icon("4486DD26-4110-457E-BBD7-B5D19DF72E4E","f5ca",0,"google","other","language","",1554),
				"treasure-chest":new icon("A0678E6D-C3D3-42AB-B9E7-C1B12D368B70","f725",0,"alexefremo","other","","",1836),
				"tree":new icon("58E298BD-F32E-420D-9E55-BDB44D583AB7","f531",0,"templarian","nature"),
				"trello":new icon("25CA8276-A876-459D-B203-C81C58F88342","f532",0,"templarian","logos"),
				"trending-down":new icon("ACC5BB4D-9439-472F-9DD5-F026FF36D023","f533",0,"google","arrows,other"),
				"trending-neutral":new icon("A39F489B-ABB1-4420-A6DC-20AF0E2CF6DA","f534",0,"google","arrows,other"),
				"trending-up":new icon("4277434D-74AD-48E7-9C5F-BB7226C4FC39","f535",0,"google","arrows,other"),
				"triangle":new icon("78EC62FE-EC63-407F-BCF3-92C441398DDA","f536",1,"xt3000"),
				"triangle-outline":new icon("74A6BF3E-CEC2-40C3-A900-109D5E05E218","f537",0,"xt3000"),
				"trophy":new icon("0B9368A1-FC31-4D0D-8909-C2D44DCC0B83","f538",1,"r3volution11","sport","achievement"),
				"trophy-award":new icon("39F70CE8-5C56-4AAB-A4F7-93F871B1CB96","f539",0,"r3volution11","sport","achievement-award"),
				"trophy-outline":new icon("D7B01958-C212-49B9-B58B-146B4017348C","f53a",0,"xt3000","sport","achievement-outline"),
				"trophy-variant":new icon("C6664923-EE26-4175-90CB-AD87B517F2FF","f53b",0,"r3volution11","sport","achievement-variant"),
				"trophy-variant-outline":new icon("C3A5133F-0462-40DB-863A-3659FC5DFE0E","f53c",0,"xt3000","sport","achievement-variant-outline"),
				"truck":new icon("A0B91DEA-DB9A-4737-B2F4-26B805B88648","f53d",0,"google","travel","","lorry"),
				"truck-delivery":new icon("D0EB091D-C62C-4A93-9AE4-AE942F5738C7","f53e",0,"xt3000","travel,other","","lorry"),
				"truck-fast":new icon("401AC514-6441-4DDC-80DC-48CF851C5B5E","f787",0,"templarian","travel,other","","courier,lorry",1932),
				"truck-trailer":new icon("6F488FA3-B882-443D-8619-0124217E267C","f726",0,"mrgrigri","travel","","",1836),
				"tshirt-crew":new icon("6B67D149-AE33-40CF-997F-C57A7ECB8D42","f53f",0,"templarian"),
				"tshirt-v":new icon("94791D5D-EEC5-4562-98DD-DF285E972EC8","f540",0,"templarian"),
				"tumblr":new icon("B48358A6-983D-4E15-8FE1-905D706A4A4B","f541",0,"google","logos"),
				"tumblr-reblog":new icon("DBC01AAD-8FE1-4668-9E76-7AF716D30C32","f542",0,"templarian"),
				"tune":new icon("B1F7C2ED-4017-4162-A4C7-31D8761D8DC3","f62e",0,"google","tech,player","mixer-settings","equaliser",1650),
				"tune-vertical":new icon("AB147073-9D20-4DA1-A108-3856FC1764C1","f66a",0,"xt3000","tech,player","","equaliser",1650),
				"twitch":new icon("8BA5EB2D-7C4F-4336-8994-20CAA433BB26","f543",0,"templarian","logos"),
				"twitter":new icon("A95F7C7C-DE85-4564-BA65-DEDCF3BE105A","f544",0,"templarian","logos"),
				"twitter-box":new icon("1ADB886B-B791-42BF-AC04-5EB73E665EA6","f545",0,"google","logos","","",0,1932),
				"twitter-circle":new icon("3979C805-4C53-4F45-A6E5-9CAADE1C2D80","f546",0,"templarian","logos"),
				"twitter-retweet":new icon("2788034C-2A06-46C0-82B9-A34CB23C88E0","f547",0,"templarian"),
				"uber":new icon("9B23FB77-FAF2-4F8E-B071-D23726EA8632","f748",0,"sandberg","logos,travel","","taxi",1932),
				"ubuntu":new icon("D0B38B4B-389B-49A8-9797-BE1092231DE9","f548",0,"templarian","logos"),
				"ultra-high-definition":new icon("A7C08392-F82F-4910-8D0F-6A1907AE19E3","f7f8",0,"templarian",_,_,"uhd",2046),
				"umbraco":new icon("EB029748-89CF-4E75-BBC9-9747BEF7AE29","f549",0,"templarian","logos"),
				"umbrella":new icon("6E7A679E-94FE-4BBD-931F-59B9F25B54EE","f54a",0,"xt3000","weather"),
				"umbrella-outline":new icon("7E42C11A-74C3-4C0F-BE6B-9794F343925A","f54b",0,"xt3000","weather"),
				"undo":new icon("C9D6F6DE-E9F7-4AC9-B9F1-41160A4C2B0E","f54c",0),
				"undo-variant":new icon("C262C766-4474-4BC5-AE66-23E5735F86F1","f54d",1,"templarian"),
				"unfold-less-horizontal":new icon("E533CB7E-48C2-4D9D-B935-B51C918703C0","f54e",0,"other","","",0,1932),
				"unfold-less-vertical":new icon("E4DFDADF-60F8-4E90-A501-38381F4346A0","f75f",1,"templarian","other","","",1932),
				"unfold-more-horizontal":new icon("E85F4170-11D3-4757-8247-17EBD07A08D4","f54f",0,"other","","",0,1932),
				"unfold-more-vertical":new icon("AE8D43D2-00EC-46D9-A21C-4D0024A539D7","f760",1,"templarian","other","","",1932),
				"ungroup":new icon("87E56CEE-67B1-427E-9A28-303F8B6D29A7","f550",1,"templarian","editor"),
				"unity":new icon("50CFC57C-9C70-4953-BDC4-F6340EB7A243","f6ae",0,"templarian","logos","","",1712),
				"untappd":new icon("BC7B3CEA-B4D3-4F52-8378-5ACF408A3D9B","f551",0,"templarian","logos"),
				"update":new icon("1B274396-AAE7-4CD8-8D57-27E31D915F68","f6af",0,"google","other","","",1712),
				"upload":new icon("08F8FCE9-67A0-4696-9B83-0B1F11EA959E","f552",1,"google","networking,other"),
				"upload-multiple":new icon("2B1A438E-4795-43D1-B4FD-3997C8E1BA9F",_,0,"mrgrigri","networking,other",_,_,"2.x.x"),
				"upload-network":new icon("B473675B-DF1E-4450-B85E-786B483C9FA4","f6f5",0,"templarian","networking","","",1836,1932),
				"usb":new icon("25033E0B-3AD4-414D-9972-559F2690FC1D","f553",0,"google","networking"),
				"van-passenger":new icon("293262AA-69E7-4D04-B441-AAA13D22C63C","f7f9",0,"greenturtwig","travel",_,_,2046),
				"van-utility":new icon("517A8F96-14C9-4FAB-8AC2-27321C91E1BF","f7f9",0,"greenturtwig","travel","van-candy",_,2046),
				"vanish":new icon("437A175D-CA2F-44C9-9FA0-A59A43E7C590","f7fb",0,"","other","","",2046),
				"vector-arrange-above":new icon("576A1B80-550B-46BD-90A6-A497D8A29BC5","f554",1,"xt3000","editor"),
				"vector-arrange-below":new icon("C2EC8280-2EFC-44F4-BA6D-89DE72F06CA3","f555",1,"xt3000","editor"),
				"vector-circle":new icon("5C73E245-C6D4-42F0-A5D6-C14F53982661","f556",0,"xt3000","editor"),
				"vector-circle-variant":new icon("D5741976-7530-4859-97C1-F170BCE7C8B3","f557",0,"xt3000","editor"),
				"vector-combine":new icon("7845F254-C78F-44D3-84E3-421B0B2AFF31","f558",1,"xt3000","editor"),
				"vector-curve":new icon("546B7A4F-6D63-46CD-B74D-DEF09CE8D8FB","f559",0,"templarian","editor","","bezier"),
				"vector-difference":new icon("C4CA626C-23C3-495A-A73B-4B55A6FBC1F9","f55a",1,"xt3000","editor"),
				"vector-difference-ab":new icon("9D39AD1D-F643-43EF-B55B-6CF2EC4637EC","f55b",1,"xt3000","editor"),
				"vector-difference-ba":new icon("A327D00A-F451-4B88-AEBA-EA87016806CB","f55c",1,"xt3000","editor"),
				"vector-intersection":new icon("DACB8CA9-A0A9-4766-B1A3-EC334425514A","f55d",1,"xt3000","editor"),
				"vector-line":new icon("8C2D4FBB-00B1-4815-971F-03F0788093C2","f55e",0,"xt3000","editor"),
				"vector-point":new icon("C8B18CF5-BD7E-41FC-A653-6B46D85F982A","f55f",0,"templarian","editor"),
				"vector-polygon":new icon("6CD0A5FB-8FB8-45E7-9955-A876E4B2ABB4","f560",0,"xt3000","editor"),
				"vector-polyline":new icon("1D1C3847-C645-42AE-A93C-DE1E64685762","f561",0,"xt3000","editor"),
				"vector-radius":new icon("1B112A31-E2A7-4BAD-B1F1-5289B8811F08","f749",0,"templarian","editor","","",1932),
				"vector-rectangle":new icon("2A12555B-0CBC-4FC9-9F86-88F7785B3B2C","f5c6",0,"templarian","editor","","",1554),
				"vector-selection":new icon("B7C380C9-13D8-4A0E-8EEC-1B4FB23F1FB9","f562",0,"xt3000","editor"),
				"vector-square":new icon("039be9b8-08ad-11e4-bf19-842b2b6cfe1b","f001",0,"templarian","editor"),
				"vector-triangle":new icon("CE6EAE27-922A-48B9-83AF-5C333B20724F","f563",0,"xt3000","editor"),
				"vector-union":new icon("2FD284B6-3DC1-4733-B08E-BAD459E87B87","f564",1,"xt3000","editor"),
				"venmo":new icon("B68F24D9-0E45-4729-9DB9-46E0D73589F2",/*"f578"*/_,0,"templarian","logos",_,_,"2.x.x"),
				"verified":new icon("FC112FD8-5338-49C0-B4E0-FE1816A71E74","f565",0,_,_,"shield-check"),
				"vibrate":new icon("68E64FD4-A020-4DEF-B2CB-5EA5BAA80E42","f566",0),
				"video":new icon("B1337ECC-EF1F-481B-9E75-6A8DB7A01BB9","f567",0),
				"video-3d":new icon("3F4D3E00-72CA-4167-A269-F9DD1A94540D","f7fc",0,"templarian",_,_,_,2046),
				"video-off":new icon("F4C3A814-205E-4F0A-9B3D-34B5777A4237","f568",0),
				"video-switch":new icon("465D18D8-ABEA-4D2B-8A05-C6555C36803F","f569",0),
				"view-agenda":new icon("E0B1CD58-0403-430F-AA9A-30B9E0122314","f56a",0),
				"view-array":new icon("B3E07750-AF3A-49FA-BA72-7CE5D4A3C7AB","f56b",0),
				"view-carousel":new icon("99C269BA-B1CD-4BC0-9BCC-7C5D95F881AC","f56c",0),
				"view-column":new icon("163CB77E-4663-4F8E-B73E-20FCC5C5BED3","f56d",0),
				"view-dashboard":new icon("B6D8B213-DC5F-40D3-97E4-EFA9B499A19D","f56e"),
				"view-day":new icon("AD31242E-143E-475E-822B-E363C9E9F2F4","f56f",0),
				"view-grid":new icon("E788F50B-B654-4AEC-ACD7-6E9F5AE8B789","f570",0,"xt3000"),
				"view-headline":new icon("86DC0560-F109-4301-ACC7-46A6F74F441A","f571",0),
				"view-list":new icon("D9FCEB1D-004D-442E-A979-320101768F99","f572",0),
				"view-module":new icon("467C52AB-0DEA-43AF-BAE4-76FD66D6C7F0","f573"),
				"view-parallel":new icon("A085C7C7-F5C5-441C-84C0-05EB3B6A8767","f727",0,"mririgo","other","","",1836),
				"view-quilt":new icon("F3640F38-D10F-42C8-8A68-751D965B1F65","f574",0),
				"view-sequential":new icon("350F115F-0C20-4AB3-8206-81D2A25A2EF4","f728",0,"mririgo","other","","",1836),
				"view-stream":new icon("1B42A4BC-3B55-4C21-BDEF-94DC970012F9","f575",0),
				"view-week":new icon("8ED74862-BA7D-43FC-91EA-283D655B451F","f576",0),
				"vimeo":new icon("0FF21C45-66B4-492A-829C-9F46778323A9","f577",0,"templarian","logos"),
				"vine":new icon("B68F24D9-0E45-4729-9DB9-46E0D73589F2","f578",0,"templarian","logos"),
				"violin":new icon("D6702650-990F-416E-BF27-F6F2B86BFB8D","f60f",0,"google","other","","",1554),
				"visualstudio":new icon("E009DA08-136C-465C-8481-308E99BCA3BF","f610",0,"infanf","logos","","",1554),
				"vk":new icon("9098736F-D298-4724-AE04-6BEA124F3854","f579",0,"templarian","logos","vkontakte"),
				"vk-box":new icon("9BDEAB2C-8D25-43FA-9722-9FD68D21E76A","f57a",0,"krambertech","logos","","vkontakte"),
				"vk-circle":new icon("00E657E0-F05A-423A-813F-3DC14C5E6439","f57b",0,"krambertech","logos","","vkontakte"),
				"vlc":new icon("3695CD89-BCB2-4D10-A8C5-9190F31F7C92","f57c",0,"infanf","logos,travel","","cone",1554),
				"voice":new icon("F1EEA910-2CD7-448A-A12F-A1BD0FDC6010","f5cb",0,"google","users,other","","",1554),
				"voicemail":new icon("04CEF7C6-E77F-4A66-89F3-2F5B544C482B","f57d",0),
				"volume-high":new icon("CE6E08CF-2476-4BBB-AF91-6D081F1CBEF9","f57e",1,"google","player"),
				"volume-low":new icon("213621FE-E003-4B40-9385-B9BCE19DB035","f57f",0,"google","player"),
				"volume-medium":new icon("0E37E506-8AD8-42C7-87E4-F8A2AEE03972","f580",0,"google","player"),
				"volume-minus":new icon("D8BFD10F-6D55-4EE1-8D30-5B5CB064CBBF","f75d",1,"templarian","player","","down",1932),
				"volume-mute":new icon("A78C1259-0DB5-4793-9EA9-DD69FEB337A8","f75e",1,"templarian","player","","off",1932),
				"volume-off":new icon("74834C94-6AE1-493B-A9FB-4EE2A8FD989C","f581",1,"google","player","mute"),
				"volume-plus":new icon("DECF3A51-F972-4D34-815D-D103BCE3888B","f75c",1,"templarian","player","","up",1932),
				"vpn":new icon("A9EE1532-2932-4F71-95DC-1EFB56BA4DFC","f582",0,"templarian","networking","","virtual,private,network"),
				"vuejs":new icon("CB3BC222-1858-41C6-A488-0C2BB1FB2EA8",_,0,"templarian","logos,other",_,_,"2.x.x"),
				"walk":new icon("DA42DA16-21E0-4A08-89E4-F634EBBCF85A","f583",0,"google","sport,travel,other","","walker,walking"),
				"wall":new icon("5DAB0112-3768-4ADC-8796-A88B4473FE56","f7fd",0,"templarian",_,_,"bricks",2046),
				"wallet":new icon("C5ABA786-D897-4770-AA78-CE4CB2A9230E","f584",0,"google","money"),
				"wallet-giftcard":new icon("0D4DD4F1-0915-4D3D-8F21-A96C2DDAF6E0","f585",0,"google","money"),
				"wallet-membership":new icon("BBE325B3-416A-4160-8E95-162B076B8839","f586",0),
				"wallet-travel":new icon("790A03D3-B40A-468A-A6D6-CA3679FDBD8D","f587",0,"google","money,travel"),
				"wan":new icon("0E468855-81AF-4CA1-ACF0-D166D07F188C","f588",0,"xt3000","networking"),
				"washing-machine":new icon("42C06A23-81D5-4EF6-8CFA-B4FBF66E7B17","f729",0,"google","places,other","","laundrette,laundry",1836),
				"watch":new icon("3389F6CD-3E46-47DE-B26A-341C1B65D6BF","f589",0,"google","time"),
				"watch-export":new icon("4FAFD079-50D1-4FD3-9427-CF0C08148D84","f58a",0,"templarian","time"),
				"watch-import":new icon("0D93B47F-C9F9-4C87-B63C-656184A87C74","f58b",0,"templarian","time"),
				"watch-vibrate":new icon("AE556BFC-A1A0-4B42-9123-B48DC7A3CBF3","f6b0",0,"templarian","time","","",1712,1836),
				"water":new icon("17EEE663-92E4-4AB1-87FE-94F2CD296C4B","f58c",0,"google","science"),
				"water-off":new icon("6C9777A0-967D-4242-91B2-E4D6B5596498","f58d",0,"google","science"),
				"water-percent":new icon("2CE24A47-D798-4FFD-A53D-65FE9D452E2F","f58e",0,"xt3000","science","humidity"),
				"water-pump":new icon("06862D93-608A-4B21-9193-83FA8C6BBDCD","f58f",0,"templarian","places"),
				"waves":new icon("547979BF-6FF4-4CFF-BD55-1E5793C9DAA3","f78c",0,"xt3000","other","","",1932),
				"watermark":new icon("20907A4A-11CA-447E-A4F5-D0F0901D197E","f612",0,"google","other","","",1554),
				"weather-cloudy":new icon("9286B6B3-09EE-4465-9A70-D7874E26F3DF","f590",0,"templarian","weather"),
				"weather-fog":new icon("9E1AC9CA-0FA4-44C6-BA5D-2EB3CED4899D","f591",0,"templarian","weather"),
				"weather-hail":new icon("BED775CF-13BD-4D5A-A06F-7B026E820CB1","f592",0,"templarian","weather"),
				"weather-lightning":new icon("6AF7BD8A-088F-4B07-806D-7456EB382D76","f593",0,"templarian","weather"),
				"weather-lightning-rainy":new icon("F69033FD-E6F0-48E7-ADA7-7CDF71B1673C","f67d",0,"templarian","weather","","",1712),
				"weather-night":new icon("1C3BA3AB-E86E-481B-A3C2-867B37A6E55A","f594",0,"templarian","weather"),
				"weather-partlycloudy":new icon("80E6A6FB-1524-4A7D-9551-17D3BDFBD7C5","f595",0,"templarian","weather"),
				"weather-pouring":new icon("220955AA-770D-4884-A2ED-F21D2DC2CCDA","f596",0,"templarian","weather"),
				"weather-rainy":new icon("45EF5E01-7499-4964-A897-5602F45A822E","f597",0,"templarian","weather"),
				"weather-snowy":new icon("88999373-43C5-4851-BBCF-5335D8DFBDA0","f598",0,"templarian","weather"),
				"weather-snowy-rainy":new icon("0938BCD1-BCF8-4439-B6B3-A590150878BC","f67e",0,"templarian","weather","","",1712),
				"weather-sunny":new icon("7F85265E-304C-4575-A73F-F0FCF0CA951B","f599",0,"templarian","nature,weather"),
				"weather-sunset":new icon("5EF29669-A342-46D1-AE1B-47917E44311D","f59a",0,"templarian","weather","","sunrise"),
				"weather-sunset-down":new icon("032B7D10-9218-4B71-B190-C486832BEF61","f59b",0,"templarian","weather"),
				"weather-sunset-up":new icon("AC82F126-0773-44CE-A004-77E7DDD130C9","f59c",0,"templarian","weather","","sunrise"),
				"weather-windy":new icon("7544E7E7-02F7-405C-9ADB-2E2540B07343","f59d",0,"templarian","weather"),
				"weather-windy-variant":new icon("454DE99F-BA48-4A7B-A2C6-C0E162065D10","f59e",0,"templarian","weather"),
				"web":new icon("DA9C32CA-8C31-4462-B123-479169C31587","f59f",0,"google","networking,other"),
				"webcam":new icon("03483AFB-9D53-4E10-B00C-1095C1873276","f5a0",0,"chrislitherland","tech"),
				"webhook":new icon("5B415522-B2A4-4D34-BEE3-D81D607BBD0B","f62f",0,"templarian","other","","",1650),
				"webpack":new icon("65235220-D361-4E99-BEC6-E62B231E4384","f72a",0,"templarian","logos","","",1836),
				"wechat":new icon("31CBB823-2223-40D5-BCF7-470F91159757","f611",0,"infanf","logos","","",1554),
				"weight":new icon("F5DECC39-2E4C-4574-B141-832DFBA8CB43","f5a1",0,"templarian","science"),
				"weight-kilogram":new icon("5EDFF36D-4C8E-4B8D-BE3F-76C27DB804DF","f5a2",0,"templarian","science","","kg"),
				"whatsapp":new icon("C58497CE-5E84-483C-9C85-3007ADF9BC9A","f5a3",0,"templarian","logos"),
				"wheelchair-accessibility":new icon("FB4E1390-EFB1-4364-B6EE-F936C5715163","f5a4",0,"r3volution11"),
				"white-balance-auto":new icon("2FE12EF0-B5CE-4ADB-9B1B-3F796F0EDE0E","f5a5",0),
				"white-balance-incandescent":new icon("4464050A-1A97-46CF-BBA5-CE52D600CB45","f5a6",0),
				"white-balance-iridescent":new icon("E88B06D9-C60D-4084-9AE9-742266F0E8FB","f5a7",0),
				"white-balance-sunny":new icon("7DCAB3C3-C32F-483D-98F1-1728919AA17B","f5a8",0,"google","nature,weather,other"),
				"widgets":new icon("419C0A49-C751-4204-8C82-7E43B0896BD9","f72b",0,"google","other","","",1836),
				"wifi":new icon("E77CF681-7DD0-4EDF-AA35-0DB80790BC03","f5a9",1,"templarian","networking"),
				"wifi-off":new icon("A7CAE187-B853-41DD-9D8D-FB9A28C3F764","f5aa",0,"xt3000","networking"),
				"wii":new icon("AA2F2BCF-A9BD-4B3A-83A4-880E518F9428","f5ab",0,"templarian","logos","","nintendo"),
				"wiiu":new icon("7D322B2B-5B7D-46B4-ACC3-A8900CFED5C9","f72c",0,"greenturtwig","logos","","nintendo",1836),
				"wikipedia":new icon("19DE621D-F082-42B5-9FD3-FEF8D84A2BB9","f5ac",0,"templarian","logos"),
				"window-close":new icon("0CB92EB7-2EE0-401C-9113-7D52E78DB51E","f5ad",0,"templarian","characters,other"),
				"window-closed":new icon("42DDDE71-7AA4-4A61-98F5-2A3B0AD486FF","f5ae",0,"templarian"),
				"window-maximize":new icon("AB365770-45CF-44AC-941E-8E1396FAF428","f5af",0,"templarian"),
				"window-minimize":new icon("C329F2CA-AC52-45CD-87D7-253AB115D47F","f5b0",0,"templarian"),
				"window-open":new icon("5617DB90-FDD7-4909-B322-D1EC44EB1372","f5b1",0,"templarian"),
				"window-restore":new icon("405C8463-0E67-48A3-B824-7C5E74423125","f5b2",0,"templarian"),
				"windows":new icon("6E06B49E-5127-4D5A-9C8B-F58BA8943BC4","f5b3",0,"templarian","logos","","microsoft"),
				"wordpress":new icon("0059A2CA-E266-4A57-9EE8-4520B7330D5C","f5b4",0,"templarian","logos","","",0,2046),
				"worker":new icon("54665F14-32CD-41E3-B5C5-0E9ABDD3A317","f5b5",0,"templarian"),
				"wrap":new icon("79D47101-F8CB-496B-99B0-957DADED5D44","f5b6",0,"r3volution11","editor"),
				"wrench":new icon("CACAAE64-D38D-423E-8C84-68EFF0EA0F8A","f5b7",0),
				"wunderlist":new icon("5D5E7753-B3F1-4D0C-B175-62749D448492","f5b8",0,"templarian","logos"),
				"xamarin":new icon("958B8A8B-A4D7-45A4-8C80-39F7140443C0",_,0,"_selectlol","logos",_,_,"2.x.x"),
				"xamarin-outline":new icon("7016027D-C32A-4462-A9E5-98132FA518B4",_,0,"_selectlol","logos",_,_,"2.x.x"),
				"xaml":new icon("1AC4596D-76B2-4F11-AF23-157736CABB86","f673",0,"templarian","other","","",1650),
				"xbox":new icon("B7B4ECD9-2895-4E36-88A9-5F3AC5D6C264","f5b9",0,"templarian","logos","","microsoft"),
				"xbox-controller":new icon("74BB58AC-EF8B-447C-A15D-C444F1F67D93","f5ba",0,"templarian"),
				"xbox-controller-battery-alert":new icon("57F11EDC-2759-4D62-BDD2-C7C3F5199623","f74a",0,"templarian","other","","",1932),
				"xbox-controller-battery-empty":new icon("51BB7455-5893-4F47-92D1-B3FD408C2ADC","f74b",0,"templarian","other","","",1932),
				"xbox-controller-battery-full":new icon("CC73B4E7-6B14-459D-AED5-35E50655C05C","f74c",0,"templarian","other","","",1932),
				"xbox-controller-battery-low":new icon("B65873D1-4808-4C3C-8AD6-A242D61B1985","f74d",0,"templarian","other","","",1932),
				"xbox-controller-battery-medium":new icon("2B434E26-4ECE-4654-BBDC-4FE13CCCEE3E","f74e",0,"templarian","other","","",1932),
				"xbox-controller-battery-unknown":new icon("9CC18C3C-57B6-470C-9F09-80B62ECFABD7","f74f",0,"templarian","other","","",1932),
				"xbox-controller-off":new icon("F73FF165-CE6C-4E27-B492-93F3B82C70EE","f5bb",0,"templarian"),
				"xda":new icon("9A7A9F69-9BC4-4619-981D-DF8423A22FF2","f5bc",0,"templarian","logos"),
				"xing":new icon("496476A3-F614-4925-90E6-3BB83C1C4E37","f5bd",0,"xt3000","logos"),
				"xing-box":new icon("5415674F-E6F6-433D-9A9F-E976FD7245F8","f5be",0,"xt3000","logos"),
				"xing-circle":new icon("7F545D3A-5E66-42D4-88AB-8A2BD817D731","f5bf",0,"xt3000","logos"),
				"xml":new icon("994C18D8-DAF1-4311-A30B-CD93F5ADC233","f5c0",1,"templarian"),
				"xmpp":new icon("F2F74E7E-9EC8-4748-AF3B-A14D6158770D","f7fe",0,"","logos,other",_,_,2046),
				"yammer":new icon("B74213B2-B220-4D15-AFA5-CAE0E40D6CFE","f788",0,"mrgrigri","logos","","",1932),
				"yeast":new icon("17C0DA66-AB24-4935-A928-26BE13FDC3C0","f5c1",0,"templarian"),
				"yelp":new icon("C43C676A-F2BE-489A-8613-BE6EF651F0AC","f5c2",0,"xt3000","logos"),
				"yin-yang":new icon("068670F6-B9DF-40C5-8C50-C9A3953F6201","f67f",0,"templarian","other","","",1712),
				"youtube-creator-studio":new icon("7150F7D3-B162-41DE-80A8-5DFD930EDF1B",_,0,_,"google",_,_,"2.x.x"),
				"youtube-play":new icon("0A078909-90AF-41F5-8E76-CAB565D49AAA","f5c3",0,"google","google"),
				"zip-box":new icon("00A83C35-A726-464B-ACEE-F0D690045C25","f5c4",0,"google","files")
			},
			paths:{
				...
				"alarm-bell":"M15,18.66V22H5V18.66C8.09,20.45 11.91,20.45 15,18.66M22,4A2,2 0 0,0 20,2C19.69,2 19.39,2.07 19.12,2.21C18.82,2.36 18.56,2.58 18.36,2.85C17.72,3.75 17.94,5 18.85,5.64C19.18,5.87 19.59,6 20,6C20.08,6 20.16,6 20.24,6C21.97,10.43 20.66,15.46 17,18.5C16.68,18.75 16.35,19 16,19.22V21H17V19.74C20.14,17.5 22,13.86 22,10C22,8.5 21.72,7 21.17,5.62C21.69,5.24 22,4.64 22,4M18,10A8,8 0 0,1 10,18A8,8 0 0,1 2,10A8,8 0 0,1 10,2A8,8 0 0,1 18,10Z",
				...
				"alarm-light":"M6,6.9L3.87,4.78L5.28,3.37L7.4,5.5L6,6.9M13,1V4H11V1H13M20.13,4.78L18,6.9L16.6,5.5L18.72,3.37L20.13,4.78M4.5,10.5V12.5H1.5V10.5H4.5M19.5,10.5H22.5V12.5H19.5V10.5M6,20H18A2,2 0 0,1 20,22H4A2,2 0 0,1 6,20M12,5A6,6 0 0,1 18,11V19H6V11A6,6 0 0,1 12,5Z",
				...
				"alarm-snooze":"M7.88,3.39L6.6,1.86L2,5.71L3.29,7.24L7.88,3.39M22,5.72L17.4,1.86L16.11,3.39L20.71,7.25L22,5.72M12,4A9,9 0 0,0 3,13A9,9 0 0,0 12,22A9,9 0 0,0 21,13A9,9 0 0,0 12,4M12,20A7,7 0 0,1 5,13A7,7 0 0,1 12,6A7,7 0 0,1 19,13A7,7 0 0,1 12,20M9,11H12.63L9,15.2V17H15V15H11.37L15,10.8V9H9V11Z",
				...
				"alert-octagram":"M2.2,16.06L3.88,12L2.2,7.94L6.26,6.26L7.94,2.2L12,3.88L16.06,2.2L17.74,6.26L21.8,7.94L20.12,12L21.8,16.06L17.74,17.74L16.06,21.8L12,20.12L7.94,21.8L6.26,17.74L2.2,16.06M13,17V15H11V17H13M13,13V7H11V13H13Z",
				"alert-outline":"M12,2L1,21H23M12,6L19.53,19H4.47M11,10V14H13V10M11,16V18H13V16",
				"all-inclusive":"M18.6,6.62C17.16,6.62 15.8,7.18 14.83,8.15L7.8,14.39C7.16,15.03 6.31,15.38 5.4,15.38C3.53,15.38 2,13.87 2,12C2,10.13 3.53,8.62 5.4,8.62C6.31,8.62 7.16,8.97 7.84,9.65L8.97,10.65L10.5,9.31L9.22,8.2C8.2,7.18 6.84,6.62 5.4,6.62C2.42,6.62 0,9.04 0,12C0,14.96 2.42,17.38 5.4,17.38C6.84,17.38 8.2,16.82 9.17,15.85L16.2,9.61C16.84,8.97 17.69,8.62 18.6,8.62C20.47,8.62 22,10.13 22,12C22,13.87 20.47,15.38 18.6,15.38C17.7,15.38 16.84,15.03 16.16,14.35L15,13.34L13.5,14.68L14.78,15.8C15.8,16.81 17.15,17.37 18.6,17.37C21.58,17.37 24,14.96 24,12C24,9 21.58,6.62 18.6,6.62Z",
				...
				"angularjs":"M12,2.5L20.84,5.65L19.5,17.35L12,21.5L4.5,17.35L3.16,5.65L12,2.5M12,4.5L5,7L6.08,16.22L12,19.5L17.92,16.22L19,7L12,4.5M12,5.72L16.58,16H14.87L13.94,13.72H10.04L9.12,16H7.41L12,5.72M13.34,12.3L12,9.07L10.66,12.3H13.34Z",
				...
				"approval":"M23,12L20.56,9.22L20.9,5.54L17.29,4.72L15.4,1.54L12,3L8.6,1.54L6.71,4.72L3.1,5.53L3.44,9.21L1,12L3.44,14.78L3.1,18.47L6.71,19.29L8.6,22.47L12,21L15.4,22.46L17.29,19.28L20.9,18.46L20.56,14.78L23,12M10,17L6,13L7.41,11.59L10,14.17L16.59,7.58L18,9L10,17Z",
				...
				"arrow-collapse-all":"M19.5,3.09L20.91,4.5L16.41,9H20V11H13V4H15V7.59L19.5,3.09M20.91,19.5L19.5,20.91L15,16.41V20H13V13H20V15H16.41L20.91,19.5M4.5,3.09L9,7.59V4H11V11H4V9H7.59L3.09,4.5L4.5,3.09M3.09,19.5L7.59,15H4V13H11V20H9V16.41L4.5,20.91L3.09,19.5Z",
				"arrow-collapse-down":"M19.92,12.08L12,20L4.08,12.08L5.5,10.67L11,16.17V2H13V16.17L18.5,10.66L19.92,12.08M12,20H2V22H22V20H12Z",
				"arrow-collapse-left":"M11.92,19.92L4,12L11.92,4.08L13.33,5.5L7.83,11H22V13H7.83L13.34,18.5L11.92,19.92M4,12V2H2V22H4V12Z",
				"arrow-collapse-right":"M12.08,4.08L20,12L12.08,19.92L10.67,18.5L16.17,13H2V11H16.17L10.67,5.5L12.08,4.08M20,12V22H22V2H20V12Z",
				"arrow-collapse-up":"M4.08,11.92L12,4L19.92,11.92L18.5,13.33L13,7.83V22H11V7.83L5.5,13.33L4.08,11.92M12,4H22V2H2V4H12Z",
				"arrow-down":"M11,4H13V16L18.5,10.5L19.92,11.92L12,19.84L4.08,11.92L5.5,10.5L11,16V4Z",
				"arrow-down-bold":"M9,4H15V12H19.84L12,19.84L4.16,12H9V4Z",
				"arrow-down-bold-box":"M5,3H19A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3M12,17L17,12H14V8H10V12H7L12,17Z",
				"arrow-down-bold-box-outline":"M12,17L7,12H10V8H14V12H17L12,17M5,3H19A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3M5,5V19H19V5H5Z",
				...
				"arrow-down-box":"M3,5A2,2 0 0,1 5,3H19A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5C3.89,21 3,20.1 3,19V5M11,6V14.5L7.5,11L6.08,12.42L12,18.34L17.92,12.42L16.5,11L13,14.5V6H11Z",
				...
				"arrow-down-thick":"M10,4H14V13L17.5,9.5L19.92,11.92L12,19.84L4.08,11.92L6.5,9.5L10,13V4Z",
				...
				"arrow-expand-down":"M22,4V2H2V4H11V18.17L5.5,12.67L4.08,14.08L12,22L19.92,14.08L18.5,12.67L13,18.17V4H22Z",
				...
				"arrow-expand-up":"M2,20V22H22V20H13V5.83L18.5,11.33L19.92,9.92L12,2L4.08,9.92L5.5,11.33L11,5.83V20H2Z",
				"arrow-left":"M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z",
				"arrow-left-bold":"M20,9V15H12V19.84L4.16,12L12,4.16V9H20Z",
				"arrow-left-bold-box":"M21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3H19A2,2 0 0,1 21,5M7,12L12,17V14H16V10H12V7L7,12Z",
				"arrow-left-bold-box-outline":"M7,12L12,7V10H16V14H12V17L7,12M21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3H19A2,2 0 0,1 21,5M19,5H5V19H19V5Z",
				...
				"arrow-left-thick":"M20,10V14H11L14.5,17.5L12.08,19.92L4.16,12L12.08,4.08L14.5,6.5L11,10H20Z",
				"arrow-right":"M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z",
				"arrow-right-bold":"M4,15V9H12V4.16L19.84,12L12,19.84V15H4Z",
				"arrow-right-bold-box":"M3,19V5A2,2 0 0,1 5,3H19A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19M17,12L12,7V10H8V14H12V17L17,12Z",
				"arrow-right-bold-box-outline":"M17,12L12,17V14H8V10H12V7L17,12M3,19V5A2,2 0 0,1 5,3H19A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19M5,19H19V5H5V19Z",
				...
				"arrow-right-box":"M5,21A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3H19A2,2 0 0,1 21,5V19C21,20.11 20.1,21 19,21H5M6,13H14.5L11,16.5L12.42,17.92L18.34,12L12.42,6.08L11,7.5L14.5,11H6V13Z",
				...
				"arrow-right-thick":"M4,10V14H13L9.5,17.5L11.92,19.92L19.84,12L11.92,4.08L9.5,6.5L13,10H4Z",
				...
				"arrow-up-bold":"M15,20H9V12H4.16L12,4.16L19.84,12H15V20Z",
				"arrow-up-bold-box":"M19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3H19A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21M12,7L7,12H10V16H14V12H17L12,7Z",
				"arrow-up-bold-box-outline":"M12,7L17,12H14V16H10V12H7L12,7M19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3H19A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21M19,19V5H5V19H19Z",
				...
				"arrow-up-box":"M21,19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3H19C20.11,3 21,3.9 21,5V19M13,18V9.5L16.5,13L17.92,11.58L12,5.66L6.08,11.58L7.5,13L11,9.5V18H13Z",
				...
				"baby-buggy":"M13,2V10H21A8,8 0 0,0 13,2M19.32,15.89C20.37,14.54 21,12.84 21,11H6.44L5.5,9H2V11H4.22C4.22,11 6.11,15.07 6.34,15.42C5.24,16 4.5,17.17 4.5,18.5A3.5,3.5 0 0,0 8,22C9.76,22 11.22,20.7 11.46,19H13.54C13.78,20.7 15.24,22 17,22A3.5,3.5 0 0,0 20.5,18.5C20.5,17.46 20.04,16.53 19.32,15.89M8,20A1.5,1.5 0 0,1 6.5,18.5A1.5,1.5 0 0,1 8,17A1.5,1.5 0 0,1 9.5,18.5A1.5,1.5 0 0,1 8,20M17,20A1.5,1.5 0 0,1 15.5,18.5A1.5,1.5 0 0,1 17,17A1.5,1.5 0 0,1 18.5,18.5A1.5,1.5 0 0,1 17,20Z",
				...
				"battery-charging-wireless":"M13,4H11V2H5V4H3A1,1 0 0,0 2,5V21A1,1 0 0,0 3,22H13A1,1 0 0,0 14,21V5A1,1 0 0,0 13,4M20.07,4.93L18.66,6.34C21.79,9.46 21.79,14.53 18.66,17.66L20.07,19.07C23.97,15.17 23.97,8.84 20.07,4.93M17.24,7.76L15.83,9.17C17.39,10.73 17.39,13.26 15.83,14.83L17.24,16.24C19.58,13.9 19.58,10.1 17.24,7.76Z",
				"battery-charging-wireless-10":"M20.07,4.93L18.66,6.34C21.79,9.46 21.79,14.53 18.66,17.66L20.07,19.07C23.97,15.17 23.97,8.84 20.07,4.93M17.24,7.76L15.83,9.17C17.39,10.73 17.39,13.26 15.83,14.83L17.24,16.24C19.58,13.9 19.58,10.1 17.24,7.76M13,4H11V2H5V4H3A1,1 0 0,0 2,5V21A1,1 0 0,0 3,22H13A1,1 0 0,0 14,21V5A1,1 0 0,0 13,4M12,18.5H4V6H12V18.5Z",
				"battery-charging-wireless-20":"M20.07,4.93L18.66,6.34C21.79,9.46 21.79,14.53 18.66,17.66L20.07,19.07C23.97,15.17 23.97,8.84 20.07,4.93M17.24,7.76L15.83,9.17C17.39,10.73 17.39,13.26 15.83,14.83L17.24,16.24C19.58,13.9 19.58,10.1 17.24,7.76M13,4H11V2H5V4H3A1,1 0 0,0 2,5V21A1,1 0 0,0 3,22H13A1,1 0 0,0 14,21V5A1,1 0 0,0 13,4M12,17H4V6H12V17Z",
				"battery-charging-wireless-30":"M20.07,4.93L18.66,6.34C21.79,9.46 21.79,14.53 18.66,17.66L20.07,19.07C23.97,15.17 23.97,8.84 20.07,4.93M17.24,7.76L15.83,9.17C17.39,10.73 17.39,13.26 15.83,14.83L17.24,16.24C19.58,13.9 19.58,10.1 17.24,7.76M13,4H11V2H5V4H3A1,1 0 0,0 2,5V21A1,1 0 0,0 3,22H13A1,1 0 0,0 14,21V5A1,1 0 0,0 13,4M12,16H4V6H12V16Z",
				"battery-charging-wireless-40":"M20.07,4.93L18.66,6.34C21.79,9.46 21.79,14.53 18.66,17.66L20.07,19.07C23.97,15.17 23.97,8.84 20.07,4.93M17.24,7.76L15.83,9.17C17.39,10.73 17.39,13.26 15.83,14.83L17.24,16.24C19.58,13.9 19.58,10.1 17.24,7.76M13,4H11V2H5V4H3A1,1 0 0,0 2,5V21A1,1 0 0,0 3,22H13A1,1 0 0,0 14,21V5A1,1 0 0,0 13,4M12,14.5H4V6H12V14.5Z",
				"battery-charging-wireless-50":"M20.07,4.93L18.66,6.34C21.79,9.46 21.79,14.53 18.66,17.66L20.07,19.07C23.97,15.17 23.97,8.84 20.07,4.93M17.24,7.76L15.83,9.17C17.39,10.73 17.39,13.26 15.83,14.83L17.24,16.24C19.58,13.9 19.58,10.1 17.24,7.76M13,4H11V2H5V4H3A1,1 0 0,0 2,5V21A1,1 0 0,0 3,22H13A1,1 0 0,0 14,21V5A1,1 0 0,0 13,4M12,13H4V6H12V13Z",
				"battery-charging-wireless-60":"M20.07,4.93L18.66,6.34C21.79,9.46 21.79,14.53 18.66,17.66L20.07,19.07C23.97,15.17 23.97,8.84 20.07,4.93M17.24,7.76L15.83,9.17C17.39,10.73 17.39,13.26 15.83,14.83L17.24,16.24C19.58,13.9 19.58,10.1 17.24,7.76M13,4H11V2H5V4H3A1,1 0 0,0 2,5V21A1,1 0 0,0 3,22H13A1,1 0 0,0 14,21V5A1,1 0 0,0 13,4M12,11.6H4V6H12V11.6Z",
				"battery-charging-wireless-70":"M20.07,4.93L18.66,6.34C21.79,9.46 21.79,14.53 18.66,17.66L20.07,19.07C23.97,15.17 23.97,8.84 20.07,4.93M17.24,7.76L15.83,9.17C17.39,10.73 17.39,13.26 15.83,14.83L17.24,16.24C19.58,13.9 19.58,10.1 17.24,7.76M13,4H11V2H5V4H3A1,1 0 0,0 2,5V21A1,1 0 0,0 3,22H13A1,1 0 0,0 14,21V5A1,1 0 0,0 13,4M12,10H4V6H12V10Z",
				"battery-charging-wireless-80":"M20.07,4.93L18.66,6.34C21.79,9.46 21.79,14.53 18.66,17.66L20.07,19.07C23.97,15.17 23.97,8.84 20.07,4.93M17.24,7.76L15.83,9.17C17.39,10.73 17.39,13.26 15.83,14.83L17.24,16.24C19.58,13.9 19.58,10.1 17.24,7.76M13,4H11V2H5V4H3A1,1 0 0,0 2,5V21A1,1 0 0,0 3,22H13A1,1 0 0,0 14,21V5A1,1 0 0,0 13,4M12,9H4V6H12V9Z",
				"battery-charging-wireless-90":"M20.07,4.93L18.66,6.34C21.79,9.46 21.79,14.53 18.66,17.66L20.07,19.07C23.97,15.17 23.97,8.84 20.07,4.93M17.24,7.76L15.83,9.17C17.39,10.73 17.39,13.26 15.83,14.83L17.24,16.24C19.58,13.9 19.58,10.1 17.24,7.76M13,4H11V2H5V4H3A1,1 0 0,0 2,5V21A1,1 0 0,0 3,22H13A1,1 0 0,0 14,21V5A1,1 0 0,0 13,4M12,7.5H4V6H12V7.5Z",
				"battery-charging-wireless-alert":"M13,4H11V2H5V4H3A1,1 0 0,0 2,5V21A1,1 0 0,0 3,22H13A1,1 0 0,0 14,21V5A1,1 0 0,0 13,4M9,18H7V16H9V18M9,14H7V9H9V14M20.07,4.93L18.66,6.34C21.79,9.46 21.79,14.53 18.66,17.66L20.07,19.07C23.97,15.17 23.97,8.84 20.07,4.93M17.24,7.76L15.83,9.17C17.39,10.73 17.39,13.26 15.83,14.83L17.24,16.24C19.58,13.9 19.58,10.1 17.24,7.76Z",
				"battery-charging-wireless-outline":"M20.07,4.93L18.66,6.34C21.79,9.46 21.79,14.53 18.66,17.66L20.07,19.07C23.97,15.17 23.97,8.84 20.07,4.93M17.24,7.76L15.83,9.17C17.39,10.73 17.39,13.26 15.83,14.83L17.24,16.24C19.58,13.9 19.58,10.1 17.24,7.76M13,4H11V2H5V4H3A1,1 0 0,0 2,5V21A1,1 0 0,0 3,22H13A1,1 0 0,0 14,21V5A1,1 0 0,0 13,4M12,20H4V6H12V20Z",
				...
				"beaker":"M3,3H21V5A2,2 0 0,0 19,7V19A2,2 0 0,1 17,21H7A2,2 0 0,1 5,19V7A2,2 0 0,0 3,5V3M7,5V7H12V8H7V9H10V10H7V11H10V12H7V13H12V14H7V15H10V16H7V19H17V5H7Z",
				"beats":"M7,12A5,5 0 0,0 12,17A5,5 0 0,0 17,12A5,5 0 0,0 12,7C10.87,7 9.84,7.37 9,8V2.46C9.95,2.16 10.95,2 12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12C2,8.3 4,5.07 7,3.34V12M12,9A3,3 0 0,1 15,12A3,3 0 0,1 12,15A3,3 0 0,1 9,12A3,3 0 0,1 12,9Z",
				...
				"book-secure":"M18,2H12V9L9.5,7.5L7,9V2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V4A2,2 0 0,0 18,2M18,20H10V16H11V15A3,3 0 0,1 14,12A3,3 0 0,1 17,15V16H18V20M15,15V16H13V15A1,1 0 0,1 14,14A1,1 0 0,1 15,15Z",
				"book-unsecure":"M18,2H12V9L9.5,7.5L7,9V2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V4A2,2 0 0,0 18,2M18,20H10V16H11V14A3,3 0 0,1 14,11A3,3 0 0,1 17,14H15A1,1 0 0,0 14,13A1,1 0 0,0 13,14V16H18V20Z",
				...
				"bow-tie":"M15,14L21,17V7L15,10V14M9,14L3,17V7L9,10V14M10,10H14V14H10V10Z",
				...
				"camera-burst":"M1,5H3V19H1V5M5,5H7V19H5V5M22,5H10A1,1 0 0,0 9,6V18A1,1 0 0,0 10,19H22A1,1 0 0,0 23,18V6A1,1 0 0,0 22,5M11,17L13.5,13.85L15.29,16L17.79,12.78L21,17H11Z",
				...
				"cancel":"M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A8,8 0 0,0 4,12C4,13.85 4.63,15.55 5.68,16.91L16.91,5.68C15.55,4.63 13.85,4 12,4M12,20A8,8 0 0,0 20,12C20,10.15 19.37,8.45 18.32,7.09L7.09,18.32C8.45,19.37 10.15,20 12,20Z",
				...
				"caravan":"M4,4A2,2 0 0,0 2,6V17H4A3,3 0 0,0 7,20A3,3 0 0,0 10,17H22V15H19V6A2,2 0 0,0 17,4H4M5,9H9V12H5V9M12,9H16V15H12V9M7,16A1,1 0 0,1 8,17A1,1 0 0,1 7,18A1,1 0 0,1 6,17A1,1 0 0,1 7,16Z",
				...
				"cards-variant":"M5,2H19A1,1 0 0,1 20,3V13A1,1 0 0,1 19,14H5A1,1 0 0,1 4,13V3A1,1 0 0,1 5,2M6,4V12H18V4H6M20,17A1,1 0 0,1 19,18H5A1,1 0 0,1 4,17V16H20V17M20,21A1,1 0 0,1 19,22H5A1,1 0 0,1 4,21V20H20V21Z",
				...
				"cast-off":"M1.6,1.27L0.25,2.75L1.41,3.8C1.16,4.13 1,4.55 1,5V8H3V5.23L18.2,19H14V21H20.41L22.31,22.72L23.65,21.24M6.5,3L8.7,5H21V16.14L23,17.95V5C23,3.89 22.1,3 21,3M1,10V12A9,9 0 0,1 10,21H12C12,14.92 7.08,10 1,10M1,14V16A5,5 0 0,1 6,21H8A7,7 0 0,0 1,14M1,18V21H4A3,3 0 0,0 1,18Z",
				...
				"cellphone-wireless":"M20.07,4.93C21.88,6.74 23,9.24 23,12C23,14.76 21.88,17.26 20.07,19.07L18.66,17.66C20.11,16.22 21,14.22 21,12C21,9.79 20.11,7.78 18.66,6.34L20.07,4.93M17.24,7.76C18.33,8.85 19,10.35 19,12C19,13.65 18.33,15.15 17.24,16.24L15.83,14.83C16.55,14.11 17,13.11 17,12C17,10.89 16.55,9.89 15.83,9.17L17.24,7.76M13,10A2,2 0 0,1 15,12A2,2 0 0,1 13,14A2,2 0 0,1 11,12A2,2 0 0,1 13,10M11.5,1A2.5,2.5 0 0,1 14,3.5V8H12V4H3V19H12V16H14V20.5A2.5,2.5 0 0,1 11.5,23H3.5A2.5,2.5 0 0,1 1,20.5V3.5A2.5,2.5 0 0,1 3.5,1H11.5Z",
				...
				"chart-line-stacked":"M17.45,15.18L22,6.81V19L22,21H2V3H4V15.54L4,19H4.31L6,19H6.57L10.96,11.44L17.45,15.18M22,3L21.97,3.45L17,11L10,6L6,12V3H22Z",
				"chart-line-variant":"M3.5,18.5L9.5,12.5L13.5,16.5L22,6.92L20.59,5.5L13.5,13.5L9.5,9.5L2,17L3.5,18.5Z",
				...
				"clipboard-flow":"M19,4H14.82C14.25,2.44 12.53,1.64 11,2.2C10.14,2.5 9.5,3.16 9.18,4H5A2,2 0 0,0 3,6V20A2,2 0 0,0 5,22H19A2,2 0 0,0 21,20V6A2,2 0 0,0 19,4M12,4A1,1 0 0,1 13,5A1,1 0 0,1 12,6A1,1 0 0,1 11,5A1,1 0 0,1 12,4M10,17H8V10H5L9,6L13,10H10V17M15,20L11,16H14V9H16V16H19L15,20Z",
				...
				"clipboard-plus":"M9,4A3,3 0 0,1 12,1A3,3 0 0,1 15,4H19A2,2 0 0,1 21,6V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V6A2,2 0 0,1 5,4H9M12,3A1,1 0 0,0 11,4A1,1 0 0,0 12,5A1,1 0 0,0 13,4A1,1 0 0,0 12,3M13,12V9H11V12H8V14H11V17H13V14H16V12H13Z",
				...
				"close-outline":"M3,16.74L7.76,12L3,7.26L7.26,3L12,7.76L16.74,3L21,7.26L16.24,12L21,16.74L16.74,21L12,16.24L7.26,21L3,16.74M12,13.41L16.74,18.16L18.16,16.74L13.41,12L18.16,7.26L16.74,5.84L12,10.59L7.26,5.84L5.84,7.26L10.59,12L5.84,16.74L7.26,18.16L12,13.41Z",
				...
				"cloud-braces":"M6,20A6,6 0 0,1 0,14C0,10.91 2.34,8.36 5.35,8.04C6.6,5.64 9.11,4 12,4C15.63,4 18.66,6.58 19.35,10C21.95,10.19 24,12.36 24,15A5,5 0 0,1 19,20H6M18.5,12H18A1,1 0 0,1 17,11V10A2,2 0 0,0 15,8H13.5V10H15V11A2,2 0 0,0 17,13A2,2 0 0,0 15,15V16H13.5V18H15A2,2 0 0,0 17,16V15A1,1 0 0,1 18,14H18.5V12M5.5,12V14H6A1,1 0 0,1 7,15V16A2,2 0 0,0 9,18H10.5V16H9V15A2,2 0 0,0 7,13A2,2 0 0,0 9,11V10H10.5V8H9A2,2 0 0,0 7,10V11A1,1 0 0,1 6,12H5.5Z",
				...
				"cloud-tags":"M6,20A6,6 0 0,1 0,14C0,10.91 2.34,8.36 5.35,8.04C6.6,5.64 9.11,4 12,4C15.63,4 18.66,6.58 19.35,10C21.95,10.19 24,12.36 24,15A5,5 0 0,1 19,20H6M9.09,8.4L4.5,13L9.09,17.6L10.5,16.18L7.32,13L10.5,9.82L9.09,8.4M14.91,8.4L13.5,9.82L16.68,13L13.5,16.18L14.91,17.6L19.5,13L14.91,8.4Z",
				...
				"code-tags-check":"M6.59,3.41L2,8L6.59,12.6L8,11.18L4.82,8L8,4.82L6.59,3.41M12.41,3.41L11,4.82L14.18,8L11,11.18L12.41,12.6L17,8L12.41,3.41M21.59,11.59L13.5,19.68L9.83,16L8.42,17.41L13.5,22.5L23,13L21.59,11.59Z",
				...
				"coffee-outline":"M2,21V19H20V21H2M20,8V5H18V8H20M20,3A2,2 0 0,1 22,5V8A2,2 0 0,1 20,10H18V13A4,4 0 0,1 14,17H8A4,4 0 0,1 4,13V3H20M16,5H6V13A2,2 0 0,0 8,15H14A2,2 0 0,0 16,13V5Z",
				...
				"coins":"M15,4A8,8 0 0,1 23,12A8,8 0 0,1 15,20A8,8 0 0,1 7,12A8,8 0 0,1 15,4M15,18A6,6 0 0,0 21,12A6,6 0 0,0 15,6A6,6 0 0,0 9,12A6,6 0 0,0 15,18M3,12C3,14.61 4.67,16.83 7,17.65V19.74C3.55,18.85 1,15.73 1,12C1,8.27 3.55,5.15 7,4.26V6.35C4.67,7.17 3,9.39 3,12Z",
				...
				"contacts":"M20,0H4V2H20V0M4,24H20V22H4V24M20,4H4A2,2 0 0,0 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6A2,2 0 0,0 20,4M12,6.75A2.25,2.25 0 0,1 14.25,9A2.25,2.25 0 0,1 12,11.25A2.25,2.25 0 0,1 9.75,9A2.25,2.25 0 0,1 12,6.75M17,17H7V15.5C7,13.83 10.33,13 12,13C13.67,13 17,13.83 17,15.5V17Z",
				...
				"creation":"M19,1L17.74,3.75L15,5L17.74,6.26L19,9L20.25,6.26L23,5L20.25,3.75M9,4L6.5,9.5L1,12L6.5,14.5L9,20L11.5,14.5L17,12L11.5,9.5M19,15L17.74,17.74L15,19L17.74,20.25L19,23L20.25,20.25L23,19L20.25,17.74",
				...
				"credit-card-plus":"M21,18H24V20H21V23H19V20H16V18H19V15H21V18M19,8V6H3V8H19M19,12H3V18H14V20H3C1.89,20 1,19.1 1,18V6C1,4.89 1.89,4 3,4H19A2,2 0 0,1 21,6V13H19V12Z",
				...
				"currency-chf":"M7,3H18V5H9V11H17V13H9V16H11V18H9V21H7V18H5V16H7V3Z",
				"currency-cny":"M11,21V16H6V14H11V13.71L10.16,12H6V10H9.19L5.77,3H8L12,11.2L16,3H18.23L14.81,10H18V12H13.84L13,13.71V14H18V16H13V21H11Z",
				"currency-eth":"M12,1.75L5.75,12.25L12,16L18.25,12.25L12,1.75M5.75,13.5L12,22.25L18.25,13.5L12,17.25L5.75,13.5Z",
				...
				"currency-jpy":"M11,21V16H6V14H11V13.71L10.16,12H6V10H9.19L5.77,3H8L12,11.2L16,3H18.23L14.81,10H18V12H13.84L13,13.71V14H18V16H13V21H11Z",
				"currency-krw":"M2,3H4L5.33,9H9.33L10.67,3H13.33L14.67,9H18.67L20,3H22L20.67,9H22V11H20.22L19.78,13H22V15H19.33L18,21H15.33L14,15H10L8.67,21H6L4.67,15H2V13H4.22L3.78,11H2V9H3.33L2,3M13.11,11H10.89L10.44,13H13.56L13.11,11M7.33,18L8,15H6.67L7.33,18M8.89,11H5.78L6.22,13H8.44L8.89,11M16.67,18L17.33,15H16L16.67,18M18.22,11H15.11L15.56,13H17.78L18.22,11M12,6L11.33,9H12.67L12,6Z",
				...
				"currency-twd":"M3,11H21V13H15V19H21V21H15A2,2 0 0,1 13,19V13H10.35L5.73,21L4,20L8.04,13H3V11M5,3H19V5H5V3Z",
				...
				"decagram":"M23,12L20.56,9.22L20.9,5.54L17.29,4.72L15.4,1.54L12,3L8.6,1.54L6.71,4.72L3.1,5.53L3.44,9.21L1,12L3.44,14.78L3.1,18.47L6.71,19.29L8.6,22.47L12,21L15.4,22.46L17.29,19.28L20.9,18.46L20.56,14.78L23,12Z",
				"decagram-outline":"M23,12L20.56,14.78L20.9,18.46L17.29,19.28L15.4,22.46L12,21L8.6,22.47L6.71,19.29L3.1,18.47L3.44,14.78L1,12L3.44,9.21L3.1,5.53L6.71,4.72L8.6,1.54L12,3L15.4,1.54L17.29,4.72L20.9,5.54L20.56,9.22L23,12M20.33,12L18.5,9.89L18.74,7.1L16,6.5L14.58,4.07L12,5.18L9.42,4.07L8,6.5L5.26,7.09L5.5,9.88L3.67,12L5.5,14.1L5.26,16.9L8,17.5L9.42,19.93L12,18.81L14.58,19.92L16,17.5L18.74,16.89L18.5,14.1L20.33,12Z",
				...
				"delete-circle":"M12,2C17.53,2 22,6.47 22,12C22,17.53 17.53,22 12,22C6.47,22 2,17.53 2,12C2,6.47 6.47,2 12,2M17,7H14.5L13.5,6H10.5L9.5,7H7V9H17V7M9,18H15A1,1 0 0,0 16,17V10H8V17A1,1 0 0,0 9,18Z",
				"delete-empty":"M20.37,8.91L19.37,10.64L7.24,3.64L8.24,1.91L11.28,3.66L12.64,3.29L16.97,5.79L17.34,7.16L20.37,8.91M6,19V7H11.07L18,11V19A2,2 0 0,1 16,21H8A2,2 0 0,1 6,19Z",
				...
				"desktop-classic":"M6,2C4.89,2 4,2.89 4,4V12C4,13.11 4.89,14 6,14H18C19.11,14 20,13.11 20,12V4C20,2.89 19.11,2 18,2H6M6,4H18V12H6V4M4,15C2.89,15 2,15.89 2,17V20C2,21.11 2.89,22 4,22H20C21.11,22 22,21.11 22,20V17C22,15.89 21.11,15 20,15H4M8,17H20V20H8V17M9,17.75V19.25H13V17.75H9M15,17.75V19.25H19V17.75H15Z",
				...
				"developer-board":"M22,9V7H20V5A2,2 0 0,0 18,3H4A2,2 0 0,0 2,5V19A2,2 0 0,0 4,21H18A2,2 0 0,0 20,19V17H22V15H20V13H22V11H20V9H22M18,19H4V5H18V19M6,13H11V17H6V13M12,7H16V10H12V7M6,7H11V12H6V7M12,11H16V17H12V11Z",
				...
				"dip-switch":"M3,4H7A1,1 0 0,1 8,5V19A1,1 0 0,1 7,20H3A1,1 0 0,1 2,19V5A1,1 0 0,1 3,4M10,4H14A1,1 0 0,1 15,5V19A1,1 0 0,1 14,20H10A1,1 0 0,1 9,19V5A1,1 0 0,1 10,4M17,4H21A1,1 0 0,1 22,5V19A1,1 0 0,1 21,20H17A1,1 0 0,1 16,19V5A1,1 0 0,1 17,4M4,18H6V13H4V18M11,11H13V6H11V11M18,18H20V13H18V18Z",
				...
				"do-not-disturb":"M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M17,13H7V11H17V13Z",
				"do-not-disturb-off":"M17,11V13H15.54L20.22,17.68C21.34,16.07 22,14.11 22,12A10,10 0 0,0 12,2C9.89,2 7.93,2.66 6.32,3.78L13.54,11H17M2.27,2.27L1,3.54L3.78,6.32C2.66,7.93 2,9.89 2,12A10,10 0 0,0 12,22C14.11,22 16.07,21.34 17.68,20.22L20.46,23L21.73,21.73L2.27,2.27M7,13V11H8.46L10.46,13H7Z",
				...
				"dots-horizontal-circle":"M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,10.5A1.5,1.5 0 0,0 10.5,12A1.5,1.5 0 0,0 12,13.5A1.5,1.5 0 0,0 13.5,12A1.5,1.5 0 0,0 12,10.5M6.5,10.5A1.5,1.5 0 0,0 5,12A1.5,1.5 0 0,0 6.5,13.5A1.5,1.5 0 0,0 8,12A1.5,1.5 0 0,0 6.5,10.5M17.5,10.5A1.5,1.5 0 0,0 16,12A1.5,1.5 0 0,0 17.5,13.5A1.5,1.5 0 0,0 19,12A1.5,1.5 0 0,0 17.5,10.5Z",
				...
				"dots-vertical-circle":"M2,12A10,10 0 0,1 12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12M10.5,12A1.5,1.5 0 0,0 12,13.5A1.5,1.5 0 0,0 13.5,12A1.5,1.5 0 0,0 12,10.5A1.5,1.5 0 0,0 10.5,12M10.5,17.5A1.5,1.5 0 0,0 12,19A1.5,1.5 0 0,0 13.5,17.5A1.5,1.5 0 0,0 12,16A1.5,1.5 0 0,0 10.5,17.5M10.5,6.5A1.5,1.5 0 0,0 12,8A1.5,1.5 0 0,0 13.5,6.5A1.5,1.5 0 0,0 12,5A1.5,1.5 0 0,0 10.5,6.5Z",
				"douban":"M20,6H4V4H20V6M20,18V20H4V18H7.33L6.26,14H5V8H19V14H17.74L16.67,18H20M7,12H17V10H7V12M9.4,18H14.6L15.67,14H8.33L9.4,18Z",
				"download":"M5,20H19V18H5M19,9H15V3H9V9H5L12,16L19,9Z",
				"download-network":"M17,3A2,2 0 0,1 19,5V15A2,2 0 0,1 17,17H13V19H14A1,1 0 0,1 15,20H22V22H15A1,1 0 0,1 14,23H10A1,1 0 0,1 9,22H2V20H9A1,1 0 0,1 10,19H11V17H7C5.89,17 5,16.1 5,15V5A2,2 0 0,1 7,3H17M12,14.5L16.5,10H13V6H11V10H7.5L12,14.5Z",
				...
				"elephant":"M19.5,15.5A0.5,0.5 0 0,1 19,16A0.5,0.5 0 0,1 18.5,15.5V8.5C18.5,6.57 16.43,5 14.5,5H6A4,4 0 0,0 2,9V19H6V15H11V19H15V14.5A0.5,0.5 0 0,1 15.5,14A0.5,0.5 0 0,1 16,14.5V16A3,3 0 0,0 19,19A3,3 0 0,0 22,16V14H19.5V15.5Z",
				...
				"email-alert":"M16,9V7L10,11L4,7V9L10,13L16,9M16,5A2,2 0 0,1 18,7V16A2,2 0 0,1 16,18H4C2.89,18 2,17.1 2,16V7A2,2 0 0,1 4,5H16M20,12V7H22V12H20M20,16V14H22V16H20Z",
				...
				"email-outline":"M4,4H20A2,2 0 0,1 22,6V18A2,2 0 0,1 20,20H4C2.89,20 2,19.1 2,18V6C2,4.89 2.89,4 4,4M12,11L20,6H4L12,11M4,18H20V8.37L12,13.36L4,8.37V18Z",
				...
				"emoticon-dead":"M12,2C6.47,2 2,6.47 2,12C2,17.53 6.47,22 12,22A10,10 0 0,0 22,12C22,6.47 17.5,2 12,2M12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20M16.18,7.76L15.12,8.82L14.06,7.76L13,8.82L14.06,9.88L13,10.94L14.06,12L15.12,10.94L16.18,12L17.24,10.94L16.18,9.88L17.24,8.82L16.18,7.76M7.82,12L8.88,10.94L9.94,12L11,10.94L9.94,9.88L11,8.82L9.94,7.76L8.88,8.82L7.82,7.76L6.76,8.82L7.82,9.88L6.76,10.94L7.82,12M12,14C9.67,14 7.69,15.46 6.89,17.5H17.11C16.31,15.46 14.33,14 12,14Z",
				...
				"emoticon-excited":"M12,2C6.47,2 2,6.47 2,12C2,17.53 6.47,22 12,22A10,10 0 0,0 22,12C22,6.47 17.5,2 12,2M12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20M13,9.94L14.06,11L15.12,9.94L16.18,11L17.24,9.94L15.12,7.82L13,9.94M8.88,9.94L9.94,11L11,9.94L8.88,7.82L6.76,9.94L7.82,11L8.88,9.94M12,17.5C14.33,17.5 16.31,16.04 17.11,14H6.89C7.69,16.04 9.67,17.5 12,17.5Z",
				...
				"eye-off-outline":"M2,5.27L3.28,4L20,20.72L18.73,22L15.65,18.92C14.5,19.3 13.28,19.5 12,19.5C7,19.5 2.73,16.39 1,12C1.69,10.24 2.79,8.69 4.19,7.46L2,5.27M12,9A3,3 0 0,1 15,12C15,12.35 14.94,12.69 14.83,13L11,9.17C11.31,9.06 11.65,9 12,9M12,4.5C17,4.5 21.27,7.61 23,12C22.18,14.08 20.79,15.88 19,17.19L17.58,15.76C18.94,14.82 20.06,13.54 20.82,12C19.17,8.64 15.76,6.5 12,6.5C10.91,6.5 9.84,6.68 8.84,7L7.3,5.47C8.74,4.85 10.33,4.5 12,4.5M3.18,12C4.83,15.36 8.24,17.5 12,17.5C12.69,17.5 13.37,17.43 14,17.29L11.72,15C10.29,14.85 9.15,13.71 9,12.28L5.6,8.87C4.61,9.72 3.78,10.78 3.18,12Z",
				...
				"fan-off":"M12.5,2C9.64,2 8.57,4.55 9.29,7.47L15,13.16C15.87,13.37 16.81,13.81 17.28,14.73C18.46,17.1 22.03,17 22.03,12.5C22.03,8.92 18.05,8.13 14.35,10.13C14.03,9.73 13.61,9.42 13.13,9.22C13.32,8.29 13.76,7.24 14.75,6.75C17.11,5.57 17,2 12.5,2M3.28,4L2,5.27L4.47,7.73C3.22,7.74 2,8.87 2,11.5C2,15.07 5.96,15.85 9.65,13.87C9.97,14.27 10.4,14.59 10.89,14.79C10.69,15.71 10.25,16.75 9.27,17.24C6.91,18.42 7,22 11.5,22C13.8,22 14.94,20.36 14.94,18.21L18.73,22L20,20.72L3.28,4Z",
				"fast-forward":"M13,6V18L21.5,12M4,18L12.5,12L4,6V18Z",
				"fast-forward-outline":"M15,9.9L18,12L15,14.1V9.9M6,9.9L9,12L6,14.1V9.9M13,6V18L21.5,12L13,6M4,6V18L12.5,12L4,6Z",
				...
				"file-account":"M13,9H18.5L13,3.5V9M6,2H14L20,8V20A2,2 0 0,1 18,22H6C4.89,22 4,21.1 4,20V4C4,2.89 4.89,2 6,2M14,20V19C14,17.67 11.33,17 10,17C8.67,17 6,17.67 6,19V20H14M10,12A2,2 0 0,0 8,14A2,2 0 0,0 10,16A2,2 0 0,0 12,14A2,2 0 0,0 10,12Z",
				...
				"file-percent":"M14,2L20,8V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V4A2,2 0 0,1 6,2H14M7.37,20L15,12.35L13.65,11L6,18.65L7.37,20M13,9H18.5L13,3.5V9M7.5,11A1.5,1.5 0 0,0 6,12.5A1.5,1.5 0 0,0 7.5,14A1.5,1.5 0 0,0 9,12.5A1.5,1.5 0 0,0 7.5,11M13.5,17A1.5,1.5 0 0,0 12,18.5A1.5,1.5 0 0,0 13.5,20A1.5,1.5 0 0,0 15,18.5A1.5,1.5 0 0,0 13.5,17Z",
				"file-plus":"M13,9H18.5L13,3.5V9M6,2H14L20,8V20A2,2 0 0,1 18,22H6C4.89,22 4,21.1 4,20V4C4,2.89 4.89,2 6,2M11,15V12H9V15H6V17H9V20H11V17H14V15H11Z",
				...
				"flag-variant-outline":"M6,3A1,1 0 0,1 7,4V4.88C8.06,4.44 9.5,4 11,4C14,4 14,6 16,6C19,6 20,4 20,4V12C20,12 19,14 16,14C13,14 13,12 11,12C8,12 7,14 7,14V21H5V4A1,1 0 0,1 6,3M7,7.25V11.5C7,11.5 9,10 11,10C13,10 14,12 16,12C18,12 18,11 18,11V7.5C18,7.5 17,8 16,8C14,8 13,6 11,6C9,6 7,7.25 7,7.25Z",
				...
				"floor-plan":"M10,5V10H9V5H5V13H9V12H10V17H9V14H5V19H12V17H13V19H19V17H21V21H3V3H21V15H19V10H13V15H12V9H19V5H10Z",
				...
				"folder-star":"M20,6H12L10,4H4A2,2 0 0,0 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V8A2,2 0 0,0 20,6M17.94,17L15,15.28L12.06,17L12.84,13.67L10.25,11.43L13.66,11.14L15,8L16.34,11.14L19.75,11.43L17.16,13.67L17.94,17Z",
				...
				"font-awesome":"M6,3A2.5,2.5 0 0,1 8.5,5.5C8.5,6.53 7.88,7.41 7,7.79V8.66C8.11,8.36 9.72,8 11,8C12.15,8 12.89,8.22 13.54,8.42C14.13,8.6 14.65,8.75 15.5,8.75C17.13,8.75 18.4,8.18 18.54,8.11C18.68,8.04 18.84,8 19,8A1,1 0 0,1 20,9V17C20,17.38 19.79,17.72 19.45,17.89C19.38,17.93 17.71,18.75 15.5,18.75C14.39,18.75 13.45,18.55 12.54,18.35C11.69,18.17 10.89,18 10,18C8.85,18 7.67,18.39 7,18.66V22H5V7.79C4.12,7.41 3.5,6.53 3.5,5.5A2.5,2.5 0 0,1 6,3Z",
				...
				"food-croissant":"M22,19L19,17L22,15V19M15,15L19,9L22,13L18,16L15,15M5,17L2,19V15L5,17M9,15L6,16L2,13L5,9L9,15M14,6L18,8L13,15H11L6,8L10,6H14Z",
				...
				"forklift":"M6,4V11H4C2.89,11 2,11.89 2,13V17A3,3 0 0,0 5,20A3,3 0 0,0 8,17H10A3,3 0 0,0 13,20A3,3 0 0,0 16,17V13L12,4H6M17,5V19H22V17.5H18.5V5H17M7.5,5.5H11.2L14.5,13H7.5V5.5M5,15.5A1.5,1.5 0 0,1 6.5,17A1.5,1.5 0 0,1 5,18.5A1.5,1.5 0 0,1 3.5,17A1.5,1.5 0 0,1 5,15.5M13,15.5A1.5,1.5 0 0,1 14.5,17A1.5,1.5 0 0,1 13,18.5A1.5,1.5 0 0,1 11.5,17A1.5,1.5 0 0,1 13,15.5Z",
				"format-align-bottom":"M13,9L15.5,6.5L16.92,7.92L12,12.84L7.08,7.92L8.5,6.5L11,9V3H13V9M3,15H21V17H3V15M3,19H13V21H3V19Z",
				...
				"format-align-middle":"M13,6L15,4L16.42,5.42L12,9.84L7.58,5.42L9,4L11,6V2H13V6M3,11H21V13H3V11M13,18V22H11V18L9,20L7.58,18.58L12,14.16L16.42,18.58L15,20L13,18Z",
				"format-align-right":"M3,3H21V5H3V3M9,7H21V9H9V7M3,11H21V13H3V11M9,15H21V17H9V15M3,19H21V21H3V19Z",
				"format-align-top":"M13,15L15.5,17.5L16.92,16.08L12,11.16L7.08,16.08L8.5,17.5L11,15V21H13V15M3,3H21V5H3V3M3,7H13V9H3V7Z",
				...
				"format-color-text":"M9.62,12L12,5.67L14.37,12M11,3L5.5,17H7.75L8.87,14H15.12L16.25,17H18.5L13,3H11Z",
				...
				"format-font":"M17,8H20V20H21V21H17V20H18V17H14L12.5,20H14V21H10V20H11L17,8M18,9L14.5,16H18V9M5,3H10C11.11,3 12,3.89 12,5V16H9V11H6V16H3V5C3,3.89 3.89,3 5,3M6,5V9H9V5H6Z",
				...
				"format-page-break":"M7,11H9V13H7V11M11,11H13V13H11V11M19,17H15V11.17L21,17.17V22H3V13H5V20H19V17M3,2H21V11H19V4H5V11H3V2Z",
				...
				"format-pilcrow":"M10,11A4,4 0 0,1 6,7A4,4 0 0,1 10,3H18V5H16V21H14V5H12V21H10V11Z",
				...
				"garage-open":"M19,20H17V11H7V20H5V9L12,5L19,9V20M8,12H16V14H8V12Z",
				...
				"glassdoor":"M8,2A3,3 0 0,0 5,5V16.5H8V5H19A3,3 0 0,0 16,2H8M16,7.5V19H5A3,3 0 0,0 8,22H16A3,3 0 0,0 19,19V7.5H16Z",
				...
				"gondola":"M18,10H13V7.59L22.12,6.07L21.88,4.59L16.41,5.5C16.46,5.35 16.5,5.18 16.5,5A1.5,1.5 0 0,0 15,3.5A1.5,1.5 0 0,0 13.5,5C13.5,5.35 13.63,5.68 13.84,5.93L13,6.07V5H11V6.41L10.41,6.5C10.46,6.35 10.5,6.18 10.5,6A1.5,1.5 0 0,0 9,4.5A1.5,1.5 0 0,0 7.5,6C7.5,6.36 7.63,6.68 7.83,6.93L1.88,7.93L2.12,9.41L11,7.93V10H6C4.89,10 4,10.9 4,12V18A2,2 0 0,0 6,20H18A2,2 0 0,0 20,18V12A2,2 0 0,0 18,10M6,12H8.25V16H6V12M9.75,16V12H14.25V16H9.75M18,16H15.75V12H18V16Z",
				"google":"M21.35,11.1H12.18V13.83H18.69C18.36,17.64 15.19,19.27 12.19,19.27C8.36,19.27 5,16.25 5,12C5,7.9 8.2,4.73 12.2,4.73C15.29,4.73 17.1,6.7 17.1,6.7L19,4.72C19,4.72 16.56,2 12.1,2C6.42,2 2.03,6.8 2.03,12C2.03,17.05 6.16,22 12.25,22C17.6,22 21.5,18.33 21.5,12.91C21.5,11.76 21.35,11.1 21.35,11.1V11.1Z",
				"google-analytics":"M19,3A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H17L15,21V9L15,5A2,2 0 0,1 17,3H19M5,21A2,2 0 0,1 3,19V17A2,2 0 0,1 5,15H9V11A2,2 0 0,1 11,9H14.5V21H5Z",
				"google-assistant":"M8,3A6,6 0 0,1 14,9A6,6 0 0,1 8,15A6,6 0 0,1 2,9A6,6 0 0,1 8,3M21,8A1,1 0 0,1 22,9A1,1 0 0,1 21,10A1,1 0 0,1 20,9A1,1 0 0,1 21,8M17.5,10A2.5,2.5 0 0,1 20,12.5A2.5,2.5 0 0,1 17.5,15A2.5,2.5 0 0,1 15,12.5A2.5,2.5 0 0,1 17.5,10M17.5,16A3,3 0 0,1 20.5,19A3,3 0 0,1 17.5,22A3,3 0 0,1 14.5,19A3,3 0 0,1 17.5,16Z",
				...
				"google-keep":"M4,2H20A2,2 0 0,1 22,4V17.33L17.33,22H4A2,2 0 0,1 2,20V4A2,2 0 0,1 4,2M17,17V20.25L20.25,17H17M10,19H14V18H15V13C16.21,12.09 17,10.64 17,9A5,5 0 0,0 12,4A5,5 0 0,0 7,9C7,10.64 7.79,12.09 9,13V18H10V19M14,17H10V16H14V17M14,15H10V14H14V15M12,5A4,4 0 0,1 16,9C16,10.5 15.2,11.77 14,12.46V13H10V12.46C8.8,11.77 8,10.5 8,9A4,4 0 0,1 12,5Z",
				...
				"google-nearby":"M21.36,10.46L13.54,2.64C12.69,1.79 11.31,1.79 10.46,2.64L2.64,10.46C1.79,11.31 1.79,12.69 2.64,13.54L10.46,21.36C11.31,22.21 12.69,22.21 13.54,21.36L21.36,13.54C22.21,12.69 22.21,11.31 21.36,10.46M12,19L5,12L12,5L19,12L12,19M16.5,12L12,16.5L7.5,12L12,7.5L16.5,12Z",
				...
				"google-photos":"M17,12V7L12,2V7H7L2,12H7V17L12,22V17H17L22,12H17M12.88,12.88L12,15.53L11.12,12.88L8.47,12L11.12,11.12L12,8.46L12.88,11.11L15.53,12L12.88,12.88Z",
				...
				"google-wallet":"M15.44,2.56H20.24C20.24,2.56 23.12,11.36 20.24,21.5H15.5C15.5,21.5 15.12,16.8 13.28,12.8C13.28,12.8 12.5,16.08 11.6,18H6.72C6.72,18 5.76,13.44 2.5,9.5H7.28C7.28,9.5 8.16,10.4 8.88,11.6C8.88,11.6 9.5,9.12 9.5,6H14.32C14.32,6 15.92,8.32 16.64,9.76C16.64,9.76 16.4,6.24 15.44,2.56Z",
				"gradient":"M11,9H13V11H11V9M9,11H11V13H9V11M13,11H15V13H13V11M15,9H17V11H15V9M7,9H9V11H7V9M19,3H5A2,2 0 0,0 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5A2,2 0 0,0 19,3M9,18H7V16H9V18M13,18H11V16H13V18M17,18H15V16H17V18M19,11H17V13H19V15H17V13H15V15H13V13H11V15H9V13H7V15H5V13H7V11H5V5H19V11Z",
				...
				"grid-large":"M4,2H20A2,2 0 0,1 22,4V20A2,2 0 0,1 20,22H4C2.92,22 2,21.1 2,20V4A2,2 0 0,1 4,2M4,4V11H11V4H4M4,20H11V13H4V20M20,20V13H13V20H20M20,4H13V11H20V4Z",
				...
				"guitar-acoustic":"M19.59,3H22V5H20.41L16.17,9.24C15.8,8.68 15.32,8.2 14.76,7.83L19.59,3M12,8A4,4 0 0,1 16,12C16,13.82 14.77,15.42 13,15.87V16A5,5 0 0,1 8,21A5,5 0 0,1 3,16A5,5 0 0,1 8,11H8.13C8.58,9.24 10.17,8 12,8M12,10.5A1.5,1.5 0 0,0 10.5,12A1.5,1.5 0 0,0 12,13.5A1.5,1.5 0 0,0 13.5,12A1.5,1.5 0 0,0 12,10.5M6.94,14.24L6.23,14.94L9.06,17.77L9.77,17.06L6.94,14.24Z",
				"guitar-electric":"M19.59,3H22V5H20.41L15.12,10.29L13.71,8.9L19.59,3M12,9C12.26,9 12.5,9.1 12.71,9.3L14.71,11.3C14.89,11.5 15,11.73 15,12L14.9,12.4L10.9,20.4C10.71,20.75 10.36,20.93 10,20.93C9.65,20.93 9.29,20.75 9.11,20.4L7.25,16.7L3.55,14.9C3.18,14.7 3,14.35 3,14C3,13.65 3.18,13.3 3.55,13.1L11.55,9.1C11.69,9 11.84,9 12,9M9.35,11.82L8.65,12.5L11.5,15.35L12.18,14.65L9.35,11.82M7.94,13.23L7.23,13.94L10.06,16.77L10.77,16.06L7.94,13.23Z",
				...
				"headphones-off":"M12,1A9,9 0 0,0 3,10V17C3,17.62 3.19,18.19 3.5,18.67L9,13.18V12H5V10A7,7 0 0,1 12,3C14,3 15.77,3.82 17.04,5.14L18.45,3.72C16.82,2.04 14.53,1 12,1M21.22,3.5L3.5,21.22L4.77,22.5L7.27,20H9V18.27L15,12.27V20H18A3,3 0 0,0 21,17V10C21,8.89 20.8,7.82 20.43,6.84L22.5,4.77L21.22,3.5M18.83,8.44C18.94,8.94 19,9.46 19,10V12H15.27L18.83,8.44Z",
				...
				"heart-half":"M13,7.2V17.74L13,20.44L12,21.35L10.55,20.03C5.4,15.36 2,12.27 2,8.5C2,5.41 4.42,3 7.5,3C10,3 13,5 13,7.2Z",
				"heart-half-full":"M16.5,5C15,5 13.58,5.91 13,7.2V17.74C17.25,13.87 20,11.2 20,8.5C20,6.5 18.5,5 16.5,5M16.5,3C19.58,3 22,5.41 22,8.5C22,12.27 18.6,15.36 13.45,20.03L12,21.35L10.55,20.03C5.4,15.36 2,12.27 2,8.5C2,5.41 4.42,3 7.5,3C9.24,3 10.91,3.81 12,5.08C13.09,3.81 14.76,3 16.5,3Z",
				"heart-half-outline":"M4,8.5C4,11.2 6.75,13.87 11,17.74V7.2C10.42,5.91 9,5 7.5,5C5.5,5 4,6.5 4,8.5M13,7.2V17.74L13,20.44L12,21.35L10.55,20.03C5.4,15.36 2,12.27 2,8.5C2,5.41 4.42,3 7.5,3C10,3 13,5 13,7.2Z",
				"heart-off":"M1,4.27L2.28,3L20,20.72L18.73,22L15.18,18.44L13.45,20.03L12,21.35L10.55,20.03C5.4,15.36 2,12.27 2,8.5C2,7.55 2.23,6.67 2.63,5.9L1,4.27M7.5,3C9.24,3 10.91,3.81 12,5.08C13.09,3.81 14.76,3 16.5,3C19.58,3 22,5.41 22,8.5C22,11.07 20.42,13.32 17.79,15.97L5.27,3.45C5.95,3.16 6.7,3 7.5,3Z",
				...
				"high-definition":"M5,7H7V11H9V7H11V17H9V13H7V17H5V7M13,7H16A3,3 0 0,1 19,10V14A3,3 0 0,1 16,17H13V7M16,15A1,1 0 0,0 17,14V10A1,1 0 0,0 16,9H15V15H16Z",
				...
				"home-circle":"M19.07,4.93C17.22,3 14.66,1.96 12,2C9.34,1.96 6.79,3 4.94,4.93C3,6.78 1.96,9.34 2,12C1.96,14.66 3,17.21 4.93,19.06C6.78,21 9.34,22.04 12,22C14.66,22.04 17.21,21 19.06,19.07C21,17.22 22.04,14.66 22,12C22.04,9.34 21,6.78 19.07,4.93M17,12V18H13.5V13H10.5V18H7V12H5L12,5L19.5,12H17Z",
				"home-heart":"M2,12L12,3L22,12H19V20H5V12H2M12,18L12.72,17.34C15.3,15 17,13.46 17,11.57C17,10.03 15.79,8.82 14.25,8.82C13.38,8.82 12.55,9.23 12,9.87C11.45,9.23 10.62,8.82 9.75,8.82C8.21,8.82 7,10.03 7,11.57C7,13.46 8.7,15 11.28,17.34L12,18Z",
				...
				"home-outline":"M9,19V13H11L13,13H15V19H18V10.91L12,4.91L6,10.91V19H9M12,2.09L21.91,12H20V21H13V15H11V21H4V12H2.09L12,2.09Z",
				"home-variant":"M8,20H5V12H2L12,3L22,12H19V20H12V14H8V20M14,14V17H17V14H14Z",
				"hook":"M18,6C18,7.82 16.76,9.41 15,9.86V17A5,5 0 0,1 10,22A5,5 0 0,1 5,17V12L10,17H7A3,3 0 0,0 10,20A3,3 0 0,0 13,17V9.86C11.23,9.4 10,7.8 10,5.97C10,3.76 11.8,2 14,2C16.22,2 18,3.79 18,6M14,8A2,2 0 0,0 16,6A2,2 0 0,0 14,4A2,2 0 0,0 12,6A2,2 0 0,0 14,8Z",
				"hook-off":"M13,9.86V11.18L15,13.18V9.86C17.14,9.31 18.43,7.13 17.87,5C17.32,2.85 15.14,1.56 13,2.11C10.86,2.67 9.57,4.85 10.13,7C10.5,8.4 11.59,9.5 13,9.86M14,4A2,2 0 0,1 16,6A2,2 0 0,1 14,8A2,2 0 0,1 12,6A2,2 0 0,1 14,4M18.73,22L14.86,18.13C14.21,20.81 11.5,22.46 8.83,21.82C6.6,21.28 5,19.29 5,17V12L10,17H7A3,3 0 0,0 10,20A3,3 0 0,0 13,17V16.27L2,5.27L3.28,4L13,13.72L15,15.72L20,20.72L18.73,22Z",
				...
				"hulu":"M19.5,12.8V22H14.7V13.9C14.7,13.2 14.1,12.6 13.4,12.6H10.5C9.8,12.6 9.2,13.2 9.2,13.9V22H4.5V2H9.3V8.4C9.6,8.3 9.9,8.2 10.2,8.2H15C17.5,8.2 19.5,10.3 19.5,12.8Z",
				...
				"humble-bundle":"M11.91,6.4L10.8,7.06C9.53,3.71 11.36,3.5 11.36,3.5C10.2,5.08 11.91,6.4 11.91,6.4M13.45,3.56C14.47,3.56 16.28,5.69 11.41,10.25C6.7,14.67 10.5,15.92 10.5,15.92C8.43,13.73 12.2,11.19 12.2,11.19C12.2,11.19 15,12.54 16,13.13C16.97,13.71 17.6,17.23 16.11,18.96C13.3,22.23 5.74,20.9 4.76,18.25C4.34,17.13 3,13.04 5.7,10.54C7.82,8.67 8.75,9.18 11.78,7.4C15.22,5.38 13.41,3.5 13.45,3.56M2.25,3.14L10.29,7.34L8.35,8.19L1.5,4.61C1.08,4.4 0.92,3.9 1.13,3.5C1.34,3.09 1.84,2.93 2.25,3.14M22.73,13.83C23.14,14.04 23.29,14.54 23.08,14.94C22.87,15.34 22.38,15.5 21.97,15.29L12.63,10.42L13.74,9.14L22.73,13.83Z",
				"ice-cream":"M12,2C14.21,2 16,3.79 16,6.05C17.14,6.28 18,7.29 18,8.5A2.5,2.5 0 0,1 15.5,11H8.5A2.5,2.5 0 0,1 6,8.5C6,7.29 6.86,6.28 8,6A4,4 0 0,1 12,2M9,12H15L13,22H11L9,12Z",
				...
				"inbox":"M19,15H15A3,3 0 0,1 12,18A3,3 0 0,1 9,15H5V5H19M19,3H5C3.89,3 3,3.9 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5A2,2 0 0,0 19,3Z",
				"inbox-arrow-down":"M16,10H14V7H10V10H8L12,14M19,15H15A3,3 0 0,1 12,18A3,3 0 0,1 9,15H5V5H19M19,3H5C3.89,3 3,3.9 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5A2,2 0 0,0 19,3Z",
				"inbox-arrow-up":"M14,14H10V11H8L12,7L16,11H14V14M16,11M5,15V5H19V15H15A3,3 0 0,1 12,18A3,3 0 0,1 9,15H5M19,3H5C3.89,3 3,3.9 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5A2,2 0 0,0 19,3",
				...
				"language-r":"M12,4.29C6.5,4.29 2,7.29 2,11C2,14.28 5.56,17 10.24,17.58V19.71H13.65V17.59C14.5,17.5 15.29,17.34 16.04,17.11L17.42,19.71H21.28L18.96,15.8C20.83,14.58 22,12.87 22,11C22,7.29 17.5,4.29 12,4.29V4.29M13.53,6.91C17.73,6.91 20.83,8.31 20.83,11.5C20.83,13.21 19.91,14.41 18.41,15.15C18.32,15.1 18.24,15.05 18.19,15C17.83,14.84 17.23,14.66 17.23,14.66C17.23,14.66 20.21,14.44 20.21,11.47C20.21,8.5 17.09,8.45 17.09,8.45H10.24V15.61C7.69,14.87 5.93,13.3 5.93,11.5C5.93,8.96 9.33,6.91 13.53,6.91M13.68,10.89H15.75C15.75,10.89 16.7,10.84 16.7,11.83C16.7,12.8 15.75,12.8 15.75,12.8H13.68V10.89M13.65,15.3H14.57C14.75,15.3 14.84,15.35 15,15.5C15.13,15.6 15.27,15.79 15.39,15.96C14.84,16.03 14.26,16.06 13.65,16.06V15.3Z",
				"language-swift":"M17.09,19.72C14.73,21.08 11.5,21.22 8.23,19.82C5.59,18.7 3.4,16.74 2,14.5C2.67,15.05 3.46,15.5 4.3,15.9C7.67,17.47 11.03,17.36 13.4,15.9C10.03,13.31 7.16,9.94 5.03,7.19C4.58,6.74 4.25,6.18 3.91,5.68C12.19,11.73 11.83,13.27 6.32,4.67C11.21,9.61 15.75,12.41 15.75,12.41C15.91,12.5 16,12.57 16.11,12.63C16.21,12.38 16.3,12.12 16.37,11.85C17.16,9 16.26,5.73 14.29,3.04C18.84,5.79 21.54,10.95 20.41,15.28C20.38,15.39 20.35,15.5 20.36,15.67C22.6,18.5 22,21.45 21.71,20.89C20.5,18.5 18.23,19.24 17.09,19.72V19.72Z",
				"language-typescript":"M3,3H21V21H3V3M13.71,17.86C14.21,18.84 15.22,19.59 16.8,19.59C18.4,19.59 19.6,18.76 19.6,17.23C19.6,15.82 18.79,15.19 17.35,14.57L16.93,14.39C16.2,14.08 15.89,13.87 15.89,13.37C15.89,12.96 16.2,12.64 16.7,12.64C17.18,12.64 17.5,12.85 17.79,13.37L19.1,12.5C18.55,11.54 17.77,11.17 16.7,11.17C15.19,11.17 14.22,12.13 14.22,13.4C14.22,14.78 15.03,15.43 16.25,15.95L16.67,16.13C17.45,16.47 17.91,16.68 17.91,17.26C17.91,17.74 17.46,18.09 16.76,18.09C15.93,18.09 15.45,17.66 15.09,17.06L13.71,17.86M13,11.25H8V12.75H9.5V20H11.25V12.75H13V11.25Z",
				...
				"laptop-off":"M1,4.27L2.28,3L20,20.72L18.73,22L16.73,20H0V18H4C2.89,18 2,17.1 2,16V6C2,5.78 2.04,5.57 2.1,5.37L1,4.27M4,16H12.73L4,7.27V16M20,16V6H7.82L5.82,4H20A2,2 0 0,1 22,6V16A2,2 0 0,1 20,18H24V20H21.82L17.82,16H20Z",
				...
				"lightbulb-on":"M12,6A6,6 0 0,1 18,12C18,14.22 16.79,16.16 15,17.2V19A1,1 0 0,1 14,20H10A1,1 0 0,1 9,19V17.2C7.21,16.16 6,14.22 6,12A6,6 0 0,1 12,6M14,21V22A1,1 0 0,1 13,23H11A1,1 0 0,1 10,22V21H14M20,11H23V13H20V11M1,11H4V13H1V11M13,1V4H11V1H13M4.92,3.5L7.05,5.64L5.63,7.05L3.5,4.93L4.92,3.5M16.95,5.63L19.07,3.5L20.5,4.93L18.37,7.05L16.95,5.63Z",
				...
				"linkedin-box":"M19,3A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3H19M18.5,18.5V13.2A3.26,3.26 0 0,0 15.24,9.94C14.39,9.94 13.4,10.46 12.92,11.24V10.13H10.13V18.5H12.92V13.57C12.92,12.8 13.54,12.17 14.31,12.17A1.4,1.4 0 0,1 15.71,13.57V18.5H18.5M6.88,8.56A1.68,1.68 0 0,0 8.56,6.88C8.56,5.95 7.81,5.19 6.88,5.19A1.69,1.69 0 0,0 5.19,6.88C5.19,7.81 5.95,8.56 6.88,8.56M8.27,18.5V10.13H5.5V18.5H8.27Z",
				...
				"lock-reset":"M12.63,2C18.16,2 22.64,6.5 22.64,12C22.64,17.5 18.16,22 12.63,22C9.12,22 6.05,20.18 4.26,17.43L5.84,16.18C7.25,18.47 9.76,20 12.64,20A8,8 0 0,0 20.64,12A8,8 0 0,0 12.64,4C8.56,4 5.2,7.06 4.71,11H7.47L3.73,14.73L0,11H2.69C3.19,5.95 7.45,2 12.63,2M15.59,10.24C16.09,10.25 16.5,10.65 16.5,11.16V15.77C16.5,16.27 16.09,16.69 15.58,16.69H10.05C9.54,16.69 9.13,16.27 9.13,15.77V11.16C9.13,10.65 9.54,10.25 10.04,10.24V9.23C10.04,7.7 11.29,6.46 12.81,6.46C14.34,6.46 15.59,7.7 15.59,9.23V10.24M12.81,7.86C12.06,7.86 11.44,8.47 11.44,9.23V10.24H14.19V9.23C14.19,8.47 13.57,7.86 12.81,7.86Z",
				"locker":"M8,2H16A2,2 0 0,1 18,4V20A2,2 0 0,1 16,22H8A2,2 0 0,1 6,20V4A2,2 0 0,1 8,2M8,4V20H16V4H8M10,13H12V17H10V13M10,6H14V7.5H10V6M10,9H14V10.5H10V9Z",
				"locker-multiple":"M3,2H21A2,2 0 0,1 23,4V20A2,2 0 0,1 21,22H3A2,2 0 0,1 1,20V4A2,2 0 0,1 3,2M13,4V20H21V4H13M3,4V20H11V4H3M5,13H7V17H5V13M5,6H9V7.5H5V6M5,9H9V10.5H5V9M15,13H17V17H15V13M15,6H19V7.5H15V6M15,9H19V10.5H15V9Z",
				...
				"loop":"M9,14V21H2V19H5.57C4,17.3 3,15 3,12.5A9.5,9.5 0 0,1 12.5,3A9.5,9.5 0 0,1 22,12.5A9.5,9.5 0 0,1 12.5,22H12V20H12.5A7.5,7.5 0 0,0 20,12.5A7.5,7.5 0 0,0 12.5,5A7.5,7.5 0 0,0 5,12.5C5,14.47 5.76,16.26 7,17.6V14H9Z",
				...
				"magnify-minus-outline":"M15.5,14H14.71L14.43,13.73C15.41,12.59 16,11.11 16,9.5A6.5,6.5 0 0,0 9.5,3A6.5,6.5 0 0,0 3,9.5A6.5,6.5 0 0,0 9.5,16C11.11,16 12.59,15.41 13.73,14.43L14,14.71V15.5L19,20.5L20.5,19L15.5,14M9.5,14C7,14 5,12 5,9.5C5,7 7,5 9.5,5C12,5 14,7 14,9.5C14,12 12,14 9.5,14M7,9H12V10H7V9Z",
				...
				"magnify-plus-outline":"M15.5,14L20.5,19L19,20.5L14,15.5V14.71L13.73,14.43C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.43,13.73L14.71,14H15.5M9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14M12,10H10V12H9V10H7V9H9V7H10V9H12V10Z",
				...
				"menu-down-outline":"M18,9V10.5L12,16.5L6,10.5V9H18M12,13.67L14.67,11H9.33L12,13.67Z",
				"menu-left":"M14,7L9,12L14,17V7Z",
				"menu-right":"M10,17L15,12L10,7V17Z",
				"menu-up":"M7,15L12,10L17,15H7Z",
				"menu-up-outline":"M18,16V14.5L12,8.5L6,14.5V16H18M12,11.33L14.67,14H9.33L12,11.33Z",
				...
				"message-bulleted":"M20,2H4A2,2 0 0,0 2,4V22L6,18H20A2,2 0 0,0 22,16V4A2,2 0 0,0 20,2M8,14H6V12H8V14M8,11H6V9H8V11M8,8H6V6H8V8M15,14H10V12H15V14M18,11H10V9H18V11M18,8H10V6H18V8Z",
				"message-bulleted-off":"M1.27,1.73L0,3L2,5V22L6,18H15L20.73,23.73L22,22.46L1.27,1.73M8,14H6V12H8V14M6,11V9L8,11H6M20,2H4.08L10,7.92V6H18V8H10.08L11.08,9H18V11H13.08L20.07,18C21.14,17.95 22,17.08 22,16V4A2,2 0 0,0 20,2Z",
				...
				"metronome-tick":"M12,1.75L8.57,2.67L4.07,19.5C4.06,19.5 4,19.84 4,20C4,21.11 4.89,22 6,22H18C19.11,22 20,21.11 20,20C20,19.84 19.94,19.5 19.93,19.5L15.43,2.67L12,1.75M10.29,4H13.71L17.2,17H13V12H11V17H6.8L10.29,4M11,5V9H10V11H14V9H13V5H11Z",
				"micro-sd":"M8,2A2,2 0 0,0 6,4V11L4,13V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V4A2,2 0 0,0 18,2H8M9,4H11V8H9V4M12,4H14V8H12V4M15,4H17V8H15V4Z",
				...
				"movie-roll":"M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A2.5,2.5 0 0,0 9.5,6.5A2.5,2.5 0 0,0 12,9A2.5,2.5 0 0,0 14.5,6.5A2.5,2.5 0 0,0 12,4M4.4,9.53C3.97,10.84 4.69,12.25 6,12.68C7.32,13.1 8.73,12.39 9.15,11.07C9.58,9.76 8.86,8.35 7.55,7.92C6.24,7.5 4.82,8.21 4.4,9.53M19.61,9.5C19.18,8.21 17.77,7.5 16.46,7.92C15.14,8.34 14.42,9.75 14.85,11.07C15.28,12.38 16.69,13.1 18,12.67C19.31,12.25 20.03,10.83 19.61,9.5M7.31,18.46C8.42,19.28 10,19.03 10.8,17.91C11.61,16.79 11.36,15.23 10.24,14.42C9.13,13.61 7.56,13.86 6.75,14.97C5.94,16.09 6.19,17.65 7.31,18.46M16.7,18.46C17.82,17.65 18.07,16.09 17.26,14.97C16.45,13.85 14.88,13.6 13.77,14.42C12.65,15.23 12.4,16.79 13.21,17.91C14,19.03 15.59,19.27 16.7,18.46M12,10.5A1.5,1.5 0 0,0 10.5,12A1.5,1.5 0 0,0 12,13.5A1.5,1.5 0 0,0 13.5,12A1.5,1.5 0 0,0 12,10.5Z",
				...
				"mushroom":"M12,2A10,10 0 0,1 22,12A2,2 0 0,1 20,14H4A2,2 0 0,1 2,12A10,10 0 0,1 12,2M12,8A2,2 0 0,0 14,6A2,2 0 0,0 12,4A2,2 0 0,0 10,6A2,2 0 0,0 12,8M17,12A2,2 0 0,0 19,10A2,2 0 0,0 17,8A2,2 0 0,0 15,10A2,2 0 0,0 17,12M7,12A2,2 0 0,0 9,10A2,2 0 0,0 7,8A2,2 0 0,0 5,10A2,2 0 0,0 7,12M15,15L16.27,19.45L16.35,20C16.35,21.1 15.45,22 14.35,22H9.65A2,2 0 0,1 7.65,20L7.73,19.45L9,15H15Z",
				"mushroom-outline":"M4,12H20C20,8.27 17.44,5.13 14,4.25C13.86,5.24 13,6 12,6C11,6 10.14,5.24 10,4.25C6.56,5.13 4,8.27 4,12M12,2A10,10 0 0,1 22,12A2,2 0 0,1 20,14H4A2,2 0 0,1 2,12A10,10 0 0,1 12,2M13.5,17H10.5L9.92,19L9.65,20H14.35L14.08,19L13.5,17M15,15L16,18.5L16.27,19.45L16.35,20C16.35,21.1 15.45,22 14.35,22H9.65L9.17,21.94C8.1,21.66 7.45,20.57 7.73,19.5L8,18.5L9,15H15M16,7A2,2 0 0,1 18,9A2,2 0 0,1 16,11A2,2 0 0,1 14,9A2,2 0 0,1 16,7M8,7A2,2 0 0,1 10,9A2,2 0 0,1 8,11A2,2 0 0,1 6,9A2,2 0 0,1 8,7Z",
				...
				"music-off":"M2,5.27L3.28,4L20,20.72L18.73,22L9,12.27V17.5A3.5,3.5 0 0,1 5.5,21A3.5,3.5 0 0,1 2,17.5A3.5,3.5 0 0,1 5.5,14C6.04,14 6.55,14.12 7,14.34V10.27L2,5.27M21,3V15.5C21,16.5 20.57,17.42 19.88,18.06L14.94,13.12C15.58,12.43 16.5,12 17.5,12C18.04,12 18.55,12.12 19,12.34V6.47L10.17,8.35L7.66,5.84L21,3Z",
				...
				"network":"M17,3A2,2 0 0,1 19,5V15A2,2 0 0,1 17,17H13V19H14A1,1 0 0,1 15,20H22V22H15A1,1 0 0,1 14,23H10A1,1 0 0,1 9,22H2V20H9A1,1 0 0,1 10,19H11V17H7C5.89,17 5,16.1 5,15V5A2,2 0 0,1 7,3H17Z",
				...
				"note-multiple":"M16,9H21.5L16,3.5V9M7,2H17L23,8V18A2,2 0 0,1 21,20H7C5.89,20 5,19.1 5,18V4A2,2 0 0,1 7,2M3,6V22H21V24H3A2,2 0 0,1 1,22V6H3Z",
				"note-multiple-outline":"M3,6V22H21V24H3A2,2 0 0,1 1,22V6H3M16,9H21.5L16,3.5V9M7,2H17L23,8V18A2,2 0 0,1 21,20H7C5.89,20 5,19.1 5,18V4A2,2 0 0,1 7,2M7,4V18H21V11H14V4H7Z",
				...
				"notebook":"M3,7V5H5V4C5,2.89 5.9,2 7,2H13V9L15.5,7.5L18,9V2H19C20.05,2 21,2.95 21,4V20C21,21.05 20.05,22 19,22H7C5.95,22 5,21.05 5,20V19H3V17H5V13H3V11H5V7H3M7,11H5V13H7V11M7,7V5H5V7H7M7,19V17H5V19H7Z",
				...
				"nut":"M21,16.5C21,16.88 20.79,17.21 20.47,17.38L12.57,21.82C12.41,21.94 12.21,22 12,22C11.79,22 11.59,21.94 11.43,21.82L3.53,17.38C3.21,17.21 3,16.88 3,16.5V7.5C3,7.12 3.21,6.79 3.53,6.62L11.43,2.18C11.59,2.06 11.79,2 12,2C12.21,2 12.41,2.06 12.57,2.18L20.47,6.62C20.79,6.79 21,7.12 21,7.5V16.5M12,7A5,5 0 0,0 7,12A5,5 0 0,0 12,17A5,5 0 0,0 17,12A5,5 0 0,0 12,7Z",
				...
				"oar":"M20.23,15.21C18.77,13.75 14.97,10.2 12.77,11.27L4.5,3L3,4.5L11.28,12.79C10.3,15 13.88,18.62 15.35,20.08C17.11,21.84 18.26,20.92 19.61,19.57C21.1,18.08 21.61,16.61 20.23,15.21Z",
				...
				"octagram":"M2.2,16.06L3.88,12L2.2,7.94L6.26,6.26L7.94,2.2L12,3.88L16.06,2.2L17.74,6.26L21.8,7.94L20.12,12L21.8,16.06L17.74,17.74L16.06,21.8L12,20.12L7.94,21.8L6.26,17.74L2.2,16.06Z",
				"octagram-outline":"M2.2,16.06L3.88,12L2.2,7.94L6.26,6.26L7.94,2.2L12,3.88L16.06,2.2L17.74,6.26L21.8,7.94L20.12,12L21.8,16.06L17.74,17.74L16.06,21.8L12,20.12L7.94,21.8L6.26,17.74L2.2,16.06M4.81,9L6.05,12L4.81,15L7.79,16.21L9,19.19L12,17.95L15,19.19L16.21,16.21L19.19,15L17.95,12L19.19,9L16.21,7.79L15,4.81L12,6.05L9,4.81L7.79,7.79L4.81,9Z",
				...
				"onenote":"M1.96,4.8L14,3.08V5H20L21,5A1,1 0 0,1 22,6V10A1,1 0 0,1 21,11H20V19H14V21L1.96,19.21V4.8M11,16.75V8.25L9,8.5V12.75L7,8.75L5,9V16L6.5,16.25V10.75L9,16.5L11,16.75M14,14H18V13H14V14M14,11H18V10H14V11M14,8H18V7H14V8M14,16V17H18V16H14Z",
				...
				"orbit":"M8.11,1.75C9.3,1.25 10.62,1 12,1C18.08,1 23,5.92 23,12C23,18.08 18.08,23 12,23C5.92,23 1,18.08 1,12C1,10.62 1.25,9.3 1.72,8.08C2.24,8.61 2.83,8.96 3.45,9.18C3.16,10.07 3,11 3,12A9,9 0 0,0 12,21A9,9 0 0,0 21,12A9,9 0 0,0 12,3C11,3 10.07,3.16 9.18,3.45C8.96,2.83 8.61,2.24 8.11,1.75M4.93,2.93C6.03,2.93 6.93,3.82 6.93,4.93A2,2 0 0,1 4.93,6.93C3.82,6.93 2.93,6.03 2.93,4.93C2.93,3.82 3.82,2.93 4.93,2.93M12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7Z",
				...
				"page-layout-body":"M6,2H18A2,2 0 0,1 20,4V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V4A2,2 0 0,1 6,2M6,8V16H18V8H6Z",
				"page-layout-footer":"M6,2H18A2,2 0 0,1 20,4V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V4A2,2 0 0,1 6,2M6,16V20H18V16H6Z",
				"page-layout-header":"M6,2H18A2,2 0 0,1 20,4V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V4A2,2 0 0,1 6,2M6,4V8H18V4H6Z",
				"page-layout-sidebar-left":"M6,2H18A2,2 0 0,1 20,4V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V4A2,2 0 0,1 6,2M6,8V16H10V8H6Z",
				"page-layout-sidebar-right":"M6,2H18A2,2 0 0,1 20,4V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V4A2,2 0 0,1 6,2M14,8V16H18V8H14Z",
				...
				"pencil-circle":"M12,2C6.47,2 2,6.47 2,12C2,17.53 6.47,22 12,22C17.53,22 22,17.53 22,12C22,6.47 17.53,2 12,2M15.1,7.07C15.24,7.07 15.38,7.12 15.5,7.23L16.77,8.5C17,8.72 17,9.07 16.77,9.28L15.77,10.28L13.72,8.23L14.72,7.23C14.82,7.12 14.96,7.07 15.1,7.07M13.13,8.81L15.19,10.87L9.13,16.93H7.07V14.87L13.13,8.81Z",
				...
				"pentagon":"M12,2.5L2,9.8L5.8,21.5H18.2L22,9.8L12,2.5Z",
				"pentagon-outline":"M12,5L19.6,10.5L16.7,19.4H7.3L4.4,10.5L12,5M12,2.5L2,9.8L5.8,21.5H18.1L22,9.8L12,2.5Z",
				...
				"periodic-table-co2":"M5,7A2,2 0 0,0 3,9V15A2,2 0 0,0 5,17H8V15H5V9H8V7H5M11,7A2,2 0 0,0 9,9V15A2,2 0 0,0 11,17H13A2,2 0 0,0 15,15V9A2,2 0 0,0 13,7H11M11,9H13V15H11V9M16,10.5V12H19V13.5H17.5A1.5,1.5 0 0,0 16,15V18H20.5V16.5H17.5V15H19A1.5,1.5 0 0,0 20.5,13.5V12A1.5,1.5 0 0,0 19,10.5H16Z",
				"periscope":"M12,7A2,2 0 0,1 10,9A2,2 0 0,1 8,7C7.37,7.84 7,8.87 7,10A5,5 0 0,0 12,15A5,5 0 0,0 17,10A5,5 0 0,0 12,5C11.57,5 11.16,5.05 10.77,5.15C11.5,5.45 12,6.17 12,7M12,2A8,8 0 0,1 20,10C20,11.05 19.8,12.04 19.43,12.96C17.89,17.38 13.63,22 12,22C10.37,22 6.11,17.38 4.57,12.96C4.2,12.04 4,11.05 4,10A8,8 0 0,1 12,2Z",
				...
				"piano":"M4,3H20A2,2 0 0,1 22,5V19A2,2 0 0,1 20,21H4A2,2 0 0,1 2,19V5A2,2 0 0,1 4,3M4,5V19H8V13H6.75V5H4M9,19H15V13H13.75V5H10.25V13H9V19M16,19H20V5H17.25V13H16V19Z",
				...
				"pillar":"M6,5H18A1,1 0 0,1 19,6A1,1 0 0,1 18,7H6A1,1 0 0,1 5,6A1,1 0 0,1 6,5M21,2V4H3V2H21M15,8H17V22H15V8M7,8H9V22H7V8M11,8H13V22H11V8Z",
				...
				"pipe":"M22,14H20V16H14V13H16V11H14V6A2,2 0 0,0 12,4H4V2H2V10H4V8H10V11H8V13H10V18A2,2 0 0,0 12,20H20V22H22",
				"pipe-disconnected":"M16,9V11H8V9H10V8H4V10H2V2H4V4H12A2,2 0 0,1 14,6V9H16M10,15V18A2,2 0 0,0 12,20H20V22H22V14H20V16H14V15H16V13H8V15H10Z",
				"pistol":"M7,5H23V9H22V10H16A1,1 0 0,0 15,11V12A2,2 0 0,1 13,14H9.62C9.24,14 8.89,14.22 8.72,14.56L6.27,19.45C6.1,19.79 5.76,20 5.38,20H2C2,20 -1,20 3,14C3,14 6,10 2,10V5H3L3.5,4H6.5L7,5M14,12V11A1,1 0 0,0 13,10H12C12,10 11,11 12,12A2,2 0 0,1 10,10A1,1 0 0,0 9,11V12A1,1 0 0,0 10,13H13A1,1 0 0,0 14,12Z",
				...
				"plane-shield":"M12,1L3,5V11C3,16.55 6.84,21.74 12,23C17.16,21.74 21,16.55 21,11V5L12,1M12,5.68C12.5,5.68 12.95,6.11 12.95,6.63V10.11L18,13.26V14.53L12.95,12.95V16.42L14.21,17.37V18.32L12,17.68L9.79,18.32V17.37L11.05,16.42V12.95L6,14.53V13.26L11.05,10.11V6.63C11.05,6.11 11.5,5.68 12,5.68Z",
				...
				"plus-outline":"M4,9H9V4H15V9H20V15H15V20H9V15H4V9M11,13V18H13V13H18V11H13V6H11V11H6V13H11Z",
				...
				"power-socket-uk":"M14.5,13.75H18V16H14.5V13.75M6,13.75H9.5V16H6V13.75M11,6H13V10H11V6M4.22,2A2.22,2.22 0 0,0 2,4.22V19.78C2,21 3,22 4.22,22H19.78A2.22,2.22 0 0,0 22,19.78V4.22C22,3 21,2 19.78,2H4.22M12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4Z",
				"power-socket-us":"M8,7H10V12H8V7M4.22,2H19.78C21,2 22,3 22,4.22V19.78A2.22,2.22 0 0,1 19.78,22H4.22C3,22 2,21 2,19.78V4.22A2.22,2.22 0 0,1 4.22,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4M14,7.5H16V11.5H14V7.5M10.5,16.25A1.5,1.5 0 0,1 12,14.75A1.5,1.5 0 0,1 13.5,16.25V17H10.5V16.25Z",
				"prescription":"M4,4V10L4,14H6V10H8L13.41,15.41L9.83,19L11.24,20.41L14.83,16.83L18.41,20.41L19.82,19L16.24,15.41L19.82,11.83L18.41,10.41L14.83,14L10.83,10H11A3,3 0 0,0 14,7A3,3 0 0,0 11,4H4M6,6H11A1,1 0 0,1 12,7A1,1 0 0,1 11,8H6V6Z",
				...
				"printer-settings":"M18,2V6H6V2H18M19,11A1,1 0 0,0 20,10A1,1 0 0,0 19,9A1,1 0 0,0 18,10A1,1 0 0,0 19,11M16,18V13H8V18H16M19,7A3,3 0 0,1 22,10V16H18V20H6V16H2V10A3,3 0 0,1 5,7H19M15,24V22H17V24H15M11,24V22H13V24H11M7,24V22H9V24H7Z",
				...
				"publish":"M5,4V6H19V4H5M5,14H9V20H15V14H19L12,7L5,14Z",
				...
				"reorder-horizontal":"M3,15H21V13H3V15M3,19H21V17H3V19M3,11H21V9H3V11M3,5V7H21V5H3Z",
				"reorder-vertical":"M9,3V21H11V3H9M5,3V21H7V3H5M13,3V21H15V3H13M19,3H17V21H19V3Z",
				...
				"restart":"M11,4C13.05,4 15.09,4.77 16.65,6.33C19.78,9.46 19.77,14.5 16.64,17.64C14.81,19.5 12.3,20.24 9.91,19.92L10.44,17.96C12.15,18.12 13.93,17.54 15.24,16.23C17.58,13.89 17.58,10.09 15.24,7.75C14.06,6.57 12.53,6 11,6V10.58L6.04,5.63L11,0.68V4M5.34,17.65C2.7,15 2.3,11 4.11,7.94L5.59,9.41C4.5,11.64 4.91,14.39 6.75,16.23C7.27,16.75 7.87,17.16 8.5,17.45L8,19.4C7,19 6.12,18.43 5.34,17.65Z",
				"restore":"M13,3A9,9 0 0,0 4,12H1L4.89,15.89L4.96,16.03L9,12H6A7,7 0 0,1 13,5A7,7 0 0,1 20,12A7,7 0 0,1 13,19C11.07,19 9.32,18.21 8.06,16.94L6.64,18.36C8.27,20 10.5,21 13,21A9,9 0 0,0 22,12A9,9 0 0,0 13,3M12,8V13L16.28,15.54L17,14.33L13.5,12.25V8H12Z",
				"rewind":"M11.5,12L20,18V6M11,18V6L2.5,12L11,18Z",
				"rewind-outline":"M10,9.9L7,12L10,14.1V9.9M19,9.9L16,12L19,14.1V9.9M12,6V18L3.5,12L12,6M21,6V18L12.5,12L21,6Z",
				"rhombus":"M21.5,10.8L13.2,2.5C12.5,1.8 11.5,1.8 10.8,2.5L2.5,10.8C1.8,11.5 1.8,12.5 2.5,13.2L10.8,21.5C11.5,22.2 12.5,22.2 13.2,21.5L21.5,13.2C22.1,12.5 22.1,11.5 21.5,10.8Z",
				"rhombus-outline":"M21.5,10.8L13.2,2.5C12.5,1.8 11.5,1.8 10.8,2.5L2.5,10.8C1.8,11.5 1.8,12.5 2.5,13.2L10.8,21.5C11.5,22.2 12.5,22.2 13.2,21.5L21.5,13.2C22.1,12.5 22.1,11.5 21.5,10.8M20.3,12L12,20.3L3.7,12L12,3.7L20.3,12Z",
				...
				"rice":"M22,11H19.7C19.4,9.9 18.9,8.8 18.2,8L21.6,2.6L19.9,1.5L16.7,6.6C16.3,6.3 16,6.1 15.5,5.9L16.4,2.3L14.5,1.8L13.7,5.2C13.1,5.1 12.6,5 12,5C8.3,5 5.2,7.6 4.3,11H2C2,15.1 4.5,18.6 8,20.2V22H16V20.2C19.5,18.6 22,15.1 22,11M12,7C14.6,7 16.8,8.7 17.6,11H6.4C7.2,8.7 9.4,7 12,7Z",
				"ring":"M12,10L8,4.4L9.6,2H14.4L16,4.4L12,10M15.5,6.8L14.3,8.5C16.5,9.4 18,11.5 18,14A6,6 0 0,1 12,20A6,6 0 0,1 6,14C6,11.5 7.5,9.4 9.7,8.5L8.5,6.8C5.8,8.1 4,10.8 4,14A8,8 0 0,0 12,22A8,8 0 0,0 20,14C20,10.8 18.2,8.1 15.5,6.8Z",
				...
				"scanner":"M19.8,10.7L4.2,5L3.5,6.9L17.6,12H5A2,2 0 0,0 3,14V18A2,2 0 0,0 5,20H19A2,2 0 0,0 21,18V12.5C21,11.7 20.5,10.9 19.8,10.7M7,17H5V15H7V17M19,17H9V15H19V17Z",
				...
				"security-home":"M11,13H13V16H16V11H18L12,6L6,11H8V16H11V13M12,1L21,5V11C21,16.55 17.16,21.74 12,23C6.84,21.74 3,16.55 3,11V5L12,1Z",
				...
				"selection":"M2,4C2,2.89 2.9,2 4,2H7V4H4V7H2V4M22,4V7H20V4H17V2H20A2,2 0 0,1 22,4M20,20V17H22V20C22,21.11 21.1,22 20,22H17V20H20M2,20V17H4V20H7V22H4A2,2 0 0,1 2,20M10,2H14V4H10V2M10,20H14V22H10V20M20,10H22V14H20V10M2,10H4V14H2V10Z",
				"selection-off":"M0.5,3.77L1.78,2.5L21.5,22.22L20.23,23.5L18.73,22H17V20.27L3.73,7H2V5.27L0.5,3.77M4,2H7V4H5.82L3.83,2H4M22,4V7H20V4H17V2H20A2,2 0 0,1 22,4M20,17H22V20L22,20.17L20,18.18V17M2,20V17H4V20H7V22H4A2,2 0 0,1 2,20M10,2H14V4H10V2M10,20H14V22H10V20M20,10H22V14H20V10M2,10H4V14H2V10Z",
				"send":"M2,21L23,12L2,3V10L17,12L2,14V21Z",
				"send-secure":"M23,18V17.5A2.5,2.5 0 0,0 20.5,15A2.5,2.5 0 0,0 18,17.5V18A1,1 0 0,0 17,19V23A1,1 0 0,0 18,24H23A1,1 0 0,0 24,23V19A1,1 0 0,0 23,18M22,18H19V17.5A1.5,1.5 0 0,1 20.5,16A1.5,1.5 0 0,1 22,17.5V18M23,12L2,21V14L17,12L2,10V3L23,12Z",
				...
				"shield-half-full":"M21,11C21,16.55 17.16,21.74 12,23C6.84,21.74 3,16.55 3,11V5L12,1L21,5V11M12,21C15.75,20 19,15.54 19,11.22V6.3L12,3.18V21Z",
				...
				"sign-direction":"M11,12H3.5L6,9.5L3.5,7H11V3L12,2L13,3V7H18L20.5,9.5L18,12H13V20A2,2 0 0,1 15,22H9A2,2 0 0,1 11,20V12Z",
				"sign-text":"M11,3L12,2L13,3V5H20A1,1 0 0,1 21,6V16A1,1 0 0,1 20,17H13V20A2,2 0 0,1 15,22H9A2,2 0 0,1 11,20V17H4A1,1 0 0,1 3,16V6A1,1 0 0,1 4,5H11V3M6,8V10H18V8H6M6,12V14H13V12H6Z",
				"signal":"M3,21H6V18H3M8,21H11V14H8M13,21H16V9H13M18,21H21V3H18V21Z",
				"signal-2g":"M11,19.5H2V13.5A3,3 0 0,1 5,10.5H8V7.5H2V4.5H8A3,3 0 0,1 11,7.5V10.5A3,3 0 0,1 8,13.5H5V16.5H11M22,10.5H17.5V13.5H19V16.5H16V7.5H22V4.5H16A3,3 0 0,0 13,7.5V16.5A3,3 0 0,0 16,19.5H19A3,3 0 0,0 22,16.5",
				"signal-3g":"M11,16.5V14.25C11,13 10,12 8.75,12C10,12 11,11 11,9.75V7.5A3,3 0 0,0 8,4.5H2V7.5H8V10.5H5V13.5H8V16.5H2V19.5H8A3,3 0 0,0 11,16.5M22,16.5V10.5H17.5V13.5H19V16.5H16V7.5H22V4.5H16A3,3 0 0,0 13,7.5V16.5A3,3 0 0,0 16,19.5H19A3,3 0 0,0 22,16.5Z",
				"signal-4g":"M22,16.5V10.5H17.5V13.5H19V16.5H16V7.5H22V4.5H16A3,3 0 0,0 13,7.5V16.5A3,3 0 0,0 16,19.5H19A3,3 0 0,0 22,16.5M8,19.5H11V4.5H8V10.5H5V4.5H2V13.5H8V19.5Z",
				"signal-hspa":"M10.5,10.5H13.5V4.5H16.5V19.5H13.5V13.5H10.5V19.5H7.5V4.5H10.5V10.5Z",
				"signal-hspa-plus":"M19,8V11H22V14H19V17H16V14H13V11H16V8H19M5,10.5H8V4.5H11V19.5H8V13.5H5V19.5H2V4.5H5V10.5Z",
				"signal-off":"M18,3V16.18L21,19.18V3H18M4.28,5L3,6.27L10.73,14H8V21H11V14.27L13,16.27V21H16V19.27L19.73,23L21,21.72L4.28,5M13,9V11.18L16,14.18V9H13M3,18V21H6V18H3Z",
				...
				"skull":"M12,2A9,9 0 0,0 3,11C3,14.03 4.53,16.82 7,18.47V22H9V19H11V22H13V19H15V22H17V18.46C19.47,16.81 21,14 21,11A9,9 0 0,0 12,2M8,11A2,2 0 0,1 10,13A2,2 0 0,1 8,15A2,2 0 0,1 6,13A2,2 0 0,1 8,11M16,11A2,2 0 0,1 18,13A2,2 0 0,1 16,15A2,2 0 0,1 14,13A2,2 0 0,1 16,11M12,14L13.5,17H10.5L12,14Z",
				...
				"source-commit":"M17,12C17,14.42 15.28,16.44 13,16.9V21H11V16.9C8.72,16.44 7,14.42 7,12C7,9.58 8.72,7.56 11,7.1V3H13V7.1C15.28,7.56 17,9.58 17,12M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9Z",
				"source-commit-end":"M17,12A5,5 0 0,1 12,17A5,5 0 0,1 7,12C7,9.58 8.72,7.56 11,7.1V3H13V7.1C15.28,7.56 17,9.58 17,12M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9Z",
				"source-commit-end-local":"M12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9M11,5V3H13V5H11Z",
				"source-commit-local":"M12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9M11,5V3H13V5H11M11,21V19H13V21H11Z",
				"source-commit-next-local":"M17,12A5,5 0 0,1 12,17A5,5 0 0,1 7,12C7,9.58 8.72,7.56 11,7.1V3H13V7.1C15.28,7.56 17,9.58 17,12M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9M11,21V19H13V21H11Z",
				"source-commit-start":"M12,7A5,5 0 0,1 17,12C17,14.42 15.28,16.44 13,16.9V21H11V16.9C8.72,16.44 7,14.42 7,12A5,5 0 0,1 12,7M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9Z",
				"source-commit-start-next-local":"M12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9M11,21V19H13V21H11Z",
				...
				"soy-sauce":"M13.9,7.5C13.9,6.8 14.1,6.3 14.2,6H14.8L15.7,3.5H16.5V2H7.5V3.5H8.3L9.2,6H9.8C10,6.3 10.1,6.8 10.1,7.5C10.1,8.8 6,13.7 6,17.6V19.6C6,21 8.7,21.9 12,21.9C15.3,21.9 18,21 18,19.6V17.6C18,13.7 13.9,8.8 13.9,7.5M12,15A2,2 0 0,1 10,13A2,2 0 0,1 12,11A2,2 0 0,1 14,13A2,2 0 0,1 12,15Z",
				...
				"speaker-wireless":"M20.07,19.07L18.66,17.66C20.11,16.22 21,14.21 21,12C21,9.78 20.11,7.78 18.66,6.34L20.07,4.93C21.88,6.74 23,9.24 23,12C23,14.76 21.88,17.26 20.07,19.07M17.24,16.24L15.83,14.83C16.55,14.11 17,13.11 17,12C17,10.89 16.55,9.89 15.83,9.17L17.24,7.76C18.33,8.85 19,10.35 19,12C19,13.65 18.33,15.15 17.24,16.24M4,3H12A2,2 0 0,1 14,5V19A2,2 0 0,1 12,21H4A2,2 0 0,1 2,19V5A2,2 0 0,1 4,3M8,5A2,2 0 0,0 6,7A2,2 0 0,0 8,9A2,2 0 0,0 10,7A2,2 0 0,0 8,5M8,11A4,4 0 0,0 4,15A4,4 0 0,0 8,19A4,4 0 0,0 12,15A4,4 0 0,0 8,11M8,13A2,2 0 0,1 10,15A2,2 0 0,1 8,17A2,2 0 0,1 6,15A2,2 0 0,1 8,13Z",
				...
				"square-outline":"M3,3H21V21H3V3M5,5V19H19V5H5Z",
				"square-root":"M11.76,16.83L14.59,14L11.76,11.17L13.17,9.76L16,12.59L18.83,9.76L20.24,11.17L17.41,14L20.24,16.83L18.83,18.24L16,15.41L13.17,18.24L11.76,16.83M2,11H5V11H5L7.29,16.4L10,6H22V8H11.55L8.68,19H6.22L3.68,13H2V11Z",
				...
				"sticker-emoji":"M5.5,2C3.56,2 2,3.56 2,5.5V18.5C2,20.44 3.56,22 5.5,22H16L22,16V5.5C22,3.56 20.44,2 18.5,2H5.5M5.75,4H18.25A1.75,1.75 0 0,1 20,5.75V15H18.5C16.56,15 15,16.56 15,18.5V20H5.75A1.75,1.75 0 0,1 4,18.25V5.75A1.75,1.75 0 0,1 5.75,4M14.44,6.77C14.28,6.77 14.12,6.79 13.97,6.83C13.03,7.09 12.5,8.05 12.74,9C12.79,9.15 12.86,9.3 12.95,9.44L16.18,8.56C16.18,8.39 16.16,8.22 16.12,8.05C15.91,7.3 15.22,6.77 14.44,6.77M8.17,8.5C8,8.5 7.85,8.5 7.7,8.55C6.77,8.81 6.22,9.77 6.47,10.7C6.5,10.86 6.59,11 6.68,11.16L9.91,10.28C9.91,10.11 9.89,9.94 9.85,9.78C9.64,9 8.95,8.5 8.17,8.5M16.72,11.26L7.59,13.77C8.91,15.3 11,15.94 12.95,15.41C14.9,14.87 16.36,13.25 16.72,11.26Z",
				...
				"surround-sound-2-0":"M17,7H19A2,2 0 0,1 21,9V15A2,2 0 0,1 19,17H17A2,2 0 0,1 15,15V9A2,2 0 0,1 17,7M17,9V15H19V9H17M9,17H3V15L7,9H3V7H7A2,2 0 0,1 9,9C9,9.42 8.87,9.81 8.65,10.13L5.41,15H9V17M12,17A1,1 0 0,1 11,16A1,1 0 0,1 12,15A1,1 0 0,1 13,16A1,1 0 0,1 12,17Z",
				"surround-sound-3-1":"M13,17A1,1 0 0,1 12,16A1,1 0 0,1 13,15A1,1 0 0,1 14,16A1,1 0 0,1 13,17M19,7V15H20V17H16V15H17V9H16L17,7H19M4,7H8A2,2 0 0,1 10,9V15A2,2 0 0,1 8,17H4V15H8V13H5V11H8V9H4V7Z",
				"surround-sound-5-1":"M13,17A1,1 0 0,1 12,16A1,1 0 0,1 13,15A1,1 0 0,1 14,16A1,1 0 0,1 13,17M19,7V15H20V17H16V15H17V9H16L17,7H19M6,13A2,2 0 0,1 4,11V7H10V9H6V11H8A2,2 0 0,1 10,13V15A2,2 0 0,1 8,17H4V15H8V13H6Z",
				"surround-sound-7-1":"M12,17A1,1 0 0,1 11,16A1,1 0 0,1 12,15A1,1 0 0,1 13,16A1,1 0 0,1 12,17M18,7V15H19V17H15V15H16V9H15L16,7H18M11,7L8,17H6L8.4,9H5V7H11Z",
				"svg":"M5.13,10.71H8.87L6.22,8.06C5.21,8.06 4.39,7.24 4.39,6.22A1.83,1.83 0 0,1 6.22,4.39C7.24,4.39 8.06,5.21 8.06,6.22L10.71,8.87V5.13C10,4.41 10,3.25 10.71,2.54C11.42,1.82 12.58,1.82 13.29,2.54C14,3.25 14,4.41 13.29,5.13V8.87L15.95,6.22C15.95,5.21 16.76,4.39 17.78,4.39C18.79,4.39 19.61,5.21 19.61,6.22C19.61,7.24 18.79,8.06 17.78,8.06L15.13,10.71H18.87C19.59,10 20.75,10 21.46,10.71C22.18,11.42 22.18,12.58 21.46,13.29C20.75,14 19.59,14 18.87,13.29H15.13L17.78,15.95C18.79,15.95 19.61,16.76 19.61,17.78A1.83,1.83 0 0,1 17.78,19.61C16.76,19.61 15.95,18.79 15.95,17.78L13.29,15.13V18.87C14,19.59 14,20.75 13.29,21.46C12.58,22.18 11.42,22.18 10.71,21.46C10,20.75 10,19.59 10.71,18.87V15.13L8.06,17.78C8.06,18.79 7.24,19.61 6.22,19.61C5.21,19.61 4.39,18.79 4.39,17.78C4.39,16.76 5.21,15.95 6.22,15.95L8.87,13.29H5.13C4.41,14 3.25,14 2.54,13.29C1.82,12.58 1.82,11.42 2.54,10.71C3.25,10 4.41,10 5.13,10.71Z",
				...
				"sword-cross":"M6.2,2.44L18.1,14.34L20.22,12.22L21.63,13.63L19.16,16.1L22.34,19.28C22.73,19.67 22.73,20.3 22.34,20.69L21.63,21.4C21.24,21.79 20.61,21.79 20.22,21.4L17,18.23L14.56,20.7L13.15,19.29L15.27,17.17L3.37,5.27V2.44H6.2M15.89,10L20.63,5.26V2.44H17.8L13.06,7.18L15.89,10M10.94,15L8.11,12.13L5.9,14.34L3.78,12.22L2.37,13.63L4.84,16.1L1.66,19.29C1.27,19.68 1.27,20.31 1.66,20.7L2.37,21.41C2.76,21.8 3.39,21.8 3.78,21.41L7,18.23L9.44,20.7L10.85,19.29L8.73,17.17L10.94,15Z",
				...
				"tab-plus":"M19,19V9H12V5H5V19H19M19,3A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5C3,3.89 3.9,3 5,3H19M7,13H10V10H12V13H15V15H12V18H10V15H7V13Z",
				...
				"table-settings":"M7,22H9V24H7V22M11,22H13V24H11V22M15,22H17V24H15V22M5,4H19A2,2 0 0,1 21,6V18A2,2 0 0,1 19,20H5A2,2 0 0,1 3,18V6A2,2 0 0,1 5,4M5,8V12H11V8H5M13,8V12H19V8H13M5,14V18H11V14H5M13,14V18H19V14H13Z",
				...
				"taco":"M19,18H5A4,4 0 0,1 1,14A8,8 0 0,1 9,6C10.06,6 11.07,6.21 12,6.58C12.93,6.21 13.94,6 15,6A8,8 0 0,1 23,14A4,4 0 0,1 19,18M3,14A2,2 0 0,0 5,16A2,2 0 0,0 7,14C7,11.63 8.03,9.5 9.67,8.04L9,8A6,6 0 0,0 3,14M19,16A2,2 0 0,0 21,14A6,6 0 0,0 15,8A6,6 0 0,0 9,14C9,14.73 8.81,15.41 8.46,16H19Z",
				...
				"television-classic":"M8.16,3L6.75,4.41L9.34,7H4C2.89,7 2,7.89 2,9V19C2,20.11 2.89,21 4,21H20C21.11,21 22,20.11 22,19V9C22,7.89 21.11,7 20,7H14.66L17.25,4.41L15.84,3L12,6.84L8.16,3M4,9H17V19H4V9M19.5,9A1,1 0 0,1 20.5,10A1,1 0 0,1 19.5,11A1,1 0 0,1 18.5,10A1,1 0 0,1 19.5,9M19.5,12A1,1 0 0,1 20.5,13A1,1 0 0,1 19.5,14A1,1 0 0,1 18.5,13A1,1 0 0,1 19.5,12Z",
				...
				"textbox-password":"M17,7H22V17H17V19A1,1 0 0,0 18,20H20V22H17.5C16.95,22 16,21.55 16,21C16,21.55 15.05,22 14.5,22H12V20H14A1,1 0 0,0 15,19V5A1,1 0 0,0 14,4H12V2H14.5C15.05,2 16,2.45 16,3C16,2.45 16.95,2 17.5,2H20V4H18A1,1 0 0,0 17,5V7M2,7H13V9H4V15H13V17H2V7M20,15V9H17V15H20M8.5,12A1.5,1.5 0 0,0 7,10.5A1.5,1.5 0 0,0 5.5,12A1.5,1.5 0 0,0 7,13.5A1.5,1.5 0 0,0 8.5,12M13,10.89C12.39,10.33 11.44,10.38 10.88,11C10.32,11.6 10.37,12.55 11,13.11C11.55,13.63 12.43,13.63 13,13.11V10.89Z",
				...
				"timer-sand":"M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5M10,6H14V6.75L12,8.75L10,6.75V6Z",
				"timer-sand-empty":"M6,2V8H6V8L10,12L6,16V16H6V22H18V16H18V16L14,12L18,8V8H18V2H6M16,16.5V20H8V16.5L12,12.5L16,16.5M12,11.5L8,7.5V4H16V7.5L12,11.5Z",
				"timer-sand-full":"M6,2V8H6V8L10,12L6,16V16H6V22H18V16H18V16L14,12L18,8V8H18V2H6Z",
				...
				"tower-beach":"M17,4V8H18V10H17.64L21,23H18.93L18.37,20.83L12,17.15L5.63,20.83L5.07,23H3L6.36,10H6V8H7V4H6V3L18,1V4H17M7.28,14.43L6.33,18.12L10,16L7.28,14.43M15.57,10H8.43L7.8,12.42L12,14.85L16.2,12.42L15.57,10M17.67,18.12L16.72,14.43L14,16L17.67,18.12Z",
				"tower-fire":"M17,4V8H18V10H17.64L21,23H18.93L18.37,20.83L12,17.15L5.63,20.83L5.07,23H3L6.36,10H6V8H7V4H6V3L12,1L18,3V4H17M7.28,14.43L6.33,18.12L10,16L7.28,14.43M15.57,10H8.43L7.8,12.42L12,14.85L16.2,12.42L15.57,10M17.67,18.12L16.72,14.43L14,16L17.67,18.12Z",
				"trackpad":"M4,3H20A2,2 0 0,1 22,5V19A2,2 0 0,1 20,21H4A2,2 0 0,1 2,19V5A2,2 0 0,1 4,3M4,5V13H20V5H4M4,19H11V15H4V19M20,19V15H13V19H20Z",
				...
				"treasure-chest":"M5,4H19A3,3 0 0,1 22,7V11H15V10H9V11H2V7A3,3 0 0,1 5,4M11,11H13V13H11V11M2,12H9V13L11,15H13L15,13V12H22V20H2V12Z",
				...
				"truck-fast":"M3,13.5L2.25,12H7.5L6.9,10.5H2L1.25,9H9.05L8.45,7.5H1.11L0.25,6H4A2,2 0 0,1 6,4H18V8H21L24,12V17H22A3,3 0 0,1 19,20A3,3 0 0,1 16,17H12A3,3 0 0,1 9,20A3,3 0 0,1 6,17H4V13.5H3M19,18.5A1.5,1.5 0 0,0 20.5,17A1.5,1.5 0 0,0 19,15.5A1.5,1.5 0 0,0 17.5,17A1.5,1.5 0 0,0 19,18.5M20.5,9.5H18V12H22.46L20.5,9.5M9,18.5A1.5,1.5 0 0,0 10.5,17A1.5,1.5 0 0,0 9,15.5A1.5,1.5 0 0,0 7.5,17A1.5,1.5 0 0,0 9,18.5Z",
				"truck-trailer":"M22,15V17H10A3,3 0 0,1 7,20A3,3 0 0,1 4,17H2V6A2,2 0 0,1 4,4H17A2,2 0 0,1 19,6V15H22M7,16A1,1 0 0,0 6,17A1,1 0 0,0 7,18A1,1 0 0,0 8,17A1,1 0 0,0 7,16Z",
				...
				"uber":"M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22C6.64,22 2.27,17.79 2,12.5H9V14.5A0.5,0.5 0 0,0 9.5,15H14.5A0.5,0.5 0 0,0 15,14.5V9.5A0.5,0.5 0 0,0 14.5,9H9.5A0.5,0.5 0 0,0 9,9.5V11.5H2C2.27,6.21 6.64,2 12,2Z",
				...
				"ultra-high-definition":"M9,7H11V11H13V7H15V17H13V13H11V17H9V7M17,7H20A3,3 0 0,1 23,10V14A3,3 0 0,1 20,17H17V7M20,15A1,1 0 0,0 21,14V10A1,1 0 0,0 20,9H19V15H20M7,14A3,3 0 0,1 4,17A3,3 0 0,1 1,14V7H3V14A1,1 0 0,0 4,15A1,1 0 0,0 5,14V7H7V14Z",
				...
				"unfold-less-horizontal":"M16.59,5.41L15.17,4L12,7.17L8.83,4L7.41,5.41L12,10M7.41,18.59L8.83,20L12,16.83L15.17,20L16.58,18.59L12,14L7.41,18.59Z",
				"unfold-less-vertical":"M5.41,7.41L10,12L5.41,16.59L4,15.17L7.17,12L4,8.83L5.41,7.41M18.59,16.59L14,12L18.59,7.42L20,8.83L16.83,12L20,15.17L18.59,16.59Z",
				"unfold-more-horizontal":"M12,18.17L8.83,15L7.42,16.41L12,21L16.59,16.41L15.17,15M12,5.83L15.17,9L16.58,7.59L12,3L7.41,7.59L8.83,9L12,5.83Z",
				"unfold-more-vertical":"M18.17,12L15,8.83L16.41,7.41L21,12L16.41,16.58L15,15.17L18.17,12M5.83,12L9,15.17L7.59,16.59L3,12L7.59,7.42L9,8.83L5.83,12Z",
				...
				"unity":"M9.11,17H6.5L1.59,12L6.5,7H9.11L10.42,4.74L17.21,3L19.08,9.74L17.77,12L19.08,14.26L17.21,21L10.42,19.26L9.11,17M9.25,16.75L14.38,18.13L11.42,13H5.5L9.25,16.75M16.12,17.13L17.5,12L16.12,6.87L13.15,12L16.12,17.13M9.25,7.25L5.5,11H11.42L14.38,5.87L9.25,7.25Z",
				...
				"upload-multiple":"M9,14V8H5L12,1L19,8H15V14H9M5,18V16H19V18H5M19,20H5V22H19V20Z",
				"upload-network":"M17,3A2,2 0 0,1 19,5V15A2,2 0 0,1 17,17H13V19H14A1,1 0 0,1 15,20H22V22H15A1,1 0 0,1 14,23H10A1,1 0 0,1 9,22H2V20H9A1,1 0 0,1 10,19H11V17H7C5.89,17 5,16.1 5,15V5A2,2 0 0,1 7,3H17M12,5.5L7.5,10H11V14H13V10H16.5L12,5.5Z",
				...
				"van-passenger":"M3,7C1.89,7 1,7.89 1,9V17H3A3,3 0 0,0 6,20A3,3 0 0,0 9,17H15A3,3 0 0,0 18,20A3,3 0 0,0 21,17H23V13C23,11.89 22.11,11 21,11L18,7H3M3,8.5H7V11H3V8.5M9,8.5H13V11H9V8.5M15,8.5H17.5L19.46,11H15V8.5M6,15.5A1.5,1.5 0 0,1 7.5,17A1.5,1.5 0 0,1 6,18.5A1.5,1.5 0 0,1 4.5,17A1.5,1.5 0 0,1 6,15.5M18,15.5A1.5,1.5 0 0,1 19.5,17A1.5,1.5 0 0,1 18,18.5A1.5,1.5 0 0,1 16.5,17A1.5,1.5 0 0,1 18,15.5Z",
				...
				"vanish":"M16,13V11H21V13H16M14.83,7.76L17.66,4.93L19.07,6.34L16.24,9.17L14.83,7.76M11,16H13V21H11V16M11,3H13V8H11V3M4.93,17.66L7.76,14.83L9.17,16.24L6.34,19.07L4.93,17.66M4.93,6.34L6.34,4.93L9.17,7.76L7.76,9.17L4.93,6.34M8,13H3V11H8V13M19.07,17.66L17.66,19.07L14.83,16.24L16.24,14.83L19.07,17.66Z",
				...
				"vector-radius":"M2,4H4V2H10V4A10,10 0 0,1 20,14H22V20H20V22H18V20H16V14H18A8,8 0 0,0 10,6V8H4V6H2V4M18,16V18H20V16H18M6,4V6H8V4H6Z",
				...
				"venmo":"M19.5,3C20.14,4.08 20.44,5.19 20.44,6.6C20.44,11.08 16.61,16.91 13.5,21H6.41L3.56,4L9.77,3.39L11.28,15.5C12.69,13.21 14.42,9.61 14.42,7.16C14.42,5.81 14.19,4.9 13.83,4.15L19.5,3Z",
				...
				"video-3d":"M5,7H9A2,2 0 0,1 11,9V15A2,2 0 0,1 9,17H5V15H9V13H6V11H9V9H5V7M13,7H16A3,3 0 0,1 19,10V14A3,3 0 0,1 16,17H13V7M16,15A1,1 0 0,0 17,14V10A1,1 0 0,0 16,9H15V15H16Z",
				...
				"view-parallel":"M4,21V3H8V21H4M10,21V3H14V21H10M16,21V3H20V21H16Z",
				"view-quilt":"M10,5V11H21V5M16,18H21V12H16M4,18H9V5H4M10,18H15V12H10V18Z",
				"view-sequential":"M3,4H21V8H3V4M3,10H21V14H3V10M3,16H21V20H3V16Z",
				...
				"volume-mute":"M3,9H7L12,4V20L7,15H3V9M16.59,12L14,9.41L15.41,8L18,10.59L20.59,8L22,9.41L19.41,12L22,14.59L20.59,16L18,13.41L15.41,16L14,14.59L16.59,12Z",
				...
				"volume-plus":"M3,9H7L12,4V20L7,15H3V9M14,11H17V8H19V11H22V13H19V16H17V13H14V11Z",
				...
				"vuejs":"M2,3H5.5L12,15L18.5,3H22L12,21L2,3M6.5,3H9.5L12,7.58L14.5,3H17.5L12,13.08L6.5,3Z",
				...
				"wall":"M3,16H12V21H3V16M2,10H8V15H2V10M9,10H15V15H9V10M16,10H22V15H16V10M13,16H21V21H13V16M3,4H11V9H3V4M12,4H21V9H12V4Z",
				...
				"widgets":"M3,3H11V7.34L16.66,1.69L22.31,7.34L16.66,13H21V21H13V13H16.66L11,7.34V11H3V3M3,13H11V21H3V13Z",
				...
				"wiiu":"M2,15.96C2,18.19 3.54,19.5 5.79,19.5H18.57C20.47,19.5 22,18.2 22,16.32V6.97C22,5.83 21.15,4.6 20.11,4.6H17.15V12.3C17.15,18.14 6.97,18.09 6.97,12.41V4.5H4.72C3.26,4.5 2,5.41 2,6.85V15.96M9.34,11.23C9.34,15.74 14.66,15.09 14.66,11.94V4.5H9.34V11.23Z",
