				...
				this.aside.addEventListener(`click`,event=>{
					...
					switch(target){
						...
						case this.actions.data:
							...
							break;
						case this.actions.link:
							this.custom||this.retired?page.alert(`No${this.custom?`t`:` longer`} available.`):!page.offline?location.href=`https://materialdesignicons.com/icon/${this.name}`:page.alert`Could not connect.`;
							break;
						default:
